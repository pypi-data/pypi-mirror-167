...
def match_container_type(type_name, candidate_type_names, candidate_default_height="2"):
    ...
    exact_match = outer.loc[outer["candidate_code"] == outer["my_code"], ["candidate_name", "candidate_code", "my_code", "index"]]
    ...
    if len(exact_match) == 0:
        length_match = outer.loc[(outer["candidate_length"] == outer["my_length"]) & (
                    (outer["candidate_maintype"] == outer["my_maintype"]) | (outer["candidate_maintype"] == "*")) & (
                                     ...
                                     "candidate_name", "candidate_code", "my_code", "index", "candidate_height", "my_height",
        ...
        if len(length_match) > 0:
            ...
            if len(subtype_exact_match) > 0:
                ...
                return subtype_exact_match["index"].values[0]
            else:
                ...
                if len(maintype_height_exact_match) > 0:
                    ...
                    return maintype_height_exact_match["index"].values[0]
                else:
                    ...
                    if len(only_maintype_exact_match) > 0:
                        ...
                        return only_maintype_exact_match["index"].values[0]
                    else:
                        only_height_exact_match = length_match.loc[height_exact_filt, :]
                        if len(only_height_exact_match) > 0:
                            print(only_height_exact_match)
                            return only_height_exact_match["index"].values[0]
                        else:
                            print(length_match)
                            return length_match["index"].values[0]
    else:
        print(exact_match)
...
def match_container_types(type_names, candidate_type_names, candidate_default_height="2"):
    ...
    df_unique_names["match_index"] = [match_container_type(type_name, candidate_type_names, candidate_default_height) for type_name in
                                      df_unique_names["type_name"]]
