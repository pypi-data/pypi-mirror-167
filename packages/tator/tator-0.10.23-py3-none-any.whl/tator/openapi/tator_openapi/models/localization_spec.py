...
class LocalizationSpec(object):
    ...
    def __init__(self, frame=None, height=None, media_id=None, parent=None, points=None, type=None, u=None, v=None, version=None, width=None, x=None, y=None, local_vars_configuration=None):  # noqa: E501
