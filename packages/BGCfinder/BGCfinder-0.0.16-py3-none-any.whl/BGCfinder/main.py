...
from BGCfinder.model import GINEConv_pretrain, GINEConv_train, model_prediction
...
def main():
	...
	# Configuration
	MODEL_CHECKPOINT_PATH = absolute_pwd('model/BGC_finder_checkpoint')
	if not os.path_import_exists(MODEL_CHECKPOINT_PATH):
	...
	model = GINEConv_train(pretrain_model=GINEConv_pretrain(num_hidden= 15, num_node_features=12, num_edge_features=4, n_layers=150).to(device),
