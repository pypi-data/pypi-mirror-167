...
R4Z1_INSTANCES = PlatformInstances(instance_types=[
    AWS_T4_G1,
    AWS_T4_G4,
    AWS_T4_G8,
    AWS_K80_24G_G1,
...
class R4Z1Platform(GenericK8sPlatform):
    """ R4Z1 Platform Overrides """

    allowed_instances: PlatformInstances = R4Z1_INSTANCES
