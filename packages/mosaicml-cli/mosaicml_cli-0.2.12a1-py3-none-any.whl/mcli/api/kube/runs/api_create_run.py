...
def create_run(
    ...
    Args:
        ...
        _priority (``Optional[PriorityLabel | str]``): **DEPRECATED** An optional priority
            level at which the run should be created. Only effective for certain platforms.
    ...
    # If internal, add agent
    if conf.internal and mcli_job.optimization_level > 0:
        agent_integration = MCLIGitRepoIntegration(
        ...
        mcli_job.integrations.append(agent_integration)
