...
Note: if you're running tests that interface with MAPI/query graphql, you'll want to make sure to run `export MOSAICML_API_ENDPOINT=http://localhost:3001/graphql` to point to your local graphql server.
