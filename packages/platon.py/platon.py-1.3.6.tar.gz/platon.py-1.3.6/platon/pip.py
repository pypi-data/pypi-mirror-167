...
class Pip(InnerContract):
    ...
    def submit_version_proposal(self,
        ...
        """
        return self.function_factory(InnerFn.govern_submitVersionProposal, locals())
    ...
    def submit_param_proposal(self,
        ...
        """
        return self.function_factory(InnerFn.govern_submitParamProposal, locals())
    ...
    def submit_text_proposal(self,
        ...
        :param pip_number: generally, it is the pull request id of github.com/PlatONNetwork/PIPs project
        """
        return self.function_factory(InnerFn.govern_submitTextProposal, locals())
    ...
    def submit_cancel_proposal(self,
        ...
        """
        return self.function_factory(InnerFn.govern_submitCancelProposal, locals())
    ...
    def vote(self,
        ...
        """
        return self.function_factory(InnerFn.govern_vote, locals())
    ...
    def declare_version(self,
        ...
        :param version_sign: node version signature, obtained by rpc 'admin_getProgramVersion' interface
        """
        return self.function_factory(InnerFn.govern_declareVersion, locals())
    ...
    def get_proposal(self, proposal_id: Union[bytes, HexStr]):
        ...
        """
        return self.function_factory(InnerFn.govern_getProposal, locals(), is_call=True)
    ...
    def get_proposal_votes(self,
        ...
        return self.function_factory(InnerFn.govern_getProposalVotes, kwargs, is_call=True)
    ...
    def get_proposal_result(self, proposal_id: Union[bytes, HexStr]):
        ...
        """
        return self.function_factory(InnerFn.govern_getProposalResult, locals(), is_call=True)

    def proposal_list(self):
        """
        Get proposal list for the chain
        """
        return self.function_factory(InnerFn.govern_proposalList, locals(), is_call=True)

    def get_chain_version(self):
        """
        Query the chain effective version of the node
        """
        return self.function_factory(InnerFn.govern_getChainVersion, locals(), is_call=True)
    ...
    def get_govern_param(self, module: str, name: str):
        ...
        :param name: parameter name
        """
        return self.function_factory(InnerFn.govern_getGovernParam, locals(), is_call=True)
    ...
    def govern_param_list(self, module: str = ''):
        ...
        """
        return self.function_factory(InnerFn.govern_governParamList, locals(), is_call=True)
