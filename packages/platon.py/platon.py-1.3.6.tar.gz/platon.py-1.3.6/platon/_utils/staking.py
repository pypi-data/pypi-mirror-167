...
class Staking(InnerContract):
    ...
    def create_staking(self,
        ...
        """
        return self.function_factory(InnerFn.staking_createStaking, locals())
    ...
    def edit_staking(self,
        ...
        return self.function_factory(InnerFn.staking_editStaking, kwargs)
    ...
    def increase_staking(self,
        ...
        """
        return self.function_factory(InnerFn.staking_increaseStaking, locals())
    ...
    def withdrew_staking(self, node_id: Union[NodeID, HexStr]):
        ...
        """
        return self.function_factory(InnerFn.staking_withdrewStaking, locals())

    def get_candidate_list(self):
        """
        Gets all staking node information.
        """
        return self.function_factory(InnerFn.staking_getCandidateList, locals())

    def get_verifier_list(self):
        """
        Get all verifier node information.
        """
        return self.function_factory(InnerFn.staking_getVerifierList, locals(), is_call=True)

    def get_validator_list(self):
        """
        get information about the current consensus verifier node.
        """
        return self.function_factory(InnerFn.staking_getValidatorList, locals(), is_call=True)
    ...
    def get_candidate_info(self, node_id: Union[NodeID, HexStr]):
        ...
        """
        return self.function_factory(InnerFn.staking_getCandidateInfo, locals(), is_call=True)

    def get_block_reward(self):
        """
        get the current block reward, which is updated every epoch.
        """
        return self.function_factory(InnerFn.staking_getBlockReward, locals(), is_call=True)

    def get_staking_reward(self):
        """
        get the current staking reward, which is updated every epoch.
        """
        return self.function_factory(InnerFn.staking_getStakingReward, locals(), is_call=True)

    def get_avg_block_time(self):
        """
        Get the average block time over history.
        """
        return self.function_factory(InnerFn.staking_getAvgBlockTime, locals(), is_call=True)
