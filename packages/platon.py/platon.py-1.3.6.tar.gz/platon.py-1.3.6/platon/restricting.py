...
class Restricting(InnerContract):
    ...
    def create_restricting(self,
        ...
        return self.function_factory(InnerFn.restricting_createRestricting, kwargs)
    ...
    def get_restricting_info(self, release_address: Bech32Address):
        ...
        """
        return self.function_factory(InnerFn.restricting_getRestrictingInfo, locals(), is_call=True)
