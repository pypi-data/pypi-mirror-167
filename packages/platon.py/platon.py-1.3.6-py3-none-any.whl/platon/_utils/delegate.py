...
class _DelegatePart(InnerContract):
    ...
    def delegate(self,
        ...
        return self.function_factory(InnerFn.delegate_delegate, kwargs)
    ...
    def withdrew_delegate(self,
        ...
        return self.function_factory(InnerFn.delegate_withdrewDelegate, kwargs)

    def redeem_delegate(self):
        """
        redeem all unlocked delegates.
        """
        return self.function_factory(InnerFn.delegate_redeemDelegate, locals())

    def get_delegate_list(self, address: Bech32Address):
        """
        Get all delegate information of the address.
        """
        return self.function_factory(InnerFn.delegate_getDelegateList, locals(), is_call=True)
    ...
    def get_delegate_info(self,
        ...
        block = self.web3.platon.get_block(staking_block_identifier)
        kwargs['staking_block_identifier'] = block['number']
        return self.function_factory(InnerFn.delegate_getDelegateInfo, kwargs, is_call=True)

    def get_delegate_lock_info(self, address: Bech32Address):
        """
        Get locked delegate information of the address.
        """
        return self.function_factory(InnerFn.delegate_getDelegateLockInfo, locals(), is_call=True)
...
class _DelegateReward(InnerContract):
    ...
    def withdraw_delegate_reward(self):
        ...
        """
        return self.function_factory(InnerFn.delegate_withdrawDelegateReward, locals())
    ...
    def get_delegate_reward(self,
        ...
        return self.function_factory(InnerFn.delegate_getDelegateReward, kwargs, is_call=True)
