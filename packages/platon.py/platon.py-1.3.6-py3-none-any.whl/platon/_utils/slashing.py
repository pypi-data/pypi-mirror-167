...
class Slashing(InnerContract):
    ...
    def report_duplicate_sign(self, report_type: int, data: str):
        ...
        """
        return self.function_factory(InnerFn.slashing_reportDuplicateSign, locals())
    ...
    def check_duplicate_sign(self,
        ...
        return self.function_factory(InnerFn.slashing_checkDuplicateSign, kwargs, is_call=True)
