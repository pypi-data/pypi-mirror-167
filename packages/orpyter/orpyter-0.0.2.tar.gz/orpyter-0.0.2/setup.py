...
DESCRIPTION = "Yet another tool to turn python functions into microservices with auto-generated HTTP API, interactive UI, and more."
URL = "https://github.com/weanalyze/orpyter"
EMAIL = "dev@weanalyze.co"
