...
from django_filters.fields import ModelMultipleChoiceField, ModelChoiceField

from extras.forms import NautobotFilterForm
...
class CableTemplateFilterForm(NautobotFilterForm):
    ...
    owner = ModelMultipleChoiceField(queryset=Tenant.objects.all(), to_field_name="slug", required=False, widget=StaticSelect2())
    plug = ModelMultipleChoiceField(queryset=CablePlug.objects.all(), to_field_name="name", required=False, widget=StaticSelect2())
