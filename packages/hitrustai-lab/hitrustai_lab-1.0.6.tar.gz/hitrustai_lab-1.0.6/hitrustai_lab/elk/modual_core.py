...
class UpdateELKAPI:
    ...
    def get_update_data(self):
        ...
        if info_start_point is None:
            ...
            info_data = self.orm.query_filter(self.dict_arg["orm_predict_info"], self.n_rows, (self.dict_arg["orm_predict_info"].pk_id > info_start_point))
            result_data = self.orm.query_filter(self.dict_arg["orm_predict_result"], self.n_rows, (self.dict_arg["orm_predict_result"].pk_id > result_start_point))
        ...
        if info_data.shape[0] == 0 and result_data.shape[0] == 0:
            ...
            predict_data = self.orm.query_filter(self.dict_arg["orm_predict_result"], self.n_rows, (self.dict_arg["orm_result_id"].in_(info_data['pk_id'].tolist())))
