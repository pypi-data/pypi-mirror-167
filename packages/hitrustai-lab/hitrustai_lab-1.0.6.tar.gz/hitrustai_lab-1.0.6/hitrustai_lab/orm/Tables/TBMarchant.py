...
class TBmerchantRiskInfo(Base):
    ...
    diia_serial_number = Column(VARCHAR(100))
    customer_id = Column(VARCHAR(20))
    ...
    merchant_id = Column(VARCHAR(100))
    pan_hash = Column(VARCHAR(100))
    purchase_amount = Column(VARCHAR(100))
    purchase_currency = Column(Integer, nullable=False)
    merchant_create_time = Column(VARCHAR(50))
