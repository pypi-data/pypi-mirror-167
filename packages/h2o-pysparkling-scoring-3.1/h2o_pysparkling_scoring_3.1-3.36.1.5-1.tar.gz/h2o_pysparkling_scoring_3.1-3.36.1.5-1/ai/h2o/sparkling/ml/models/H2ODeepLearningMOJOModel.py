...
from ai.h2o.sparkling.ml.params.HasDeprecatedAutoencoderOnMOJO import HasDeprecatedAutoencoderOnMOJO


class H2ODeepLearningMOJOModel(H2OSupervisedMOJOModelParams, HasIgnoredColsOnMOJO, HasDeprecatedVariableImportancesOnMOJO, HasDeprecatedAutoencoderOnMOJO):
