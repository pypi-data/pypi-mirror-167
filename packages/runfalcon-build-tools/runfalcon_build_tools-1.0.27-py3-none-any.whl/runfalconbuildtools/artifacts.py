...
class S3ArtifactMetadata:
    ...
    def to_simple_file_name(self) -> str:
        return  self.name + \
                ('-' + self.latest_version if self.latest_version != None else '') + \
                '.' + self.type
...
class S3Artifact(Artifact):
    ...
    def __init__(self, name:str, type:str, version:str = None):
    ...
    def is_latest_version(self) -> bool:
        return self.version == None or self.version == 'latest'
