...
from runfalconbuildtools.repository_manager import RepositoryManager, Repository
...
class AppBuilder(BaseBuilder, ABC):
    ...
    def get_source_artifacts(self):
        ...
        repository_manager:RepositoryManager = RepositoryManager(repository)
        repository_manager.get_source_artifacts(self.get_app_directory())
