...
def read_annotations_pvoc(path: str) -> list[dict]:
    '''
    Reads all xml files in path as pvoc data and returns the annotations, which is a list with a dict for every object.
    '''
    data = []
