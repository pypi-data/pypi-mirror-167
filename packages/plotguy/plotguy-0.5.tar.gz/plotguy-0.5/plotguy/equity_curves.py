...
class Plot:
    ...
    def __new__(self, filename, output_folder, start_date, end_date, para_dict, result_df, generate_filepath):
        ...
        subchart_dropdown = components.subchart_dropdown
                ...
                if chart2_button_clicks > self.chart2_button_clicks:
                    ...
                    if self.chart_type == 2:
                        ...
                        if self.line_selected > -1:
                            ...
                            sub_chart1_area = {}
                            sub_chart2_area = {}
                            sub_chart1 = components.generate_subchart(df_chart, 'volume', 'bar', 'yellow')
                            sub_chart2 = components.generate_subchart(df_chart, 'sma', 'line', '#FF01FE')
