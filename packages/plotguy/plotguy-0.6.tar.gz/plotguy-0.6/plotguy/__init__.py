...
def plot_equity_curves(filename, output_folder, start_date, end_date, para_dict, result_df):

    app = equity_curves.Plot(filename, output_folder, start_date, end_date, para_dict, result_df, generate_filepath)
