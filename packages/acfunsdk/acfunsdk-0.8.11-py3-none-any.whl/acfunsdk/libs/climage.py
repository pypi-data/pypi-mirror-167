...
def populate_kdtree(color_type, palette):
    ...
    if color_type == _color_types.color8:
        ...
        for s in [8, 18, 28, 38, 48, 58, 68, 78, 88, 98, 108, 118, 128, 138, 148, 158, 168, 178, 188, 198, 208, 218,
                  228, 238]:
...
def _get_system_colors(palette):
    ...
    if palette == "default":
        return [[0, 0, 0, 0], [128, 0, 0, 1], [0, 128, 0, 2], [128, 128, 0, 3], [0, 0, 128, 4], [128, 0, 128, 5],
                [0, 128, 128, 6], [192, 192, 192, 7], [128, 128, 128, 8], [255, 0, 0, 9], [0, 255, 0, 10],
                [255, 255, 0, 11], [0, 0, 255, 12], [255, 0, 255, 13], [0, 255, 255, 14], [255, 255, 255, 15]]
    if palette == "xterm":
        return [[0, 0, 0, 0], [205, 0, 0, 1], [0, 205, 0, 2], [205, 205, 0, 3], [0, 0, 238, 4], [205, 0, 205, 5],
                [0, 205, 205, 6], [229, 229, 229, 7], [127, 127, 127, 8], [255, 0, 0, 9], [0, 255, 0, 10],
                [255, 255, 0, 11], [92, 92, 255, 12], [255, 0, 255, 13], [0, 255, 255, 14], [255, 255, 255, 15]]
    elif palette == "linuxconsole":
        return [[0, 0, 0, 0], [170, 0, 0, 1], [0, 170, 0, 2], [170, 85, 0, 3], [0, 0, 170, 4], [170, 0, 170, 5],
                [0, 170, 170, 6], [170, 170, 170, 7], [85, 85, 85, 8], [255, 85, 85, 9], [85, 255, 85, 10],
                [255, 255, 85, 11], [85, 85, 255, 12], [255, 85, 255, 13], [85, 255, 255, 14], [255, 255, 255, 15]]
    elif palette == "solarized":
        return [[7, 54, 66, 0], [220, 50, 47, 1], [133, 153, 0, 2], [181, 137, 0, 3], [38, 139, 210, 4],
                [211, 54, 130, 5], [42, 161, 152, 6], [238, 232, 213, 7], [0, 43, 54, 8], [203, 75, 22, 9],
                [88, 110, 117, 10], [101, 123, 131, 11], [131, 148, 150, 12], [108, 113, 196, 13], [147, 161, 161, 14],
                [253, 246, 227, 15]]
    elif palette == "rxvt":
        return [[0, 0, 0, 0], [205, 0, 0, 1], [0, 205, 0, 2], [205, 205, 0, 3], [0, 0, 205, 4], [205, 0, 205, 5],
                [0, 205, 205, 6], [250, 235, 215, 7], [64, 64, 64, 8], [255, 0, 0, 9], [0, 255, 0, 10],
                [255, 255, 0, 11], [0, 0, 255, 12], [255, 0, 255, 13], [0, 255, 255, 14], [255, 255, 255, 15]]
    elif palette == "tango":
        return [[0, 0, 0, 0], [204, 0, 0, 1], [78, 154, 6, 2], [196, 160, 0, 3], [52, 101, 164, 4], [117, 80, 123, 5],
                [6, 152, 154, 6], [211, 215, 207, 7], [85, 87, 83, 8], [239, 41, 41, 9], [138, 226, 52, 10],
                [252, 233, 79, 11], [114, 159, 207, 12], [173, 127, 168, 13], [52, 226, 226, 14], [238, 238, 236, 15]]
    elif palette == "gruvbox":
        return [[251, 241, 199, 0], [204, 36, 29, 1], [152, 151, 26, 2], [215, 153, 33, 3], [69, 133, 136, 4],
                [177, 98, 134, 5], [104, 157, 106, 6], [124, 111, 100, 7], [146, 131, 116, 8], [157, 0, 6, 9],
                [121, 116, 14, 10], [181, 118, 20, 11], [7, 102, 120, 12], [143, 63, 113, 13], [66, 123, 88, 14],
                [60, 56, 54, 15]]
    elif palette == "gruvboxdark":
        return [[40, 40, 40, 0], [204, 36, 29, 1], [152, 151, 26, 2], [215, 153, 33, 3], [69, 133, 136, 4],
                [177, 98, 134, 5], [104, 157, 106, 6], [168, 153, 132, 7], [146, 131, 116, 8], [251, 73, 52, 9],
                [184, 187, 38, 10], [250, 189, 47, 11], [131, 165, 152, 12], [211, 134, 155, 13], [142, 192, 124, 14],
                [235, 219, 178, 15]]
