...
USER root"""
    ...
    files = [path for path in os.listdir(channeldir) if path != '.devcontainer']
    for filepath in files:
        if filepath == 'data':
            data = [path for path in os.listdir(os.path.join(channeldir, 'data')) if path != 'volumes']
            for datapath in data:
                if os.path.isdir(os.path.join(channeldir, filepath, datapath)):  shutil.copytree(os.path.join(channeldir, filepath, datapath), os.path.join(builddir, filepath, datapath))
                else: shutil.copyfile(os.path.join(channeldir, filepath, datapath), os.path.join(builddir, filepath, datapath))
        elif os.path.isdir(os.path.join(channeldir, filepath)):  shutil.copytree(os.path.join(channeldir, filepath), os.path.join(builddir, filepath))
