...
_lists = {
    ...
    "Pixels": {"Channel", "TiffData", "Plane", "BinData"},
    "Plane": {"AnnotationRef"},
    "Channel": {"AnnotationRef"},
    "MicrobeamManipulation": {"ROIRef", "Type", "LightSourceSettings"},
    "Instrument": {
        "Detector",
        "Dichroic",
        "FilterSet",
    ...
    "ROI": {"AnnotationRef"},
    "Plate": {"AnnotationRef", "Well", "PlateAcquisition"},
    "Reagent": {"AnnotationRef"},
    "Screen": {"Reagent", "PlateRef", "AnnotationRef"},
