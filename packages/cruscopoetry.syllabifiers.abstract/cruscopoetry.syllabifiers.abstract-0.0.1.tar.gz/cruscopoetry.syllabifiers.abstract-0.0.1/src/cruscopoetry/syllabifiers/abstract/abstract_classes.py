...
class AbstractSyllable(abc.ABC):
	...
	@property
	def has_phonetic_stress(self):
		return (self.stress % 2) == 1

	@property
	def has_metric_stress(self):
		return self.stress in (2, 3, 6, 7)

	@property
	def has_semantic_stress(self):
		return self.stress in (2, 3, 6, 7)
