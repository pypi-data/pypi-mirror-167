...
class Job(BaseModel):  # JobSummary+JobDetails
    jobEid: str
    jobName: str
    description: str
    role: str
    createdOn: str  # TODO: validator
    lastModifiedOn: str  # TODO: validator
    glueVersion: str
    maxRetries: int
    ...
    lastStartedOn: Optional[str]  # TODO: validator
    lastCompletedOn: Optional[str]  # TODO: validator
...
class JobsWithLastRunCache(BaseModel):
    jobs: Jobs
    created_at: Optional[str]


class TablesCache(BaseModel):
    tables: TableDetails
    created_at: Optional[str]
