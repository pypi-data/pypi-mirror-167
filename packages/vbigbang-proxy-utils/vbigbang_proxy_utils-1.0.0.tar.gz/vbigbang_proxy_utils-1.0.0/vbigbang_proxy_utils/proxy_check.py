...
class ProxyCheck(ABC):
    ...
    @abstractmethod
    def _check_ok(self) -> (bool, object):
        """
    ...
    def _check_ok(self) -> (bool, object):
        ...
        try:
            if self.zm_ver_index == 0:
                ...
                response = requests.get('https://cloud.cn2030.com/sc/wx/HandlerSubscribe.ashx', headers=headers,
                ...
                # 贵州版本
                response = requests.get('https://cloud.cn2030.com/sc/api/PovPortal/GetIndex', headers=headers,
