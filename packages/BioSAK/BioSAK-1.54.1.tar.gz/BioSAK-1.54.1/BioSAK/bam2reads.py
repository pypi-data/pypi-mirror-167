...
BioSAK bam2reads -b sorted.bam -o bam2reads_wd_ctg1 -r contig_1 -s reads.fastq
BioSAK bam2reads -b sorted.bam -o bam2reads_wd_ctg2 -r contig_2:2000-5000
BioSAK bam2reads -b sorted.bam -o bam2reads_wd_ctg3 -r contig_3:2000-
BioSAK bam2reads -b sorted.bam -o bam2reads_wd_ctg4 -r contig_4:-5000 
...
def bam2reads(args):
    ...
    extracted_read_file     = '%s/reads.fasta'              % output_dir
    if in_fastq is True:
        extracted_read_file = '%s/reads.fastq'              % output_dir
    ...
    # extract sequences
    if read_seq_file is not None:
        select_seq_arg_dict = {'seq': read_seq_file,  'id': read_id_txt,  'option': 1,
                               'out': extracted_read_file,  'oneline': True,  'fq': in_fastq}
