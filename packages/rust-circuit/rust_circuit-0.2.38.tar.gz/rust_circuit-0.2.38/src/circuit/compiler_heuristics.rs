...
use super::{
    ...
    circuit_utils::{sum_of_node_sizes, sum_of_node_sizes_cached, total_flops, total_flops_cached},
    deep_map_op, deep_map_op_context,
    deep_rewrite::compiler_simp,
    Circuit, CircuitNode, CircuitRc, Einsum, HashBytes,
};
