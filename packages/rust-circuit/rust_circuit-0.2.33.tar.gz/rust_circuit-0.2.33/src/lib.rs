...
fn rust_circuit(py: Python<'_>, m: &PyModule) -> PyResult<()> {
    use circuit::algebraic_rewrite::{
        ...
        einsum_of_permute_merge, einsum_pull_removable_axes, generalfunction_pull_removable_axes,
    ...
    use circuit::circuit_manipulation::{
        deep_map_preorder_py, deep_map_py, filter_nodes_py, path_get, replace_nodes,
