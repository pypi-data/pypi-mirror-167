...
fn rust_circuit(py: Python<'_>, m: &PyModule) -> PyResult<()> {
    use circuit::algebraic_rewrite::{
        ...
        add_make_broadcasts_explicit, add_outer_product_broadcasts_on_top, add_pull_removable_axes,
        concat_elim_identity, concat_merge_uniform, concat_pull_removable_axes,
        concat_repeat_to_rearrange, deep_optimize_einsums, distribute, distribute_all,
        einsum_elim_identity, einsum_elim_zero, einsum_flatten_once, einsum_merge_scalars,
        einsum_nest_optimize, einsum_nest_path, einsum_of_permute_merge,
