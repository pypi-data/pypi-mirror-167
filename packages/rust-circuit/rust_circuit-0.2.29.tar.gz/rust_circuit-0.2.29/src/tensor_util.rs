...
use crate::{
    ...
    filter_by_variant,
    py_types::{Tensor, CAST_TENSOR, PY_CAST_INT, PY_ID, PY_TORCH},
    pycall,
...
pub type Shape = Vec<usize>; // TODO: maybe this should be struct which preserves invariant that dim shapes >= 0?
...
impl TensorAxisIndex {
    ...
    pub fn new_tensor_randint_seeded(length: usize, base_length: usize, seed: usize) -> Self {
