...
class EinsumSpec(object):
    ...
    def flops(self) -> int: ...
    def optimize_dp(
        self, check_outer: bool, mem_limit: Optional[int] = None, hash_limit: Optional[int] = None
    ) -> List[List[int]]: ...
    def optimize(
        self, check_outer: bool, mem_limit: Optional[int] = None, hash_limit: Optional[int] = None
    ) -> List[List[int]]: ...
...
def optimize_einsum_spec_cached(
    spec: EinsumSpec, check_outer: bool, mem_limit: Optional[int] = None, hash_limit: Optional[int] = None
) -> List[List[int]]: ...
...
# these default numbers aren't necessarily correct...
