...
fn test_generalfuction() {
    use super::{Add, ArrayConstant, Einsum};
    use crate::circuit::circuit_optimizer::optimize_and_evaluate;
    ...
    let circuit = Einsum::nrc(
        vec![(
            Add::nrc(
                vec![
                    ArrayConstant::randn_named(vec![2, 3, 4], None, TorchDeviceDtypeOp::default())
                        .rc(),
