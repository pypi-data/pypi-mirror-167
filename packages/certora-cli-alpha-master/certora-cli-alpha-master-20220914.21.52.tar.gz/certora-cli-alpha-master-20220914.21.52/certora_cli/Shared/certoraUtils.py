...
def reset_certora_internal_dir() -> None:
    ...
    CERTORA_BUILD_DIRECTORY = CERTORA_INTERNAL_ROOT / Path(build_uuid)
    CERTORA_BUILD_DIRECTORY = Path("")  # this line should be deleted when internal roots are supported
