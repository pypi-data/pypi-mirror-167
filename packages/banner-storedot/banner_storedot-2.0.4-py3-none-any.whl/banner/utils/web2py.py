...
from utils.pandas import series_to_table_df
...
JOINS = dict(
    neware_cache=dict(
        ...
        augm_per_cycle=dict(left=['ip', 'dev_uid', 'unit_id', 'chl_id', 'test_id'], right=['ip', 'dev_uid', 'unit_id', 'chl_id', 'test_id'], how='inner'),
    ),
    pouch=dict(
    ...
    augm_per_cycle=dict(
        ...
        neware_cache=dict(left=['ip', 'dev_uid', 'unit_id', 'chl_id', 'test_id'], right=['ip', 'dev_uid', 'unit_id', 'chl_id', 'test_id'], how='inner'),
    ),
)
