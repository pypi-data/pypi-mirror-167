...
# script location
MY_PYTHON_VERSION=`python -c 'import sys; print(f"{sys.version_info[0]}.{sys.version_info[1]}")'`
SCRIPT_LOCATION="/usr/local/lib/python$MY_PYTHON_VERSION/dist-packages/site24x7_plugin_helper/main.py"

query="select * from testtable"
this_plugin_name="my_testing_plugin_a"
python3 $SCRIPT_LOCATION --plugin=$this_plugin_name --query=$query --env="src/site24x7_plugin_helper/.env"
```
