...
REQUEST_CLIENT = site24x7_plugin_helper.connector.request_client
...
python3 main.py --plugin=$thisPluginName --query=$query --version=1 --env="src/site24x7_plugin_helper/.env"
```
