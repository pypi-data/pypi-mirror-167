...
from pyg_extension.nn.basemodel import GeneralReadOutLayer
from pyg_extension.nn.cgcnn import CrystalGraphConvNeuralNet
from pyg_extension.nn.flow_geo import LearningFlow
from pyg_extension.utils.log_model import print_log_dataset
...
model = CrystalGraphConvNeuralNet(11, 4, 2, nc_node_hidden=16, nc_node_interaction=16, num_interactions=1,
                                  edge_method="gaussian", nc_edge_hidden=50, node_method="x",
                                  layer_readout=GeneralReadOutLayer([16, "mean", 1], last_layer=None),
                                  ).to(device)
