...
from pyg_extension.data.structuretodata import AddSAPymatgen, AddXPymatgen, AddXASE, \
    StructureToData, AddXArray, \
    AddPBCEdgeXYZ
...
class MyTestCase(unittest.TestCase):
    ...
    def test_AddXArray(self):
        ...
        addsap = StructureToData(sub_converters=[sub_converters1, sub_converters2, sub_converters3, sub_converters4],
                                 n_jobs=1)
        # res = addsap.transform(datas, y=None, )
        res = addsap.transform(datas, y=None)
        print(res)
