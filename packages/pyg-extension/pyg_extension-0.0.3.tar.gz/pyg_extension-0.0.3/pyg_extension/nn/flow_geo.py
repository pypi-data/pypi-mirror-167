...
from pyg_extension.utils.log_model import LogModule, get_layers_with_weight, HookGradientModule, make_dot_
...
class LearningFlow:
    ...
    def __init__(self, model: Module, train_loader: DataLoader, validate_loader: DataLoader, device="cpu",
                 ...
                 loss_threshold: float = 0.1, print_freq: Union[int, str, None] = 10, print_what="all", process_label=None):
        """
