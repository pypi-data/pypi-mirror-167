# from modules.torch.acceldata_sdk.torch_client import TorchClient
from acceldata_sdk.torch_client import TorchClient

# from modules.torch.acceldata_sdk.models.tags import AssetLabel, CustomAssetMetadata
# import  modules.torch.acceldata_sdk.constants as const
...
print(torchclient.get_datasource(2, True))

print(torchclient.get_datasource('COMPUTE_WH', True))
...
torchclient = TorchClient(**torch_credentials)
# print(torchclient.get_datasource(assemblyName, True))
print(torchclient.get_datasource(847, True))

print(torchclient.get_datasource('SnowflakeProd', False))
print(torchclient.get_datasources(const.AssetSourceType.SNOWFLAKE))
exit()
#####
