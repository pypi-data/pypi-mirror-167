...
get_swagger_ui_html.__kwdefaults__.update(
    {
        r'swagger_js_url': r'https://cdn.staticfile.org/swagger-ui/4.12.0/swagger-ui-bundle.min.js',
        r'swagger_css_url': r'https://cdn.staticfile.org/swagger-ui/4.12.0/swagger-ui.min.css',
    }
)
