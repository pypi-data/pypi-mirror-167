#!/usr/bin/env python
# -*- coding: UTF-8 -*-
""" Transform deepNLU results into a Graph """


from baseblock import BaseObject


class SimplifyParseResult(BaseObject):
    """ Transform deepNLU results into a simple and denormalized form

    The output is highly recursive and very complex
