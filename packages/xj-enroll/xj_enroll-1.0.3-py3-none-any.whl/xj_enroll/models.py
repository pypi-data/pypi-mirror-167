...
class EnrollRuleValuate(models.Model):
    ...
    enroll_rule_group_id = models.ForeignKey(EnrollRuleGroup, verbose_name='报名规则组ID', db_column='enroll_rule_group_id', related_name='+', unique=False, on_delete=models.DO_NOTHING, help_text='')
...
class Enroll(models.Model):
    ...
    enroll_calc_rule_id = models.ForeignKey(verbose_name='报名计价规则', to=EnrollRuleValuate, db_column='enroll_calc_rule_id', related_name='+', unique=False, blank=True, null=True, on_delete=models.DO_NOTHING, help_text='')
...
class EnrollRecordSubitem(models.Model):
    ...
    enroll_record_id = models.ForeignKey(verbose_name='报名记录ID', to=EnrollRecord, db_column='enroll_record_id', related_name='+', unique=False, blank=True, null=True, on_delete=models.DO_NOTHING, help_text='')
    enroll_subitem_id = models.ForeignKey(verbose_name='报名分项ID', to=EnrollSubitem, db_column='enroll_subitem_id', related_name='+', unique=False, blank=True, null=True, on_delete=models.DO_NOTHING, help_text='说明：如果分项选择失败，行业规定是整单取消重新购买，不支持选择某项来取消。但为了灵活，允许后台工作端修改每项单价和数量（分项小计不可以修改），也能达到取消的效果。')
