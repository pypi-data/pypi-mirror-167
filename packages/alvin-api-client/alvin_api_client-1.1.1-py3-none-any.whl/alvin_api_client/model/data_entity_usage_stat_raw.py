...
class DataEntityUsageStatRaw(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, org_id, entity_name, usage_type, job_platform_type, job_id, job_step_id, job_platform_id, sync_id, execution_time_seconds, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, org_id, entity_name, usage_type, job_platform_type, job_id, job_step_id, job_platform_id, sync_id, execution_time_seconds, *args, **kwargs):  # noqa: E501
        """DataEntityUsageStatRaw - a model defined in OpenAPI
