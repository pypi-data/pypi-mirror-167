...
class HightouchCredentials(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, workspace_name, base_url, api_key, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, workspace_name, base_url, api_key, *args, **kwargs):  # noqa: E501
        """HightouchCredentials - a model defined in OpenAPI
