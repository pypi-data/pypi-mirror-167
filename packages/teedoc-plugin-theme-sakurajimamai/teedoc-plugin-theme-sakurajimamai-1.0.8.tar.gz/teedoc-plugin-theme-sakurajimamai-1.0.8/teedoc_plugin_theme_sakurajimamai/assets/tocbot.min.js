    ...
    var e = {
        163: e => {
            e.exports = function (e) {
                ...
                function i(n, o) {
                    var l, c, a,
                        u = o.appendChild((l = n, c = document.createElement("li"), a = document.createElement("a"), e.listItemClass && c.setAttribute("class", e.listItemClass), e.onClick && (a.onclick = e.onClick), e.includeTitleTags && a.setAttribute("title", l.textContent), e.includeHtml && l.childNodes.length ? t.call(l.childNodes, (function (e) {
                ...
                function a(t) {
                    return t && -1 !== t.className.indexOf(e.collapsibleClass) && -1 !== t.className.indexOf(e.isCollapsedClass) ? (t.className = t.className.split(r + e.isCollapsedClass).join(""), a(t.parentNode.parentNode)) : t
                }
                ...
                return {
                    enableTocAnimation: function () {
                        ...
                        if (t.forEach((function (e) {
                            i(e, n)
                        })), null !== e) return e.firstChild && e.removeChild(e.firstChild), 0 === t.length ? e : e.appendChild(n)
                        ...
                        var u, d = i;
                        if (l && null !== document.querySelector(e.tocSelector) && d.length > 0) {
                            n.call(d, (function (t, n) {
                                return c(t) > s + e.headingsOffset + 10 ? (u = d[0 === n ? n : n - 1], !0) : n === d.length - 1 ? (u = d[d.length - 1], !0) : void 0
                            }));
                            ...
                            var h = document.querySelector(e.tocSelector).querySelector("." + e.linkClass + ".node-name--" + u.nodeName + '[href="' + e.basePath + "#" + u.id.replace(/([ #;&,.+*~':"!^$[\]()=>|/@])/g, "\\$1") + '"]');
                            ...
                            })), h && h.nextSibling && -1 !== h.nextSibling.className.indexOf(e.isCollapsedClass) && (h.nextSibling.className = h.nextSibling.className.split(r + e.isCollapsedClass).join("")), a(h && h.parentNode.parentNode)
                        }
                    }
                }
            }
            ...
            l = [], o = function (e) {
                "use strict";
                var t, o, l, r = n(547), i = {}, s = {}, c = n(163), a = n(279), u = n(938),
                    ...
                    return s.destroy = function () {
                        ...
                        if (d) {
                            i = function () {
                                ...
                                return e
                            }(r, e || {}), this.options = i, this.state = {}, i.scrollSmooth && (i.duration = i.scrollSmoothDuration, i.offset = i.scrollSmoothOffset, s.scrollSmooth = n(374).initSmoothScrolling(i)), t = c(i), o = a(i), this._buildHtml = t, this._parseContent = o, s.destroy();
                            var p = function (e) {
                                try {
                            ...
                            if (null !== p) {
                                var C = h(i);
                                if (null !== C && null !== (l = o.selectHeadings(p, i.headingSelector))) {
                                    var g = o.nestHeadingsArray(l).nest;
                                    ...
                                    return this._clickListener = m((function (e) {
                                        i.scrollSmooth && t.disableTocAnimation(e), t.updateToc(l), v && clearTimeout(v), v = setTimeout((function () {
            ...
            }(void 0 !== n.g ? n.g : this.window || this.global), void 0 === (r = "function" == typeof o ? o.apply(t, l) : o) || (e.exports = r)
        }, 279: e => {
            e.exports = function (e) {
                var t = [].reduce;
