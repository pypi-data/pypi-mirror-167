...
!function (t, e) {
    ...
    var s = {
            ...
            play: null,
            stop: null
        }, t = "undefined" != typeof window && void 0 !== window.document, n = t ? window : {},
        a = !(!t || !n.document.documentElement) && "ontouchstart" in n.document.documentElement,
        r = t && "PointerEvent" in n, g = "viewer", c = "move", u = "switch", d = "zoom", m = "".concat(g, "-active"),
        f = "".concat(g, "-close"), v = "".concat(g, "-fade"), p = "".concat(g, "-fixed"),
        b = "".concat(g, "-fullscreen"), h = "".concat(g, "-fullscreen-exit"), w = "".concat(g, "-hide"),
        y = "".concat(g, "-hide-md-down"), x = "".concat(g, "-hide-sm-down"), k = "".concat(g, "-hide-xs-down"),
        z = "".concat(g, "-in"), D = "".concat(g, "-invisible"), T = "".concat(g, "-loading"),
        E = "".concat(g, "-move"), A = "".concat(g, "-open"), I = "".concat(g, "-show"),
        S = "".concat(g, "-transition"), O = "click", C = "dblclick", R = "dragstart", L = "focusin", F = "keydown",
        N = "load", Y = r ? "pointerdown" : a ? "touchstart" : "mousedown",
        X = r ? "pointermove" : a ? "touchmove" : "mousemove",
        M = r ? "pointerup pointercancel" : a ? "touchend touchcancel" : "mouseup", q = "resize", P = "transitionend",
        W = "wheel", j = "ready", H = "show", B = "shown", V = "viewed", U = "rotated", K = "".concat(g, "Action"),
        Z = /\s\s*/,
    ...
    function ot(e, i) {
        if (e && nt(i)) if (Array.isArray(e) || J(e.length)) for (var t = e.length, n = 0; n < t && !1 !== i.call(e, e[n], n, e); n += 1) ; else tt(e) && Object.keys(e).forEach(function (t) {
            i.call(e, e[t], t, e)
        });
        return e
    }
    ...
    var vt, pt, bt = (pt = !1, t && (vt = !1, St = function () {
    ...
    function kt(t) {
        var e = t.rotate, i = t.scaleX, n = t.scaleY, o = t.translateX, s = t.translateY, t = [];
    ...
    var At, It = {
        render: function () {
            ...
            var e = t || this.index, i = this.items[e].offsetWidth || 30, t = i + 1;
            rt(this.list, st({width: t * this.length}, kt({translateX: (this.viewerData.width - i) / 2 - t * e})))
        }, resetList: function () {
            var t = this.list;
            t.innerHTML = "", ct(t, S), rt(t, kt({translateX: 0}))
        }, initImage: function (r) {
            var t, h = this, l = this.options, e = this.image, i = this.viewerData, n = this.footer.offsetHeight,
                c = i.width, u = Math.max(i.height - n, n), d = this.imageData || {};
            this.imageInitializing = {
                ...
                var n = Math.min(.9 * n, t), o = Math.min(.9 * o, e), s = (c - n) / 2, a = (u - o) / 2, t = {
                    left: s,
                    top: a,
                    x: s,
                    y: a,
        ...
        bind: function () {
            ...
            yt(e, O, this.onClick = this.click.bind(this)), yt(e, R, this.onDragStart = this.dragstart.bind(this)), yt(i, Y, this.onPointerDown = this.pointerdown.bind(this)), yt(n, X, this.onPointerMove = this.pointermove.bind(this)), yt(n, M, this.onPointerUp = this.pointerup.bind(this)), yt(n, F, this.onKeyDown = this.keydown.bind(this)), yt(window, q, this.onResize = this.resize.bind(this)), t.zoomable && t.zoomOnWheel && yt(e, W, this.onWheel = this.wheel.bind(this), {
                passive: !1,
                capture: !0
            }), t.toggleOnDblclick && yt(i, C, this.onDblclick = this.dblclick.bind(this))
        }, unbind: function () {
            var t = this.options, e = this.viewer, i = this.canvas, n = this.element.ownerDocument;
            wt(e, O, this.onClick), wt(e, R, this.onDragStart), wt(i, Y, this.onPointerDown), wt(n, X, this.onPointerMove), wt(n, M, this.onPointerUp), wt(n, F, this.onKeyDown), wt(window, q, this.onResize), t.zoomable && t.zoomOnWheel && wt(e, W, this.onWheel, {
                passive: !1,
                capture: !0
        ...
        click: function (t) {
            ...
            var e = this.element, i = this.options, n = this.image, o = this.index, s = this.viewerData;
            ct(n, D), i.loading && ct(this.canvas, T), n.style.cssText = "height:0;" + "margin-left:".concat(s.width / 2, "px;") + "margin-top:".concat(s.height / 2, "px;") + "max-width:none!important;position:absolute;width:0;", this.initImage(function () {
                ut(n, E, i.movable), ut(n, S, i.transition), t.renderImage(function () {
                    t.viewed = !0, t.viewing = !1, nt(i.viewed) && yt(e, V, i.viewed, {once: !0}), xt(e, V, {
            ...
            var n = t.target, t = n.parentNode, o = t.offsetWidth || 30, s = t.offsetHeight || 50,
                a = !!gt(n, "filled");
            Dt(n, this.options, function (t, e) {
                ...
                o < s * i ? a ? t = s * i : e = o / i : a ? e = o / i : t = s * i, rt(n, st({
                    width: t,
                    height: e
                }, kt({translateX: (o - t) / 2, translateY: (s - e) / 2})))
            })
        }, keydown: function (t) {
            var e = this.options;
            if (e.keyboard) {
            ...
            !this.viewed || this.showing || this.viewing || this.hiding || ("mousedown" === t.type || "pointerdown" === t.type && "mouse" === t.pointerType) && (J(n) && 1 !== n || J(o) && 0 !== o || t.ctrlKey) || (t.preventDefault(), t.changedTouches ? ot(t.changedTouches, function (t) {
                i[t.identifier] = Et(t)
            }) : i[t.pointerId || 0] = Et(t), o = !!e.movable && c, e.zoomOnTouch && e.zoomable && 1 < Object.keys(i).length ? o = d : e.slideOnTouch && ("touch" === t.pointerType || "touchstart" === t.type) && this.isSwitchable() && (o = u), !e.transition || o !== c && o !== d || ct(this.image, S), this.action = o)
        ...
        show: function () {
            ...
            var n, o = this.viewer;
            return ct(o, w), o.setAttribute("role", "dialog"), o.setAttribute("aria-labelledby", this.title.id), o.setAttribute("aria-modal", !0), o.removeAttribute("aria-hidden"), i.transition && !t ? (n = this.shown.bind(this), this.transitioning = {
                abort: function () {
                    wt(o, P, n), ct(o, z)
                }
            }, lt(o, S), o.initialOffsetWidth = o.offsetWidth, yt(o, P, n, {once: !0}), lt(o, z)) : (lt(o, z), this.shown()), this
        }, hide: function () {
            ...
            var s, a, r = this.viewer, h = this.image;
            return n.transition && !t ? (s = function t(e) {
                e && e.target === r && (wt(r, P, t), i.hidden())
            }, a = function () {
                ht(r, S) ? (yt(r, P, s), ct(r, z)) : o()
            }, this.transitioning = {
                abort: function () {
                    i.viewed && ht(h, S) ? wt(h, P, a) : ht(r, S) && wt(r, P, s)
                }
            }, this.viewed && ht(h, S) ? (yt(h, P, a, {once: !0}), this.zoomTo(0, !1, null, !0)) : a()) : o(), this
        }, view: function () {
            var i = this,
            ...
            var e = this.element, n = this.options, o = this.title, s = this.canvas, a = this.items[t],
                r = a.querySelector("img"), h = gt(r, "originalUrl"), l = r.getAttribute("alt"),
                c = document.createElement("img");
            if (ot(n.inheritedAttributes, function (t) {
                var e = r.getAttribute(t);
                null !== e && c.setAttribute(t, e)
            }), c.src = h, c.alt = l, nt(n.view) && yt(e, "view", n.view, {once: !0}), !1 === xt(e, "view", {
                originalImage: this.images[t],
                index: t,
                image: c
            }) || !this.isShown || this.hiding || this.played) return this;
            h = this.items[this.index];
            ct(h, m), h.removeAttribute("aria-selected"), lt(a, m), a.setAttribute("aria-selected", !0), n.focus && a.focus(), this.image = c, this.viewed = !1, this.index = t, this.imageData = {}, lt(c, D), n.loading && lt(s, T), s.innerHTML = "", s.appendChild(c), this.renderList(), o.innerHTML = "";

            function u() {
                var t = i.imageData, e = Array.isArray(n.title) ? n.title[1] : n.title;
                o.innerHTML = _(t = nt(e) ? e.call(i, c, t) : "".concat(l, " (").concat(t.naturalWidth, " × ").concat(t.naturalHeight, ")")) ? t.replace(/&(?!amp;|quot;|#39;|lt;|gt;)/g, "&amp;").replace(/"/g, "&quot;").replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;") : t
            }
            ...
            }, c.complete ? this.load() : (yt(c, N, d = this.load.bind(this), {once: !0}), this.timeout && clearTimeout(this.timeout), this.timeout = setTimeout(function () {
                ct(c, D), i.timeout = !1
            }, 1e3)), this
        }, prev: function () {
            var t = this.index - 1;
            ...
            var e = this, i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : t,
                n = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : null, o = this.element,
                s = this.options, a = this.imageData;
            if (t = Number(t), i = Number(i), this.viewed && !this.played && s.movable) {
                var r = a.x, h = a.y, l = !1;
                if (J(t) ? l = !0 : t = r, J(i) ? l = !0 : i = h, l) {
                    if (nt(s.move) && yt(o, "move", s.move, {once: !0}), !1 === xt(o, "move", {
                        x: t,
                        y: i,
                        oldX: r,
                        oldY: h,
                    ...
                    a.x = t, a.y = i, a.left = t, a.top = i, this.moving = !0, this.renderImage(function () {
                        e.moving = !1, nt(s.moved) && yt(o, "moved", s.moved, {once: !0}), xt(o, "moved", {
                            x: t,
                            y: i,
                            oldX: r,
                            oldY: h,
            ...
            if (J(t = Number(t)) && this.viewed && !this.played && n.rotatable) {
                var s = o.rotate;
                if (nt(n.rotate) && yt(i, "rotate", n.rotate, {once: !0}), !1 === xt(i, "rotate", {
                    degree: t,
                    oldDegree: s
                })) return this;
                o.rotate = t, this.rotating = !0, this.renderImage(function () {
                    e.rotating = !1, nt(n.rotated) && yt(i, U, n.rotated, {once: !0}), xt(i, U, {
                        degree: t,
                        oldDegree: s
                    }, {cancelable: !1})
                })
            ...
            if (t = Number(t), i = Number(i), this.viewed && !this.played && o.scalable) {
                ...
                if (J(t) ? h = !0 : t = a, J(i) ? h = !0 : i = r, h) {
                    if (nt(o.scale) && yt(n, "scale", o.scale, {once: !0}), !1 === xt(n, "scale", {
                        scaleX: t,
                        scaleY: i,
                        oldScaleX: a,
                        oldScaleY: r
                    ...
                    s.scaleX = t, s.scaleY = i, this.scaling = !0, this.renderImage(function () {
                        e.scaling = !1, nt(o.scaled) && yt(n, "scaled", o.scaled, {once: !0}), xt(n, "scaled", {
                            scaleX: t,
                            scaleY: i,
                            oldScaleX: a,
                            oldScaleY: r
            ...
            if (J(t = Math.max(0, t)) && this.viewed && !this.played && (r || l.zoomable)) {
                ...
                var r = v * (t = a && .055 <= l.zoomRatio && .95 < t && t < 1.05 ? 1 : t), b = p * t, w = r - g,
                    v = b - f, y = u.ratio;
                if (nt(l.zoom) && yt(h, "zoom", l.zoom, {once: !0}), !1 === xt(h, "zoom", {
                    ratio: t,
                    oldRatio: y,
                    originalEvent: a
                })) return this;
                this.zooming = !0, a ? (p = {
                    left: (p = (p = this.viewer).getBoundingClientRect()).left + (window.pageXOffset - document.documentElement.clientLeft),
                    top: p.top + (window.pageYOffset - document.documentElement.clientTop)
                }, c = c && Object.keys(c).length ? (o = n = i = 0, ot(c, function (t) {
                    ...
                    e.zooming = !1, nt(l.zoomed) && yt(h, "zoomed", l.zoomed, {once: !0}), xt(h, "zoomed", {
                        ratio: t,
                        oldRatio: y,
                        originalEvent: a
                    }, {cancelable: !1})
            ...
            return this.played = !0, this.onLoadWhenPlay = a, t && this.requestFullscreen(t), lt(s, I), ot(this.items, function (t, e) {
            ...
            }), ct(t, I), t.innerHTML = "", this.exitFullscreen(), this
        }, full: function () {
            var t = this, e = this.options, i = this.viewer, n = this.image, o = this.list;
            return !this.isShown || this.played || this.fulled || !e.inline || (this.fulled = !0, this.open(), lt(this.button, h), e.transition && (ct(o, S), this.viewed && ct(n, S)), lt(i, p), i.setAttribute("role", "dialog"), i.setAttribute("aria-labelledby", this.title.id), i.setAttribute("aria-modal", !0), i.removeAttribute("style"), rt(i, {zIndex: e.zIndex}), e.focus && this.enforceFocus(), this.initContainer(), this.viewerData = st({}, this.containerData), this.renderList(), this.viewed && this.initImage(function () {
            ...
            var t = this, e = this.options, i = this.viewer, n = this.image, o = this.list;
            return this.isShown && !this.played && this.fulled && e.inline && (this.fulled = !1, this.close(), ct(this.button, h), e.transition && (ct(o, S), this.viewed && ct(n, S)), e.focus && this.clearEnforceFocus(), i.removeAttribute("role"), i.removeAttribute("aria-labelledby"), i.removeAttribute("aria-modal"), ct(i, p), rt(i, {zIndex: e.zIndexInline}), this.viewerData = st({}, this.parentData), this.renderViewer(), this.renderList(), this.viewed && this.initImage(function () {
                t.renderImage(function () {
                    e.transition && setTimeout(function () {
                        lt(n, S), lt(o, S)
                    }, 0)
            ...
            return this.viewed && !this.played && e.tooltip && (i.textContent = "".concat(Math.round(100 * n.ratio), "%"), this.tooltipping ? clearTimeout(this.tooltipping) : e.transition ? (this.fading && xt(i, P), lt(i, I), lt(i, v), lt(i, S), i.removeAttribute("aria-hidden"), i.initialOffsetWidth = i.offsetWidth, lt(i, z)) : (lt(i, I), i.removeAttribute("aria-hidden")), this.tooltipping = setTimeout(function () {
                e.transition ? (yt(i, P, function () {
                    ct(i, I), ct(i, v), ct(i, S), i.setAttribute("aria-hidden", !0), t.fading = !1
                }, {once: !0}), ct(i, z), t.fading = !0) : (ct(i, I), i.setAttribute("aria-hidden", !0)), t.tooltipping = !1
            }, 1e3)), this
        }, toggle: function () {
        ...
        getImageURL: function (t) {
            ...
            var i = this;
            this.clearEnforceFocus(), yt(document, L, this.onFocusin = function (t) {
            ...
            this.onFocusin && (wt(document, L, this.onFocusin), this.onFocusin = null)
        }, open: function () {
            var t = this.body;
            lt(t, A), t.style.paddingRight = "".concat(this.scrollbarWidth + (parseFloat(this.initialBodyComputedPaddingRight) || 0), "px")
        }, close: function () {
            var t = this.body;
            ct(t, A), t.style.paddingRight = this.initialBodyPaddingRight
        }, shown: function () {
                    ...
                    case d:
                        this.zoom((s = l({}, h = i), a = [], ot(h, function (o, t) {
                            delete s[t], ot(s, function (t) {
                                var e = Math.abs(o.startX - t.startX), i = Math.abs(o.startY - t.startY),
                                    n = Math.abs(o.endX - t.endX), t = Math.abs(o.endY - t.endY),
                                    i = Math.sqrt(e * e + i * i), t = Math.sqrt(n * n + t * t);
                                a.push((t - i) / i)
                            })
                        }), a.sort(function (t, e) {
        ...
        function i(t) {
            ...
            this.element = t, this.options = st({}, s, it(e) && e), this.action = !1, this.fading = !1, this.fulled = !1, this.hiding = !1, this.imageClicked = !1, this.imageData = {}, this.index = this.options.initialViewIndex, this.isImg = !1, this.isShown = !1, this.length = 0, this.moving = !1, this.played = !1, this.playing = !1, this.pointers = {}, this.ready = !1, this.rotating = !1, this.scaling = !1, this.showing = !1, this.timeout = !1, this.tooltipping = !1, this.viewed = !1, this.viewing = !1, this.wheeling = !1, this.zooming = !1, this.id = Rt(), this.init()
        }
        ...
        return t = i, n = [{
            ...
            key: "init", value: function () {
                ...
                }), this.isImg = t, this.length = e.length, this.images = e, this.initBody(), Q(document.createElement(g).style.transition) && (a.transition = !1), a.inline ? (i = 0, n = function () {
                    var t;
