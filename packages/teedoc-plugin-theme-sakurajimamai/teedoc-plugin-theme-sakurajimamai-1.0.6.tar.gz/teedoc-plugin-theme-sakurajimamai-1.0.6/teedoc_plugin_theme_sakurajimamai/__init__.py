...
class Plugin(Plugin_Base):
    ...
    def on_init(self, config, doc_src_path, site_config, logger = None, multiprocess = True, **kw_args):
        ...
        # image viewer
        self.css["/static/css/theme_sakurajimamai/viewer.min.css"] = os.path.join(self.assets_abs_path, "viewer.min.css")
        # js files
        self.dark_js = {
        ...
        if "code_highlight_js" in self.config and self.config["code_highlight_js"]:
            ...
            self.footer_js["/static/css/theme_sakurajimamai/prism.min.js"] = os.path.join(self.assets_abs_path, "prism.min.js")
        self.images = {
