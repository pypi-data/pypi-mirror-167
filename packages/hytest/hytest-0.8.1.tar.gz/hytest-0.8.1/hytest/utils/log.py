...
class HtmlLogger:
    ...
    def test_start(self,_title=''):
        ...
        self.doc = document(title= ('测试报告','Test Report')[l.n])
        self.doc.head.add(
                        meta(charset="UTF-8"),
        ...
        self.main.add(h1(f'{("测试报告","Test Report")[l.n]} - hytest v{version}', style='font-family: auto'))
    ...
    def test_end(self, runner):
        ...
        reportFile = os.path.join('log',f'report_{timestamp}.html')
