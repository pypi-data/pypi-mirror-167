...
from python_rabbitmq.connection import (
    RMQConnection,
    MandatoryError,
    DeclarationError
)
from python_rabbitmq.defs import (
    ConfirmModeOK,
    DeliveryError,
    DEFAULT_EXCHANGE,
    QueueParams,
...
class RMQPublish:
    ...
    def __init__(self,
        ...
        """
        :param body: bytes
        :param exchange_params: python_rabbitmq.ExchangeParams
        :param routing_key: str
        :param queue_params: python_rabbitmq.QueueParams
        :param publish_params: python_rabbitmq.PublishParams
