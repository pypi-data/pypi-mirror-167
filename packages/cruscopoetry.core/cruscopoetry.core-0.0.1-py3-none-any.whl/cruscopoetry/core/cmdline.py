...
#		render.add_argument("-f", "--format", choices = ["txt", "html"], default= "txt", help="the rendering format")
#		render.add_argument("-i", "--input", help="the JSON file to render as text")
#		render.add_argument("--tr_id", type=str, default=None, help="the id of the translation to include in the text file.")
#		render.add_argument(
...
#		)
#		render.add_argument("--indent", type=str, default="  ", help="the indent string to be used in the txt file.")
#		render.add_argument("--number_after", type=int, default=5, help="the number whose lines have one of its multiples as number will display their number.")
#		render.add_argument("-o", "--output", help="the txt file to save the renderer in (if not specified, it will be printed on stdout.")
		...
		txtrender.add_argument("--number_after", type=int, default=5, help="the number whose lines have one of its multiples as number will display their number.")
		...
		htmlrender.add_argument("--number_after", type=int, default=5, help="the number whose lines have one of its multiples as number will display their number.")
	...
	def main(cls):
		...
		if args.operation == "build":
			...
			cls.render(args.format, args.input, args.output, args.tr_id, args.tr_layout, indent, args.number_after)
	...
	@classmethod
	def render(cls, file_format, infile, outfile, translation_id, translation_arrangement, indent, number_after):
		if file_format == 'txt':
			...
			text = renderer.render(translation_id, translation_arrangement, number_after)
		else:
			return
		if outfile == None:
			print(text)
