...
def main_direct(runner_path, project_path, launch_command, dev=True, launch=True):
    ...
    for project_file in project_files:
        ...
        # Process script
        new_path = ArtemisLoader.process_script(runner_path, launch_command, project_file, project_files, is_entry_point=is_entry_point, project_name=project_settings['name'], dev=dev, launch=launch)
