...
class ArtemisLoader:
    ...
    @staticmethod
    def process_script(runner_path : str, launch_command : str, code_path : str, project_files : List[str], is_entry_point=False, project_name="", dev=False, launch=True) -> str:
        '''
