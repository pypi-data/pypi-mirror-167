...
class ArtemisLoader:
    ...
    @staticmethod
    def process_script(runner_path : str, launch_command : str, code_path : str, project_files : List[str], is_entry_point=False, project_name="", entry_point_path="", dev=False, launch=True) -> str:
        '''
        ...
        if dev:
            ...
            if not is_entry_point:
                ...
                original_contents_lines.insert(0, f'Artemis.init("{runner_path}", "{launch_command}", "{code_path}", "{entry_point_path}", {launch}, {dev})')
