...
class DataGoogleIamWorkloadIdentityPool(
    ...
    jsii_type="@dschmidt/provider-google-beta.dataGoogleIamWorkloadIdentityPool.DataGoogleIamWorkloadIdentityPool",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.dataGoogleIamWorkloadIdentityPool.DataGoogleIamWorkloadIdentityPoolConfig",
