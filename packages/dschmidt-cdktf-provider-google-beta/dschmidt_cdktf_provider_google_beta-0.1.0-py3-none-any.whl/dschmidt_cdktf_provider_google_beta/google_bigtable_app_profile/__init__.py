...
class GoogleBigtableAppProfile(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleBigtableAppProfile.GoogleBigtableAppProfile",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleBigtableAppProfile.GoogleBigtableAppProfileConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleBigtableAppProfile.GoogleBigtableAppProfileSingleClusterRouting",
    jsii_struct_bases=[],
    name_mapping={
...
class GoogleBigtableAppProfileSingleClusterRoutingOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleBigtableAppProfile.GoogleBigtableAppProfileSingleClusterRoutingOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleBigtableAppProfile.GoogleBigtableAppProfileTimeouts",
    jsii_struct_bases=[],
...
class GoogleBigtableAppProfileTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleBigtableAppProfile.GoogleBigtableAppProfileTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
