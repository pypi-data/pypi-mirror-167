...
class DataGoogleContainerRegistryImage(
    ...
    jsii_type="@dschmidt/provider-google-beta.dataGoogleContainerRegistryImage.DataGoogleContainerRegistryImage",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.dataGoogleContainerRegistryImage.DataGoogleContainerRegistryImageConfig",
