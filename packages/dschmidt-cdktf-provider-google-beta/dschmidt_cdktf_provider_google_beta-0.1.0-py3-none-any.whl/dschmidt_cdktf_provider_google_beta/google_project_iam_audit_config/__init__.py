...
class GoogleProjectIamAuditConfig(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleProjectIamAuditConfig.GoogleProjectIamAuditConfig",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleProjectIamAuditConfig.GoogleProjectIamAuditConfigAuditLogConfig",
    jsii_struct_bases=[],
...
class GoogleProjectIamAuditConfigAuditLogConfigList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleProjectIamAuditConfig.GoogleProjectIamAuditConfigAuditLogConfigList",
):
    def __init__(
        self,
...
class GoogleProjectIamAuditConfigAuditLogConfigOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleProjectIamAuditConfig.GoogleProjectIamAuditConfigAuditLogConfigOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleProjectIamAuditConfig.GoogleProjectIamAuditConfigConfig",
