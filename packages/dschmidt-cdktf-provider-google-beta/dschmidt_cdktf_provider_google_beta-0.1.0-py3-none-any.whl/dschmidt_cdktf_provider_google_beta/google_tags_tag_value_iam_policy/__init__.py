...
class GoogleTagsTagValueIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleTagsTagValueIamPolicy.GoogleTagsTagValueIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleTagsTagValueIamPolicy.GoogleTagsTagValueIamPolicyConfig",
