...
class GoogleDialogflowAgent(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowAgent.GoogleDialogflowAgent",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowAgent.GoogleDialogflowAgentConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowAgent.GoogleDialogflowAgentTimeouts",
    jsii_struct_bases=[],
...
class GoogleDialogflowAgentTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowAgent.GoogleDialogflowAgentTimeoutsOutputReference",
):
    def __init__(
        self,
