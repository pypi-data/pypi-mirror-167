...
class GoogleSccNotificationConfig(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleSccNotificationConfig.GoogleSccNotificationConfig",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleSccNotificationConfig.GoogleSccNotificationConfigConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleSccNotificationConfig.GoogleSccNotificationConfigStreamingConfig",
    jsii_struct_bases=[],
...
class GoogleSccNotificationConfigStreamingConfigOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleSccNotificationConfig.GoogleSccNotificationConfigStreamingConfigOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleSccNotificationConfig.GoogleSccNotificationConfigTimeouts",
    jsii_struct_bases=[],
...
class GoogleSccNotificationConfigTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleSccNotificationConfig.GoogleSccNotificationConfigTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
