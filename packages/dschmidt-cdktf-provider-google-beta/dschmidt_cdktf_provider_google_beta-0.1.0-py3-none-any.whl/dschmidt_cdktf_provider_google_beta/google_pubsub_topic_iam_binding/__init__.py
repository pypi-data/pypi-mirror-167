...
class GooglePubsubTopicIamBinding(
    ...
    jsii_type="@dschmidt/provider-google-beta.googlePubsubTopicIamBinding.GooglePubsubTopicIamBinding",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googlePubsubTopicIamBinding.GooglePubsubTopicIamBindingCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class GooglePubsubTopicIamBindingConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googlePubsubTopicIamBinding.GooglePubsubTopicIamBindingConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googlePubsubTopicIamBinding.GooglePubsubTopicIamBindingConfig",
