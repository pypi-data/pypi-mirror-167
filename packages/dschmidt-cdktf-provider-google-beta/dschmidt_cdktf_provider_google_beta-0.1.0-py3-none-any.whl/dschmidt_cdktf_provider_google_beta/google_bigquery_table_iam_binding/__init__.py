...
class GoogleBigqueryTableIamBinding(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleBigqueryTableIamBinding.GoogleBigqueryTableIamBinding",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleBigqueryTableIamBinding.GoogleBigqueryTableIamBindingCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class GoogleBigqueryTableIamBindingConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleBigqueryTableIamBinding.GoogleBigqueryTableIamBindingConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleBigqueryTableIamBinding.GoogleBigqueryTableIamBindingConfig",
