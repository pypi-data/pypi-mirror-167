...
class GoogleComputeVpnTunnel(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleComputeVpnTunnel.GoogleComputeVpnTunnel",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeVpnTunnel.GoogleComputeVpnTunnelConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeVpnTunnel.GoogleComputeVpnTunnelTimeouts",
    jsii_struct_bases=[],
...
class GoogleComputeVpnTunnelTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleComputeVpnTunnel.GoogleComputeVpnTunnelTimeoutsOutputReference",
):
    def __init__(
        self,
