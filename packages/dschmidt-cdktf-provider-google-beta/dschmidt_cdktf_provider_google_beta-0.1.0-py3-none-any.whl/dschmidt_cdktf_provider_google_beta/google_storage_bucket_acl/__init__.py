...
class GoogleStorageBucketAcl(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleStorageBucketAcl.GoogleStorageBucketAcl",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleStorageBucketAcl.GoogleStorageBucketAclConfig",
