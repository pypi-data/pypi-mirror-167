...
class GoogleComputeGlobalNetworkEndpoint(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleComputeGlobalNetworkEndpoint.GoogleComputeGlobalNetworkEndpoint",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeGlobalNetworkEndpoint.GoogleComputeGlobalNetworkEndpointConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeGlobalNetworkEndpoint.GoogleComputeGlobalNetworkEndpointTimeouts",
    jsii_struct_bases=[],
...
class GoogleComputeGlobalNetworkEndpointTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleComputeGlobalNetworkEndpoint.GoogleComputeGlobalNetworkEndpointTimeoutsOutputReference",
):
    def __init__(
        self,
