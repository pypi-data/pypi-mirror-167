...
class DataGoogleServiceAccountAccessToken(
    ...
    jsii_type="@dschmidt/provider-google-beta.dataGoogleServiceAccountAccessToken.DataGoogleServiceAccountAccessToken",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.dataGoogleServiceAccountAccessToken.DataGoogleServiceAccountAccessTokenConfig",
