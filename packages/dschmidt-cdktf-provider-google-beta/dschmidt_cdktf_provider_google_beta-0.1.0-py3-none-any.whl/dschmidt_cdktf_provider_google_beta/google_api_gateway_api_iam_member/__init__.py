...
class GoogleApiGatewayApiIamMember(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleApiGatewayApiIamMember.GoogleApiGatewayApiIamMember",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleApiGatewayApiIamMember.GoogleApiGatewayApiIamMemberCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class GoogleApiGatewayApiIamMemberConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleApiGatewayApiIamMember.GoogleApiGatewayApiIamMemberConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleApiGatewayApiIamMember.GoogleApiGatewayApiIamMemberConfig",
