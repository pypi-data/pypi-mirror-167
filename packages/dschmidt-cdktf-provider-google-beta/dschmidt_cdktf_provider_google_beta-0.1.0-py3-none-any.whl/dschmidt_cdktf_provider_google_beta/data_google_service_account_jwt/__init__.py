...
class DataGoogleServiceAccountJwt(
    ...
    jsii_type="@dschmidt/provider-google-beta.dataGoogleServiceAccountJwt.DataGoogleServiceAccountJwt",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.dataGoogleServiceAccountJwt.DataGoogleServiceAccountJwtConfig",
