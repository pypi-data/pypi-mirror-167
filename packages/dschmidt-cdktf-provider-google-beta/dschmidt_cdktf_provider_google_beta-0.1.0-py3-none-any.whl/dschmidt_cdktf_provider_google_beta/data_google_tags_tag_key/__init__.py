...
class DataGoogleTagsTagKey(
    ...
    jsii_type="@dschmidt/provider-google-beta.dataGoogleTagsTagKey.DataGoogleTagsTagKey",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.dataGoogleTagsTagKey.DataGoogleTagsTagKeyConfig",
