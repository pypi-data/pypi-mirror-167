...
class GoogleLoggingProjectBucketConfig(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleLoggingProjectBucketConfig.GoogleLoggingProjectBucketConfig",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleLoggingProjectBucketConfig.GoogleLoggingProjectBucketConfigConfig",
