...
class GoogleComputeTargetTcpProxy(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleComputeTargetTcpProxy.GoogleComputeTargetTcpProxy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeTargetTcpProxy.GoogleComputeTargetTcpProxyConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeTargetTcpProxy.GoogleComputeTargetTcpProxyTimeouts",
    jsii_struct_bases=[],
...
class GoogleComputeTargetTcpProxyTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleComputeTargetTcpProxy.GoogleComputeTargetTcpProxyTimeoutsOutputReference",
):
    def __init__(
        self,
