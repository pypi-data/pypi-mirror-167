...
class GoogleComputeTargetInstance(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleComputeTargetInstance.GoogleComputeTargetInstance",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeTargetInstance.GoogleComputeTargetInstanceConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeTargetInstance.GoogleComputeTargetInstanceTimeouts",
    jsii_struct_bases=[],
...
class GoogleComputeTargetInstanceTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleComputeTargetInstance.GoogleComputeTargetInstanceTimeoutsOutputReference",
):
    def __init__(
        self,
