...
class GoogleComputeSharedVpcServiceProject(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleComputeSharedVpcServiceProject.GoogleComputeSharedVpcServiceProject",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeSharedVpcServiceProject.GoogleComputeSharedVpcServiceProjectConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeSharedVpcServiceProject.GoogleComputeSharedVpcServiceProjectTimeouts",
    jsii_struct_bases=[],
...
class GoogleComputeSharedVpcServiceProjectTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleComputeSharedVpcServiceProject.GoogleComputeSharedVpcServiceProjectTimeoutsOutputReference",
):
    def __init__(
        self,
