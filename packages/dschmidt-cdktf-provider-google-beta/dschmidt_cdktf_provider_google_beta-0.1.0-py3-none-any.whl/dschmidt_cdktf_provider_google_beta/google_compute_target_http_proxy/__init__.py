...
class GoogleComputeTargetHttpProxy(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleComputeTargetHttpProxy.GoogleComputeTargetHttpProxy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeTargetHttpProxy.GoogleComputeTargetHttpProxyConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeTargetHttpProxy.GoogleComputeTargetHttpProxyTimeouts",
    jsii_struct_bases=[],
...
class GoogleComputeTargetHttpProxyTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleComputeTargetHttpProxy.GoogleComputeTargetHttpProxyTimeoutsOutputReference",
):
    def __init__(
        self,
