...
class GoogleFirestoreIndex(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleFirestoreIndex.GoogleFirestoreIndex",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleFirestoreIndex.GoogleFirestoreIndexConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleFirestoreIndex.GoogleFirestoreIndexFields",
    jsii_struct_bases=[],
    name_mapping={
...
class GoogleFirestoreIndexFieldsList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleFirestoreIndex.GoogleFirestoreIndexFieldsList",
):
    def __init__(
        self,
...
class GoogleFirestoreIndexFieldsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleFirestoreIndex.GoogleFirestoreIndexFieldsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleFirestoreIndex.GoogleFirestoreIndexTimeouts",
    jsii_struct_bases=[],
...
class GoogleFirestoreIndexTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleFirestoreIndex.GoogleFirestoreIndexTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
