...
class GoogleMonitoringCustomService(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleMonitoringCustomService.GoogleMonitoringCustomService",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleMonitoringCustomService.GoogleMonitoringCustomServiceConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleMonitoringCustomService.GoogleMonitoringCustomServiceTelemetry",
    jsii_struct_bases=[],
...
class GoogleMonitoringCustomServiceTelemetryOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleMonitoringCustomService.GoogleMonitoringCustomServiceTelemetryOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleMonitoringCustomService.GoogleMonitoringCustomServiceTimeouts",
    jsii_struct_bases=[],
...
class GoogleMonitoringCustomServiceTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleMonitoringCustomService.GoogleMonitoringCustomServiceTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
