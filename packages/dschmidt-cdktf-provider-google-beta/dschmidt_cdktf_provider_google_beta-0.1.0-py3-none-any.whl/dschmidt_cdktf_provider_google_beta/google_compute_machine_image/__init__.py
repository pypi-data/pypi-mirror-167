...
class GoogleComputeMachineImage(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleComputeMachineImage.GoogleComputeMachineImage",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeMachineImage.GoogleComputeMachineImageConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeMachineImage.GoogleComputeMachineImageMachineImageEncryptionKey",
    jsii_struct_bases=[],
    name_mapping={
...
class GoogleComputeMachineImageMachineImageEncryptionKeyOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleComputeMachineImage.GoogleComputeMachineImageMachineImageEncryptionKeyOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeMachineImage.GoogleComputeMachineImageTimeouts",
    jsii_struct_bases=[],
...
class GoogleComputeMachineImageTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleComputeMachineImage.GoogleComputeMachineImageTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
