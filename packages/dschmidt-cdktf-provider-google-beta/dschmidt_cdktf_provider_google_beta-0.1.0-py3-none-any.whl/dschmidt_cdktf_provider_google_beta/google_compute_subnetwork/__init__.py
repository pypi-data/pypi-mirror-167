...
class GoogleComputeSubnetwork(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleComputeSubnetwork.GoogleComputeSubnetwork",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeSubnetwork.GoogleComputeSubnetworkConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeSubnetwork.GoogleComputeSubnetworkLogConfig",
    jsii_struct_bases=[],
    name_mapping={
...
class GoogleComputeSubnetworkLogConfigOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleComputeSubnetwork.GoogleComputeSubnetworkLogConfigOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeSubnetwork.GoogleComputeSubnetworkSecondaryIpRange",
    jsii_struct_bases=[],
...
class GoogleComputeSubnetworkSecondaryIpRangeList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleComputeSubnetwork.GoogleComputeSubnetworkSecondaryIpRangeList",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
class GoogleComputeSubnetworkSecondaryIpRangeOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleComputeSubnetwork.GoogleComputeSubnetworkSecondaryIpRangeOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeSubnetwork.GoogleComputeSubnetworkTimeouts",
    jsii_struct_bases=[],
...
class GoogleComputeSubnetworkTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleComputeSubnetwork.GoogleComputeSubnetworkTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
