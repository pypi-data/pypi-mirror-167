...
class GoogleSqlDatabase(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleSqlDatabase.GoogleSqlDatabase",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleSqlDatabase.GoogleSqlDatabaseConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleSqlDatabase.GoogleSqlDatabaseTimeouts",
    jsii_struct_bases=[],
...
class GoogleSqlDatabaseTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleSqlDatabase.GoogleSqlDatabaseTimeoutsOutputReference",
):
    def __init__(
        self,
