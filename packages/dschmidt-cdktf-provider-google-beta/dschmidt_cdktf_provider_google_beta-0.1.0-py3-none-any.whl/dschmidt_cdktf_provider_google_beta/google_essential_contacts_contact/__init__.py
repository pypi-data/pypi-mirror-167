...
class GoogleEssentialContactsContact(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleEssentialContactsContact.GoogleEssentialContactsContact",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleEssentialContactsContact.GoogleEssentialContactsContactConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleEssentialContactsContact.GoogleEssentialContactsContactTimeouts",
    jsii_struct_bases=[],
...
class GoogleEssentialContactsContactTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleEssentialContactsContact.GoogleEssentialContactsContactTimeoutsOutputReference",
):
    def __init__(
        self,
