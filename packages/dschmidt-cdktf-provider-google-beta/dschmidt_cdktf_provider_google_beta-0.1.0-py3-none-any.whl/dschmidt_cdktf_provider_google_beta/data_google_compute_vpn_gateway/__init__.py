...
class DataGoogleComputeVpnGateway(
    ...
    jsii_type="@dschmidt/provider-google-beta.dataGoogleComputeVpnGateway.DataGoogleComputeVpnGateway",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.dataGoogleComputeVpnGateway.DataGoogleComputeVpnGatewayConfig",
