...
class GoogleBigqueryDatasetIamMember(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleBigqueryDatasetIamMember.GoogleBigqueryDatasetIamMember",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleBigqueryDatasetIamMember.GoogleBigqueryDatasetIamMemberCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class GoogleBigqueryDatasetIamMemberConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleBigqueryDatasetIamMember.GoogleBigqueryDatasetIamMemberConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleBigqueryDatasetIamMember.GoogleBigqueryDatasetIamMemberConfig",
