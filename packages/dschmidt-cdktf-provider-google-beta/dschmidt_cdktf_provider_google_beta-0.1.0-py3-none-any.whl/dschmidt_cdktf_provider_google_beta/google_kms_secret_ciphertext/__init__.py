...
class GoogleKmsSecretCiphertext(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleKmsSecretCiphertext.GoogleKmsSecretCiphertext",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleKmsSecretCiphertext.GoogleKmsSecretCiphertextConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleKmsSecretCiphertext.GoogleKmsSecretCiphertextTimeouts",
    jsii_struct_bases=[],
...
class GoogleKmsSecretCiphertextTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleKmsSecretCiphertext.GoogleKmsSecretCiphertextTimeoutsOutputReference",
):
    def __init__(
        self,
