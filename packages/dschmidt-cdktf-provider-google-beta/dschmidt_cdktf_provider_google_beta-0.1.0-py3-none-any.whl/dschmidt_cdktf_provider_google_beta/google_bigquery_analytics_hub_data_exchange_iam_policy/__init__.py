...
class GoogleBigqueryAnalyticsHubDataExchangeIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleBigqueryAnalyticsHubDataExchangeIamPolicy.GoogleBigqueryAnalyticsHubDataExchangeIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleBigqueryAnalyticsHubDataExchangeIamPolicy.GoogleBigqueryAnalyticsHubDataExchangeIamPolicyConfig",
