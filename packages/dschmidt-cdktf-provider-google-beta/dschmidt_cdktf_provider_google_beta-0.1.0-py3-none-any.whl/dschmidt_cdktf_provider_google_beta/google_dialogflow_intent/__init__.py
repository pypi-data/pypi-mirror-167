...
class GoogleDialogflowIntent(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowIntent.GoogleDialogflowIntent",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowIntent.GoogleDialogflowIntentConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowIntent.GoogleDialogflowIntentFollowupIntentInfo",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class GoogleDialogflowIntentFollowupIntentInfoList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowIntent.GoogleDialogflowIntentFollowupIntentInfoList",
):
    def __init__(
        self,
...
class GoogleDialogflowIntentFollowupIntentInfoOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowIntent.GoogleDialogflowIntentFollowupIntentInfoOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowIntent.GoogleDialogflowIntentTimeouts",
    jsii_struct_bases=[],
...
class GoogleDialogflowIntentTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowIntent.GoogleDialogflowIntentTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
