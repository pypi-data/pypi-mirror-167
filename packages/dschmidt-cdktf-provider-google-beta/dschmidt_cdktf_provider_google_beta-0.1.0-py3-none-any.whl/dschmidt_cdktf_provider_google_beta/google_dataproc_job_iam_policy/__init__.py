...
class GoogleDataprocJobIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleDataprocJobIamPolicy.GoogleDataprocJobIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleDataprocJobIamPolicy.GoogleDataprocJobIamPolicyConfig",
