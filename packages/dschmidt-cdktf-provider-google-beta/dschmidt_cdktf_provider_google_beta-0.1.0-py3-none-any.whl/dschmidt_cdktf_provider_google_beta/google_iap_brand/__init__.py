...
class GoogleIapBrand(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleIapBrand.GoogleIapBrand",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleIapBrand.GoogleIapBrandConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleIapBrand.GoogleIapBrandTimeouts",
    jsii_struct_bases=[],
...
class GoogleIapBrandTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleIapBrand.GoogleIapBrandTimeoutsOutputReference",
):
    def __init__(
        self,
