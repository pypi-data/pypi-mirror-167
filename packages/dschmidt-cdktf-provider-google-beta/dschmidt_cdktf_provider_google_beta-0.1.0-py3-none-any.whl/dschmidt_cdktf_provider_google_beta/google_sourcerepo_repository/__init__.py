...
class GoogleSourcerepoRepository(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleSourcerepoRepository.GoogleSourcerepoRepository",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleSourcerepoRepository.GoogleSourcerepoRepositoryConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleSourcerepoRepository.GoogleSourcerepoRepositoryPubsubConfigs",
    jsii_struct_bases=[],
    name_mapping={
...
class GoogleSourcerepoRepositoryPubsubConfigsList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleSourcerepoRepository.GoogleSourcerepoRepositoryPubsubConfigsList",
):
    def __init__(
        self,
...
class GoogleSourcerepoRepositoryPubsubConfigsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleSourcerepoRepository.GoogleSourcerepoRepositoryPubsubConfigsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleSourcerepoRepository.GoogleSourcerepoRepositoryTimeouts",
    jsii_struct_bases=[],
...
class GoogleSourcerepoRepositoryTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleSourcerepoRepository.GoogleSourcerepoRepositoryTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
