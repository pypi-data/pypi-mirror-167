...
class GoogleCloudIdentityGroup(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleCloudIdentityGroup.GoogleCloudIdentityGroup",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleCloudIdentityGroup.GoogleCloudIdentityGroupConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleCloudIdentityGroup.GoogleCloudIdentityGroupGroupKey",
    jsii_struct_bases=[],
...
class GoogleCloudIdentityGroupGroupKeyOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleCloudIdentityGroup.GoogleCloudIdentityGroupGroupKeyOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleCloudIdentityGroup.GoogleCloudIdentityGroupTimeouts",
    jsii_struct_bases=[],
...
class GoogleCloudIdentityGroupTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleCloudIdentityGroup.GoogleCloudIdentityGroupTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
