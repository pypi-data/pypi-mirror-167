...
class GoogleNetworkConnectivityHub(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleNetworkConnectivityHub.GoogleNetworkConnectivityHub",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleNetworkConnectivityHub.GoogleNetworkConnectivityHubConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleNetworkConnectivityHub.GoogleNetworkConnectivityHubRoutingVpcs",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class GoogleNetworkConnectivityHubRoutingVpcsList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleNetworkConnectivityHub.GoogleNetworkConnectivityHubRoutingVpcsList",
):
    def __init__(
        self,
...
class GoogleNetworkConnectivityHubRoutingVpcsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleNetworkConnectivityHub.GoogleNetworkConnectivityHubRoutingVpcsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleNetworkConnectivityHub.GoogleNetworkConnectivityHubTimeouts",
    jsii_struct_bases=[],
...
class GoogleNetworkConnectivityHubTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleNetworkConnectivityHub.GoogleNetworkConnectivityHubTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
