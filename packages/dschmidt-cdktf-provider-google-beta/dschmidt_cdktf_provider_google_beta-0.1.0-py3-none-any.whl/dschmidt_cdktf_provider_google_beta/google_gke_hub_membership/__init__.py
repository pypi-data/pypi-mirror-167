...
class GoogleGkeHubMembership(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleGkeHubMembership.GoogleGkeHubMembership",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleGkeHubMembership.GoogleGkeHubMembershipAuthority",
    jsii_struct_bases=[],
...
class GoogleGkeHubMembershipAuthorityOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleGkeHubMembership.GoogleGkeHubMembershipAuthorityOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleGkeHubMembership.GoogleGkeHubMembershipConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleGkeHubMembership.GoogleGkeHubMembershipEndpoint",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleGkeHubMembership.GoogleGkeHubMembershipEndpointGkeCluster",
    jsii_struct_bases=[],
...
class GoogleGkeHubMembershipEndpointGkeClusterOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleGkeHubMembership.GoogleGkeHubMembershipEndpointGkeClusterOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
class GoogleGkeHubMembershipEndpointOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleGkeHubMembership.GoogleGkeHubMembershipEndpointOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleGkeHubMembership.GoogleGkeHubMembershipTimeouts",
    jsii_struct_bases=[],
...
class GoogleGkeHubMembershipTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleGkeHubMembership.GoogleGkeHubMembershipTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
