...
class GoogleDialogflowCxAgent(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowCxAgent.GoogleDialogflowCxAgent",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowCxAgent.GoogleDialogflowCxAgentConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowCxAgent.GoogleDialogflowCxAgentSpeechToTextSettings",
    jsii_struct_bases=[],
...
class GoogleDialogflowCxAgentSpeechToTextSettingsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowCxAgent.GoogleDialogflowCxAgentSpeechToTextSettingsOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowCxAgent.GoogleDialogflowCxAgentTimeouts",
    jsii_struct_bases=[],
...
class GoogleDialogflowCxAgentTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleDialogflowCxAgent.GoogleDialogflowCxAgentTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
