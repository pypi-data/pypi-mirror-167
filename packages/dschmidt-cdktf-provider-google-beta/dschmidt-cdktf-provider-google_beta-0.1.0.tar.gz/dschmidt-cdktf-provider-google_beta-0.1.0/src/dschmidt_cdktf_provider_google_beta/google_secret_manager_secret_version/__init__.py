...
class GoogleSecretManagerSecretVersion(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleSecretManagerSecretVersion.GoogleSecretManagerSecretVersion",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleSecretManagerSecretVersion.GoogleSecretManagerSecretVersionConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleSecretManagerSecretVersion.GoogleSecretManagerSecretVersionTimeouts",
    jsii_struct_bases=[],
...
class GoogleSecretManagerSecretVersionTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleSecretManagerSecretVersion.GoogleSecretManagerSecretVersionTimeoutsOutputReference",
):
    def __init__(
        self,
