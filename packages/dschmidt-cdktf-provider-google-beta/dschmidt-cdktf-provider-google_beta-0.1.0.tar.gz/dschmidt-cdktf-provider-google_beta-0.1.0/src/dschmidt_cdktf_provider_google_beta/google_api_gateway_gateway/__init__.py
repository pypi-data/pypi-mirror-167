...
class GoogleApiGatewayGateway(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleApiGatewayGateway.GoogleApiGatewayGateway",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleApiGatewayGateway.GoogleApiGatewayGatewayConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleApiGatewayGateway.GoogleApiGatewayGatewayTimeouts",
    jsii_struct_bases=[],
...
class GoogleApiGatewayGatewayTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleApiGatewayGateway.GoogleApiGatewayGatewayTimeoutsOutputReference",
):
    def __init__(
        self,
