...
class DataGoogleSpannerInstance(
    ...
    jsii_type="@dschmidt/provider-google-beta.dataGoogleSpannerInstance.DataGoogleSpannerInstance",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.dataGoogleSpannerInstance.DataGoogleSpannerInstanceConfig",
