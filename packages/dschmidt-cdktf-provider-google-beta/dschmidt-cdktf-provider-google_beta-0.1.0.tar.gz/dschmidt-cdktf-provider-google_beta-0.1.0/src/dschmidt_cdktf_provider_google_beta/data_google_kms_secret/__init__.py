...
class DataGoogleKmsSecret(
    ...
    jsii_type="@dschmidt/provider-google-beta.dataGoogleKmsSecret.DataGoogleKmsSecret",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.dataGoogleKmsSecret.DataGoogleKmsSecretConfig",
