...
class GoogleComputeDiskIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleComputeDiskIamPolicy.GoogleComputeDiskIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeDiskIamPolicy.GoogleComputeDiskIamPolicyConfig",
