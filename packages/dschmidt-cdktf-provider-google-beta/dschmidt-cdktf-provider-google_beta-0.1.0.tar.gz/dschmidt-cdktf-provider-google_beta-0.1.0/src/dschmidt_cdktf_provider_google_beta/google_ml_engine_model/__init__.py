...
class GoogleMlEngineModel(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleMlEngineModel.GoogleMlEngineModel",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleMlEngineModel.GoogleMlEngineModelConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleMlEngineModel.GoogleMlEngineModelDefaultVersion",
    jsii_struct_bases=[],
...
class GoogleMlEngineModelDefaultVersionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleMlEngineModel.GoogleMlEngineModelDefaultVersionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleMlEngineModel.GoogleMlEngineModelTimeouts",
    jsii_struct_bases=[],
...
class GoogleMlEngineModelTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleMlEngineModel.GoogleMlEngineModelTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
