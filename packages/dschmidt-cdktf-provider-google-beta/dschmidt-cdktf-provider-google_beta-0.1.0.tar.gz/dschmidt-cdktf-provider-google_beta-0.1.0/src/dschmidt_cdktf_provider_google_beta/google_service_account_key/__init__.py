...
class GoogleServiceAccountKey(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleServiceAccountKey.GoogleServiceAccountKey",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleServiceAccountKey.GoogleServiceAccountKeyConfig",
