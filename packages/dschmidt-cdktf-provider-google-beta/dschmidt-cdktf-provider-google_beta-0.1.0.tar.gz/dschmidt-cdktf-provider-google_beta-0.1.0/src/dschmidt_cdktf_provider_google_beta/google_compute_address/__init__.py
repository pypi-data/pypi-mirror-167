...
class GoogleComputeAddress(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleComputeAddress.GoogleComputeAddress",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeAddress.GoogleComputeAddressConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeAddress.GoogleComputeAddressTimeouts",
    jsii_struct_bases=[],
...
class GoogleComputeAddressTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleComputeAddress.GoogleComputeAddressTimeoutsOutputReference",
):
    def __init__(
        self,
