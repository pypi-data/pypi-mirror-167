...
class GoogleTagsTagKeyIamBinding(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleTagsTagKeyIamBinding.GoogleTagsTagKeyIamBinding",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleTagsTagKeyIamBinding.GoogleTagsTagKeyIamBindingCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class GoogleTagsTagKeyIamBindingConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleTagsTagKeyIamBinding.GoogleTagsTagKeyIamBindingConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleTagsTagKeyIamBinding.GoogleTagsTagKeyIamBindingConfig",
