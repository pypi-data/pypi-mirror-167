...
class DataGoogleFirebaseWebAppConfigA(
    ...
    jsii_type="@dschmidt/provider-google-beta.dataGoogleFirebaseWebAppConfig.DataGoogleFirebaseWebAppConfigA",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.dataGoogleFirebaseWebAppConfig.DataGoogleFirebaseWebAppConfigAConfig",
