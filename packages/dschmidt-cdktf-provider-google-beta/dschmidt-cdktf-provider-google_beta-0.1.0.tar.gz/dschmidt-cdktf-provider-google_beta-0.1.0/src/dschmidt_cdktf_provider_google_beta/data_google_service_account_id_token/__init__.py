...
class DataGoogleServiceAccountIdToken(
    ...
    jsii_type="@dschmidt/provider-google-beta.dataGoogleServiceAccountIdToken.DataGoogleServiceAccountIdToken",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.dataGoogleServiceAccountIdToken.DataGoogleServiceAccountIdTokenConfig",
