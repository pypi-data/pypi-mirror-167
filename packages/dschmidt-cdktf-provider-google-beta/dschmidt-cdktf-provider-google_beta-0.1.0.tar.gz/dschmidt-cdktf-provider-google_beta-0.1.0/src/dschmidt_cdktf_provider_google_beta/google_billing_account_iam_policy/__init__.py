...
class GoogleBillingAccountIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleBillingAccountIamPolicy.GoogleBillingAccountIamPolicy",
):
    ...
    def __init__(
        ...
        *,
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(GoogleBillingAccountIamPolicy.__init__)
    ...
    def billing_account_id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleBillingAccountIamPolicy, "billing_account_id").fset)
    ...
    def id(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleBillingAccountIamPolicy, "id").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
    ...
    def policy_data(self, value: builtins.str) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(getattr(GoogleBillingAccountIamPolicy, "policy_data").fset)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "policyData", value)


@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleBillingAccountIamPolicy.GoogleBillingAccountIamPolicyConfig",
...
class GoogleBillingAccountIamPolicyConfig(cdktf.TerraformMetaArguments):
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(GoogleBillingAccountIamPolicyConfig.__init__)
