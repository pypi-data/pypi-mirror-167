...
class GoogleComputeHttpHealthCheck(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleComputeHttpHealthCheck.GoogleComputeHttpHealthCheck",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeHttpHealthCheck.GoogleComputeHttpHealthCheckConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeHttpHealthCheck.GoogleComputeHttpHealthCheckTimeouts",
    jsii_struct_bases=[],
...
class GoogleComputeHttpHealthCheckTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleComputeHttpHealthCheck.GoogleComputeHttpHealthCheckTimeoutsOutputReference",
):
    def __init__(
        self,
