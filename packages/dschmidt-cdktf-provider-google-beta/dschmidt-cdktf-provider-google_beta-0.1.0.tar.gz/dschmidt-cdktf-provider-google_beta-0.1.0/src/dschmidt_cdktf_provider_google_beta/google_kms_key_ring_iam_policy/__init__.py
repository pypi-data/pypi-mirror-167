...
class GoogleKmsKeyRingIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleKmsKeyRingIamPolicy.GoogleKmsKeyRingIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleKmsKeyRingIamPolicy.GoogleKmsKeyRingIamPolicyConfig",
