...
class GoogleComputeMachineImageIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleComputeMachineImageIamPolicy.GoogleComputeMachineImageIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeMachineImageIamPolicy.GoogleComputeMachineImageIamPolicyConfig",
