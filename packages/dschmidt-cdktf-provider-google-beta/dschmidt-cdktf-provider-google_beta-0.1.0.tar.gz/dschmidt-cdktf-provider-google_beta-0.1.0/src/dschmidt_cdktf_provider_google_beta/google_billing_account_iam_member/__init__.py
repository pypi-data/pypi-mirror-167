...
class GoogleBillingAccountIamMember(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleBillingAccountIamMember.GoogleBillingAccountIamMember",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleBillingAccountIamMember.GoogleBillingAccountIamMemberCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class GoogleBillingAccountIamMemberConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleBillingAccountIamMember.GoogleBillingAccountIamMemberConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleBillingAccountIamMember.GoogleBillingAccountIamMemberConfig",
