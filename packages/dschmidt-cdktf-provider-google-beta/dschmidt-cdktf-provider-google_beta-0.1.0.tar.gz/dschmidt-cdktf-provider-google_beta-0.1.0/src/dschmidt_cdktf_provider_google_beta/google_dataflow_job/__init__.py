...
class GoogleDataflowJob(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleDataflowJob.GoogleDataflowJob",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleDataflowJob.GoogleDataflowJobConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleDataflowJob.GoogleDataflowJobTimeouts",
    jsii_struct_bases=[],
...
class GoogleDataflowJobTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleDataflowJob.GoogleDataflowJobTimeoutsOutputReference",
):
    def __init__(
        self,
