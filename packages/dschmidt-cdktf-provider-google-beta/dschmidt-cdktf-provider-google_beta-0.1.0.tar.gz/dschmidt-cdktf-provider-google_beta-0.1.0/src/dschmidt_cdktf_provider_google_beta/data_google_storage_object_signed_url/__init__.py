...
class DataGoogleStorageObjectSignedUrl(
    ...
    jsii_type="@dschmidt/provider-google-beta.dataGoogleStorageObjectSignedUrl.DataGoogleStorageObjectSignedUrl",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.dataGoogleStorageObjectSignedUrl.DataGoogleStorageObjectSignedUrlConfig",
