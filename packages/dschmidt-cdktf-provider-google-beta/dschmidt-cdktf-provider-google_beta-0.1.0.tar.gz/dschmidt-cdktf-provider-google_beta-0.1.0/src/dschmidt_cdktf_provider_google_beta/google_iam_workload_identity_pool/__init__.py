...
class GoogleIamWorkloadIdentityPool(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleIamWorkloadIdentityPool.GoogleIamWorkloadIdentityPool",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleIamWorkloadIdentityPool.GoogleIamWorkloadIdentityPoolConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleIamWorkloadIdentityPool.GoogleIamWorkloadIdentityPoolTimeouts",
    jsii_struct_bases=[],
...
class GoogleIamWorkloadIdentityPoolTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleIamWorkloadIdentityPool.GoogleIamWorkloadIdentityPoolTimeoutsOutputReference",
):
    def __init__(
        self,
