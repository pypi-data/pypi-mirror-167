...
class GoogleDnsResponsePolicy(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleDnsResponsePolicy.GoogleDnsResponsePolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleDnsResponsePolicy.GoogleDnsResponsePolicyConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleDnsResponsePolicy.GoogleDnsResponsePolicyNetworks",
    jsii_struct_bases=[],
...
class GoogleDnsResponsePolicyNetworksList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleDnsResponsePolicy.GoogleDnsResponsePolicyNetworksList",
):
    def __init__(
        self,
...
class GoogleDnsResponsePolicyNetworksOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleDnsResponsePolicy.GoogleDnsResponsePolicyNetworksOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleDnsResponsePolicy.GoogleDnsResponsePolicyTimeouts",
    jsii_struct_bases=[],
...
class GoogleDnsResponsePolicyTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleDnsResponsePolicy.GoogleDnsResponsePolicyTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
