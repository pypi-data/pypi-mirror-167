...
class GoogleStorageObjectAcl(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleStorageObjectAcl.GoogleStorageObjectAcl",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleStorageObjectAcl.GoogleStorageObjectAclConfig",
