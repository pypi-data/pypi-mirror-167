...
class GoogleApigeeEnvgroupAttachment(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleApigeeEnvgroupAttachment.GoogleApigeeEnvgroupAttachment",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleApigeeEnvgroupAttachment.GoogleApigeeEnvgroupAttachmentConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleApigeeEnvgroupAttachment.GoogleApigeeEnvgroupAttachmentTimeouts",
    jsii_struct_bases=[],
...
class GoogleApigeeEnvgroupAttachmentTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleApigeeEnvgroupAttachment.GoogleApigeeEnvgroupAttachmentTimeoutsOutputReference",
):
    def __init__(
        self,
