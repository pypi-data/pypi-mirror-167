...
class GoogleProject(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleProject.GoogleProject",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleProject.GoogleProjectConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleProject.GoogleProjectTimeouts",
    jsii_struct_bases=[],
    name_mapping={
        "create": "create",
        "delete": "delete",
...
class GoogleProjectTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleProject.GoogleProjectTimeoutsOutputReference",
):
    def __init__(
        self,
