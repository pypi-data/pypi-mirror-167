...
class GoogleComputeGlobalAddress(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleComputeGlobalAddress.GoogleComputeGlobalAddress",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeGlobalAddress.GoogleComputeGlobalAddressConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleComputeGlobalAddress.GoogleComputeGlobalAddressTimeouts",
    jsii_struct_bases=[],
...
class GoogleComputeGlobalAddressTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleComputeGlobalAddress.GoogleComputeGlobalAddressTimeoutsOutputReference",
):
    def __init__(
        self,
