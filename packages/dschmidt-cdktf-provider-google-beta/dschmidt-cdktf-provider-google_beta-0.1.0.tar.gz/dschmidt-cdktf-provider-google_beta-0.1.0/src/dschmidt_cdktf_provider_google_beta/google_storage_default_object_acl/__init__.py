...
class GoogleStorageDefaultObjectAcl(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleStorageDefaultObjectAcl.GoogleStorageDefaultObjectAcl",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleStorageDefaultObjectAcl.GoogleStorageDefaultObjectAclConfig",
