...
class GoogleBigqueryReservation(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleBigqueryReservation.GoogleBigqueryReservation",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleBigqueryReservation.GoogleBigqueryReservationConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleBigqueryReservation.GoogleBigqueryReservationTimeouts",
    jsii_struct_bases=[],
...
class GoogleBigqueryReservationTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google-beta.googleBigqueryReservation.GoogleBigqueryReservationTimeoutsOutputReference",
):
    def __init__(
        self,
