...
class GoogleBetaProvider(
    ...
    jsii_type="@dschmidt/provider-google-beta.googleBetaProvider.GoogleBetaProvider",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleBetaProvider.GoogleBetaProviderBatching",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google-beta.googleBetaProvider.GoogleBetaProviderConfig",
    jsii_struct_bases=[],
    name_mapping={
