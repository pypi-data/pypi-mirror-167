...
class dMondate:
    ...
    async def try_select_one_by_key(self, _key: tMondateKey) -> bool:
        ...
        """
        async with dMondateSelectOne(self._dbcon) as _qry:
    ...
    async def update(self, irec: tMondate = None):
        ...
        async with dMondateUpdate(self._dbcon) as _qry:
    ...
    async def insert(self, irec: tMondate = None):
        ...
        async with dMondateInsert(self._dbcon) as _qry:
            await _qry.exec(self.rec)
    ...
    async def delete_one(self, irec: tMondateKey = None):
        ...
        async with dMondateDeleteOne(self._dbcon) as _qry:
            await _qry.exec(_key)
