...
class dBatch:
    ...
    async def lock_one_by_key(self, _key: tBatchKey, _lock4update: mettle.db.DBLock, _expected: bool = True) -> bool:
        ...
        :return: True if selected, False if not found and _expected is set to False
        """
        async with dBatchLockOne(self._dbcon) as _qry:
...
_lock4update.retrys, _lock4update.mili_seconds), err_code = mettle.lib.xMettle.eCode.DBLockNoWaitFailed)
    ...
    async def try_select_one_by_key(self, _key: tBatchKey) -> bool:
        ...
        """
        async with dBatchSelectOne(self._dbcon) as _qry:
            await _qry.exec(_key)
            if not await _qry.fetch():
                return False
    ...
    async def update(self, irec: tBatch = None):
        ...
        async with dBatchUpdate(self._dbcon) as _qry:
    ...
    async def insert(self, irec: tBatch = None):
        ...
        async with dBatchInsert(self._dbcon) as _qry:
            await _qry.exec(self.rec)
    ...
    async def delete_one(self, irec: tBatchKey = None):
        ...
        async with dBatchDeleteOne(self._dbcon) as _qry:
            await _qry.exec(_key)
