...
class dJob:
    ...
    async def try_select_one_by_key(self, _key: tJobKey) -> bool:
        ...
        """
        async with dJobSelectOne(self._dbcon) as _qry:
    ...
    async def update(self, irec: tJob = None):
        ...
        async with dJobUpdate(self._dbcon) as _qry:
    ...
    async def insert(self, irec: tJob = None):
        ...
        async with dJobInsert(self._dbcon) as _qry:
            await _qry.exec(self.rec)
    ...
    async def delete_one(self, irec: tJobKey = None):
        ...
        async with dJobDeleteOne(self._dbcon) as _qry:
            await _qry.exec(_key)
