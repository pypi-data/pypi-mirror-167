...
def test_get_plots_from_text():
    data = (
        ...
        'S_cas,0.363,N/A,909,N/A,0,0,0,141,638,58.9\n'
        'K_wal,0.494,0,903,617,0,0,0,101,0,0\n'
        'A_gos,0.518,1736,875,N/A,0,0,0,63.2,657,0\n'
        'K_lac,0.557,1691,894,611,0,0,0,102,0,0\n'
        'A_nid,0.903,0,691,N/A,0,0,0,0,378,0\n'
        'S_pom,0.922,1194,684,344,0,0,0,0,0,0\n'
        'Y_lip,0.954,1297,714,N/A,0,0,0,0,375,0'
    )

    with pytest.warns(UserWarning):
        analyzer = pyodide_utilities.get_analyzer_from_text(data, 0.002, 400, 9_000_000)
        plot, missing = pyodide_utilities.get_plot_and_table("NP_010181.2", analyzer)
