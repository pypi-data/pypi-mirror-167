...
class GlobalEncodingField():
	def __init__(self) -> GlobalEncodingField:
		self.value = 0
...
class LidarHeader(): 
	...
	@property
	def project_id3(self) -> bytearray(8): ...
...
class LidarPointData():
	...
	def get_32bit_from_64bit(self) -> List[int, int]: ...
...
class Lidar():
	...
	def add_point(self, point_data: LidarPointData, time: float = None, colour_data: ColourData = None, waveform_data: WaveformPacket = None) -> None: ...
...
class WbEnvironment():
	...
	def __new__(WbEnvironment) -> WbEnvironment: ...
	...
	def new_vector(self,  shape_type: VectorGeometryType, attributes: List[AttributeField] = None, proj: str = "") -> Vector: ...
