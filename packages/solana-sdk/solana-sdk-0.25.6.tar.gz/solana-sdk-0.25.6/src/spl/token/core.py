...
import solanasdk.system_program as sp
...
from solanasdk.rpc.types import RPCResponse, TokenAccountOpts, TxOpts
from solanasdk.transaction import Transaction
from solanasdk.utils.helpers import decode_byte_string
...
class _TokenCore:  # pylint: disable=too-few-public-methods
    ...
    def _transfer_with_ata(
        ...
        if add_create_ata:
            txn = Transaction().add(
                spl_token.create_associated_token_account(payer, dest, mint),
                spl_token.transfer(
