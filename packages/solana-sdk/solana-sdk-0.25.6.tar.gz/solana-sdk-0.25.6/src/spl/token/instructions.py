...
from solanasdk.system_program import SYS_PROGRAM_ID
from solanasdk.sysvar import SYSVAR_RENT_PUBKEY
from solanasdk.transaction import AccountMeta, TransactionInstruction
...
def initialize_mint(params: InitializeMintParams) -> TransactionInstruction:
    ...
    Example:
        ...
        <class 'solanasdk.transaction.TransactionInstruction'>
