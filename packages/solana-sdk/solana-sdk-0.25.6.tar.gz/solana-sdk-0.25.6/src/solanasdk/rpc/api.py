...
from solanasdk.blockhash import Blockhash, BlockhashCache
from solanasdk.keypair import Keypair
from solanasdk.message import Message
...
def DataSliceOpt(*args, **kwargs) -> types.DataSliceOpts:  # pylint: disable=invalid-name
    ...
    warn(
        "solanasdk.rpc.api.DataSliceOpt is deprecated, please use solanasdk.rpc.types.DataSliceOpts",
...
def MemcmpOpt(*args, **kwargs) -> types.MemcmpOpts:  # pylint: disable=invalid-name
    ...
    warn(
        "solanasdk.rpc.api.MemcmpOpt is deprecated, please use solanasdk.rpc.types.MemcmpOpts",
        category=DeprecationWarning,
    )
