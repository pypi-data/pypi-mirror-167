...
class inception_block_a(tf.keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        outputs = concatenate([branch1x1, branch5x5, branch3x3dbl, branch_pool],axis=channel_axis)
        return outputs
...
class reduction_block_a(tf.keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        outputs = concatenate([branch3x3, branch3x3dbl, branch_pool],axis=channel_axis)
        return outputs
...
class inception_block_b(tf.keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        outputs = concatenate([branch1x1, branch7x7, branch7x7dbl, branch_pool],axis=channel_axis)
        return outputs
...
class reduction_block_b(tf.keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        outputs = concatenate([branch3x3, branch7x7x3, branch_pool],axis=channel_axis)
        return outputs
############################################################################
...
class inception_block_c(tf.keras.layers.Layer):
    ...
    def call(self, inputs):
        ...
        outputs = concatenate([branch1x1, branch3x3, branch3x3dbl, branch_pool],axis=channel_axis)
        return outputs
...
class InceptionV3(Model):
    ...
    def __init__(self, classes,conv_block=None):
...
def inceptionV3(classes=1000):
    ...
    x = InceptionV3(classes=classes)(input_layer)
