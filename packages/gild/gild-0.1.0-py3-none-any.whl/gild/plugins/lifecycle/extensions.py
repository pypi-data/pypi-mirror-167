...
class AppStartup(Declarative):
    ...
    extension point of the "gild" plugin. AppStartup object are used
...
class AppClosing(Declarative):
    ...
    extension point of the "gild" plugin. AppClosing object are used
...
class AppClosed(Declarative):
    ...
    extension point of the "gild" plugin. AppClosed object are used
