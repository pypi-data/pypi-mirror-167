...
class Spider:
    ...
    def find(self, before, after=None, begin=None, end=None):
        ...
        :param after: (optional) texts which is before the finding text, could be a string or a list of string
    ...
    def find_links(self, begin=None, end=None, contains=None, regex=False):
        ...
        :param begin: (optional) texts from where to begin the finding, could be a string or a list of string or an offset int
        :param end: (optional) texts from where to end the finding, could be a string or a list of string or an offset int
        :param contains: (optional) url style to filter the links
        :param regex: (optional) whether url is a regex pattern
    ...
    def find_images(self, begin=None, end=None):
        """
        ...
        return self.find_words_list(betweens, begin, end)
    ...
    def find_forms(self, begin=None, end=None):
        ...
        s = self._page
        # print(s)
        forms = self._get_texts(self._page, '<form', '</form', begin, end)
        print(forms)
        pass
        ...
        for table in tables:
            ...
            for row in rows:
                ...
                for cell in cells:
                    ...
                    # get cell text
                    cell_text = html2text(cell, line_break=True)
                    if text_only:
                        cell_obj = cell_text
                    else:
                        cell_obj = (cell_text, urls)
    ...
    def find_list_items(self, begin=None, end=None, is_ol=False):
        """
