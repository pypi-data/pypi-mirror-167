...
class _MultiOutputEstimator(MetaEstimatorMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    def fit(self, X, y, sample_weight, X_valid, y_valid, **fit_params):
    ...
    def fit(self, X, y, sample_weight, X_valid, y_valid, **fit_params):
        ...
        **fit_params : dict of string -> object
        ...
        self : object
            Returns a fitted instance.
        """
        super().fit(X, y, sample_weight, X_valid, y_valid, **fit_params)
...
def _fit_estimator(estimator, X, y, sample_weight, X_valid, y_valid, **fit_params):
    """Definition of Base fit function."""
    estimator = clone(estimator)
    if sample_weight is not None:
        estimator.fit(X, y, sample_weight, X_valid, y_valid, **fit_params)
    else:
        estimator.fit(X, y, None, X_valid, y_valid, **fit_params)
    return estimator
