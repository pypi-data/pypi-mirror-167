...
class _MultiOutputEstimator(MetaEstimatorMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    def fit(self, X, y, sample_weight, eval_set, **fit_params):
    ...
    def fit(self, X, y, sample_weight, eval_set, **fit_params):
        ...
        **fit_params : dict of string -> object
        ...
        self : object
            Returns a fitted instance.
        """
        super().fit(X, y, sample_weight, eval_set, **fit_params)
...
def _fit_estimator(estimator, X, y, sample_weight, eval_set, **fit_params):
