#!/usr/bin/env python3
"""
This helper file contains Nornir pyATS functions and tasks.
...
import sys
import yaml
from .utils import print_task_title, print_task_name, task_host, task_info, task_error
from .cli import write_commands_to_file
from .restconf.cisco_rpc import rc_cisco_rpc_copy_file, rc_cisco_rpc_is_syncing
