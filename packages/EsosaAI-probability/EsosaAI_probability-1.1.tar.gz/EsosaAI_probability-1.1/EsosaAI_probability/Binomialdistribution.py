...
class Binomial(Distribution):
    ...
    def plot_bar(self):
        ...
        plt.bar(x= list(set(self.data)), height= np.bincount(self.data))
        plt.xlabel("Probability")
        plt.ylabel("Number of Outomes")
    ...
    def plot_pdf(self):
        ...
        plt.title("Chart showing the density function of various probabilities")
