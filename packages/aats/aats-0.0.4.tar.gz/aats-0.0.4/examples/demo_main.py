...
# setup public config
trade_service.set_md_connection(ip='127.0.0.1', port=15002, send_type = NetWorkType.P2P)  # default setting
...
trade_service.set_ts_connection(ip='localhost', port=8062)  # default setting
