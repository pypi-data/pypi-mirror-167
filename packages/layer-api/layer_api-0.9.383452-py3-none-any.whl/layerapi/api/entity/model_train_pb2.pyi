...
class ModelTrain(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created_by_id",b"created_by_id","end_time",b"end_time","hyperparameter_tuning_id",b"hyperparameter_tuning_id","id",b"id","model_version_id",b"model_version_id","project_id",b"project_id","start_time",b"start_time","train_status",b"train_status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["created_by_id",b"created_by_id","description",b"description","end_time",b"end_time","end_timestamp",b"end_timestamp","fabric",b"fabric","flavor",b"flavor","hyperparameter_tuning_id",b"hyperparameter_tuning_id","id",b"id","index",b"index","model_version_id",b"model_version_id","project_id",b"project_id","start_time",b"start_time","start_timestamp",b"start_timestamp","train_status",b"train_status","train_type",b"train_type","uri",b"uri"]) -> None: ...
