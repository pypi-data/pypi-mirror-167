...
class Ui_DreadGameTabWidget(object):
    def setupUi(self, DreadGameTabWidget):
        ...
        self.faq_scroll_area_contents.setGeometry(QRect(0, 0, 631, 471))
        ...
        self.differences_contents.setGeometry(QRect(0, 0, 631, 471))
        ...
        self.known_crashes_contents.setGeometry(QRect(0, 0, 621, 502))
        ...
        self.hints_scroll_area_contents.setGeometry(QRect(0, 0, 631, 471))
        ...
        self.hint_item_names_scroll_contents.setGeometry(QRect(0, 0, 631, 471))
        ...
        self.hint_locations_scroll_contents.setGeometry(QRect(0, 0, 631, 471))
