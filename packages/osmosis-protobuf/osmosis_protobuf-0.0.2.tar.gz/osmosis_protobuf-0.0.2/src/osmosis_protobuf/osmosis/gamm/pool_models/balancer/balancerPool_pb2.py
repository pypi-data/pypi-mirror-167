...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = b'Z?github.com/osmosis-labs/osmosis/v11/x/gamm/pool-models/balancer'
