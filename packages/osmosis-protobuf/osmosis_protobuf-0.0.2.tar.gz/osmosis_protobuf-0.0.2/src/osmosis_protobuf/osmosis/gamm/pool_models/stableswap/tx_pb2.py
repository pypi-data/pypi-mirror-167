...
MsgStableSwapAdjustScalingFactors = _reflection.GeneratedProtocolMessageType('MsgStableSwapAdjustScalingFactors', (_message.Message,), {'DESCRIPTOR': _MSGSTABLESWAPADJUSTSCALINGFACTORS, '__module__': 'osmosis.gamm.pool_models.stableswap.tx_pb2'})
_sym_db.RegisterMessage(MsgStableSwapAdjustScalingFactors)
MsgStableSwapAdjustScalingFactorsResponse = _reflection.GeneratedProtocolMessageType('MsgStableSwapAdjustScalingFactorsResponse', (_message.Message,), {'DESCRIPTOR': _MSGSTABLESWAPADJUSTSCALINGFACTORSRESPONSE, '__module__': 'osmosis.gamm.pool_models.stableswap.tx_pb2'})
_sym_db.RegisterMessage(MsgStableSwapAdjustScalingFactorsResponse)
_MSG = DESCRIPTOR.services_by_name['Msg']
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b'ZAgithub.com/osmosis-labs/osmosis/v11/x/gamm/pool-models/stableswap'
    ...
    _MSGSTABLESWAPADJUSTSCALINGFACTORS.fields_by_name['scaling_factors']._serialized_options = b'\xf2\xde\x1f yaml:"stableswap_scaling_factor"\xc8\xde\x1f\x00'
