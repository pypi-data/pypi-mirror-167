...
MsgExtendLockup = _reflection.GeneratedProtocolMessageType('MsgExtendLockup', (_message.Message,), {'DESCRIPTOR': _MSGEXTENDLOCKUP, '__module__': 'osmosis.lockup.tx_pb2'})
_sym_db.RegisterMessage(MsgExtendLockup)
MsgExtendLockupResponse = _reflection.GeneratedProtocolMessageType('MsgExtendLockupResponse', (_message.Message,), {'DESCRIPTOR': _MSGEXTENDLOCKUPRESPONSE, '__module__': 'osmosis.lockup.tx_pb2'})
_sym_db.RegisterMessage(MsgExtendLockupResponse)
_MSG = DESCRIPTOR.services_by_name['Msg']
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b'Z2github.com/osmosis-labs/osmosis/v11/x/lockup/types'
