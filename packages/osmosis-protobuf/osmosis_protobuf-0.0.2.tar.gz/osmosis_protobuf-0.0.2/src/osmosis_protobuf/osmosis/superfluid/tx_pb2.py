...
MsgUnPoolWhitelistedPool = _reflection.GeneratedProtocolMessageType('MsgUnPoolWhitelistedPool', (_message.Message,), {'DESCRIPTOR': _MSGUNPOOLWHITELISTEDPOOL, '__module__': 'osmosis.superfluid.tx_pb2'})
_sym_db.RegisterMessage(MsgUnPoolWhitelistedPool)
MsgUnPoolWhitelistedPoolResponse = _reflection.GeneratedProtocolMessageType('MsgUnPoolWhitelistedPoolResponse', (_message.Message,), {'DESCRIPTOR': _MSGUNPOOLWHITELISTEDPOOLRESPONSE, '__module__': 'osmosis.superfluid.tx_pb2'})
_sym_db.RegisterMessage(MsgUnPoolWhitelistedPoolResponse)
_MSG = DESCRIPTOR.services_by_name['Msg']
if _descriptor._USE_C_DESCRIPTORS == False:
    DESCRIPTOR._options = None
    DESCRIPTOR._serialized_options = b'Z6github.com/osmosis-labs/osmosis/v11/x/superfluid/types'
