...
ABCIResponses = _reflection.GeneratedProtocolMessageType('ABCIResponses', (_message.Message,), {'DESCRIPTOR': _ABCIRESPONSES, '__module__': 'tendermint.state.types_pb2'})
_sym_db.RegisterMessage(ABCIResponses)
ValidatorsInfo = _reflection.GeneratedProtocolMessageType('ValidatorsInfo', (_message.Message,), {'DESCRIPTOR': _VALIDATORSINFO, '__module__': 'tendermint.state.types_pb2'})
_sym_db.RegisterMessage(ValidatorsInfo)
ConsensusParamsInfo = _reflection.GeneratedProtocolMessageType('ConsensusParamsInfo', (_message.Message,), {'DESCRIPTOR': _CONSENSUSPARAMSINFO, '__module__': 'tendermint.state.types_pb2'})
_sym_db.RegisterMessage(ConsensusParamsInfo)
Version = _reflection.GeneratedProtocolMessageType('Version', (_message.Message,), {'DESCRIPTOR': _VERSION, '__module__': 'tendermint.state.types_pb2'})
_sym_db.RegisterMessage(Version)
State = _reflection.GeneratedProtocolMessageType('State', (_message.Message,), {'DESCRIPTOR': _STATE, '__module__': 'tendermint.state.types_pb2'})
