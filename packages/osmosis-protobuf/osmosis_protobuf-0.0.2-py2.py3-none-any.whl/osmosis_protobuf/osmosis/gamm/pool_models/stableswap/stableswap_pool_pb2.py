...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _POOL.fields_by_name['scaling_factor']._serialized_options = b'\xf2\xde\x1f yaml:"stableswap_scaling_factor"\xc8\xde\x1f\x00'
