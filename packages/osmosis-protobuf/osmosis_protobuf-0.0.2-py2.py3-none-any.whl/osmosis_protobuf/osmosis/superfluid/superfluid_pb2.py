...
UnpoolWhitelistedPools = _reflection.GeneratedProtocolMessageType('UnpoolWhitelistedPools', (_message.Message,), {'DESCRIPTOR': _UNPOOLWHITELISTEDPOOLS, '__module__': 'osmosis.superfluid.superfluid_pb2'})
