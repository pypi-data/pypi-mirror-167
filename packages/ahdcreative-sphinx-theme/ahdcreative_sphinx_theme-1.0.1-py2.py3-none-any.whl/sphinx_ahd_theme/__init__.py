...
def gen_html_theme_path():
    """ return the path to the parent folder of the installed theme """
...
def update_context(app, pagename, templatename, context, doctree):
    """ Update the rendering context for a page.
        ...
        This function makes the theme version available in the jinja2
        html templates as '{{ theme_version}}'.

        Additionally we tweak the rendering context in an unconventional way. We
        are inspecting the context to see whether the page metadata has an entry
        ...
        A field list near the top of the reST source file is passed on by
