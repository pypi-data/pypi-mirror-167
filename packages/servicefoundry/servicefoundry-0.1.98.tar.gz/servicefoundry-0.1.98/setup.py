...
['servicefoundry',
 ...
 'servicefoundry.python_service',
 'servicefoundry.python_service.deployment_examples.class_deployment',
 'servicefoundry.python_service.deployment_examples.function_deployment',
 'servicefoundry.python_service.deployment_examples.model_composition',
 'servicefoundry.python_service.deployment_examples.one_service_calling_another',
 'servicefoundry.python_service.remote',
...
extras_require = \
{':extra == "fastapi"': ['fastapi>=0.78.0,<0.79.0'],
 'fastapi': ['prometheus-client>=0.14.1,<0.15.0'],
