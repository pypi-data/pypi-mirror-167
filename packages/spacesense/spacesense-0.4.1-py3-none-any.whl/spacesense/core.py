...
from spacesense.collections.models import Sentinel1SearchResult, Sentinel2SearchResult, Weather
...
class Client:
    ...
    def fuse(
        self,
        catalogs_list: List[Union[Sentinel1SearchResult, Sentinel2SearchResult, Weather]],
        fuse_id: str = None,
        aoi: Any = None,
        to_fuse: List[Union[Raster, Vector]] = [],
        ...
        #     "weather": {"aoi": {}, "start_date": <date>, "end_date": <date>, "variables": <List[str]>, "sequence_index": 1},
        # }
    ...
    def get_job(self, id):
        return Job.load_from_id(
            id=id, experiment_id=self.id, backend_url=self.backend_url, workflow_id="fuse_closest_s1_s2", name="42_0"
        )
