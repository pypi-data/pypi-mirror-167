...
import isection_formulas as iformulas
import numpy as np
...
class ISection:
    ...
    @property
    def Iy(self):
        return iformulas.Iy(*self.dimensions)

    @property
    def Iz(self):
        return iformulas.Iz(*self.dimensions)
    ...
    @property
    def It(self):
        return iformulas.It(*self.dimensions)
