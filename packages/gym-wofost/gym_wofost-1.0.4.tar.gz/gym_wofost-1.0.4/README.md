...
## Initialing gym-wofost with default parameters:
...
env_args = {
    "years_count": 8,  # number of years to simulate
    ...
    "Discount_factors_dict": {
        ...
        "P": 1,
        "K": 1,
    },  # discount factor of each action"""
}

# -- Init the env  :
env = gym.make("wofost-v0")

# -- Change the env's parameters :
env.set_args(env_args)
