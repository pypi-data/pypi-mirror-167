...
def return_apr_dict(action : str, irrigation_amount : Union[int, float], N_amount : Union[int, float], P_amount : Union[int, float], K_amount : Union[int, float]) -> Tuple[dict, dict]:
...
def gen_agromanager(
    base : List[dict], dicton : dict, costs : dict, irrigation_amount : Union[float, int], N_amount : Union[float, int], P_amount : Union[float, int], K_amount : Union[float, int], seed : int =5676
...
class AgroActions:
    ...
    def generate_agromanagement(
        self, dict_periodicity : Dict[str, int], irrigation_amount : Union[float, int], N_amount : Union[float, int], P_amount : Union[float, int], K_amount : Union[float, int], year : int
    ):
