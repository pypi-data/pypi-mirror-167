from hrthy_core.security.scopes import (
    ...
    SCOPE_COMPANY_CREATE, SCOPE_COMPANY_DELETE, SCOPE_COMPANY_LIST, SCOPE_COMPANY_MY_DELETE,
    ...
    SCOPE_USER_CREATE, SCOPE_USER_DELETE, SCOPE_USER_LIST, SCOPE_USER_MYSELF_DELETE, SCOPE_USER_MYSELF_UPDATE,
...
HIERARCHY_SCOPES = {
    ...
    SCOPE_USER_MYSELF_UPDATE: {'type': ScopeType.COMPANY, 'includes': [], 'depends': [], 'visible': True},
    SCOPE_USER_MYSELF_DELETE: {'type': ScopeType.COMPANY, 'includes': [], 'depends': [], 'visible': True},
    # endregion
