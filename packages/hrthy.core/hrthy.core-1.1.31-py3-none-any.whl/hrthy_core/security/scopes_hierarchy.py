...
HIERARCHY_SCOPES = {
    ...
    SCOPE_CANDIDATE_ADDITIONAL_FIELDS_PROTECTED_VALUE_UPDATE: {
        ...
        'depends': [SCOPE_CANDIDATE_ADDITIONAL_FIELDS_PROTECTED_LIST], 'visible': [SCOPE_ROLE_MY_ASSIGN_GLOBAL]
    },
    ...
    SCOPE_CANDIDATE_ADDITIONAL_FIELDS_VALUE_MY_UPDATE: {
        'type': ScopeType.GLOBAL, 'includes': [],
        'depends': [SCOPE_CANDIDATE_ADDITIONAL_FIELDS_MY_LIST], 'visible': True
    },
    SCOPE_CANDIDATE_ADDITIONAL_FIELDS_PROTECTED_VALUE_MY_UPDATE: {
        'type': ScopeType.GLOBAL, 'includes': [],
        'depends': [SCOPE_CANDIDATE_ADDITIONAL_FIELDS_PROTECTED_MY_LIST], 'visible': True
    },
