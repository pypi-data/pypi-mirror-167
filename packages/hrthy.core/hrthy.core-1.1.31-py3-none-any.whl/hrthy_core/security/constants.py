from hrthy_core.security.scopes import (
    ...
    SCOPE_COMPANY_MYSELF_GET, SCOPE_COMPANY_MY_UPDATE, SCOPE_COMPANY_RESTORE, SCOPE_COMPANY_UPDATE,
    ...
    SCOPE_PIPELINE_ADDITIONAL_FIELDS_MY_UPDATE, SCOPE_PIPELINE_CANDIDATE_ASSIGN, SCOPE_PIPELINE_CANDIDATE_MY_ASSIGN,
