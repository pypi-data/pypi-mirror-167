...
SCOPE_COMPANY_MY_RESTORE = 'com.my.r'  # Admin
...
SCOPE_CANDIDATE_ADDITIONAL_FIELDS_PROTECTED_VALUE_UPDATE = 'can.fields.protected.value.u'  #
# Superuser
SCOPE_CANDIDATE_ADDITIONAL_FIELDS_VALUE_MY_UPDATE = 'can.fields.value.my.u'  # Admin, User
SCOPE_CANDIDATE_ADDITIONAL_FIELDS_PROTECTED_VALUE_MY_UPDATE = 'can.fields.protected.value.my.u'
# Admin, User
