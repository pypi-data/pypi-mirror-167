...
HIERARCHY_SCOPES = {
    ...
    SCOPE_COMPANY_MYSELF_GET: {'type': ScopeType.PERSONAL, 'includes': [], 'depends': [], 'visible': True},
    # endregion
    ...
    SCOPE_ROLE_MYSELF_GET: {
        'type': ScopeType.PERSONAL, 'includes': [], 'depends': [SCOPE_ROLE_MY_LIST], 'visible': False
    },
    # endregion
