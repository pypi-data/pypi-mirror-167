...
import cohesity_management_sdk.models_v2.file_operations
...
class SnapshotDiffResult(object):
    ...
    def from_dictionary(cls,
        ...
        file_operations = None
        if dictionary.get('fileOperations') != None:
            file_operations = list()
            for structure in dictionary.get('fileOperations'):
                file_operations.append(cohesity_management_sdk.models_v2.file_operations.FileOperation.from_dictionary(structure))
