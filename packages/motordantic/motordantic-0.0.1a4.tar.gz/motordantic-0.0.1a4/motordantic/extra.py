...
class ExtraQueryMapper(object):
    ...
    def in_(self, list_values: List) -> dict:
        ...
        try:
            return {
                "$in": [
                    validate_field_value(self.model, self.field_name, v)
    ...
    def ne(self, value: Any) -> dict:
        return {"$ne": validate_field_value(self.model, self.field_name, value)}
    ...
    def gte(self, value: Any) -> dict:
        return {"$gte": validate_field_value(self.model, self.field_name, value)}

    def lte(self, value: Any) -> dict:
        return {"$lte": validate_field_value(self.model, self.field_name, value)}

    def gt(self, value: Any) -> dict:
        return {"$gt": validate_field_value(self.model, self.field_name, value)}

    def lt(self, value: Any) -> dict:
        return {"$lt": validate_field_value(self.model, self.field_name, value)}
    ...
    def range(self, range_values: Union[List, Tuple]) -> dict:
        ...
        to_ = range_values[1]
        return {
            "$gte": validate_field_value(self.model, self.field_name, from_),
            "$lte": validate_field_value(self.model, self.field_name, to_),
        }
