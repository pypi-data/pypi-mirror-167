...
class MongoModel(BasePydanticModel, metaclass=ModelMetaclass):
    ...
    def save_sync(
        ...
        return self.Q._io_loop.run_until_complete(self.save(updated_fields, session))

    async def delete(self) -> None:
        await self.Q.delete_one(_id=self.pk)

    def delete_sync(self) -> None:
        return self.Q._io_loop.run_until_complete(self.delete())
    ...
    @classmethod
    def use(cls: Type["MongoModel"], database: AgnosticDatabase) -> None:
