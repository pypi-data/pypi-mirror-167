...
def encontrar_bordes(imagen,tipo_umbral,tipo_contorno,color_borde,ancho_borde,lim_th):
	...
	NUEVO a partir de la version 0.0.13: Tambien retorna otro parametro que indica el umbral de binarizacion, esto es util para "calibrar" las imagenes, cuando no hay linea negra
	...
	NUEVO a partir de la version 0.0.13, lim_th(int): Un valor entero que desde el mismo y para valores más chicos devuelve la imagen con los bordes 
