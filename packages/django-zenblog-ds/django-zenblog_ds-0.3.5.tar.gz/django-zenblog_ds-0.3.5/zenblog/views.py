...
def home(request):
    ...
    return render(request, 'zenblog/index.html', context)


def about(request):
    context = {
    }
    return render(request, 'zenblog/about.html', context)


def contact(request):
    context = {
    }
    return render(request, 'zenblog/contact.html', context)
