...
import datetime
from txp.common.utils import reports_utils
...
w = reports_utils.get_report_sections(firestore_db, bigquery_db, "tranxpert-mvp.reports_test.sections",
                                      "labshowroom-001", "report_2",
                                      datetime.datetime.strptime("2022-09-08 21:00:00.0+0000",
                                                                 '%Y-%m-%d %H:%M:%S.%f%z'),
                                      datetime.datetime.strptime("2022-09-08 21:20:00.0+0000",
                                                                 '%Y-%m-%d %H:%M:%S.%f%z'))
