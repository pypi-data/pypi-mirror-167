...
def _build_run_batch_querytree(
    ...
    if fd.is_temporal:
        ...
        return RenameColsNode.ref(qt, {ANCHOR_TIME: None})
        ...
        if aggregation_level == AGGREGATION_LEVEL_PARTIAL:
            ...
            qt = ConvertEpochToTimestamp.ref(
            ...
            return RenameColsNode.ref(qt, renames)
            ...
            return RenameColsNode.ref(qt, {ANCHOR_TIME: fd.trailing_time_window_aggregation.time_key})
