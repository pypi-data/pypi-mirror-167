...
class ContainerInfo(_object):
    ...
    def __init__(self, name, column_info_list, type=GS_CONTAINER_COLLECTION, row_key=True, expiration=None, dataAffinity=None):
        """
        __init__(self, name, column_info_list, type=GS_CONTAINER_COLLECTION, row_key=True, expiration=None, dataAffinity=None) -> ContainerInfo
        ...
        """
        this = _griddb_python.new_ContainerInfo(name, column_info_list, type, row_key, expiration, dataAffinity)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __swig_setmethods__["column_info_list"] = _griddb_python.ContainerInfo_column_info_list_set
    __swig_getmethods__["column_info_list"] = _griddb_python.ContainerInfo_column_info_list_get
    if _newclass:
        column_info_list = _swig_property(_griddb_python.ContainerInfo_column_info_list_get, _griddb_python.ContainerInfo_column_info_list_set)
    __swig_setmethods__["dataAffinity"] = _griddb_python.ContainerInfo_dataAffinity_set
    __swig_getmethods__["dataAffinity"] = _griddb_python.ContainerInfo_dataAffinity_get
    if _newclass:
        dataAffinity = _swig_property(_griddb_python.ContainerInfo_dataAffinity_get, _griddb_python.ContainerInfo_dataAffinity_set)
...
class Container(_object):
    ...
    def query_by_time_series_range(self, *args):
        """
        query_by_time_series_range(self, startTime, endTime, order) -> Query
        query_by_time_series_range(self, startTime, endTime) -> Query
        """
    ...
    def aggregate_time_series(self, startTime, endTime, aggregation, column=None):
        """
        aggregate_time_series(self, startTime, endTime, aggregation, column=None) -> AggregationResult
        aggregate_time_series(self, startTime, endTime, aggregation) -> AggregationResult
        """
    ...
    def query_by_time_series_sampling(self, startTime, endTime, columnSet, mode, interval, intervalUnit):
        """query_by_time_series_sampling(self, startTime, endTime, columnSet, mode, interval, intervalUnit) -> Query"""
