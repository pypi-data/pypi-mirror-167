...
class TestCommand(Command):
    ...
    user_options = [("nose-args=", None, "nosetests command-line arguments")]
...
cmdclass = {"test": TestCommand, "swig": SWIGCommand}
...
setup(
    ...
    install_requires=["pyasn1==0.2.2", "pyasn1_modules==0.0.10"],
    ext_modules=[csp],
    description="Python/C++ wrapper for Microsoft cryptoapi services (currently, Russian GOST algorithms only)",
    packages=["cprocsp"],
    py_modules=["cprocsp.csp", "cprocsp.rdn", "cprocsp.cryptoapi", "cprocsp.filetimes"],
    cmdclass=cmdclass,
)
