...
args_mdl = {"strategy":model_name,"print_consola":True,
            ...
            "url":"cv_test_false" ,"cv":True,"cv_n_split":20,
            "shuffle_cv":True,  "shuffle_cv_test_size":0.05
            }                    
...
hcm.roc_curva_cross_validation(list_path=[url1],n_splits=5,url_out="test/",postfix="123")
#hcm.roc_curva_cross_validation(list_path=[url1,url2,url3,url4,url5],n_splits=5,url_out=None)

kpi_cv = hcm.kpis_cross_validation(list_path=["cv_test_false\\cv"],n_splits=20,url_out="test/",postfix="123") # 512826 , 907403 , 
