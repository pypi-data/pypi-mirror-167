...
def generate_cv_result(X_train=None,y_train=None,X_test=None,y_test=None,api=None, num_rounds = None , metric=None, 
                       params =None ,  url=None, shuffle_cv = False ,shuffle_cv_test_size=None, cv_n_split=None, random_state=42):
...
def kpis_cross_validation(list_path=[], n_splits=5,url_out=None,postfix=""):
    ...
    result_kpis = [
                   ...
                   {"Metric":"Average Precision","Splits":n_splits,"Data":"Test","Mean":mean_valid_average_precision,"SD":std_valid_average_precision,"Min":min_valid_average_precision,"Max":max_valid_average_precision},
                   {"Metric":"Average Precision","Splits":n_splits,"Data":"Train","Mean":mean_train_average_precision,"SD":std_train_average_precision,"Min":min_train_average_precision,"Max":max_train_average_precision},
...
def roc_curva_cross_validation(list_path=[], n_splits=5,url_out=None,postfix=""):
    ...
    plt.plot([0, 1], [0, 1], linestyle='--', lw=1, color='r', label='Reference', alpha=.8)  
