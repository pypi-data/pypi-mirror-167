...
def trace_2D(function, min_variable, max_variable, values_number, args_before_variable=[], args_after_variable=[], title="", label_x="", label_y="", **kwargs) :
    ...
    #displaying
    plt.plot(variable_list, results_list)
    plt.title(title)
    plt.xlabel(label_x)
    plt.ylabel(label_y)
