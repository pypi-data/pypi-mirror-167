...
def read_route_list():
    with open(r'./core/colubrid/modules/routestructure/routestructure.py', 'r') as f2:
        data = f2.read()
...
def updateListRute(listRoutes):
    with open(r'./core/colubrid/modules/routestructure/routestructure.py', 'w') as fp:
        fp.write("%s\n" % "[")
