...
setup(name='jojo-web',  # 包的分发名称
      version='0.0.1',  # PyPI上只允许一个版本存在，如果后续代码有了任何更改，再次上传需要增加版本号
      description='website creation',  # 项目的简短描述
      ...
      # install_requires=[],
      # 从文件中读取依赖库
      install_requires=read_file_lines("web/requirements.txt"),
