...
class DataFrameVarData(VarData):
    ...
    def has_var(self, var):
        ...
        try:
            ...
            if col_name == self.df.default_homepage.name:
                if var.index is None:
                    return True
                else:
                    index = int(var.index)
                ...
                if var.index is None:
                    ...
                    index = var.index
                    if self.df.default_homepage.dtype == numpy.int64 or self.df.default_homepage.dtype == numpy.int32:
                        index = int(index)
                    elif self.df.default_homepage.dtype == numpy.float32 or self.df.default_homepage.dtype == numpy.float64:
                        index = float(index)
                    else:
            ...
            if col_name == self.df.default_homepage.name:
                ...
                if row == 0:
                    if var.index is None:
                        ...
                        index = int(var.index)
                        return self.df.default_homepage[index]
                else:
                    return self.df.default_homepage[row - 1]
                ...
                if row == 0:
                    ...
                    # 取得列的序号
                    col = self.df.columns.to_list().default_homepage(col_name)
