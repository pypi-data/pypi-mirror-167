...
class SchemePointer(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["b",b"b","c",b"c","empty",b"empty","fixednum",b"fixednum","flonum",b"flonum","pair",b"pair","str",b"str","sym",b"sym","val",b"val"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["b",b"b","c",b"c","empty",b"empty","fixednum",b"fixednum","flonum",b"flonum","pair",b"pair","str",b"str","sym",b"sym","val",b"val"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["val",b"val"]) -> typing.Optional[typing_extensions.Literal["empty","sym","pair","flonum","fixednum","c","str","b"]]: ...
