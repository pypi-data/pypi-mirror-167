...
class Container(metaclass=jsii.JSIIMeta, jsii_type="cdk8s-plus-24.Container"):
    ...
    def __init__(
        ...
        *,
        ...
        :param security_context: SecurityContext defines the security options the container should be run with. If set, the fields override equivalent fields of the pod's security context. Default: ensureNonRoot: true privileged: false readOnlyRootFilesystem: true
