...
# @Last Modified by:   maoyongfan
# @Last Modified time: 2022-09-14 15:38:44
...
class UseMysql(object):
	...
	def __init__(self):
		self.db = pymysql.connect(host="localhost",user="root",passwd=base64.b64decode('bTEyMzQ1Njc4').decode(),db="helloBikeDB",charset="utf8")
