...
setup(
    ...
    version='0.0.7',
    license='MIT',
    description='Pytest module with Verification Protocl, Verification Report and Treace Matrix',
    long_description=long_desc,
    long_description_content_type='text/markdown',
    author='JA',
    author_email='cppgent0@gmail.com',
    url='https://github.com/cppgent0/pytest-ver',
    download_url='https://github.com/cppgent0/pytest-ver/archive/refs/tags/v_0_0_7.tar.gz',
