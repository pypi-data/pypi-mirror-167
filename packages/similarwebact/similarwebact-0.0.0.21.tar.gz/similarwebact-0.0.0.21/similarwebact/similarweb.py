...
def inputConverter(item, input):
    if item == 'website':
        ...
        domain_list = {'samsung' : 'samsung.com', 'apple' : 'apple.com', 'nike' : 'nike.com', 'dyson' : 'dyson.com', 'sony' : 'sony.com'}
