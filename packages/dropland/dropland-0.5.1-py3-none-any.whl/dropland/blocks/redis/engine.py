...
from .model import HashRedisModelBase, SimpleRedisModelBase
...
class RedisStorageEngine(StorageEngine):
    ...
    @property
    def Model(self) -> SimpleRedisModelBase:
        attributes = {'_redis_engine': self}
        return type('RedisModel', (SimpleRedisModelBase,), attributes)

    # noinspection PyPep8Naming,PyTypeChecker
    @property
    def HashModel(self) -> HashRedisModelBase:
        attributes = {'_redis_engine': self}
        return type('RedisModel', (HashRedisModelBase,), attributes)
