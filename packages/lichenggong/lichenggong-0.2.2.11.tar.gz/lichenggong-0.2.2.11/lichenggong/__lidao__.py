...
def xiugay(m1919810):
    try:
        ...
        print('emm!',end='')
        print('你好像很心急')
        print('it seems that you are want to quicker')
        print('OK')
def sqrt(m):
    x0 = m/2 #初始点，也可以是别的值
    x1 = x0/2 + m/(x0*2)
...
def CN_fanti_allthing(qwe):
    ...
    fileeee(1)
    num1='114514'
    with open('.\ikun\\Password_for_Boss.txt','r') as f1:
        Password_for_Boss=f1.readline()# give "Password_for_Boss"
    mins=[0,0,0,0,0,0]
    u=list(range(10))
    for i in range(6):
...
while 1:
    try:
        ...
        print()
        print('         Fatal           Error!!!!')
        print('it seems that you delete some importtant things')
        print()
