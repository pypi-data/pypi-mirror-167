...
def get_screen_status_matrix_minute(df_day, date):
    ...
    YMD = date
    df_day_screen = df_day_screen[df_day.Date == YMD]
    ...
    for hour in range(24):
        for minute in range(60):
            ...
            screen_status, screen_on_seconds, num_unlock_events = get_screen_status(df_day_screen, log_datetime_list, hm_datetime)
