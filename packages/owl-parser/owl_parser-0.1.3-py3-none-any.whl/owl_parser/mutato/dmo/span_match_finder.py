...
from owl_parser.mutato.dmo.spans import SpanContentCheck
from owl_parser.mutato.dmo.spans import SpanDistanceCheck
from owl_parser.mutato.dmo.spans import SpanContextCheck
