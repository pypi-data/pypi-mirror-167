...
from owl_parser.singlequery.svc import GenerateViewTrie
from owl_parser.singlequery.svc import GenerateViewSpans
from owl_parser.singlequery.svc import GenerateViewSynonyms
