...
from collimator.api import Api
from collimator.diagrams import ModelGraph
from collimator.error import NotFoundError, NotLoadedError
from collimator.global_variables import GlobalVariables
from collimator.i18n import N
from collimator.log import Log
from collimator.projects import get_project
from collimator.simulation_hashed_file import SimulationHashedFile
from collimator.utils import is_uuid
...
class Model:
    ...
    @property
    def url(self) -> str:
        return f"{GlobalVariables.api_url}/editor/{self.project_uuid}/{self.uuid}"
