...
def test_zeros_at_correct_positions(valid_swe_sample_data):
    swe2hs_result = swe2hs_1d(valid_swe_sample_data, return_layers=True)
...
def test_with_and_without_layers_return_types(valid_swe_sample_data):
    without_layers = swe2hs_1d(valid_swe_sample_data, return_layers=False)
    with_layers = swe2hs_1d(valid_swe_sample_data, return_layers=True)
    pd.testing.assert_series_equal(
        without_layers,
