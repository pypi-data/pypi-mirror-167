...
Notebooks formatted with MyST-NB_.
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/swe2hs.git
    cd swe2hs
...
#. Go to the web page of your fork and click |contribute button|
   ...
   of GitLab and you can see if every test passes. 
...
#. tag your commit with the a version name version ``v.X.X.X``
#. push the tag to GitLab, the CI will automatically build the package and upload 
   it to PyPI. 
