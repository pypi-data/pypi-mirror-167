...
class SalureFunctions:
    ...
    def applymap(key: pd.Series, mapping: dict, default=None):
        ...
        :param default: fallback if mapping value is not in mapping dict (only for non Series)
    ...
    @staticmethod
    def handle_mutation_result(changes_dir: str, df: pd.DataFrame, succes: bool, row_index: Hashable = None):
        """
