...
class TaoSClient:
    ...
    def __init__(self, td_config: dict):
        ...
        self.request_url = f"http://{format_td_config['host']}:{format_td_config['port']}/rest/sqlt/{format_td_config['db']}"
        self.auth = (format_td_config['user'], format_td_config['password'])
        self.time_out = (5, 5)
