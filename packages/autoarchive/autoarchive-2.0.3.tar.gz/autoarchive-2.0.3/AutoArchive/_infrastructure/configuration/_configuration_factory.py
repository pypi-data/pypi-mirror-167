...
class ConfigurationFactory:
    ...
    * options of type ``bool``\ : ``False``"""
    ...
    def __postPopulateWithDefaults(cls, configuration):
        cls.__addOptionIfNotPresent(configuration, Options.USER_CONFIG_DIR, cls.__FACTORY_USER_CONFIG_DIR)

        cls.__addOptionIfNotPresent(
    ...
    @staticmethod
    def __addOptionIfNotPresent(configuration, option, value):
        if not configuration.isOptionPresent(option):
