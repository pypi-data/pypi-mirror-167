...
class BuilderFiQuS:
    ...
    def __init__(self,
        ...
        if flag_build:
            ...
            elif model_data.GeneralParameters.magnet_type == 'CCT':
    ...
    def buildDataCCT(self, model_data):
        ...
        # fqpls
        self.data_FiQuS.magnet.geometry.fqpls.fndpls = model_data.Quench_Protection.FQPLs.fndpls
        self.data_FiQuS.magnet.geometry.fqpls.fwhs = model_data.Quench_Protection.FQPLs.fwhs
        self.data_FiQuS.magnet.geometry.fqpls.fwws = model_data.Quench_Protection.FQPLs.fwws
        self.data_FiQuS.magnet.geometry.fqpls.n_sbs = model_data.Quench_Protection.FQPLs.n_sbs
        self.data_FiQuS.magnet.geometry.fqpls.names = model_data.Quench_Protection.FQPLs.names
        self.data_FiQuS.magnet.geometry.fqpls.r_bs = model_data.Quench_Protection.FQPLs.r_bs
        self.data_FiQuS.magnet.geometry.fqpls.r_ins = model_data.Quench_Protection.FQPLs.r_ins
        self.data_FiQuS.magnet.geometry.fqpls.thetas = model_data.Quench_Protection.FQPLs.thetas
        self.data_FiQuS.magnet.geometry.fqpls.z_ends = model_data.Quench_Protection.FQPLs.z_ends
        self.data_FiQuS.magnet.geometry.fqpls.z_starts = model_data.Quench_Protection.FQPLs.z_starts
        ...
        self.data_FiQuS.magnet.solve.fqpls.mu_rs = model_data.Quench_Protection.FQPLs.mu_rs
        self.data_FiQuS.magnet.solve.fqpls.currents = model_data.Quench_Protection.FQPLs.currents
        self.data_FiQuS.magnet.solve.fqpls.sigmas = model_data.Quench_Protection.FQPLs.sigmas
        ...
        self.data_FiQuS.magnet.solve.getdp_exe_path = model_data.Options_FiQuS.cct.solve.getdp_exe_path
