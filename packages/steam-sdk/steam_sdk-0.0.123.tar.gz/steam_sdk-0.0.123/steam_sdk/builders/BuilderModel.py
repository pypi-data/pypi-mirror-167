...
from steam_sdk.parsers.ParserYAML import dict_to_yaml, yaml_to_dict, yaml_to_data_class
...
class BuilderModel:
    ...
    def set_input_paths(self):
        ...
        self.settings_dict = yaml_to_dict(settings_file)
    ...
    def loadModelData(self):
        ...
        if self.case_model == 'magnet':
            ...
            self.model_data = yaml_to_data_class(self.file_model_data, DataModelMagnet)
        elif self.case_model == 'circuit':
            ...
            self.conductor_data = yaml_to_data_class(self.file_model_data, DataModelConductor)
        else:
