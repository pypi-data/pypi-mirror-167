...
parser.add_argument('-m','--mode',type=str,required=True,choices=["auto","manual"],default="auto",help="Choose the mode during crawling.\nIf \'manual\' is selected, \'-acc\' or \'-infile\' is required")
parser.add_argument('-acc','--accession', nargs='*', help='A series of blank-seperated CRA accession numbers')
parser.add_argument('-infile','--inputfile', type=str, help='A file containing enter-seperated CRA accession numbers')
# 3. 从命令行中结构化解析参数
