...
from alphafed.fed_avg.dp_fed_avg import DPFedAvgScheduler

from ... import logger
from ...fed_avg import FedAvgScheduler, FedSGDScheduler, SecureFedAvgScheduler
from ...fed_avg.fed_avg import DEV_TASK_ID, register_metrics
...
def get_scheduler(mode: str = VANILLA) -> FedAvgScheduler:
    ...
    if mode == VANILLA:
        ...
        scheduler = DemoDP(min_clients=3,
                           w_cap=20000,
                           q=1,
                           S=1,
                           z=0.1,
        ...
        scheduler = DemoFedIRM(min_clients=2,
                               max_clients=3,
                               name='demo_task',
                               max_rounds=50,
                               log_rounds=5,
