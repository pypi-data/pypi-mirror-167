...
const Button = ({ label, disabled, onClick, displayColor, }) => {
    return (react_1.default.createElement("button", { className: "jupyter-button widget-button", disabled: disabled, onClick: onClick },
        react_1.default.createElement("div", { className: "flex-column" },
            react_1.default.createElement("div", { className: "flex-row" },
                label,
                displayColor ? (react_1.default.createElement("span", { style: { background: displayColor, width: "1em", height: "1em", marginLeft: "0.5em" } }, "\u00A0")) : null))));
};
...
//# sourceMappingURL=lib_widgets_js.f237a9a4cd39a5803dbb.js.map