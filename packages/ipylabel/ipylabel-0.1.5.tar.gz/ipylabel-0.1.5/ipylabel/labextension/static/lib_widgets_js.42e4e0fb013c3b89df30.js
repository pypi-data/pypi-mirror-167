    ...
    return (react_1.default.createElement("div", { className: "TextWidget" },
        react_1.default.createElement("div", { className: "flex-column" },
            react_1.default.createElement("div", { className: "flex-row" },
                ...
                react_1.default.createElement(components_1.Button, { label: `Label selected as ${selectedLabel}`, disabled: finished, onClick: handleAddClick }),
                react_1.default.createElement("div", { style: { background: selectedColor } }, selectedLabel),
...
const Button = ({ label, disabled, onClick, }) => {
    return (react_1.default.createElement("button", { disabled: disabled, onClick: onClick }, label));
};
...
//# sourceMappingURL=lib_widgets_js.42e4e0fb013c3b89df30.js.map