...
const Button = ({ label, disabled, onClick, displayColor, }) => {
    return (react_1.default.createElement("button", { disabled: disabled, onClick: onClick },
        react_1.default.createElement("div", { className: "flex-column" },
            react_1.default.createElement("div", { className: "flex-row" }, displayColor ? label : react_1.default.createElement("span", { style: { background: displayColor, width: "1em", height: "1em", marginLeft: "0.5em" } }, "\u00A0")))));
};
...
//# sourceMappingURL=lib_widgets_js.a5015baea141ba6a729d.js.map