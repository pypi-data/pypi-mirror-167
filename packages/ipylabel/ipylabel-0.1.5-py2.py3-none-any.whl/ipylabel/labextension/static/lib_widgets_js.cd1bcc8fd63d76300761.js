    ...
    return (react_1.default.createElement("div", { className: "TextWidget" },
        react_1.default.createElement("div", { className: "flex-column" },
            react_1.default.createElement("div", { className: "flex-row" },
                ...
                react_1.default.createElement(components_1.Button, { label: `Label selected as ${selectedLabel}`, disabled: finished, background: selectedColor, onClick: handleAddClick }),
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const react_1 = __importDefault(__webpack_require__(/*! react */ "webpack/sharing/consume/default/react"));
const Button = ({ label, disabled, onClick, background, }) => {
    return (react_1.default.createElement("button", { style: { background }, disabled: disabled, onClick: onClick }, label));
};
...
//# sourceMappingURL=lib_widgets_js.cd1bcc8fd63d76300761.js.map