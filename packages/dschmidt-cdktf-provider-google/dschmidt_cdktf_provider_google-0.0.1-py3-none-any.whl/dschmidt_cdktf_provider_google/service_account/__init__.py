...
class ServiceAccount(
    ...
    jsii_type="@dschmidt/provider-google.serviceAccount.ServiceAccount",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.serviceAccount.ServiceAccountConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.serviceAccount.ServiceAccountTimeouts",
    jsii_struct_bases=[],
...
class ServiceAccountTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.serviceAccount.ServiceAccountTimeoutsOutputReference",
):
    def __init__(
        self,
