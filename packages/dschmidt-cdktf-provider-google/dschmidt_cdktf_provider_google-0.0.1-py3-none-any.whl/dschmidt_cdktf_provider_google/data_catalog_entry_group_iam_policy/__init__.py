...
class DataCatalogEntryGroupIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.dataCatalogEntryGroupIamPolicy.DataCatalogEntryGroupIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataCatalogEntryGroupIamPolicy.DataCatalogEntryGroupIamPolicyConfig",
