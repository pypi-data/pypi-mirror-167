...
class FolderAccessApprovalSettings(
    ...
    jsii_type="@dschmidt/provider-google.folderAccessApprovalSettings.FolderAccessApprovalSettings",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.folderAccessApprovalSettings.FolderAccessApprovalSettingsConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.folderAccessApprovalSettings.FolderAccessApprovalSettingsEnrolledServices",
    jsii_struct_bases=[],
    name_mapping={
...
class FolderAccessApprovalSettingsEnrolledServicesList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.folderAccessApprovalSettings.FolderAccessApprovalSettingsEnrolledServicesList",
):
    def __init__(
        self,
...
class FolderAccessApprovalSettingsEnrolledServicesOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.folderAccessApprovalSettings.FolderAccessApprovalSettingsEnrolledServicesOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.folderAccessApprovalSettings.FolderAccessApprovalSettingsTimeouts",
    jsii_struct_bases=[],
...
class FolderAccessApprovalSettingsTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.folderAccessApprovalSettings.FolderAccessApprovalSettingsTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
