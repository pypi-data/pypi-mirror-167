...
class DataGoogleIamTestablePermissions(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleIamTestablePermissions.DataGoogleIamTestablePermissions",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleIamTestablePermissions.DataGoogleIamTestablePermissionsConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleIamTestablePermissions.DataGoogleIamTestablePermissionsPermissions",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class DataGoogleIamTestablePermissionsPermissionsList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataGoogleIamTestablePermissions.DataGoogleIamTestablePermissionsPermissionsList",
):
    def __init__(
        self,
...
class DataGoogleIamTestablePermissionsPermissionsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataGoogleIamTestablePermissions.DataGoogleIamTestablePermissionsPermissionsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
