...
class SqlUser(
    ...
    jsii_type="@dschmidt/provider-google.sqlUser.SqlUser",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.sqlUser.SqlUserConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.sqlUser.SqlUserSqlServerUserDetails",
    jsii_struct_bases=[],
...
class SqlUserSqlServerUserDetailsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.sqlUser.SqlUserSqlServerUserDetailsOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.sqlUser.SqlUserTimeouts",
    jsii_struct_bases=[],
...
class SqlUserTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.sqlUser.SqlUserTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
