...
class GameServicesGameServerCluster(
    ...
    jsii_type="@dschmidt/provider-google.gameServicesGameServerCluster.GameServicesGameServerCluster",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.gameServicesGameServerCluster.GameServicesGameServerClusterConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.gameServicesGameServerCluster.GameServicesGameServerClusterConnectionInfo",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.gameServicesGameServerCluster.GameServicesGameServerClusterConnectionInfoGkeClusterReference",
    jsii_struct_bases=[],
...
class GameServicesGameServerClusterConnectionInfoGkeClusterReferenceOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.gameServicesGameServerCluster.GameServicesGameServerClusterConnectionInfoGkeClusterReferenceOutputReference",
):
    def __init__(
        self,
...
class GameServicesGameServerClusterConnectionInfoOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.gameServicesGameServerCluster.GameServicesGameServerClusterConnectionInfoOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.gameServicesGameServerCluster.GameServicesGameServerClusterTimeouts",
    jsii_struct_bases=[],
...
class GameServicesGameServerClusterTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.gameServicesGameServerCluster.GameServicesGameServerClusterTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
