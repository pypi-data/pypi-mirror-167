...
class ApigeeInstance(
    ...
    jsii_type="@dschmidt/provider-google.apigeeInstance.ApigeeInstance",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.apigeeInstance.ApigeeInstanceConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.apigeeInstance.ApigeeInstanceTimeouts",
    jsii_struct_bases=[],
...
class ApigeeInstanceTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.apigeeInstance.ApigeeInstanceTimeoutsOutputReference",
):
    def __init__(
        self,
