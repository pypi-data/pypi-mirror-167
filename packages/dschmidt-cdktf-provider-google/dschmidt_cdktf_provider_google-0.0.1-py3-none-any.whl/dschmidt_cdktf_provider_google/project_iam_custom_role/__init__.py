...
class ProjectIamCustomRole(
    ...
    jsii_type="@dschmidt/provider-google.projectIamCustomRole.ProjectIamCustomRole",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.projectIamCustomRole.ProjectIamCustomRoleConfig",
