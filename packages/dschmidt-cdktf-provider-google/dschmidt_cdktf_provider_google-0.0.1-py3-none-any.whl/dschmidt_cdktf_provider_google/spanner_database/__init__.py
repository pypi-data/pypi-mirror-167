...
class SpannerDatabase(
    ...
    jsii_type="@dschmidt/provider-google.spannerDatabase.SpannerDatabase",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.spannerDatabase.SpannerDatabaseConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.spannerDatabase.SpannerDatabaseEncryptionConfig",
    jsii_struct_bases=[],
...
class SpannerDatabaseEncryptionConfigOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.spannerDatabase.SpannerDatabaseEncryptionConfigOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.spannerDatabase.SpannerDatabaseTimeouts",
    jsii_struct_bases=[],
...
class SpannerDatabaseTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.spannerDatabase.SpannerDatabaseTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
