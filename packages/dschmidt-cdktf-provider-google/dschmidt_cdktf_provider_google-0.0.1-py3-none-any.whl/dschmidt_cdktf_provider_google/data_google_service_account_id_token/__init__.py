...
class DataGoogleServiceAccountIdToken(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleServiceAccountIdToken.DataGoogleServiceAccountIdToken",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleServiceAccountIdToken.DataGoogleServiceAccountIdTokenConfig",
