...
class BigqueryTableIamBinding(
    ...
    jsii_type="@dschmidt/provider-google.bigqueryTableIamBinding.BigqueryTableIamBinding",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.bigqueryTableIamBinding.BigqueryTableIamBindingCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class BigqueryTableIamBindingConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.bigqueryTableIamBinding.BigqueryTableIamBindingConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.bigqueryTableIamBinding.BigqueryTableIamBindingConfig",
