...
class DataCatalogTag(
    ...
    jsii_type="@dschmidt/provider-google.dataCatalogTag.DataCatalogTag",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataCatalogTag.DataCatalogTagConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataCatalogTag.DataCatalogTagFields",
    jsii_struct_bases=[],
    name_mapping={
...
class DataCatalogTagFieldsList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataCatalogTag.DataCatalogTagFieldsList",
):
    def __init__(
        self,
...
class DataCatalogTagFieldsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataCatalogTag.DataCatalogTagFieldsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataCatalogTag.DataCatalogTagTimeouts",
    jsii_struct_bases=[],
...
class DataCatalogTagTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataCatalogTag.DataCatalogTagTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
