...
class PubsubSubscriptionIamMember(
    ...
    jsii_type="@dschmidt/provider-google.pubsubSubscriptionIamMember.PubsubSubscriptionIamMember",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.pubsubSubscriptionIamMember.PubsubSubscriptionIamMemberCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class PubsubSubscriptionIamMemberConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.pubsubSubscriptionIamMember.PubsubSubscriptionIamMemberConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.pubsubSubscriptionIamMember.PubsubSubscriptionIamMemberConfig",
