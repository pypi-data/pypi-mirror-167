...
class DialogflowEntityType(
    ...
    jsii_type="@dschmidt/provider-google.dialogflowEntityType.DialogflowEntityType",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dialogflowEntityType.DialogflowEntityTypeConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dialogflowEntityType.DialogflowEntityTypeEntities",
    jsii_struct_bases=[],
...
class DialogflowEntityTypeEntitiesList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dialogflowEntityType.DialogflowEntityTypeEntitiesList",
):
    def __init__(
        self,
...
class DialogflowEntityTypeEntitiesOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dialogflowEntityType.DialogflowEntityTypeEntitiesOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dialogflowEntityType.DialogflowEntityTypeTimeouts",
    jsii_struct_bases=[],
...
class DialogflowEntityTypeTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dialogflowEntityType.DialogflowEntityTypeTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
