...
class ComputeHttpHealthCheck(
    ...
    jsii_type="@dschmidt/provider-google.computeHttpHealthCheck.ComputeHttpHealthCheck",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeHttpHealthCheck.ComputeHttpHealthCheckConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeHttpHealthCheck.ComputeHttpHealthCheckTimeouts",
    jsii_struct_bases=[],
...
class ComputeHttpHealthCheckTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeHttpHealthCheck.ComputeHttpHealthCheckTimeoutsOutputReference",
):
    def __init__(
        self,
