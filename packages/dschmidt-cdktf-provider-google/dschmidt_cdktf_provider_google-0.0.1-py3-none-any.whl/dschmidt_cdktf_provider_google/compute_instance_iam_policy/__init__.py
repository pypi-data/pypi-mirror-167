...
class ComputeInstanceIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.computeInstanceIamPolicy.ComputeInstanceIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeInstanceIamPolicy.ComputeInstanceIamPolicyConfig",
