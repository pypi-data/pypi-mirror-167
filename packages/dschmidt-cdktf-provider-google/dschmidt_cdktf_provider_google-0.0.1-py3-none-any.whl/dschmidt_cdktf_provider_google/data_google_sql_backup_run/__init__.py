...
class DataGoogleSqlBackupRun(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleSqlBackupRun.DataGoogleSqlBackupRun",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleSqlBackupRun.DataGoogleSqlBackupRunConfig",
