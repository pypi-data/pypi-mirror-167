...
class IamWorkloadIdentityPool(
    ...
    jsii_type="@dschmidt/provider-google.iamWorkloadIdentityPool.IamWorkloadIdentityPool",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.iamWorkloadIdentityPool.IamWorkloadIdentityPoolConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.iamWorkloadIdentityPool.IamWorkloadIdentityPoolTimeouts",
    jsii_struct_bases=[],
...
class IamWorkloadIdentityPoolTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.iamWorkloadIdentityPool.IamWorkloadIdentityPoolTimeoutsOutputReference",
):
    def __init__(
        self,
