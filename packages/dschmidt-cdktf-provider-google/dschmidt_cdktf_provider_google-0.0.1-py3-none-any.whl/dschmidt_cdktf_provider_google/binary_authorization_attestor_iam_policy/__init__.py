...
class BinaryAuthorizationAttestorIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.binaryAuthorizationAttestorIamPolicy.BinaryAuthorizationAttestorIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.binaryAuthorizationAttestorIamPolicy.BinaryAuthorizationAttestorIamPolicyConfig",
