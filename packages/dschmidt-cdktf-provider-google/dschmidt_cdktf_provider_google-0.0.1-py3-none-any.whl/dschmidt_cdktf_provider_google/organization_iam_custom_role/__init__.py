...
class OrganizationIamCustomRole(
    ...
    jsii_type="@dschmidt/provider-google.organizationIamCustomRole.OrganizationIamCustomRole",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.organizationIamCustomRole.OrganizationIamCustomRoleConfig",
