...
class DataGoogleStorageObjectSignedUrl(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleStorageObjectSignedUrl.DataGoogleStorageObjectSignedUrl",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleStorageObjectSignedUrl.DataGoogleStorageObjectSignedUrlConfig",
