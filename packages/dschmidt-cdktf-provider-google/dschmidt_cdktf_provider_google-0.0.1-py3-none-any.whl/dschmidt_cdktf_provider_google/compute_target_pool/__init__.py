...
class ComputeTargetPool(
    ...
    jsii_type="@dschmidt/provider-google.computeTargetPool.ComputeTargetPool",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeTargetPool.ComputeTargetPoolConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeTargetPool.ComputeTargetPoolTimeouts",
    jsii_struct_bases=[],
...
class ComputeTargetPoolTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeTargetPool.ComputeTargetPoolTimeoutsOutputReference",
):
    def __init__(
        self,
