...
class SourcerepoRepositoryIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.sourcerepoRepositoryIamPolicy.SourcerepoRepositoryIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.sourcerepoRepositoryIamPolicy.SourcerepoRepositoryIamPolicyConfig",
