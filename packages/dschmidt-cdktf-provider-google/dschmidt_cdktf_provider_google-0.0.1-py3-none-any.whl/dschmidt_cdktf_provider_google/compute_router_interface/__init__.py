...
class ComputeRouterInterface(
    ...
    jsii_type="@dschmidt/provider-google.computeRouterInterface.ComputeRouterInterface",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeRouterInterface.ComputeRouterInterfaceConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeRouterInterface.ComputeRouterInterfaceTimeouts",
    jsii_struct_bases=[],
...
class ComputeRouterInterfaceTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeRouterInterface.ComputeRouterInterfaceTimeoutsOutputReference",
):
    def __init__(
        self,
