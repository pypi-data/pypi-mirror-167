...
class LoggingBillingAccountBucketConfig(
    ...
    jsii_type="@dschmidt/provider-google.loggingBillingAccountBucketConfig.LoggingBillingAccountBucketConfig",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.loggingBillingAccountBucketConfig.LoggingBillingAccountBucketConfigConfig",
