...
class DataGoogleKmsSecretCiphertext(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleKmsSecretCiphertext.DataGoogleKmsSecretCiphertext",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleKmsSecretCiphertext.DataGoogleKmsSecretCiphertextConfig",
