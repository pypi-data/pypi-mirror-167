...
class IapBrand(
    ...
    jsii_type="@dschmidt/provider-google.iapBrand.IapBrand",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.iapBrand.IapBrandConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.iapBrand.IapBrandTimeouts",
    jsii_struct_bases=[],
...
class IapBrandTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.iapBrand.IapBrandTimeoutsOutputReference",
):
    def __init__(
        self,
