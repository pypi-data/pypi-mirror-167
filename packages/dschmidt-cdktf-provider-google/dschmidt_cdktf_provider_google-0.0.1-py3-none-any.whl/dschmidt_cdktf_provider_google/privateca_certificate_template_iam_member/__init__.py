...
class PrivatecaCertificateTemplateIamMember(
    ...
    jsii_type="@dschmidt/provider-google.privatecaCertificateTemplateIamMember.PrivatecaCertificateTemplateIamMember",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.privatecaCertificateTemplateIamMember.PrivatecaCertificateTemplateIamMemberCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class PrivatecaCertificateTemplateIamMemberConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.privatecaCertificateTemplateIamMember.PrivatecaCertificateTemplateIamMemberConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.privatecaCertificateTemplateIamMember.PrivatecaCertificateTemplateIamMemberConfig",
