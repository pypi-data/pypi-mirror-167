...
class DataflowJob(
    ...
    jsii_type="@dschmidt/provider-google.dataflowJob.DataflowJob",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataflowJob.DataflowJobConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataflowJob.DataflowJobTimeouts",
    jsii_struct_bases=[],
...
class DataflowJobTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataflowJob.DataflowJobTimeoutsOutputReference",
):
    def __init__(
        self,
