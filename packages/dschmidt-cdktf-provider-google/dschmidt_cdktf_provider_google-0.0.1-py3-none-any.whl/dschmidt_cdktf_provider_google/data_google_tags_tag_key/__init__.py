...
class DataGoogleTagsTagKey(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleTagsTagKey.DataGoogleTagsTagKey",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleTagsTagKey.DataGoogleTagsTagKeyConfig",
