...
class DataGoogleServiceAccountKey(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleServiceAccountKey.DataGoogleServiceAccountKey",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleServiceAccountKey.DataGoogleServiceAccountKeyConfig",
