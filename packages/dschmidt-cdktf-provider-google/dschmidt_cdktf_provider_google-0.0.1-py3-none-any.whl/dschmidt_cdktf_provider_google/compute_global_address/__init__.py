...
class ComputeGlobalAddress(
    ...
    jsii_type="@dschmidt/provider-google.computeGlobalAddress.ComputeGlobalAddress",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeGlobalAddress.ComputeGlobalAddressConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeGlobalAddress.ComputeGlobalAddressTimeouts",
    jsii_struct_bases=[],
...
class ComputeGlobalAddressTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeGlobalAddress.ComputeGlobalAddressTimeoutsOutputReference",
):
    def __init__(
        self,
