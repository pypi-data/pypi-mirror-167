...
class BigtableTableIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.bigtableTableIamPolicy.BigtableTableIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.bigtableTableIamPolicy.BigtableTableIamPolicyConfig",
