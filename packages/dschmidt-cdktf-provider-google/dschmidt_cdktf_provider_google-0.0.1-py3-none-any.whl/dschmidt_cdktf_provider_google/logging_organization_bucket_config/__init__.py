...
class LoggingOrganizationBucketConfig(
    ...
    jsii_type="@dschmidt/provider-google.loggingOrganizationBucketConfig.LoggingOrganizationBucketConfig",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.loggingOrganizationBucketConfig.LoggingOrganizationBucketConfigConfig",
