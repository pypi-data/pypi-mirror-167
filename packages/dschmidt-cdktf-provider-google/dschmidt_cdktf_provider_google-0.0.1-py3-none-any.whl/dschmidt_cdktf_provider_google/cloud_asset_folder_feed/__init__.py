...
class CloudAssetFolderFeed(
    ...
    jsii_type="@dschmidt/provider-google.cloudAssetFolderFeed.CloudAssetFolderFeed",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.cloudAssetFolderFeed.CloudAssetFolderFeedCondition",
    jsii_struct_bases=[],
    name_mapping={
        "expression": "expression",
        "description": "description",
...
class CloudAssetFolderFeedConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.cloudAssetFolderFeed.CloudAssetFolderFeedConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.cloudAssetFolderFeed.CloudAssetFolderFeedConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.cloudAssetFolderFeed.CloudAssetFolderFeedFeedOutputConfig",
    jsii_struct_bases=[],
...
class CloudAssetFolderFeedFeedOutputConfigOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.cloudAssetFolderFeed.CloudAssetFolderFeedFeedOutputConfigOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.cloudAssetFolderFeed.CloudAssetFolderFeedFeedOutputConfigPubsubDestination",
    jsii_struct_bases=[],
...
class CloudAssetFolderFeedFeedOutputConfigPubsubDestinationOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.cloudAssetFolderFeed.CloudAssetFolderFeedFeedOutputConfigPubsubDestinationOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.cloudAssetFolderFeed.CloudAssetFolderFeedTimeouts",
    jsii_struct_bases=[],
...
class CloudAssetFolderFeedTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.cloudAssetFolderFeed.CloudAssetFolderFeedTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
