...
class DialogflowFulfillment(
    ...
    jsii_type="@dschmidt/provider-google.dialogflowFulfillment.DialogflowFulfillment",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dialogflowFulfillment.DialogflowFulfillmentConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dialogflowFulfillment.DialogflowFulfillmentFeatures",
    jsii_struct_bases=[],
...
class DialogflowFulfillmentFeaturesList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dialogflowFulfillment.DialogflowFulfillmentFeaturesList",
):
    def __init__(
        self,
...
class DialogflowFulfillmentFeaturesOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dialogflowFulfillment.DialogflowFulfillmentFeaturesOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dialogflowFulfillment.DialogflowFulfillmentGenericWebService",
    jsii_struct_bases=[],
    name_mapping={
        "uri": "uri",
        "password": "password",
...
class DialogflowFulfillmentGenericWebServiceOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dialogflowFulfillment.DialogflowFulfillmentGenericWebServiceOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dialogflowFulfillment.DialogflowFulfillmentTimeouts",
    jsii_struct_bases=[],
...
class DialogflowFulfillmentTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dialogflowFulfillment.DialogflowFulfillmentTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
