...
class PubsubTopic(
    ...
    jsii_type="@dschmidt/provider-google.pubsubTopic.PubsubTopic",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.pubsubTopic.PubsubTopicConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.pubsubTopic.PubsubTopicMessageStoragePolicy",
    jsii_struct_bases=[],
...
class PubsubTopicMessageStoragePolicyOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.pubsubTopic.PubsubTopicMessageStoragePolicyOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.pubsubTopic.PubsubTopicSchemaSettings",
    jsii_struct_bases=[],
...
class PubsubTopicSchemaSettingsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.pubsubTopic.PubsubTopicSchemaSettingsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.pubsubTopic.PubsubTopicTimeouts",
    jsii_struct_bases=[],
...
class PubsubTopicTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.pubsubTopic.PubsubTopicTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
