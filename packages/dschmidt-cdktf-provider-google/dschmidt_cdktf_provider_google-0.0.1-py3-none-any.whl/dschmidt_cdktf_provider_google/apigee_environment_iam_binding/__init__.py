...
class ApigeeEnvironmentIamBinding(
    ...
    jsii_type="@dschmidt/provider-google.apigeeEnvironmentIamBinding.ApigeeEnvironmentIamBinding",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.apigeeEnvironmentIamBinding.ApigeeEnvironmentIamBindingCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class ApigeeEnvironmentIamBindingConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.apigeeEnvironmentIamBinding.ApigeeEnvironmentIamBindingConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.apigeeEnvironmentIamBinding.ApigeeEnvironmentIamBindingConfig",
