...
class KmsKeyRingIamMember(
    ...
    jsii_type="@dschmidt/provider-google.kmsKeyRingIamMember.KmsKeyRingIamMember",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.kmsKeyRingIamMember.KmsKeyRingIamMemberCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class KmsKeyRingIamMemberConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.kmsKeyRingIamMember.KmsKeyRingIamMemberConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.kmsKeyRingIamMember.KmsKeyRingIamMemberConfig",
