...
class KmsSecretCiphertext(
    ...
    jsii_type="@dschmidt/provider-google.kmsSecretCiphertext.KmsSecretCiphertext",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.kmsSecretCiphertext.KmsSecretCiphertextConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.kmsSecretCiphertext.KmsSecretCiphertextTimeouts",
    jsii_struct_bases=[],
...
class KmsSecretCiphertextTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.kmsSecretCiphertext.KmsSecretCiphertextTimeoutsOutputReference",
):
    def __init__(
        self,
