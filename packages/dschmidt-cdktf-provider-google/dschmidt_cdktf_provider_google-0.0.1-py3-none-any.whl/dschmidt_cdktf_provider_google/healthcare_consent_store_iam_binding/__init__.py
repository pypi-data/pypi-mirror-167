...
class HealthcareConsentStoreIamBinding(
    ...
    jsii_type="@dschmidt/provider-google.healthcareConsentStoreIamBinding.HealthcareConsentStoreIamBinding",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.healthcareConsentStoreIamBinding.HealthcareConsentStoreIamBindingCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class HealthcareConsentStoreIamBindingConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.healthcareConsentStoreIamBinding.HealthcareConsentStoreIamBindingConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.healthcareConsentStoreIamBinding.HealthcareConsentStoreIamBindingConfig",
