...
class PrivatecaCertificateTemplateIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.privatecaCertificateTemplateIamPolicy.PrivatecaCertificateTemplateIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.privatecaCertificateTemplateIamPolicy.PrivatecaCertificateTemplateIamPolicyConfig",
