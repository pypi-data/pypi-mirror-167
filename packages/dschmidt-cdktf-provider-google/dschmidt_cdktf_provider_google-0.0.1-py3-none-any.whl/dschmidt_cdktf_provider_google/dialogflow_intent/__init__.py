...
class DialogflowIntent(
    ...
    jsii_type="@dschmidt/provider-google.dialogflowIntent.DialogflowIntent",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dialogflowIntent.DialogflowIntentConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dialogflowIntent.DialogflowIntentFollowupIntentInfo",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class DialogflowIntentFollowupIntentInfoList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dialogflowIntent.DialogflowIntentFollowupIntentInfoList",
):
    def __init__(
        self,
...
class DialogflowIntentFollowupIntentInfoOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dialogflowIntent.DialogflowIntentFollowupIntentInfoOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dialogflowIntent.DialogflowIntentTimeouts",
    jsii_struct_bases=[],
...
class DialogflowIntentTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dialogflowIntent.DialogflowIntentTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
