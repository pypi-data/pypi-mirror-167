...
class DataprocJobIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.dataprocJobIamPolicy.DataprocJobIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataprocJobIamPolicy.DataprocJobIamPolicyConfig",
