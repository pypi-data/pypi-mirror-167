...
class ComputeSubnetwork(
    ...
    jsii_type="@dschmidt/provider-google.computeSubnetwork.ComputeSubnetwork",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeSubnetwork.ComputeSubnetworkConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeSubnetwork.ComputeSubnetworkLogConfig",
    jsii_struct_bases=[],
    name_mapping={
...
class ComputeSubnetworkLogConfigOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeSubnetwork.ComputeSubnetworkLogConfigOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeSubnetwork.ComputeSubnetworkSecondaryIpRange",
    jsii_struct_bases=[],
...
class ComputeSubnetworkSecondaryIpRangeList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeSubnetwork.ComputeSubnetworkSecondaryIpRangeList",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
class ComputeSubnetworkSecondaryIpRangeOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeSubnetwork.ComputeSubnetworkSecondaryIpRangeOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeSubnetwork.ComputeSubnetworkTimeouts",
    jsii_struct_bases=[],
...
class ComputeSubnetworkTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeSubnetwork.ComputeSubnetworkTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
