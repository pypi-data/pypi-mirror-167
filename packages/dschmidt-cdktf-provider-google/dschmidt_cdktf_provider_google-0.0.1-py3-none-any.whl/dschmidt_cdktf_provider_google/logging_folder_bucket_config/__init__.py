...
class LoggingFolderBucketConfig(
    ...
    jsii_type="@dschmidt/provider-google.loggingFolderBucketConfig.LoggingFolderBucketConfig",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.loggingFolderBucketConfig.LoggingFolderBucketConfigConfig",
