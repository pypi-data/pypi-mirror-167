...
class ComputeFirewallPolicyAssociation(
    ...
    jsii_type="@dschmidt/provider-google.computeFirewallPolicyAssociation.ComputeFirewallPolicyAssociation",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeFirewallPolicyAssociation.ComputeFirewallPolicyAssociationConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeFirewallPolicyAssociation.ComputeFirewallPolicyAssociationTimeouts",
    jsii_struct_bases=[],
...
class ComputeFirewallPolicyAssociationTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeFirewallPolicyAssociation.ComputeFirewallPolicyAssociationTimeoutsOutputReference",
):
    def __init__(
        self,
