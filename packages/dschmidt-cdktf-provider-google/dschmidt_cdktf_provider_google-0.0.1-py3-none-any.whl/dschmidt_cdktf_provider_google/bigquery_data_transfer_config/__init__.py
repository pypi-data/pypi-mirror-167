...
class BigqueryDataTransferConfig(
    ...
    jsii_type="@dschmidt/provider-google.bigqueryDataTransferConfig.BigqueryDataTransferConfig",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.bigqueryDataTransferConfig.BigqueryDataTransferConfigConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.bigqueryDataTransferConfig.BigqueryDataTransferConfigEmailPreferences",
    jsii_struct_bases=[],
...
class BigqueryDataTransferConfigEmailPreferencesOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.bigqueryDataTransferConfig.BigqueryDataTransferConfigEmailPreferencesOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.bigqueryDataTransferConfig.BigqueryDataTransferConfigScheduleOptions",
    jsii_struct_bases=[],
    name_mapping={
...
class BigqueryDataTransferConfigScheduleOptionsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.bigqueryDataTransferConfig.BigqueryDataTransferConfigScheduleOptionsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.bigqueryDataTransferConfig.BigqueryDataTransferConfigSensitiveParams",
    jsii_struct_bases=[],
...
class BigqueryDataTransferConfigSensitiveParamsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.bigqueryDataTransferConfig.BigqueryDataTransferConfigSensitiveParamsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.bigqueryDataTransferConfig.BigqueryDataTransferConfigTimeouts",
    jsii_struct_bases=[],
...
class BigqueryDataTransferConfigTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.bigqueryDataTransferConfig.BigqueryDataTransferConfigTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
