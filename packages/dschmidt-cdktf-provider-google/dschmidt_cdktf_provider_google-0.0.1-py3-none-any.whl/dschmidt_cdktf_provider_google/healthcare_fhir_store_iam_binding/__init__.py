...
class HealthcareFhirStoreIamBinding(
    ...
    jsii_type="@dschmidt/provider-google.healthcareFhirStoreIamBinding.HealthcareFhirStoreIamBinding",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.healthcareFhirStoreIamBinding.HealthcareFhirStoreIamBindingCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class HealthcareFhirStoreIamBindingConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.healthcareFhirStoreIamBinding.HealthcareFhirStoreIamBindingConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.healthcareFhirStoreIamBinding.HealthcareFhirStoreIamBindingConfig",
