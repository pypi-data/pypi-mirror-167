...
class EndpointsServiceConsumersIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.endpointsServiceConsumersIamPolicy.EndpointsServiceConsumersIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.endpointsServiceConsumersIamPolicy.EndpointsServiceConsumersIamPolicyConfig",
