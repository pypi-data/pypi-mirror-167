...
class HealthcareConsentStore(
    ...
    jsii_type="@dschmidt/provider-google.healthcareConsentStore.HealthcareConsentStore",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.healthcareConsentStore.HealthcareConsentStoreConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.healthcareConsentStore.HealthcareConsentStoreTimeouts",
    jsii_struct_bases=[],
...
class HealthcareConsentStoreTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.healthcareConsentStore.HealthcareConsentStoreTimeoutsOutputReference",
):
    def __init__(
        self,
