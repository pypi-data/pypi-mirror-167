...
class AppEngineServiceSplitTraffic(
    ...
    jsii_type="@dschmidt/provider-google.appEngineServiceSplitTraffic.AppEngineServiceSplitTraffic",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.appEngineServiceSplitTraffic.AppEngineServiceSplitTrafficConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.appEngineServiceSplitTraffic.AppEngineServiceSplitTrafficSplit",
    jsii_struct_bases=[],
...
class AppEngineServiceSplitTrafficSplitOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.appEngineServiceSplitTraffic.AppEngineServiceSplitTrafficSplitOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.appEngineServiceSplitTraffic.AppEngineServiceSplitTrafficTimeouts",
    jsii_struct_bases=[],
...
class AppEngineServiceSplitTrafficTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.appEngineServiceSplitTraffic.AppEngineServiceSplitTrafficTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
