...
class VpcAccessConnector(
    ...
    jsii_type="@dschmidt/provider-google.vpcAccessConnector.VpcAccessConnector",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.vpcAccessConnector.VpcAccessConnectorConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.vpcAccessConnector.VpcAccessConnectorTimeouts",
    jsii_struct_bases=[],
...
class VpcAccessConnectorTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.vpcAccessConnector.VpcAccessConnectorTimeoutsOutputReference",
):
    def __init__(
        self,
