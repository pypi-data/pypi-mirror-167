...
class FirestoreIndex(
    ...
    jsii_type="@dschmidt/provider-google.firestoreIndex.FirestoreIndex",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.firestoreIndex.FirestoreIndexConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.firestoreIndex.FirestoreIndexFields",
    jsii_struct_bases=[],
    name_mapping={
...
class FirestoreIndexFieldsList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.firestoreIndex.FirestoreIndexFieldsList",
):
    def __init__(
        self,
...
class FirestoreIndexFieldsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.firestoreIndex.FirestoreIndexFieldsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.firestoreIndex.FirestoreIndexTimeouts",
    jsii_struct_bases=[],
...
class FirestoreIndexTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.firestoreIndex.FirestoreIndexTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
