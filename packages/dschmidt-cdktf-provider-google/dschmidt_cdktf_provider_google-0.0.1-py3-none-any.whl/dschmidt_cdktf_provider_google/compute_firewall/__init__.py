...
class ComputeFirewall(
    ...
    jsii_type="@dschmidt/provider-google.computeFirewall.ComputeFirewall",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeFirewall.ComputeFirewallAllow",
    jsii_struct_bases=[],
...
class ComputeFirewallAllowList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeFirewall.ComputeFirewallAllowList",
):
    def __init__(
        self,
...
class ComputeFirewallAllowOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeFirewall.ComputeFirewallAllowOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeFirewall.ComputeFirewallConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeFirewall.ComputeFirewallDeny",
    jsii_struct_bases=[],
    name_mapping={"protocol": "protocol", "ports": "ports"},
)
...
class ComputeFirewallDenyList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeFirewall.ComputeFirewallDenyList",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
class ComputeFirewallDenyOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeFirewall.ComputeFirewallDenyOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeFirewall.ComputeFirewallLogConfig",
    jsii_struct_bases=[],
...
class ComputeFirewallLogConfigOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeFirewall.ComputeFirewallLogConfigOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeFirewall.ComputeFirewallTimeouts",
    jsii_struct_bases=[],
...
class ComputeFirewallTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeFirewall.ComputeFirewallTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
