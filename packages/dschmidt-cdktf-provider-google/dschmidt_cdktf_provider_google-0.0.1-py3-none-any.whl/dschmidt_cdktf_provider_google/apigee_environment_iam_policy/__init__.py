...
class ApigeeEnvironmentIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.apigeeEnvironmentIamPolicy.ApigeeEnvironmentIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.apigeeEnvironmentIamPolicy.ApigeeEnvironmentIamPolicyConfig",
