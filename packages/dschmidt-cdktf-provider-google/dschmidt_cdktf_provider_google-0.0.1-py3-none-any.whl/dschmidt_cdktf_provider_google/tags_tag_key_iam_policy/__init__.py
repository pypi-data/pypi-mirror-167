...
class TagsTagKeyIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.tagsTagKeyIamPolicy.TagsTagKeyIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.tagsTagKeyIamPolicy.TagsTagKeyIamPolicyConfig",
