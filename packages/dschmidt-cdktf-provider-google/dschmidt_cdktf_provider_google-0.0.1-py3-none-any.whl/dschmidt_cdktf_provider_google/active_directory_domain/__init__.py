...
class ActiveDirectoryDomain(
    ...
    jsii_type="@dschmidt/provider-google.activeDirectoryDomain.ActiveDirectoryDomain",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.activeDirectoryDomain.ActiveDirectoryDomainConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.activeDirectoryDomain.ActiveDirectoryDomainTimeouts",
    jsii_struct_bases=[],
...
class ActiveDirectoryDomainTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.activeDirectoryDomain.ActiveDirectoryDomainTimeoutsOutputReference",
):
    def __init__(
        self,
