...
class DnsRecordSet(
    ...
    jsii_type="@dschmidt/provider-google.dnsRecordSet.DnsRecordSet",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dnsRecordSet.DnsRecordSetConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dnsRecordSet.DnsRecordSetRoutingPolicy",
    jsii_struct_bases=[],
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dnsRecordSet.DnsRecordSetRoutingPolicyGeo",
    jsii_struct_bases=[],
...
class DnsRecordSetRoutingPolicyGeoList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dnsRecordSet.DnsRecordSetRoutingPolicyGeoList",
):
    def __init__(
        self,
...
class DnsRecordSetRoutingPolicyGeoOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dnsRecordSet.DnsRecordSetRoutingPolicyGeoOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
class DnsRecordSetRoutingPolicyOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dnsRecordSet.DnsRecordSetRoutingPolicyOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dnsRecordSet.DnsRecordSetRoutingPolicyWrr",
    jsii_struct_bases=[],
...
class DnsRecordSetRoutingPolicyWrrList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dnsRecordSet.DnsRecordSetRoutingPolicyWrrList",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
class DnsRecordSetRoutingPolicyWrrOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dnsRecordSet.DnsRecordSetRoutingPolicyWrrOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
