...
class EndpointsServiceIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicyConfig",
