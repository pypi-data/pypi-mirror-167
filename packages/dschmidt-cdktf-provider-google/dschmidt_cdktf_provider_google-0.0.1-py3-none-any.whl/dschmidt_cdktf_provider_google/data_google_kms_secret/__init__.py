...
class DataGoogleKmsSecret(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleKmsSecret.DataGoogleKmsSecret",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleKmsSecret.DataGoogleKmsSecretConfig",
