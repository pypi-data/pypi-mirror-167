...
class ServiceNetworkingPeeredDnsDomain(
    ...
    jsii_type="@dschmidt/provider-google.serviceNetworkingPeeredDnsDomain.ServiceNetworkingPeeredDnsDomain",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.serviceNetworkingPeeredDnsDomain.ServiceNetworkingPeeredDnsDomainConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.serviceNetworkingPeeredDnsDomain.ServiceNetworkingPeeredDnsDomainTimeouts",
    jsii_struct_bases=[],
...
class ServiceNetworkingPeeredDnsDomainTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.serviceNetworkingPeeredDnsDomain.ServiceNetworkingPeeredDnsDomainTimeoutsOutputReference",
):
    def __init__(
        self,
