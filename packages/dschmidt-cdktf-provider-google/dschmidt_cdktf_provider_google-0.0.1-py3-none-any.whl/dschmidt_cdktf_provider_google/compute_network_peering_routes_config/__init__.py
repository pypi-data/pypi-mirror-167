...
class ComputeNetworkPeeringRoutesConfig(
    ...
    jsii_type="@dschmidt/provider-google.computeNetworkPeeringRoutesConfig.ComputeNetworkPeeringRoutesConfig",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeNetworkPeeringRoutesConfig.ComputeNetworkPeeringRoutesConfigConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeNetworkPeeringRoutesConfig.ComputeNetworkPeeringRoutesConfigTimeouts",
    jsii_struct_bases=[],
...
class ComputeNetworkPeeringRoutesConfigTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeNetworkPeeringRoutesConfig.ComputeNetworkPeeringRoutesConfigTimeoutsOutputReference",
):
    def __init__(
        self,
