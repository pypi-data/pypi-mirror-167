...
class DialogflowCxAgent(
    ...
    jsii_type="@dschmidt/provider-google.dialogflowCxAgent.DialogflowCxAgent",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dialogflowCxAgent.DialogflowCxAgentConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dialogflowCxAgent.DialogflowCxAgentSpeechToTextSettings",
    jsii_struct_bases=[],
...
class DialogflowCxAgentSpeechToTextSettingsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dialogflowCxAgent.DialogflowCxAgentSpeechToTextSettingsOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dialogflowCxAgent.DialogflowCxAgentTimeouts",
    jsii_struct_bases=[],
...
class DialogflowCxAgentTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dialogflowCxAgent.DialogflowCxAgentTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
