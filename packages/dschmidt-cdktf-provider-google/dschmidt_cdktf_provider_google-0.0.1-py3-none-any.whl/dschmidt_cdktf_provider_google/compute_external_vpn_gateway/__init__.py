...
class ComputeExternalVpnGateway(
    ...
    jsii_type="@dschmidt/provider-google.computeExternalVpnGateway.ComputeExternalVpnGateway",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeExternalVpnGateway.ComputeExternalVpnGatewayConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeExternalVpnGateway.ComputeExternalVpnGatewayInterface",
    jsii_struct_bases=[],
...
class ComputeExternalVpnGatewayInterfaceList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeExternalVpnGateway.ComputeExternalVpnGatewayInterfaceList",
):
    def __init__(
        self,
...
class ComputeExternalVpnGatewayInterfaceOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeExternalVpnGateway.ComputeExternalVpnGatewayInterfaceOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeExternalVpnGateway.ComputeExternalVpnGatewayTimeouts",
    jsii_struct_bases=[],
...
class ComputeExternalVpnGatewayTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeExternalVpnGateway.ComputeExternalVpnGatewayTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
