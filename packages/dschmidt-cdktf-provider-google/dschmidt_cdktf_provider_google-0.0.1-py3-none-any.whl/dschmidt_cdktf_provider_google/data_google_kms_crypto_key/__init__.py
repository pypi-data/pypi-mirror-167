...
class DataGoogleKmsCryptoKey(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleKmsCryptoKey.DataGoogleKmsCryptoKey",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleKmsCryptoKey.DataGoogleKmsCryptoKeyConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleKmsCryptoKey.DataGoogleKmsCryptoKeyVersionTemplate",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class DataGoogleKmsCryptoKeyVersionTemplateList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataGoogleKmsCryptoKey.DataGoogleKmsCryptoKeyVersionTemplateList",
):
    def __init__(
        self,
...
class DataGoogleKmsCryptoKeyVersionTemplateOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataGoogleKmsCryptoKey.DataGoogleKmsCryptoKeyVersionTemplateOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
