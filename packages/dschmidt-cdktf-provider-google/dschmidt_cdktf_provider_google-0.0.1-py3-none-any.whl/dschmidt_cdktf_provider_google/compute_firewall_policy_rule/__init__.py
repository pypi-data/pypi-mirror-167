...
class ComputeFirewallPolicyRule(
    ...
    jsii_type="@dschmidt/provider-google.computeFirewallPolicyRule.ComputeFirewallPolicyRule",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeFirewallPolicyRule.ComputeFirewallPolicyRuleConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeFirewallPolicyRule.ComputeFirewallPolicyRuleMatch",
    jsii_struct_bases=[],
    name_mapping={
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeFirewallPolicyRule.ComputeFirewallPolicyRuleMatchLayer4Configs",
    jsii_struct_bases=[],
...
class ComputeFirewallPolicyRuleMatchLayer4ConfigsList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeFirewallPolicyRule.ComputeFirewallPolicyRuleMatchLayer4ConfigsList",
):
    def __init__(
        self,
...
class ComputeFirewallPolicyRuleMatchLayer4ConfigsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeFirewallPolicyRule.ComputeFirewallPolicyRuleMatchLayer4ConfigsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
class ComputeFirewallPolicyRuleMatchOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeFirewallPolicyRule.ComputeFirewallPolicyRuleMatchOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeFirewallPolicyRule.ComputeFirewallPolicyRuleTimeouts",
    jsii_struct_bases=[],
...
class ComputeFirewallPolicyRuleTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeFirewallPolicyRule.ComputeFirewallPolicyRuleTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
