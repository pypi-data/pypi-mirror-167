...
class CloudAssetProjectFeed(
    ...
    jsii_type="@dschmidt/provider-google.cloudAssetProjectFeed.CloudAssetProjectFeed",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.cloudAssetProjectFeed.CloudAssetProjectFeedCondition",
    jsii_struct_bases=[],
    name_mapping={
        "expression": "expression",
        "description": "description",
...
class CloudAssetProjectFeedConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.cloudAssetProjectFeed.CloudAssetProjectFeedConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.cloudAssetProjectFeed.CloudAssetProjectFeedConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.cloudAssetProjectFeed.CloudAssetProjectFeedFeedOutputConfig",
    jsii_struct_bases=[],
...
class CloudAssetProjectFeedFeedOutputConfigOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.cloudAssetProjectFeed.CloudAssetProjectFeedFeedOutputConfigOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.cloudAssetProjectFeed.CloudAssetProjectFeedFeedOutputConfigPubsubDestination",
    jsii_struct_bases=[],
...
class CloudAssetProjectFeedFeedOutputConfigPubsubDestinationOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.cloudAssetProjectFeed.CloudAssetProjectFeedFeedOutputConfigPubsubDestinationOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.cloudAssetProjectFeed.CloudAssetProjectFeedTimeouts",
    jsii_struct_bases=[],
...
class CloudAssetProjectFeedTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.cloudAssetProjectFeed.CloudAssetProjectFeedTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
