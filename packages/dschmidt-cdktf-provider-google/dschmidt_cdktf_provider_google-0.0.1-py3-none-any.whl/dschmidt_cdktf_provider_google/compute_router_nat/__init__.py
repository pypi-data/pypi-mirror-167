...
class ComputeRouterNat(
    ...
    jsii_type="@dschmidt/provider-google.computeRouterNat.ComputeRouterNat",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeRouterNat.ComputeRouterNatConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeRouterNat.ComputeRouterNatLogConfig",
    jsii_struct_bases=[],
...
class ComputeRouterNatLogConfigOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeRouterNat.ComputeRouterNatLogConfigOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeRouterNat.ComputeRouterNatSubnetwork",
    jsii_struct_bases=[],
    name_mapping={
        "name": "name",
...
class ComputeRouterNatSubnetworkList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeRouterNat.ComputeRouterNatSubnetworkList",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
class ComputeRouterNatSubnetworkOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeRouterNat.ComputeRouterNatSubnetworkOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeRouterNat.ComputeRouterNatTimeouts",
    jsii_struct_bases=[],
...
class ComputeRouterNatTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeRouterNat.ComputeRouterNatTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
