...
class MlEngineModel(
    ...
    jsii_type="@dschmidt/provider-google.mlEngineModel.MlEngineModel",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.mlEngineModel.MlEngineModelConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.mlEngineModel.MlEngineModelDefaultVersion",
    jsii_struct_bases=[],
...
class MlEngineModelDefaultVersionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.mlEngineModel.MlEngineModelDefaultVersionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.mlEngineModel.MlEngineModelTimeouts",
    jsii_struct_bases=[],
...
class MlEngineModelTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.mlEngineModel.MlEngineModelTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
