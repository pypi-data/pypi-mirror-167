...
class PrivatecaCaPoolIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.privatecaCaPoolIamPolicy.PrivatecaCaPoolIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.privatecaCaPoolIamPolicy.PrivatecaCaPoolIamPolicyConfig",
