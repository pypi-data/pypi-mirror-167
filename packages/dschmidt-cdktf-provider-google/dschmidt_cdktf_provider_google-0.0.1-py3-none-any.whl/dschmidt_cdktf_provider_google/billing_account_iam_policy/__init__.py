...
class BillingAccountIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.billingAccountIamPolicy.BillingAccountIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.billingAccountIamPolicy.BillingAccountIamPolicyConfig",
