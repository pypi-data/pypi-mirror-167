...
class DataGoogleSpannerInstance(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleSpannerInstance.DataGoogleSpannerInstance",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleSpannerInstance.DataGoogleSpannerInstanceConfig",
