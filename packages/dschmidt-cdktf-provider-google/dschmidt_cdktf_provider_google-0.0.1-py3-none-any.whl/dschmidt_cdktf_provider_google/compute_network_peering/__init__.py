...
class ComputeNetworkPeering(
    ...
    jsii_type="@dschmidt/provider-google.computeNetworkPeering.ComputeNetworkPeering",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeNetworkPeering.ComputeNetworkPeeringConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeNetworkPeering.ComputeNetworkPeeringTimeouts",
    jsii_struct_bases=[],
...
class ComputeNetworkPeeringTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeNetworkPeering.ComputeNetworkPeeringTimeoutsOutputReference",
):
    def __init__(
        self,
