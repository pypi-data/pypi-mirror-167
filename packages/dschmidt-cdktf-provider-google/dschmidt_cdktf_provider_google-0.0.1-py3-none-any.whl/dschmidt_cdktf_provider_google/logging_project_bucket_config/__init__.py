...
class LoggingProjectBucketConfig(
    ...
    jsii_type="@dschmidt/provider-google.loggingProjectBucketConfig.LoggingProjectBucketConfig",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.loggingProjectBucketConfig.LoggingProjectBucketConfigConfig",
