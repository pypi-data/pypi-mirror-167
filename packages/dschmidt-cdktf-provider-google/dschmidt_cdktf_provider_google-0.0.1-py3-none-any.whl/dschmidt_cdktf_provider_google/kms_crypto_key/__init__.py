...
class KmsCryptoKey(
    ...
    jsii_type="@dschmidt/provider-google.kmsCryptoKey.KmsCryptoKey",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.kmsCryptoKey.KmsCryptoKeyConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.kmsCryptoKey.KmsCryptoKeyTimeouts",
    jsii_struct_bases=[],
...
class KmsCryptoKeyTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.kmsCryptoKey.KmsCryptoKeyTimeoutsOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.kmsCryptoKey.KmsCryptoKeyVersionTemplate",
    jsii_struct_bases=[],
...
class KmsCryptoKeyVersionTemplateOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.kmsCryptoKey.KmsCryptoKeyVersionTemplateOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
