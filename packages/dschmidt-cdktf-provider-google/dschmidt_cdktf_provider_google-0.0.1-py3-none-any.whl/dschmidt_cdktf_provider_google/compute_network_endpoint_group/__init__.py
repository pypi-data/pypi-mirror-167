...
class ComputeNetworkEndpointGroup(
    ...
    jsii_type="@dschmidt/provider-google.computeNetworkEndpointGroup.ComputeNetworkEndpointGroup",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeNetworkEndpointGroup.ComputeNetworkEndpointGroupConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeNetworkEndpointGroup.ComputeNetworkEndpointGroupTimeouts",
    jsii_struct_bases=[],
...
class ComputeNetworkEndpointGroupTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeNetworkEndpointGroup.ComputeNetworkEndpointGroupTimeoutsOutputReference",
):
    def __init__(
        self,
