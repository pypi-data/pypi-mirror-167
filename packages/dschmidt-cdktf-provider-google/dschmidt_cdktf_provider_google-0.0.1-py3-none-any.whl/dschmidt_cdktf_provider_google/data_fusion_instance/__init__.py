...
class DataFusionInstance(
    ...
    jsii_type="@dschmidt/provider-google.dataFusionInstance.DataFusionInstance",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataFusionInstance.DataFusionInstanceConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataFusionInstance.DataFusionInstanceNetworkConfig",
    jsii_struct_bases=[],
...
class DataFusionInstanceNetworkConfigOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataFusionInstance.DataFusionInstanceNetworkConfigOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataFusionInstance.DataFusionInstanceTimeouts",
    jsii_struct_bases=[],
...
class DataFusionInstanceTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataFusionInstance.DataFusionInstanceTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
