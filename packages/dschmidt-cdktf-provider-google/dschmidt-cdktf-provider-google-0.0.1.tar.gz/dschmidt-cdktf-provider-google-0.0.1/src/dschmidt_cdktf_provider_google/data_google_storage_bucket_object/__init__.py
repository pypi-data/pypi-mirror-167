...
class DataGoogleStorageBucketObject(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleStorageBucketObject.DataGoogleStorageBucketObject",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleStorageBucketObject.DataGoogleStorageBucketObjectConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleStorageBucketObject.DataGoogleStorageBucketObjectCustomerEncryption",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class DataGoogleStorageBucketObjectCustomerEncryptionList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataGoogleStorageBucketObject.DataGoogleStorageBucketObjectCustomerEncryptionList",
):
    def __init__(
        self,
...
class DataGoogleStorageBucketObjectCustomerEncryptionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataGoogleStorageBucketObject.DataGoogleStorageBucketObjectCustomerEncryptionOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
