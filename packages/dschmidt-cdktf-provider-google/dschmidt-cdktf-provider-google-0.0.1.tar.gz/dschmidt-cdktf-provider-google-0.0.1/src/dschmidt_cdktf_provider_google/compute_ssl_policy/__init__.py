...
class ComputeSslPolicy(
    ...
    jsii_type="@dschmidt/provider-google.computeSslPolicy.ComputeSslPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeSslPolicy.ComputeSslPolicyConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeSslPolicy.ComputeSslPolicyTimeouts",
    jsii_struct_bases=[],
...
class ComputeSslPolicyTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeSslPolicy.ComputeSslPolicyTimeoutsOutputReference",
):
    def __init__(
        self,
