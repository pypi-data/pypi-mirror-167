...
class BigqueryTableIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.bigqueryTableIamPolicy.BigqueryTableIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.bigqueryTableIamPolicy.BigqueryTableIamPolicyConfig",
