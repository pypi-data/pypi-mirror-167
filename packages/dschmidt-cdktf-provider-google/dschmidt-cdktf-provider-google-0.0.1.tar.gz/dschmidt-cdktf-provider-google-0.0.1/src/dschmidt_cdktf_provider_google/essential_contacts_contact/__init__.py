...
class EssentialContactsContact(
    ...
    jsii_type="@dschmidt/provider-google.essentialContactsContact.EssentialContactsContact",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.essentialContactsContact.EssentialContactsContactConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.essentialContactsContact.EssentialContactsContactTimeouts",
    jsii_struct_bases=[],
...
class EssentialContactsContactTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.essentialContactsContact.EssentialContactsContactTimeoutsOutputReference",
):
    def __init__(
        self,
