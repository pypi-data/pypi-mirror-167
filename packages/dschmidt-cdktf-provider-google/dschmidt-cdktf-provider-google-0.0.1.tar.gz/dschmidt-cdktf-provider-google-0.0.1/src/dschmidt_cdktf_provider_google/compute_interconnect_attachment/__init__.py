...
class ComputeInterconnectAttachment(
    ...
    jsii_type="@dschmidt/provider-google.computeInterconnectAttachment.ComputeInterconnectAttachment",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeInterconnectAttachment.ComputeInterconnectAttachmentConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeInterconnectAttachment.ComputeInterconnectAttachmentPrivateInterconnectInfo",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class ComputeInterconnectAttachmentPrivateInterconnectInfoList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeInterconnectAttachment.ComputeInterconnectAttachmentPrivateInterconnectInfoList",
):
    def __init__(
        self,
...
class ComputeInterconnectAttachmentPrivateInterconnectInfoOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeInterconnectAttachment.ComputeInterconnectAttachmentPrivateInterconnectInfoOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeInterconnectAttachment.ComputeInterconnectAttachmentTimeouts",
    jsii_struct_bases=[],
...
class ComputeInterconnectAttachmentTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeInterconnectAttachment.ComputeInterconnectAttachmentTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
