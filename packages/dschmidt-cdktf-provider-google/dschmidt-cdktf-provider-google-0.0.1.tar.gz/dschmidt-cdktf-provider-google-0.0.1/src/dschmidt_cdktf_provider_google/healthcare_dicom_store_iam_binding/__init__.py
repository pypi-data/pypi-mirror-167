...
class HealthcareDicomStoreIamBinding(
    ...
    jsii_type="@dschmidt/provider-google.healthcareDicomStoreIamBinding.HealthcareDicomStoreIamBinding",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.healthcareDicomStoreIamBinding.HealthcareDicomStoreIamBindingCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class HealthcareDicomStoreIamBindingConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.healthcareDicomStoreIamBinding.HealthcareDicomStoreIamBindingConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.healthcareDicomStoreIamBinding.HealthcareDicomStoreIamBindingConfig",
