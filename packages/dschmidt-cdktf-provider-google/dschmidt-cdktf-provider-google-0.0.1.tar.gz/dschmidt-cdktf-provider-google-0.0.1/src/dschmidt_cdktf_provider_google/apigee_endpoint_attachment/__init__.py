...
class ApigeeEndpointAttachment(
    ...
    jsii_type="@dschmidt/provider-google.apigeeEndpointAttachment.ApigeeEndpointAttachment",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.apigeeEndpointAttachment.ApigeeEndpointAttachmentConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.apigeeEndpointAttachment.ApigeeEndpointAttachmentTimeouts",
    jsii_struct_bases=[],
...
class ApigeeEndpointAttachmentTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.apigeeEndpointAttachment.ApigeeEndpointAttachmentTimeoutsOutputReference",
):
    def __init__(
        self,
