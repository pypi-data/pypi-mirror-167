...
class OrganizationIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.organizationIamPolicy.OrganizationIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.organizationIamPolicy.OrganizationIamPolicyConfig",
