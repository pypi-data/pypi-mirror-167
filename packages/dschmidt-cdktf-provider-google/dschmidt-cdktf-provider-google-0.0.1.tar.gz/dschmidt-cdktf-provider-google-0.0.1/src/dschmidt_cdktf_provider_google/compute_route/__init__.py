...
class ComputeRoute(
    ...
    jsii_type="@dschmidt/provider-google.computeRoute.ComputeRoute",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeRoute.ComputeRouteConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeRoute.ComputeRouteTimeouts",
    jsii_struct_bases=[],
...
class ComputeRouteTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeRoute.ComputeRouteTimeoutsOutputReference",
):
    def __init__(
        self,
