...
class ComputeNetwork(
    ...
    jsii_type="@dschmidt/provider-google.computeNetwork.ComputeNetwork",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeNetwork.ComputeNetworkConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeNetwork.ComputeNetworkTimeouts",
    jsii_struct_bases=[],
...
class ComputeNetworkTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeNetwork.ComputeNetworkTimeoutsOutputReference",
):
    def __init__(
        self,
