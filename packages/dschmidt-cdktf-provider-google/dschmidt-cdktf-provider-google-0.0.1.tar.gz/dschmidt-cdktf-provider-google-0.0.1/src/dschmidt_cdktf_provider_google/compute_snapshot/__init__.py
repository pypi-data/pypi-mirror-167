...
class ComputeSnapshot(
    ...
    jsii_type="@dschmidt/provider-google.computeSnapshot.ComputeSnapshot",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeSnapshot.ComputeSnapshotConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeSnapshot.ComputeSnapshotSnapshotEncryptionKey",
    jsii_struct_bases=[],
    name_mapping={
...
class ComputeSnapshotSnapshotEncryptionKeyOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeSnapshot.ComputeSnapshotSnapshotEncryptionKeyOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeSnapshot.ComputeSnapshotSourceDiskEncryptionKey",
    jsii_struct_bases=[],
    name_mapping={
        "kms_key_service_account": "kmsKeyServiceAccount",
        "raw_key": "rawKey",
...
class ComputeSnapshotSourceDiskEncryptionKeyOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeSnapshot.ComputeSnapshotSourceDiskEncryptionKeyOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeSnapshot.ComputeSnapshotTimeouts",
    jsii_struct_bases=[],
...
class ComputeSnapshotTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeSnapshot.ComputeSnapshotTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
