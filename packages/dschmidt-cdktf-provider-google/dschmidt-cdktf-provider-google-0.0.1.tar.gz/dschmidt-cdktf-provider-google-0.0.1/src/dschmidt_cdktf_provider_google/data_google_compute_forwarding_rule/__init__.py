...
class DataGoogleComputeForwardingRule(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleComputeForwardingRule.DataGoogleComputeForwardingRule",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleComputeForwardingRule.DataGoogleComputeForwardingRuleConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleComputeForwardingRule.DataGoogleComputeForwardingRuleServiceDirectoryRegistrations",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class DataGoogleComputeForwardingRuleServiceDirectoryRegistrationsList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataGoogleComputeForwardingRule.DataGoogleComputeForwardingRuleServiceDirectoryRegistrationsList",
):
    def __init__(
        self,
...
class DataGoogleComputeForwardingRuleServiceDirectoryRegistrationsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataGoogleComputeForwardingRule.DataGoogleComputeForwardingRuleServiceDirectoryRegistrationsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
