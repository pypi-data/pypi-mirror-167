...
class BigtableAppProfile(
    ...
    jsii_type="@dschmidt/provider-google.bigtableAppProfile.BigtableAppProfile",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.bigtableAppProfile.BigtableAppProfileConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.bigtableAppProfile.BigtableAppProfileSingleClusterRouting",
    jsii_struct_bases=[],
    name_mapping={
...
class BigtableAppProfileSingleClusterRoutingOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.bigtableAppProfile.BigtableAppProfileSingleClusterRoutingOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.bigtableAppProfile.BigtableAppProfileTimeouts",
    jsii_struct_bases=[],
...
class BigtableAppProfileTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.bigtableAppProfile.BigtableAppProfileTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
