...
class ServiceAccountIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.serviceAccountIamPolicy.ServiceAccountIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.serviceAccountIamPolicy.ServiceAccountIamPolicyConfig",
