...
class KmsCryptoKeyIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.kmsCryptoKeyIamPolicy.KmsCryptoKeyIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.kmsCryptoKeyIamPolicy.KmsCryptoKeyIamPolicyConfig",
