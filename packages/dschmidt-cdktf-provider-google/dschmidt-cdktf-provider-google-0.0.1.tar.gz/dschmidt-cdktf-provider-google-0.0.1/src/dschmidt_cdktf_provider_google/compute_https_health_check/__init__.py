...
class ComputeHttpsHealthCheck(
    ...
    jsii_type="@dschmidt/provider-google.computeHttpsHealthCheck.ComputeHttpsHealthCheck",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeHttpsHealthCheck.ComputeHttpsHealthCheckConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeHttpsHealthCheck.ComputeHttpsHealthCheckTimeouts",
    jsii_struct_bases=[],
...
class ComputeHttpsHealthCheckTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeHttpsHealthCheck.ComputeHttpsHealthCheckTimeoutsOutputReference",
):
    def __init__(
        self,
