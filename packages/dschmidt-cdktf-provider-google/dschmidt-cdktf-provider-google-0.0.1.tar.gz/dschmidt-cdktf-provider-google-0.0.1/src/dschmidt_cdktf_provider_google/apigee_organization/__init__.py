...
class ApigeeOrganization(
    ...
    jsii_type="@dschmidt/provider-google.apigeeOrganization.ApigeeOrganization",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.apigeeOrganization.ApigeeOrganizationConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.apigeeOrganization.ApigeeOrganizationProperties",
    jsii_struct_bases=[],
...
class ApigeeOrganizationPropertiesOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.apigeeOrganization.ApigeeOrganizationPropertiesOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.apigeeOrganization.ApigeeOrganizationPropertiesProperty",
    jsii_struct_bases=[],
...
class ApigeeOrganizationPropertiesPropertyList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.apigeeOrganization.ApigeeOrganizationPropertiesPropertyList",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
class ApigeeOrganizationPropertiesPropertyOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.apigeeOrganization.ApigeeOrganizationPropertiesPropertyOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.apigeeOrganization.ApigeeOrganizationTimeouts",
    jsii_struct_bases=[],
...
class ApigeeOrganizationTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.apigeeOrganization.ApigeeOrganizationTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
