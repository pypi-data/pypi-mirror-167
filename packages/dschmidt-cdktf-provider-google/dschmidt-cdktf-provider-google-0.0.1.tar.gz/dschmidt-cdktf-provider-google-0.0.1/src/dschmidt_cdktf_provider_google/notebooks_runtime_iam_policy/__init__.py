...
class NotebooksRuntimeIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.notebooksRuntimeIamPolicy.NotebooksRuntimeIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.notebooksRuntimeIamPolicy.NotebooksRuntimeIamPolicyConfig",
