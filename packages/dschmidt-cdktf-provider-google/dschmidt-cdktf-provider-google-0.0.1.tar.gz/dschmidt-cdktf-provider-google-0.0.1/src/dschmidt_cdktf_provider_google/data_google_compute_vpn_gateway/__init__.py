...
class DataGoogleComputeVpnGateway(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleComputeVpnGateway.DataGoogleComputeVpnGateway",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleComputeVpnGateway.DataGoogleComputeVpnGatewayConfig",
