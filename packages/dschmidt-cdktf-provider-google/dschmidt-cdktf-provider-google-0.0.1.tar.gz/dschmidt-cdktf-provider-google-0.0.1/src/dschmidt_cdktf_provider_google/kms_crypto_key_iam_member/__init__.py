...
class KmsCryptoKeyIamMember(
    ...
    jsii_type="@dschmidt/provider-google.kmsCryptoKeyIamMember.KmsCryptoKeyIamMember",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.kmsCryptoKeyIamMember.KmsCryptoKeyIamMemberCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class KmsCryptoKeyIamMemberConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.kmsCryptoKeyIamMember.KmsCryptoKeyIamMemberConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.kmsCryptoKeyIamMember.KmsCryptoKeyIamMemberConfig",
