...
class ComputeSharedVpcServiceProject(
    ...
    jsii_type="@dschmidt/provider-google.computeSharedVpcServiceProject.ComputeSharedVpcServiceProject",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeSharedVpcServiceProject.ComputeSharedVpcServiceProjectConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeSharedVpcServiceProject.ComputeSharedVpcServiceProjectTimeouts",
    jsii_struct_bases=[],
...
class ComputeSharedVpcServiceProjectTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeSharedVpcServiceProject.ComputeSharedVpcServiceProjectTimeoutsOutputReference",
):
    def __init__(
        self,
