...
class ComputeTargetHttpsProxy(
    ...
    jsii_type="@dschmidt/provider-google.computeTargetHttpsProxy.ComputeTargetHttpsProxy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeTargetHttpsProxy.ComputeTargetHttpsProxyConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeTargetHttpsProxy.ComputeTargetHttpsProxyTimeouts",
    jsii_struct_bases=[],
...
class ComputeTargetHttpsProxyTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeTargetHttpsProxy.ComputeTargetHttpsProxyTimeoutsOutputReference",
):
    def __init__(
        self,
