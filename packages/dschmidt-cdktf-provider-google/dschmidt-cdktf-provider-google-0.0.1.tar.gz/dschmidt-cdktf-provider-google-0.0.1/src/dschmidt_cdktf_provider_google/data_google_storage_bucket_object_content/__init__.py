...
class DataGoogleStorageBucketObjectContent(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleStorageBucketObjectContent.DataGoogleStorageBucketObjectContent",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleStorageBucketObjectContent.DataGoogleStorageBucketObjectContentConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleStorageBucketObjectContent.DataGoogleStorageBucketObjectContentCustomerEncryption",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class DataGoogleStorageBucketObjectContentCustomerEncryptionList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataGoogleStorageBucketObjectContent.DataGoogleStorageBucketObjectContentCustomerEncryptionList",
):
    def __init__(
        self,
...
class DataGoogleStorageBucketObjectContentCustomerEncryptionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dataGoogleStorageBucketObjectContent.DataGoogleStorageBucketObjectContentCustomerEncryptionOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
