...
class ComputeRegionDisk(
    ...
    jsii_type="@dschmidt/provider-google.computeRegionDisk.ComputeRegionDisk",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeRegionDisk.ComputeRegionDiskConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeRegionDisk.ComputeRegionDiskDiskEncryptionKey",
    jsii_struct_bases=[],
...
class ComputeRegionDiskDiskEncryptionKeyOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeRegionDisk.ComputeRegionDiskDiskEncryptionKeyOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeRegionDisk.ComputeRegionDiskSourceSnapshotEncryptionKey",
    jsii_struct_bases=[],
...
class ComputeRegionDiskSourceSnapshotEncryptionKeyOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeRegionDisk.ComputeRegionDiskSourceSnapshotEncryptionKeyOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeRegionDisk.ComputeRegionDiskTimeouts",
    jsii_struct_bases=[],
...
class ComputeRegionDiskTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeRegionDisk.ComputeRegionDiskTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
