...
class DataGoogleServiceAccountJwt(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleServiceAccountJwt.DataGoogleServiceAccountJwt",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleServiceAccountJwt.DataGoogleServiceAccountJwtConfig",
