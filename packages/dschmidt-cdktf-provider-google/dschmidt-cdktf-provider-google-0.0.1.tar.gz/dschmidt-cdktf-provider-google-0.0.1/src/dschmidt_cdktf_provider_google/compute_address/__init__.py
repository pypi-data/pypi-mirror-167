...
class ComputeAddress(
    ...
    jsii_type="@dschmidt/provider-google.computeAddress.ComputeAddress",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeAddress.ComputeAddressConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeAddress.ComputeAddressTimeouts",
    jsii_struct_bases=[],
...
class ComputeAddressTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeAddress.ComputeAddressTimeoutsOutputReference",
):
    def __init__(
        self,
