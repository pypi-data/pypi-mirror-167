...
class ComputeTargetSslProxy(
    ...
    jsii_type="@dschmidt/provider-google.computeTargetSslProxy.ComputeTargetSslProxy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeTargetSslProxy.ComputeTargetSslProxyConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeTargetSslProxy.ComputeTargetSslProxyTimeouts",
    jsii_struct_bases=[],
...
class ComputeTargetSslProxyTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeTargetSslProxy.ComputeTargetSslProxyTimeoutsOutputReference",
):
    def __init__(
        self,
