...
class HealthcareDicomStore(
    ...
    jsii_type="@dschmidt/provider-google.healthcareDicomStore.HealthcareDicomStore",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.healthcareDicomStore.HealthcareDicomStoreConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.healthcareDicomStore.HealthcareDicomStoreNotificationConfig",
    jsii_struct_bases=[],
...
class HealthcareDicomStoreNotificationConfigOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.healthcareDicomStore.HealthcareDicomStoreNotificationConfigOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.healthcareDicomStore.HealthcareDicomStoreTimeouts",
    jsii_struct_bases=[],
...
class HealthcareDicomStoreTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.healthcareDicomStore.HealthcareDicomStoreTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
