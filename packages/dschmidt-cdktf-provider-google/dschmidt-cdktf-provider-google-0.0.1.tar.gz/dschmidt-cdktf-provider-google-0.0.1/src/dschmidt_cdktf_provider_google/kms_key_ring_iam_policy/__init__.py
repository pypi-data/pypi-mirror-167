...
class KmsKeyRingIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.kmsKeyRingIamPolicy.KmsKeyRingIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.kmsKeyRingIamPolicy.KmsKeyRingIamPolicyConfig",
