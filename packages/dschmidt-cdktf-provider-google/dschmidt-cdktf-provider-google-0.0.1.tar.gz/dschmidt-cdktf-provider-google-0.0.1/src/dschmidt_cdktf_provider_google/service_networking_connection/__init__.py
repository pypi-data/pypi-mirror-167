...
class ServiceNetworkingConnection(
    ...
    jsii_type="@dschmidt/provider-google.serviceNetworkingConnection.ServiceNetworkingConnection",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.serviceNetworkingConnection.ServiceNetworkingConnectionConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.serviceNetworkingConnection.ServiceNetworkingConnectionTimeouts",
    jsii_struct_bases=[],
...
class ServiceNetworkingConnectionTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.serviceNetworkingConnection.ServiceNetworkingConnectionTimeoutsOutputReference",
):
    def __init__(
        self,
