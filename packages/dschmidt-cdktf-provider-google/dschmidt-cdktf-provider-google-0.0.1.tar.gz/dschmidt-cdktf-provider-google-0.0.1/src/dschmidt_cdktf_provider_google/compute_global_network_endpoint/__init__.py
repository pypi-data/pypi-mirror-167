...
class ComputeGlobalNetworkEndpoint(
    ...
    jsii_type="@dschmidt/provider-google.computeGlobalNetworkEndpoint.ComputeGlobalNetworkEndpoint",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeGlobalNetworkEndpoint.ComputeGlobalNetworkEndpointConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeGlobalNetworkEndpoint.ComputeGlobalNetworkEndpointTimeouts",
    jsii_struct_bases=[],
...
class ComputeGlobalNetworkEndpointTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeGlobalNetworkEndpoint.ComputeGlobalNetworkEndpointTimeoutsOutputReference",
):
    def __init__(
        self,
