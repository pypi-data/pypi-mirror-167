...
class StorageDefaultObjectAcl(
    ...
    jsii_type="@dschmidt/provider-google.storageDefaultObjectAcl.StorageDefaultObjectAcl",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.storageDefaultObjectAcl.StorageDefaultObjectAclConfig",
