...
class ComputeTargetGrpcProxy(
    ...
    jsii_type="@dschmidt/provider-google.computeTargetGrpcProxy.ComputeTargetGrpcProxy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeTargetGrpcProxy.ComputeTargetGrpcProxyConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeTargetGrpcProxy.ComputeTargetGrpcProxyTimeouts",
    jsii_struct_bases=[],
...
class ComputeTargetGrpcProxyTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeTargetGrpcProxy.ComputeTargetGrpcProxyTimeoutsOutputReference",
):
    def __init__(
        self,
