...
class BillingAccountIamBinding(
    ...
    jsii_type="@dschmidt/provider-google.billingAccountIamBinding.BillingAccountIamBinding",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.billingAccountIamBinding.BillingAccountIamBindingCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class BillingAccountIamBindingConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.billingAccountIamBinding.BillingAccountIamBindingConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.billingAccountIamBinding.BillingAccountIamBindingConfig",
