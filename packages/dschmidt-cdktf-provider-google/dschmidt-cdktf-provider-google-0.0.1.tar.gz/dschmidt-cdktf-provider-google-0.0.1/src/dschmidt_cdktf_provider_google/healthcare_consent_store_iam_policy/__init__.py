...
class HealthcareConsentStoreIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.healthcareConsentStoreIamPolicy.HealthcareConsentStoreIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.healthcareConsentStoreIamPolicy.HealthcareConsentStoreIamPolicyConfig",
