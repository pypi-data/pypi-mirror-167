...
class CloudfunctionsFunctionIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.cloudfunctionsFunctionIamPolicy.CloudfunctionsFunctionIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.cloudfunctionsFunctionIamPolicy.CloudfunctionsFunctionIamPolicyConfig",
