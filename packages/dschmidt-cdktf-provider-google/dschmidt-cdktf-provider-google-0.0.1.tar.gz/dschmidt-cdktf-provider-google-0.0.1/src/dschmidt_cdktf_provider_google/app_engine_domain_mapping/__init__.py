...
class AppEngineDomainMapping(
    ...
    jsii_type="@dschmidt/provider-google.appEngineDomainMapping.AppEngineDomainMapping",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.appEngineDomainMapping.AppEngineDomainMappingConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.appEngineDomainMapping.AppEngineDomainMappingResourceRecords",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class AppEngineDomainMappingResourceRecordsList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.appEngineDomainMapping.AppEngineDomainMappingResourceRecordsList",
):
    def __init__(
        self,
...
class AppEngineDomainMappingResourceRecordsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.appEngineDomainMapping.AppEngineDomainMappingResourceRecordsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.appEngineDomainMapping.AppEngineDomainMappingSslSettings",
    jsii_struct_bases=[],
    name_mapping={
...
class AppEngineDomainMappingSslSettingsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.appEngineDomainMapping.AppEngineDomainMappingSslSettingsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.appEngineDomainMapping.AppEngineDomainMappingTimeouts",
    jsii_struct_bases=[],
...
class AppEngineDomainMappingTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.appEngineDomainMapping.AppEngineDomainMappingTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
