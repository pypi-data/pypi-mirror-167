...
class HealthcareFhirStoreIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.healthcareFhirStoreIamPolicy.HealthcareFhirStoreIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.healthcareFhirStoreIamPolicy.HealthcareFhirStoreIamPolicyConfig",
