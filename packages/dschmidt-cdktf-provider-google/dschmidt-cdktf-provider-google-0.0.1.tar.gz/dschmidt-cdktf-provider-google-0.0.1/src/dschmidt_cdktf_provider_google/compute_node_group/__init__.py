...
class ComputeNodeGroup(
    ...
    jsii_type="@dschmidt/provider-google.computeNodeGroup.ComputeNodeGroup",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeNodeGroup.ComputeNodeGroupAutoscalingPolicy",
    jsii_struct_bases=[],
...
class ComputeNodeGroupAutoscalingPolicyOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeNodeGroup.ComputeNodeGroupAutoscalingPolicyOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeNodeGroup.ComputeNodeGroupConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeNodeGroup.ComputeNodeGroupMaintenanceWindow",
    jsii_struct_bases=[],
...
class ComputeNodeGroupMaintenanceWindowOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeNodeGroup.ComputeNodeGroupMaintenanceWindowOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeNodeGroup.ComputeNodeGroupTimeouts",
    jsii_struct_bases=[],
...
class ComputeNodeGroupTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeNodeGroup.ComputeNodeGroupTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
