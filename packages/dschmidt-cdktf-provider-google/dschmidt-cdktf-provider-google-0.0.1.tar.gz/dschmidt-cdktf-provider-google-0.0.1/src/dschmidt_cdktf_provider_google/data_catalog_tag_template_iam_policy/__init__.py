...
class DataCatalogTagTemplateIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.dataCatalogTagTemplateIamPolicy.DataCatalogTagTemplateIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataCatalogTagTemplateIamPolicy.DataCatalogTagTemplateIamPolicyConfig",
