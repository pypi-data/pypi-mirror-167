...
class EndpointsServiceConsumersIamMember(
    ...
    jsii_type="@dschmidt/provider-google.endpointsServiceConsumersIamMember.EndpointsServiceConsumersIamMember",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.endpointsServiceConsumersIamMember.EndpointsServiceConsumersIamMemberCondition",
    jsii_struct_bases=[],
    name_mapping={
...
class EndpointsServiceConsumersIamMemberConditionOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.endpointsServiceConsumersIamMember.EndpointsServiceConsumersIamMemberConditionOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.endpointsServiceConsumersIamMember.EndpointsServiceConsumersIamMemberConfig",
