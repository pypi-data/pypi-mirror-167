...
class HealthcareDicomStoreIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.healthcareDicomStoreIamPolicy.HealthcareDicomStoreIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.healthcareDicomStoreIamPolicy.HealthcareDicomStoreIamPolicyConfig",
