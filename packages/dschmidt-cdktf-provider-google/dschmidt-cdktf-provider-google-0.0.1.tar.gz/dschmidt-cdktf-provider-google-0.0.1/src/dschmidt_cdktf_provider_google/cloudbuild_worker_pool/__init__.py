...
class CloudbuildWorkerPool(
    ...
    jsii_type="@dschmidt/provider-google.cloudbuildWorkerPool.CloudbuildWorkerPool",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.cloudbuildWorkerPool.CloudbuildWorkerPoolConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.cloudbuildWorkerPool.CloudbuildWorkerPoolNetworkConfig",
    jsii_struct_bases=[],
...
class CloudbuildWorkerPoolNetworkConfigOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.cloudbuildWorkerPool.CloudbuildWorkerPoolNetworkConfigOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.cloudbuildWorkerPool.CloudbuildWorkerPoolTimeouts",
    jsii_struct_bases=[],
...
class CloudbuildWorkerPoolTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.cloudbuildWorkerPool.CloudbuildWorkerPoolTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.cloudbuildWorkerPool.CloudbuildWorkerPoolWorkerConfig",
    jsii_struct_bases=[],
    name_mapping={
...
class CloudbuildWorkerPoolWorkerConfigOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.cloudbuildWorkerPool.CloudbuildWorkerPoolWorkerConfigOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
