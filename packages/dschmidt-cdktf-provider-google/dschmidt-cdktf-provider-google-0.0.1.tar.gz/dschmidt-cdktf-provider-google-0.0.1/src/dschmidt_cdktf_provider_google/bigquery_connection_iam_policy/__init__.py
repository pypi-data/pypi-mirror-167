...
class BigqueryConnectionIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.bigqueryConnectionIamPolicy.BigqueryConnectionIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.bigqueryConnectionIamPolicy.BigqueryConnectionIamPolicyConfig",
