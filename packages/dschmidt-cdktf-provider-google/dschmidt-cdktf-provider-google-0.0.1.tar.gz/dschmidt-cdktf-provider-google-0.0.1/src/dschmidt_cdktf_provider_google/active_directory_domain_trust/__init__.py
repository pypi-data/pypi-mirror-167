...
class ActiveDirectoryDomainTrust(
    ...
    jsii_type="@dschmidt/provider-google.activeDirectoryDomainTrust.ActiveDirectoryDomainTrust",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.activeDirectoryDomainTrust.ActiveDirectoryDomainTrustConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.activeDirectoryDomainTrust.ActiveDirectoryDomainTrustTimeouts",
    jsii_struct_bases=[],
...
class ActiveDirectoryDomainTrustTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.activeDirectoryDomainTrust.ActiveDirectoryDomainTrustTimeoutsOutputReference",
):
    def __init__(
        self,
