...
class DataGoogleContainerRegistryImage(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleContainerRegistryImage.DataGoogleContainerRegistryImage",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleContainerRegistryImage.DataGoogleContainerRegistryImageConfig",
