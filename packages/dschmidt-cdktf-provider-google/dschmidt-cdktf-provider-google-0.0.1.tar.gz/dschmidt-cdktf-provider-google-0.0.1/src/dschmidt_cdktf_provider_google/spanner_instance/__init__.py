...
class SpannerInstance(
    ...
    jsii_type="@dschmidt/provider-google.spannerInstance.SpannerInstance",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.spannerInstance.SpannerInstanceConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.spannerInstance.SpannerInstanceTimeouts",
    jsii_struct_bases=[],
...
class SpannerInstanceTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.spannerInstance.SpannerInstanceTimeoutsOutputReference",
):
    def __init__(
        self,
