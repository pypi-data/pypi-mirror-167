...
class DataGoogleTagsTagValue(
    ...
    jsii_type="@dschmidt/provider-google.dataGoogleTagsTagValue.DataGoogleTagsTagValue",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dataGoogleTagsTagValue.DataGoogleTagsTagValueConfig",
