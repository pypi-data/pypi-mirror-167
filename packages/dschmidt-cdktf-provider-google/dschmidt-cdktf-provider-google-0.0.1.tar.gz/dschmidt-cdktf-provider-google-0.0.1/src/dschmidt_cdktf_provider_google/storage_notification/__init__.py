...
class StorageNotification(
    ...
    jsii_type="@dschmidt/provider-google.storageNotification.StorageNotification",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.storageNotification.StorageNotificationConfig",
