...
class PubsubSubscriptionIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.pubsubSubscriptionIamPolicy.PubsubSubscriptionIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.pubsubSubscriptionIamPolicy.PubsubSubscriptionIamPolicyConfig",
