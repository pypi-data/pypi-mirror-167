...
class ComputeBackendBucketSignedUrlKey(
    ...
    jsii_type="@dschmidt/provider-google.computeBackendBucketSignedUrlKey.ComputeBackendBucketSignedUrlKey",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeBackendBucketSignedUrlKey.ComputeBackendBucketSignedUrlKeyConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.computeBackendBucketSignedUrlKey.ComputeBackendBucketSignedUrlKeyTimeouts",
    jsii_struct_bases=[],
...
class ComputeBackendBucketSignedUrlKeyTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.computeBackendBucketSignedUrlKey.ComputeBackendBucketSignedUrlKeyTimeoutsOutputReference",
):
    def __init__(
        self,
