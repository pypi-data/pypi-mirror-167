...
class MonitoringNotificationChannel(
    ...
    jsii_type="@dschmidt/provider-google.monitoringNotificationChannel.MonitoringNotificationChannel",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.monitoringNotificationChannel.MonitoringNotificationChannelConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.monitoringNotificationChannel.MonitoringNotificationChannelSensitiveLabels",
    jsii_struct_bases=[],
    name_mapping={
...
class MonitoringNotificationChannelSensitiveLabelsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.monitoringNotificationChannel.MonitoringNotificationChannelSensitiveLabelsOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.monitoringNotificationChannel.MonitoringNotificationChannelTimeouts",
    jsii_struct_bases=[],
...
class MonitoringNotificationChannelTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.monitoringNotificationChannel.MonitoringNotificationChannelTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
