...
class ApigeeEnvironment(
    ...
    jsii_type="@dschmidt/provider-google.apigeeEnvironment.ApigeeEnvironment",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.apigeeEnvironment.ApigeeEnvironmentConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.apigeeEnvironment.ApigeeEnvironmentNodeConfig",
    jsii_struct_bases=[],
...
class ApigeeEnvironmentNodeConfigOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.apigeeEnvironment.ApigeeEnvironmentNodeConfigOutputReference",
):
    def __init__(
        self,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.apigeeEnvironment.ApigeeEnvironmentTimeouts",
    jsii_struct_bases=[],
...
class ApigeeEnvironmentTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.apigeeEnvironment.ApigeeEnvironmentTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
