...
class TpuNode(
    ...
    jsii_type="@dschmidt/provider-google.tpuNode.TpuNode",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.tpuNode.TpuNodeConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.tpuNode.TpuNodeNetworkEndpoints",
    jsii_struct_bases=[],
    name_mapping={},
)
...
class TpuNodeNetworkEndpointsList(
    cdktf.ComplexList,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.tpuNode.TpuNodeNetworkEndpointsList",
):
    def __init__(
        self,
...
class TpuNodeNetworkEndpointsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.tpuNode.TpuNodeNetworkEndpointsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.tpuNode.TpuNodeSchedulingConfig",
    jsii_struct_bases=[],
...
class TpuNodeSchedulingConfigOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.tpuNode.TpuNodeSchedulingConfigOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.tpuNode.TpuNodeTimeouts",
    jsii_struct_bases=[],
...
class TpuNodeTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.tpuNode.TpuNodeTimeoutsOutputReference",
):
    def __init__(
        self,
        terraform_resource: cdktf.IInterpolatingParent,
