...
class DialogflowAgent(
    ...
    jsii_type="@dschmidt/provider-google.dialogflowAgent.DialogflowAgent",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dialogflowAgent.DialogflowAgentConfig",
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.dialogflowAgent.DialogflowAgentTimeouts",
    jsii_struct_bases=[],
...
class DialogflowAgentTimeoutsOutputReference(
    cdktf.ComplexObject,
    metaclass=jsii.JSIIMeta,
    jsii_type="@dschmidt/provider-google.dialogflowAgent.DialogflowAgentTimeoutsOutputReference",
):
    def __init__(
        self,
