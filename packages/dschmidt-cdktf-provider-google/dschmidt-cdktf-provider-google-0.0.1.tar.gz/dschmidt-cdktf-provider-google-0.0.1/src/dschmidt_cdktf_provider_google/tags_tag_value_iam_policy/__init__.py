...
class TagsTagValueIamPolicy(
    ...
    jsii_type="@dschmidt/provider-google.tagsTagValueIamPolicy.TagsTagValueIamPolicy",
):
...
@jsii.data_type(
    jsii_type="@dschmidt/provider-google.tagsTagValueIamPolicy.TagsTagValueIamPolicyConfig",
