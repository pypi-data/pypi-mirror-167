...
extras_require = \
{':extra == "webapi"': ['fastapi[webapi]>=0.61.1,<0.83.0'],
 ':extra == "webapi" or extra == "webapi2"': ['uvicorn[webapi,webapi2]>=0.12.2,<0.19.0'],
 ':extra == "webapi2"': ['starlite[webapi2]>=1.14.2,<2.0.0'],
