...
class RGBDCamera:
    def __init__(self, pybullet, robot, **kargs):
        ...
        # create publisher
        self.pub_image = rospy.Publisher('kinect/rgb/image_raw', Image, queue_size=10)
        ...
        depth_file = rospy.get_param('~depth_file', "/home/saun/DiffBot_RosGymBullet/haibot_rosgymbullet/resources/depth_msg.yaml")
        ...
        self.pub_depth_msg = rospy.Publisher('kinect/depth/camera_info', CameraInfo, queue_size=10)
        # publishing rgb/camera_info topic
        # rgb_file = os.path.join(os.path.dirname(__file__), "rgb_msg.yaml")
        rgb_file = rospy.get_param('~rgb_file', "/home/saun/DiffBot_RosGymBullet/haibot_rosgymbullet/resources/rgb_msg.yaml")
        with open(rgb_file, "r") as depth_file_handle:
            rgb_data = yaml.load(depth_file_handle)
        ...
        self.pub_rgb_msg = rospy.Publisher('kinect/rgb/camera_info', CameraInfo, queue_size=10)
    ...
    def execute(self):
        ...
        self.pub_rgb_msg.publish(self.rgb_camera_info_msg)
        self.pub_depth_msg.publish(self.depth_camera_info_msg)
