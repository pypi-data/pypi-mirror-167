...
class RGBDCamera:
    def __init__(self, pybullet, robot, **kargs):
        ...
        self.rgb_image_msg.step = rospy.getparam('~rgbd_camera/resolution/rgb_step', 1920)
        # depth_image
        ...
        self.depth_image_msg.step = rospy.getparam('~rgbd_camera/resolution/depth_step', 1280)
        # projection matrix
