...
class xanes3D_tools_gui():
    def __init__(self, parent_h, form_sz=[650, 740]):
        ...
        self.xanes_fit_external_command_name = os.path.join(self.global_h.script_dir, 'xanes3D_fit_external_command.py')
        self.xanes_reg_external_command_name = os.path.join(self.global_h.script_dir, 'xanes3D_reg_external_command.py')
        self.xanes_align_external_command_name = os.path.join(self.global_h.script_dir, 'xanes3D_align_external_command.py')
    ...
    def build_gui(self):
        ...
        layout = {'border':'3px solid #FFCC00', 'width': '100%', 
                  'height': '100%'}
        ...
        base_wz_os = 92
        ex_ws_os = 6
        layout = {'border':'3px solid #8855AA', 'width': 'auto',
        ...
        layout = {'justify-content':'center', 'align-items':'center','align-contents':'center',
                  'border':'3px solid #FFCC00', 'width': 'auto', 'height': 'auto'}
        ...
        layout = {'width':'60%'}
        self.hs['AlignReconOptnSliRange sldr'] = widgets.IntRangeSlider(description='z range', value=[0, 1], min=0, max=10, disabled=True,
                                                                        description_tooltip='In the case of reading and reviewing a registration file, you need to define slice start and end.')
