...
#            self.to_azure_blob2(model_dir)
    ...
    def save_to_azure(self, container_name):
        ...
        local_config_file = os.path.join(model_path, DNN_MODEL_FOLDER_NAME, 'model_config.json')
        local_model_file = os.path.join(model_path, DNN_MODEL_FOLDER_NAME, self.get_parameter("model-name"))
