...
class PIH:
            ...
            def by_group(group: CONST.AD.Groups) -> bool:
                ...
                if user_list is not None:
                    for user in user_list:
                        if user.samAccountName == PIH.SESSION.login:
                            return True
                return False
    ...
    class MESSAGE:
        ...
        class COMMAND:
            ...
            @staticmethod
            def login() -> bool:
                return PIH.message_command(LogCommands.LOG_IN, (PIH.SESSION.login, PIH.OS.get_host_name()))
            ...
            def it_notify_about_new_user(login: str, password: str) -> bool:
                ...
                me_user_login: str = PIH.SESSION.login
                it_user_list = list(
    ...
    class ACTION:
        ...
        class TIME_TRACKING:
            ...
            def report(path: str, start_date: datetime, end_date: datetime, tab_number: str = None) -> bool:
                ...
                return DataTools.rpc_unrepresent(RPC_COMMANDS.DOCS.create_time_tracking_report(PathTools.convert_to_lan_path(path, PIH.OS.get_host_name()), start_date, end_date, tab_number))
