...
from pih.collection import T, FieldItem, FieldItemList, FullName, LoginPasswordPair, Result
...
class PathTools:
    ...
    @staticmethod
    def convert_to_lan_path(value: str, host_nane: str) -> str:
        lan_adress: str = f"//{host_nane}/"
        if value[1] == ":":
            value = f"{lan_adress}{value[0]}${value[2:]}"
        return value
