...
class loadprojectini:
    def __init__(self,configini):
        ...
        resolution_entry.grid(row=10, sticky=W)
        create_frm_cb.grid(row=11, column=0, sticky=W)
        create_video_cb.grid(row=11, column=1, sticky=W)
        button_mergeframe.grid(row=12,sticky=W)
