import { S as SvelteComponent, i as init, s as safe_not_equal, A as empty, f as insert, n as detach, p as create_slot, e as element, a as space, b as attr, g as append, a7 as update_keyed_each, u as update_slot_base, q as get_all_dirty_from_scope, r as get_slot_changes, j as transition_in, k as transition_out, O as component_subscribe, E as createEventDispatcher, Z as setContext, ak as destroy_block, $ as writable, _ as set_store_value, t as text, l as listen, h as set_data } from './index.4872dbae.js';
...
function create_else_block(ctx) {
	...
	return {
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty & /*tabs*/ 2 && t0_value !== (t0_value = /*t*/ ctx[10].name + "")) set_data(t0, t0_value);
		},
		d(detaching) {
...
function create_fragment(ctx) {
	...
	return {
		...
		p(ctx, [dirty]) {
			if (dirty & /*tabs, $selected_tab, change_tab*/ 22) {
...
class Tabs extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance, create_fragment, safe_not_equal, { elem_id: 0, selected: 5 });
	}
}
