import { S as SvelteComponent, i as init, s as safe_not_equal, v as svg_element, b as attr, f as insert, g as append, w as noop, n as detach, e as element, L as src_url_equal, E as createEventDispatcher, a9 as onMount, H as binding_callbacks, aa as add_render_callback, af as create_bidirectional_transition, Y as set_style, l as listen, z as run_all, a as space, ad as add_resize_listener, j as transition_in, C as group_outros, k as transition_out, D as check_outros, B as destroy_each, I as onDestroy, a6 as tick, ag as fade, c as create_component, m as mount_component, o as destroy_component, a3 as set_input_value, ah as to_number, d as toggle_class, A as empty, K as add_flush_callback, N as bind, t as text, h as set_data, O as component_subscribe, X, P as assign, Q as StatusTracker, R as get_spread_update, T as get_spread_object, J as bubble } from './index.9d2aeb7b.js';
import { B as BlockLabel } from './BlockLabel.0e1e8ae1.js';
import { I as Image } from './Image.a02c1463.js';
import { C as Cropper, i as index, W as Webcam } from './Webcam.ee22e330.js';
import { I as IconButton, C as Clear, M as ModifyUpload } from './ModifyUpload.378b1636.js';
import { U as Upload } from './Upload.4e5384a4.js';
import { B as Block } from './Block.abfd6a60.js';
export { E as ExampleComponent } from './Image.0b186178.js';
...
function get_each_context(ctx, list, i) {
	...
	child_ctx[52] = list[i].zIndex;
	child_ctx[53] = list;
	child_ctx[54] = i;
	return child_ctx;
}

// (462:1) {#if line_count === 0}
...
// (470:1) {#each canvas_types as { name, zIndex }}
function create_each_block(ctx) {
	let canvas_1;
	let canvas_1_key_value;
	let name = /*name*/ ctx[51];
	let mounted;
	let dispose;
	const assign_canvas_1 = () => /*canvas_1_binding*/ ctx[22](canvas_1, name);
	const unassign_canvas_1 = () => /*canvas_1_binding*/ ctx[22](null, name);

	return {
		c() {
			canvas_1 = element("canvas");
			attr(canvas_1, "key", canvas_1_key_value = /*name*/ ctx[51]);
			attr(canvas_1, "class", "inset-0 m-auto hover:cursor-none");
			set_style(canvas_1, "display", "block");
			set_style(canvas_1, "position", "absolute");
			set_style(canvas_1, "z-index", /*zIndex*/ ctx[52]);
		},
		m(target, anchor) {
			...
			if (!mounted) {
				dispose = [
					listen(canvas_1, "mousedown", /*name*/ ctx[51] === "interface"
					? /*handle_draw_start*/ ctx[6]
					: undefined),
					listen(canvas_1, "mousemove", /*name*/ ctx[51] === "interface"
					? /*handle_draw_move*/ ctx[7]
					: undefined),
					listen(canvas_1, "mouseup", /*name*/ ctx[51] === "interface"
					? /*handle_draw_end*/ ctx[8]
					: undefined),
					listen(canvas_1, "mouseout", /*name*/ ctx[51] === "interface"
					? /*handle_draw_end*/ ctx[8]
					: undefined),
					listen(canvas_1, "blur", /*name*/ ctx[51] === "interface"
					? /*handle_draw_end*/ ctx[8]
					: undefined),
					listen(canvas_1, "touchstart", /*name*/ ctx[51] === "interface"
					? /*handle_draw_start*/ ctx[6]
					: undefined),
					listen(canvas_1, "touchmove", /*name*/ ctx[51] === "interface"
					? /*handle_draw_move*/ ctx[7]
					: undefined),
					listen(canvas_1, "touchend", /*name*/ ctx[51] === "interface"
					? /*handle_draw_end*/ ctx[8]
					: undefined),
					listen(canvas_1, "touchcancel", /*name*/ ctx[51] === "interface"
					? /*handle_draw_end*/ ctx[8]
					: undefined)
				];
...
function instance$5($$self, $$props, $$invalidate) {
	...
	onMount(() => {
		...
		$$invalidate(21, lazy = new LazyBrush({
	...
	let saveLine = () => {
		...
		lines.push({ points, brush_color, brush_radius });
	...
	$$self.$$set = $$props => {
		...
		if ('container_height' in $$props) $$invalidate(16, container_height = $$props.container_height);
	};

	$$self.$$.update = () => {
		if ($$self.$$.dirty[0] & /*mounted, value*/ 1049600) {
			mounted && !value && clear();
		}

		if ($$self.$$.dirty[0] & /*lazy, brush_radius*/ 2097664) {
			{
				if (lazy) {
		...
		if ($$self.$$.dirty[0] & /*width, height*/ 49152) {
			{
				if (width || height) {
...
function create_if_block_1$1(ctx) {
	...
	return {
		c() {
			...
			attr(input, "min", input_min_value = 0.5 * (/*img_width*/ ctx[2] / /*width*/ ctx[5]));
			attr(input, "max", input_max_value = 75 * (/*img_width*/ ctx[2] / /*width*/ ctx[5]));
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			if (dirty & /*img_width, width*/ 36 && input_min_value !== (input_min_value = 0.5 * (/*img_width*/ ctx[2] / /*width*/ ctx[5]))) {
				attr(input, "min", input_min_value);
			}

			if (dirty & /*img_width, width*/ 36 && input_max_value !== (input_max_value = 75 * (/*img_width*/ ctx[2] / /*width*/ ctx[5]))) {
...
function create_fragment$3(ctx) {
	...
	let t2;
	let current;
	iconbutton0 = new IconButton({ props: { Icon: Brush } });
	iconbutton0.$on("click", /*click_handler*/ ctx[8]);
	let if_block0 = /*show_size*/ ctx[3] && create_if_block_1$1(ctx);
	iconbutton1 = new IconButton({ props: { Icon: Color } });
	iconbutton1.$on("click", /*click_handler_1*/ ctx[10]);
	let if_block1 = /*show_col*/ ctx[4] && create_if_block$3(ctx);
	...
	return {
		c() {
			...
			attr(span0, "class", "absolute top-0 right-0");
			attr(span1, "class", "absolute top-6 right-0");
...
function instance$3($$self, $$props, $$invalidate) {
	...
	const click_handler = () => $$invalidate(3, show_size = !show_size);
	...
	const click_handler_1 = () => $$invalidate(4, show_col = !show_col);
	...
	$$self.$$set = $$props => {
		...
		if ('container_height' in $$props) $$invalidate(6, container_height = $$props.container_height);
		if ('img_width' in $$props) $$invalidate(2, img_width = $$props.img_width);
		if ('img_height' in $$props) $$invalidate(7, img_height = $$props.img_height);
	};

	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*container_height, img_width, img_height*/ 196) {
			$$invalidate(5, width = container_height * (img_width / img_height));
		}
	};
...
function create_if_block_7(ctx) {
	let previous_key = /*static_image*/ ctx[21] || /*value*/ ctx[0];
	let t;
	let if_block_anchor;
	let current;
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty[0] & /*static_image, value*/ 2097153 && safe_not_equal(previous_key, previous_key = /*static_image*/ ctx[21] || /*value*/ ctx[0])) {
				key_block.d(1);
...
function create_if_block_5(ctx) {
	...
	modifyupload.$on("clear", /*clear_handler_1*/ ctx[36]);
...
function create_if_block_8(ctx) {
	...
	function sketch_1_brush_radius_binding_1(value) {
		/*sketch_1_brush_radius_binding_1*/ ctx[40](value);
	}

	function sketch_1_brush_color_binding_1(value) {
		/*sketch_1_brush_color_binding_1*/ ctx[41](value);
	}
	...
	sketch_1 = new Sketch({ props: sketch_1_props });
	/*sketch_1_binding_1*/ ctx[39](sketch_1);
	...
	sketch_1.$on("change", /*handle_save*/ ctx[25]);
	modifysketch = new ModifySketch({});
	modifysketch.$on("undo", /*undo_handler_1*/ ctx[42]);
	modifysketch.$on("clear", /*handle_mask_clear*/ ctx[27]);
	let if_block = /*tool*/ ctx[1] === "color-sketch" && create_if_block_9(ctx);
	...
	return {
		...
		d(detaching) {
			/*sketch_1_binding_1*/ ctx[39](null);
			destroy_component(sketch_1, detaching);
			if (detaching) detach(t0);
			destroy_component(modifysketch, detaching);
			if (detaching) detach(t1);
...
function create_if_block_9(ctx) {
	...
	function sketchsettings_brush_radius_binding_1(value) {
		/*sketchsettings_brush_radius_binding_1*/ ctx[43](value);
	}

	function sketchsettings_brush_color_binding_1(value) {
		/*sketchsettings_brush_color_binding_1*/ ctx[44](value);
	}
...
function create_if_block_4(ctx) {
	...
	webcam.$on("capture", /*handle_save*/ ctx[25]);
...
function create_if_block_3(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			...
			if (dirty[0] & /*upload_text, or_text, drop_text*/ 224 | dirty[1] & /*$$scope*/ 65536) {
...
// (143:3) <Upload     bind:dragging     filetype="image/x-png,image/gif,image/jpeg"     on:load={handle_upload}     include_file_metadata={false}    >
...
function create_fragment$2(ctx) {
	...
	return {
		c() {
			...
			add_render_callback(() => /*div_elementresize_handler*/ ctx[45].call(div));
		...
		m(target, anchor) {
			...
			div_resize_listener = add_resize_listener(div, /*div_elementresize_handler*/ ctx[45].bind(div));
			current = true;
		},
		p(ctx, dirty) {
...
function instance$2($$self, $$props, $$invalidate) {
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty[0] & /*mode*/ 4096) {
			$$invalidate(22, brush_color = mode == "mask" ? "#000000A6" : "#000");
		}
	};
