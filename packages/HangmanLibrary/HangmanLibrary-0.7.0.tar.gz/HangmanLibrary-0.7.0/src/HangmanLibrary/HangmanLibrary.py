...
def VerifyIfLetterInWord(word, letter, listOfRightLetters, attempts, listOfUsedLetters = False):
    """
    Verifies if the guessed letter is in the word. It will also update the list with the already guesses letters as well as the remaining attempts and, if the program needs it, the list with the wrong guesses letters. It will always return the numbers of attempts 
    """
