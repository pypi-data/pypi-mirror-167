...
def h5_to_U_array_contacts_transfer(c, h5_file, pred_array, replace_missing_data_with =-1):
    """
...
def U_array_to_h5_contacts_transfer(c, h5_file, replace_missing_data_with =-1):
    """
    note if you want the index instead use...
...
def h5_to_dict(h5_in, exclude_keys=[]):
    d = dict()
