...
def try_init():
    try:
            ...
            if key.startswith("kaskada."):
                for cls in inspect.getmembers(mods[key], inspect.isclass):
                    ...
                    if (
                        ...
                        )  # kda_table formatter for QueryResponse
        ...
        html_formatter.for_type(
            "kaskada.api.v1alpha.materialization_pb2.RedisAI", generic_object_html_formatter
        )
        html_formatter.for_type(
            "kaskada.api.v1alpha.materialization_pb2.Destination", generic_object_html_formatter
        )
        html_formatter.for_type(
