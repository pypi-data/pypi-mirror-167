...
class PublicAPI(Client):
    ...
    def __init__(self, api_key='-1', api_secret_key='-1', passphrase='-1', use_server_time=False, flag='1', base_api = 'https://www.okx.com'):
        Client.__init__(self, api_key, api_secret_key, passphrase, use_server_time, flag, base_api)
    ...
    def get_delivery_exercise_history(self, instType, uly, after='', before='', limit=''):
    ...
    # Get Tier
    def get_position_tiers(self, instType, tdMode, uly='', instId='', ccy='', tier=''):
