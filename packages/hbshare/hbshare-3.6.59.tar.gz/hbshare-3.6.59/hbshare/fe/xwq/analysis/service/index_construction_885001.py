...
if __name__ == '__main__':
    ...
    ax1 = ax[1]
    ax2 = ax[1].twinx()
    sns.lineplot(ax=ax0, x='报告日期', y='885001（考虑申赎）', data=index, label='885001（考虑申赎）', color='#F04950')
    sns.lineplot(ax=ax0, x='报告日期', y='885001', data=index, label='885001', color='#6268A2')
    sns.lineplot(ax=ax1, x='报告日期', y='规模（亿元）', data=scale, label='规模（亿元）', color='#F04950')
