...
class Ui_boot_MainWindow(object):
    def setupUi(self, boot_MainWindow):
        ...
        boot_MainWindow.resize(797, 614)
        ...
        self.i2c_mode__radioButton.setGeometry(QRect(20, 70, 95, 20))
        ...
        self.update_app_part_radio.setGeometry(QRect(180, 120, 251, 20))
        ...
        self.update_and_run_checkbutton.setGeometry(QRect(480, 70, 221, 20))
        self.update_app_Button = QPushButton(self.centralwidget)
        self.update_app_Button.setObjectName(u"update_app_Button")
        self.update_app_Button.setGeometry(QRect(20, 170, 141, 24))
        ...
        self.iap_usermanual_TextEdit.setGeometry(QRect(20, 210, 391, 141))
        self.app_check_codeEdit = QLineEdit(self.centralwidget)
        self.app_check_codeEdit.setObjectName(u"app_check_codeEdit")
        self.app_check_codeEdit.setGeometry(QRect(430, 210, 271, 20))
        ...
        self.bootloader_versionEdit.setGeometry(QRect(430, 250, 271, 20))
        ...
        self.update_sucess_timeEdit.setGeometry(QRect(430, 290, 271, 20))
        ...
        self.clean_informaiton_Button.setGeometry(QRect(430, 330, 121, 24))
        self.clean_informaiton_Button.setCursor(QCursor(Qt.ArrowCursor))
        self.information_textEdit = QTextEdit(self.centralwidget)
        self.information_textEdit.setObjectName(u"information_textEdit")
        self.information_textEdit.setGeometry(QRect(10, 370, 771, 171))
        self.update_progressBar = QProgressBar(self.centralwidget)
        self.update_progressBar.setObjectName(u"update_progressBar")
        self.update_progressBar.setGeometry(QRect(10, 550, 781, 23))
        ...
        self.autoupdate_app_Button = QPushButton(self.centralwidget)
        self.autoupdate_app_Button.setObjectName(u"autoupdate_app_Button")
        self.autoupdate_app_Button.setGeometry(QRect(420, 170, 111, 24))
        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(560, 180, 71, 16))
        self.fail_time_label = QLabel(self.centralwidget)
        self.fail_time_label.setObjectName(u"fail_time_label")
        self.fail_time_label.setGeometry(QRect(620, 180, 54, 16))
    ...
    def retranslateUi(self, boot_MainWindow):
        boot_MainWindow.setWindowTitle(QCoreApplication.translate("boot_MainWindow", u"MainWindow", None))
        ...
        self.autoupdate_app_Button.setText(QCoreApplication.translate("boot_MainWindow", u"\u81ea\u52a8\u8fde\u7eed\u5347\u7ea7", None))
        self.label.setText(QCoreApplication.translate("boot_MainWindow", u"\u5931\u8d25\u6b21\u6570\uff1a", None))
        self.fail_time_label.setText(QCoreApplication.translate("boot_MainWindow", u"0", None))
    # retranslateUi
