...
from ..models.transfer_destination_container_contents import TransferDestinationContainerContents
...
class ContainerTransfer:
    ...
    _destination_contents: TransferDestinationContainerContents
    ...
    def to_dict(self) -> Dict[str, Any]:
        destination_contents = self._destination_contents.to_dict()
        ...
        field_dict.update(
            {
                "destinationContents": destination_contents,
            }
        )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_destination_contents() -> TransferDestinationContainerContents:
            destination_contents = TransferDestinationContainerContents.from_dict(
                d.pop("destinationContents")
            )
        ...
        destination_contents = (
            ...
            else cast(TransferDestinationContainerContents, UNSET)
        )
    ...
    @property
    def destination_contents(self) -> TransferDestinationContainerContents:
    ...
    def destination_contents(self, value: TransferDestinationContainerContents) -> None:
