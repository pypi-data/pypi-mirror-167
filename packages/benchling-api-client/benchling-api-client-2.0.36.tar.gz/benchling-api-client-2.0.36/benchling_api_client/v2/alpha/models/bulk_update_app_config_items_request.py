...
from ..models.bulk_update_app_config_item import BulkUpdateAppConfigItem
from ..types import UNSET, Unset

T = TypeVar("T", bound="BulkUpdateAppConfigItemsRequest")


@attr.s(auto_attribs=True, repr=False)
class BulkUpdateAppConfigItemsRequest:
    """  """

    _app_configuration_items: List[BulkUpdateAppConfigItem]
    ...
    def __repr__(self):
        ...
        return "BulkUpdateAppConfigItemsRequest({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        def get_app_configuration_items() -> List[BulkUpdateAppConfigItem]:
            app_configuration_items = []
            _app_configuration_items = d.pop("appConfigurationItems")
            for app_configuration_items_item_data in _app_configuration_items:
                app_configuration_items_item = BulkUpdateAppConfigItem.from_dict(
        ...
        app_configuration_items = (
            ...
            else cast(List[BulkUpdateAppConfigItem], UNSET)
        )

        bulk_update_app_config_items_request = cls(
            app_configuration_items=app_configuration_items,
        )

        bulk_update_app_config_items_request.additional_properties = d
        return bulk_update_app_config_items_request
    ...
    @property
    def app_configuration_items(self) -> List[BulkUpdateAppConfigItem]:
    ...
    def app_configuration_items(self, value: List[BulkUpdateAppConfigItem]) -> None:
