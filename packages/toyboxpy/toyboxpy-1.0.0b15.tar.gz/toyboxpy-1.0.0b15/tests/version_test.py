...
class TestVersion(unittest.TestCase):
    ...
    def test_Version(self):
        ...
        version = Version('/This/Is/My/Folder')
        self.assertEqual(version.operator, VersionIs.equal)
        self.assertEqual(str(version), '/This/Is/My/Folder(local)')
        self.assertEqual(version.original_version, '/This/Is/My/Folder')
        self.assertTrue(version.isLocal())

        rel_path = os.path.expanduser('~/This/Is/My/Folder')
        ...
        self.assertTrue(version.original_version[0], '/')
        self.assertTrue(version.isLocal())
    ...
    def test_operatorEqual(self):
        ...
        self.assertTrue(Version('toto') == Version('toto'))
        self.assertTrue(Version('/This/Is/My/Folder') == Version('/This/Is/My/Folder'))

        self.assertFalse(Version('toto') == Version('main'))
        self.assertFalse(Version('/This/Is/My/Folder') == Version('main'))
    ...
    def test_maybeRangeFromIncompleteNumericVersion(self):
        ...
        versions = Version.maybeRangeFromIncompleteNumericVersion('/This/Is/My/Folder')
        self.assertEqual(len(versions), 1)
        self.assertEqual(versions[0], '/This/Is/My/Folder')
    ...
    def test_includes(self):
        ...
        self.assertTrue(Version('/This/Is/My/Folder').includes(Version('/This/Is/My/Folder')))
        self.assertFalse(Version('/This/Is/My/Folder').includes(Version('/This/Is/anothery/Folder')))
        self.assertFalse(Version('/This/Is/My/Folder').includes(Version('3.4.2')))
    ...
    def test_includedVersionsIn(self):
        ...
        localVersion = Version('/This/Is/My/Folder')
