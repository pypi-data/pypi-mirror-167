...
class Files:
    ...
    def generateLuaIncludeFile(cls, dependencies):
        ...
        for dep in dependencies:
            ...
            lua_include_path = Files.findLuaIncludeFileIn(dep_folder, dep.repo_name, maybe_lua_include_path)
    ...
    def generateMakefile(cls, dependencies):
        ...
        for dep in dependencies:
            dep_folder = Paths.toyboxFolderFor(dep)
            makefile_path = Files.findMakefileIn(dep_folder, dep.repo_name)
    ...
    def generateIncludeFile(cls, dependencies):
        ...
        for dep in dependencies:
            dep_folder = Paths.toyboxFolderFor(dep)
            include_file_path = Files.findIncludeFileIn(dep_folder, dep.repo_name)
