...
class Node:
    def __init__(self, value=None):
        if isinstance(value, str):
            ...
            raise NodeValueException("Unsupported value")
        self.value = value
    ...
    def calc(self):
        if self.value is not None:
            ...
            raise NodeValueException("Can't calc an empty Node")
...
class IdentifierNode(Node):
    ...
    def calc(self):
        if self.value is not None:
            ...
            raise UnspecifiedIdentifierException("Can't calc a value with an unspecified identifier")
