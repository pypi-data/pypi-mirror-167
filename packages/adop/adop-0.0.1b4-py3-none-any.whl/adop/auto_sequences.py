...
def client_install_zip_sequence(
    ...
    for root, shasum in requires_data.items():
        ...
        if state_config.has_option(root, "source_hash"):
            if state_config.get(root, "source_hash") == cache_id:
        ...
        yield from unpack_payload.unpack(cache_file, install_root)
        ...
        yield f"{root} installation complete."
