...
from stf_client import rest
from stf_client.configuration import Configuration
from stf_client.exceptions import ApiTypeError, ApiValueError, ApiException
from stf_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance.add_origin_group_device  # this is an instance of the class Endpoint
        api_instance.add_origin_group_device()  # this invokes api_instance.add_origin_group_device.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.add_origin_group_device.callable or self.callable in this class
