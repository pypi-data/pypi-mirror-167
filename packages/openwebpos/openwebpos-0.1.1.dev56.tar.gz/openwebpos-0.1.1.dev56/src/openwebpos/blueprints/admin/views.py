...
@bp.post('/menu/<int:menu_id>/update')
...
@bp.get('/menu/<int:menu_id>/delete')
...
@bp.get('/menu/<string:menu_name>/items')
...
@bp.post('/menu/<string:menu_name>/items')
...
@bp.route('/menu/<string:menu_name>/item/<string:menu_item_name>/edit',
          methods=['GET', 'POST'])
