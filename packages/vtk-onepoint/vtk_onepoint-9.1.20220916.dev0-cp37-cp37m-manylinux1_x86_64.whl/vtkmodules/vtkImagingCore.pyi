...
VTK_IMAGE_BORDER_CLAMP:int
VTK_IMAGE_BORDER_MIRROR:int
VTK_IMAGE_BORDER_REPEAT:int
...
class vtkAbstractImageInterpolator(vtkmodules.vtkCommonCore.vtkObject):
    def CheckBoundsIJK(self, x:(float, float, float)) -> bool: ...
    def ComputeNumberOfComponents(self, inputComponents:int) -> int: ...
    def ComputeSupportSize(self, matrix:(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float), support:[int, int, int]) -> None: ...
    ...
    def GetExtent(self) -> (int, int, int, int, int, int): ...
    ...
    @overload
    def Interpolate(self, point:(float, float, float), value:[float, ...]) -> bool: ...
    def InterpolateIJK(self, point:(float, float, float), value:[float, ...]) -> None: ...
    ...
    def SetBorderMode(self, mode:int) -> None: ...
...
class vtkImageInterpolator(vtkAbstractImageInterpolator):
    def ComputeSupportSize(self, matrix:(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float), size:[int, int, int]) -> None: ...
...
class vtkImageBSplineCoefficients(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    def CheckBounds(self, point:(float, float, float)) -> int: ...
    @overload
    def Evaluate(self, point:(float, float, float), value:[float, ...]) -> None: ...
    @overload
    def Evaluate(self, x:float, y:float, z:float) -> float: ...
    @overload
    def Evaluate(self, point:(float, float, float)) -> float: ...
    def GetBorderMode(self) -> int: ...
    def GetBorderModeAsString(self) -> str: ...
...
class vtkImageBSplineInternals(object):
    @staticmethod
    def ConvertToInterpolationCoefficients(data:[float, ...], size:int, border:int, poles:[float, float, float, float], numPoles:int, tol:float) -> None: ...
    @staticmethod
    def GetInterpolationWeights(weights:[float, float, float, float, float, float, float, float, float, float], w:float, degree:int) -> int: ...
    @staticmethod
    def GetPoleValues(poles:[float, float, float, float], numPoles:int, degree:int) -> int: ...
    @staticmethod
    def InterpolatedValue(coeffs:(float, ...), value:[float, ...], width:int, height:int, slices:int, depth:int, x:float, y:float, z:float, degree:int, border:int) -> int: ...
...
class vtkImageChangeInformation(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    def GetExtentTranslation(self) -> (int, int, int): ...
    def GetInformationInput(self) -> 'vtkImageData': ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetOriginScale(self) -> (float, float, float): ...
    def GetOriginTranslation(self) -> (float, float, float): ...
    def GetOutputExtentStart(self) -> (int, int, int): ...
    def GetOutputOrigin(self) -> (float, float, float): ...
    def GetOutputSpacing(self) -> (float, float, float): ...
    def GetSpacingScale(self) -> (float, float, float): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkImageClip(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @overload
    def GetOutputWholeExtent(self) -> (int, int, int, int, int, int): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkImagePadFilter(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @overload
    def SetOutputWholeExtent(self, extent:[int, int, int, int, int, int]) -> None: ...
    @overload
    def SetOutputWholeExtent(self, minX:int, maxX:int, minY:int, maxY:int, minZ:int, maxZ:int) -> None: ...
...
class vtkImageDecomposeFilter(vtkImageIterateFilter):
    ...
    def PermuteExtent(self, extent:[int, ...], min0:int, max0:int, min1:int, max1:int, min2:int, max2:int) -> None: ...
    def PermuteIncrements(self, increments:[int, ...], inc0:int, inc1:int, inc2:int) -> None: ...
    @staticmethod
...
class vtkImageDifference(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @overload
    def GetError(self, e:[float, ...]) -> None: ...
    ...
    @overload
    def GetThresholdedError(self, e:[float, ...]) -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkImageExtractComponents(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    def GetComponents(self) -> (int, int, int): ...
    def GetNumberOfComponents(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
...
class vtkImageReslice(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    def GetBackgroundColor(self) -> (float, float, float, float): ...
    ...
    def GetOutputExtent(self) -> (int, int, int, int, int, int): ...
    def GetOutputOrigin(self) -> (float, float, float): ...
    def GetOutputScalarType(self) -> int: ...
    def GetOutputSpacing(self) -> (float, float, float): ...
    def GetResliceAxes(self) -> 'vtkMatrix4x4': ...
    @overload
    def GetResliceAxesDirectionCosines(self, x:[float, float, float], y:[float, float, float], z:[float, float, float]) -> None: ...
    @overload
    def GetResliceAxesDirectionCosines(self, xyz:[float, float, float, float, float, float, float, float, float]) -> None: ...
    @overload
    def GetResliceAxesDirectionCosines(self) -> (float, float, float, float, float, float, float, float, float): ...
    @overload
    def GetResliceAxesOrigin(self, xyz:[float, float, float]) -> None: ...
    @overload
    def GetResliceAxesOrigin(self) -> (float, float, float): ...
    ...
    @overload
    def SetBackgroundColor(self, _arg:(float, float, float, float)) -> None: ...
    ...
    @overload
    def SetResliceAxesDirectionCosines(self, x:(float, float, float), y:( float, float, float), z:(float, float, float)) -> None: ...
    @overload
    def SetResliceAxesDirectionCosines(self, xyz:(float, float, float, float, float, float, float, float, float)) -> None: ...
    @overload
    def SetResliceAxesOrigin(self, x:float, y:float, z:float) -> None: ...
    @overload
    def SetResliceAxesOrigin(self, xyz:(float, float, float)) -> None: ...
...
class vtkImageMagnify(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    def GetInterpolate(self) -> int: ...
    def GetMagnificationFactors(self) -> (int, int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def InterpolateOff(self) -> None: ...
    ...
    @overload
    def SetMagnificationFactors(self, _arg:(int, int, int)) -> None: ...
...
class vtkImageMapToColors(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    def GetMTime(self) -> int: ...
    def GetNaNColor(self) -> (int, int, int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    @overload
    def SetNaNColor(self, _arg:(int, int, int, int)) -> None: ...
...
class vtkImageMask(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @overload
    def SetMaskedOutputValue(self, num:int, v:[float, ...]) -> None: ...
    @overload
...
class vtkImagePermute(vtkImageReslice):
    def GetFilteredAxes(self) -> (int, int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def IsA(self, type:str) -> int: ...
    ...
    @overload
    def SetFilteredAxes(self, xyz:(int, int, int)) -> None: ...

class vtkImagePointDataIterator(object):
    @overload
    def __init__(self) -> None: ...
    @overload
    def __init__(self, image:'vtkImageData', extent:(int, int, int, int, int, int)=..., stencil:'vtkImageStencilData'=..., algorithm:'vtkAlgorithm'=..., threadId:int=0) -> None: ...
    @overload
    def __init__(self, __a:'vtkImagePointDataIterator') -> None: ...
    def GetId(self) -> int: ...
    @overload
    def GetIndex(self, result:[int, int, int]) -> None: ...
    @overload
    def GetIndex(self) -> (int, int, int): ...
    @overload
    @staticmethod
    def GetVoidPointer(image:'vtkImageData', i:int=0, pixelIncrement:[int, ...]=...) -> Pointer: ...
    @overload
    @staticmethod
    def GetVoidPointer(array:'vtkDataArray', i:int=0, pixelIncrement:[int, ...]=...) -> Pointer: ...
    def Initialize(self, image:'vtkImageData', extent:(int, int, int, int, int, int)=..., stencil:'vtkImageStencilData'=..., algorithm:'vtkAlgorithm'=..., threadId:int=0) -> None: ...
...
class vtkImagePointIterator(vtkImagePointDataIterator):
    ...
    @overload
    def GetPosition(self, x:[float, float, float]) -> None: ...
    def Initialize(self, image:'vtkImageData', extent:(int, int, int, int, int, int)=..., stencil:'vtkImageStencilData'=..., algorithm:'vtkAlgorithm'=..., threadId:int=0) -> None: ...
    def IsAtEnd(self) -> bool: ...
    def Next(self) -> None: ...
    def NextSpan(self) -> None: ...
...
class vtkImageResample(vtkImageReslice):
    ...
    def GetDimensionality(self) -> int: ...
    def GetMagnificationFactors(self) -> (float, float, float): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def IsA(self, type:str) -> int: ...
    ...
    @overload
    def SetMagnificationFactors(self, f:(float, float, float)) -> None: ...
    @overload
    def SetOutputSpacing(self, sx:float, sy:float, sz:float) -> None: ...
    @overload
    def SetOutputSpacing(self, spacing:(float, float, float)) -> None: ...
...
class vtkImageResize(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    def GetCroppingRegion(self) -> (float, float, float, float, float, float): ...
    def GetInterpolate(self) -> int: ...
    def GetInterpolator(self) -> 'vtkAbstractImageInterpolator': ...
    def GetMTime(self) -> int: ...
    def GetMagnificationFactors(self) -> (float, float, float): ...
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetOutputDimensions(self) -> (int, int, int): ...
    def GetOutputSpacing(self) -> (float, float, float): ...
    ...
    @overload
    def SetCroppingRegion(self, _arg:(float, float, float, float, float, float)) -> None: ...
    def SetInterpolate(self, _arg:int) -> None: ...
    def SetInterpolator(self, sampler:'vtkAbstractImageInterpolator') -> None: ...
    @overload
    def SetMagnificationFactors(self, _arg1:float, _arg2:float, _arg3:float) -> None: ...
    @overload
    def SetMagnificationFactors(self, _arg:(float, float, float)) -> None: ...
    @overload
    def SetOutputDimensions(self, _arg1:int, _arg2:int, _arg3:int) -> None: ...
    @overload
    def SetOutputDimensions(self, _arg:(int, int, int)) -> None: ...
    @overload
    def SetOutputSpacing(self, _arg1:float, _arg2:float, _arg3:float) -> None: ...
    @overload
    def SetOutputSpacing(self, _arg:(float, float, float)) -> None: ...
...
class vtkImageShrink3D(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetShift(self) -> (int, int, int): ...
    def GetShrinkFactors(self) -> (int, int, int): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @overload
    def SetShift(self, _arg:(int, int, int)) -> None: ...
    @overload
    def SetShrinkFactors(self, _arg1:int, _arg2:int, _arg3:int) -> None: ...
    @overload
    def SetShrinkFactors(self, _arg:(int, int, int)) -> None: ...
...
class vtkImageSincInterpolator(vtkAbstractImageInterpolator):
    ...
    @overload
    def GetBlurFactors(self, f:[float, float, float]) -> None: ...
    @overload
    def GetBlurFactors(self) -> (float, float, float): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    @overload
    def SetBlurFactors(self, f:(float, float, float)) -> None: ...
...
class vtkImageStencilData(vtkmodules.vtkCommonDataModel.vtkDataObject):
    ...
    def Clip(self, extent:[int, int, int, int, int, int]) -> int: ...
    ...
    @overload
    def SetExtent(self, extent:(int, int, int, int, int, int)) -> None: ...
    @overload
...
class vtkImageStencilRaster(object):
    def __init__(self, wholeExtent:(int, int)) -> None: ...
    def FillStencilData(self, data:'vtkImageStencilData', extent:(int, int, int, int, int, int), xj:int=0, yj:int=1) -> None: ...
    def GetTolerance(self) -> float: ...
    def InsertLine(self, pt1:(float, float), pt2:(float, float)) -> None: ...
    def PrepareForNewData(self, allocateExtent:(int, int)=...) -> None: ...
    def SetTolerance(self, tol:float) -> None: ...
...
class vtkImageStencilSource(vtkImageStencilAlgorithm):
    ...
    @overload
    def SetOutputWholeExtent(self, _arg:(int, int, int, int, int, int)) -> None: ...
...
class vtkImageTranslateExtent(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetTranslation(self) -> (int, int, int): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @overload
    def SetTranslation(self, _arg:(int, int, int)) -> None: ...
