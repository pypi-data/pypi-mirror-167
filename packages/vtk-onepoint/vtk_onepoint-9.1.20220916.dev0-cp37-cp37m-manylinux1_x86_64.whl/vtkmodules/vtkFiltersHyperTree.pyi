...
class vtkHyperTreeGridAxisClip(vtkmodules.vtkCommonExecutionModel.vtkHyperTreeGridAlgorithm):
    ...
    def GetMaximumBounds(self, __a:[float, float, float]) -> None: ...
    def GetMinimumBounds(self, __a:[float, float, float]) -> None: ...
...
class vtkHyperTreeGridContour(vtkmodules.vtkCommonExecutionModel.vtkHyperTreeGridAlgorithm):
    ...
    @overload
    def GenerateValues(self, __a:int, __b:[float, float]) -> None: ...
    @overload
    ...
    @overload
    def GetValues(self, __a:[float, ...]) -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkHyperTreeGridPlaneCutter(vtkmodules.vtkCommonExecutionModel.vtkHyperTreeGridAlgorithm):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetPlane(self) -> (float, float, float, float): ...
    def IsA(self, type:str) -> int: ...
