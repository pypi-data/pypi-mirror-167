...
class vtkNamedColors(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def GetColor(self, name:str, rgba:[int, int, int, int]) -> None: ...
    @overload
    def GetColor(self, name:str, rgba:'vtkColor4ub') -> None: ...
    @overload
    def GetColor(self, name:str, r:float, g:float, b:float, a:float) -> None: ...
    @overload
    def GetColor(self, name:str, rgba:[float, float, float, float]) -> None: ...
    @overload
    ...
    def GetColorRGB(self, name:str, rgb:[float, float, float]) -> None: ...
    def GetNumberOfColors(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    @overload
    def SetColor(self, name:str, rgba:(int, int, int, int)) -> None: ...
    @overload
    def SetColor(self, name:str, rgba:'vtkColor4ub') -> None: ...
    @overload
    def SetColor(self, name:str, rgb:'vtkColor3ub') -> None: ...
    @overload
    def SetColor(self, name:str, rgba:(float, float, float, float)) -> None: ...
    @overload
