...
class vtkBlockItem(vtkContextItem):
    ...
    @overload
    def SetDimensions(self, _arg:(float, float, float, float)) -> None: ...
    ...
    @overload
    def SetMargins(self, _arg:(int, int)) -> None: ...
    @overload
    def SetPadding(self, _arg1:int, _arg2:int) -> None: ...
    @overload
    def SetPadding(self, _arg:(int, int)) -> None: ...
...
class vtkBrush(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def GetColor(self, color:[int, int, int, int]) -> None: ...
    @overload
    def GetColor(self) -> Pointer: ...
    def GetColorF(self, color:[float, float, float, float]) -> None: ...
    ...
    @overload
    def SetColor(self, color:[int, int, int]) -> None: ...
    @overload
    ...
    @overload
    def SetColorF(self, color:[float, float, float]) -> None: ...
    @overload
...
class vtkContext2D(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def ComputeJustifiedStringBounds(self, string:str, bounds:[float, float, float, float]) -> None: ...
    @overload
    def ComputeStringBounds(self, string:str, bounds:'vtkPoints2D') -> None: ...
    @overload
    def ComputeStringBounds(self, string:str, bounds:[float, float, float, float]) -> None: ...
    ...
    @overload
    def DrawLine(self, p:[float, float, float, float]) -> None: ...
    @overload
    def DrawLine(self, points:'vtkPoints2D') -> None: ...
    @overload
    def DrawLines(self, points:'vtkPoints2D') -> None: ...
    @overload
    def DrawLines(self, points:[float, ...], n:int) -> None: ...
    @overload
    def DrawMarkers(self, shape:int, highlight:bool, points:[float, ...], n:int, colors:[int, ...], nc_comps:int) -> None: ...
    @overload
    def DrawMarkers(self, shape:int, highlight:bool, points:[float, ...], n:int) -> None: ...
    @overload
    ...
    @overload
    def DrawPointSprites(self, sprite:'vtkImageData', points:[float, ...], n:int, colors:[int, ...], nc_comps:int) -> None: ...
    @overload
    def DrawPointSprites(self, sprite:'vtkImageData', points:[float, ...], n:int) -> None: ...
    @overload
    def DrawPoints(self, x:[float, ...], y:[float, ...], n:int) -> None: ...
    @overload
    def DrawPoints(self, points:'vtkPoints2D') -> None: ...
    @overload
    def DrawPoints(self, points:[float, ...], n:int) -> None: ...
    @overload
    def DrawPoly(self, x:[float, ...], y:[float, ...], n:int) -> None: ...
    @overload
    def DrawPoly(self, points:'vtkPoints2D') -> None: ...
    @overload
    def DrawPoly(self, points:[float, ...], n:int) -> None: ...
    @overload
    def DrawPoly(self, points:[float, ...], n:int, colors:[int, ...], nc_comps:int) -> None: ...
    def DrawPolyData(self, x:float, y:float, polyData:'vtkPolyData', colors:'vtkUnsignedCharArray', scalarMode:int) -> None: ...
    @overload
    def DrawPolygon(self, x:[float, ...], y:[float, ...], n:int) -> None: ...
    @overload
    def DrawPolygon(self, points:'vtkPoints2D') -> None: ...
    @overload
    def DrawPolygon(self, points:[float, ...], n:int) -> None: ...
    @overload
    def DrawPolygon(self, x:[float, ...], y:[float, ...], n:int, color:[int, ...], nc_comps:int) -> None: ...
    @overload
    def DrawPolygon(self, points:'vtkPoints2D', color:[int, ...], nc_comps:int) -> None: ...
    @overload
    def DrawPolygon(self, points:[float, ...], n:int, color:[int, ...], nc_comps:int) -> None: ...
    @overload
    def DrawQuad(self, x1:float, y1:float, x2:float, y2:float, x3:float, y3:float, x4:float, y4:float) -> None: ...
    @overload
    def DrawQuad(self, p:[float, ...]) -> None: ...
    @overload
    def DrawQuadStrip(self, points:'vtkPoints2D') -> None: ...
    @overload
    def DrawQuadStrip(self, p:[float, ...], n:int) -> None: ...
    ...
    @overload
    def DrawStringRect(self, rect:(float, float, float, float), string:str) -> None: ...
...
class vtkContext3D(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def DrawPoints(self, points:(float, ...), n:int) -> None: ...
    @overload
    def DrawPoints(self, points:(float, ...), n:int, colors:[int, ...], nc_comps:int) -> None: ...
    def DrawPoly(self, points:(float, ...), n:int) -> None: ...
    def DrawTriangleMesh(self, mesh:(float, ...), n:int, colors:(int, ...) , nc:int) -> None: ...
    def EnableClippingPlane(self, i:int, planeEquation:[float, ...]) -> None: ...
    def End(self) -> bool: ...
...
class vtkContextClip(vtkAbstractContextItem):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetRect(self, rect:[float, float, float, float]) -> None: ...
...
class vtkContextDevice2D(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def DrawColoredPolygon(self, points:[float, ...], numPoints:int, colors:[int, ...]=..., nc_comps:int=0) -> None: ...
    def DrawEllipseWedge(self, x:float, y:float, outRx:float, outRy:float, inRx:float, inRy:float, startAngle:float, stopAngle:float) -> None: ...
    def DrawEllipticArc(self, x:float, y:float, rX:float, rY:float, startAngle:float, stopAngle:float) -> None: ...
    @overload
    def DrawImage(self, p:[float, float], scale:float, image:'vtkImageData') -> None: ...
    @overload
    def DrawImage(self, pos:'vtkRectf', image:'vtkImageData') -> None: ...
    def DrawLines(self, f:[float, ...], n:int, colors:[int, ...]=..., nc_comps:int=0) -> None: ...
    def DrawMarkers(self, shape:int, highlight:bool, points:[float, ...], n:int, colors:[int, ...]=..., nc_comps:int=0) -> None: ...
    def DrawMathTextString(self, point:[float, ...], string:str) -> None: ...
    def DrawPointSprites(self, sprite:'vtkImageData', points:[float, ...], n:int, colors:[int, ...]=..., nc_comps:int=0) -> None: ...
    def DrawPoints(self, points:[float, ...], n:int, colors:[int, ...]=..., nc_comps:int=0) -> None: ...
    def DrawPoly(self, points:[float, ...], n:int, colors:[int, ...]=..., nc_comps:int=0) -> None: ...
    def DrawPolyData(self, p:[float, float], scale:float, polyData:'vtkPolyData', colors:'vtkUnsignedCharArray', scalarMode:int) -> None: ...
    def DrawPolygon(self, p:[float, ...], n:int) -> None: ...
    def DrawQuad(self, __a:[float, ...], __b:int) -> None: ...
    def DrawQuadStrip(self, __a:[float, ...], __b:int) -> None: ...
    def DrawString(self, point:[float, ...], string:str) -> None: ...
    ...
    def SetClipping(self, x:[int, ...]) -> None: ...
    def SetColor4(self, color:[int, int, int, int]) -> None: ...
...
class vtkContextDevice3D(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def DisableClipping(self) -> None: ...
    def DisableClippingPlane(self, i:int) -> None: ...
    def DrawLines(self, verts:(float, ...), n:int, colors:(int, ...)=..., nc:int=0) -> None: ...
    def DrawPoints(self, verts:(float, ...), n:int, colors:(int, ...)=..., nc:int=0) -> None: ...
    def DrawPoly(self, verts:(float, ...), n:int, colors:(int, ...)=..., nc:int=0) -> None: ...
    def DrawTriangleMesh(self, mesh:(float, ...), n:int, colors:(int, ...) , nc:int) -> None: ...
    def EnableClipping(self, enable:bool) -> None: ...
    def EnableClippingPlane(self, i:int, planeEquation:[float, ...]) -> None: ...
...
class vtkContextScene(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def SetGeometry(self, _arg:(int, int)) -> None: ...
...
class vtkImageItem(vtkContextItem):
    ...
    @overload
    def SetPosition(self, _arg:(float, float)) -> None: ...
...
class vtkPen(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def GetColor(self, color:[int, int, int]) -> None: ...
    @overload
    def GetColor(self) -> Pointer: ...
    def GetColorF(self, color:[float, float, float]) -> None: ...
    def GetColorObject(self) -> 'vtkColor4ub': ...
