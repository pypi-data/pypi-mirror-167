...
class vtkParametricFunction(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def Evaluate(self, uvw:[float, float, float], Pt:[float, float, float], Duvw:[float, float, float, float, float, float, float, float, float]) -> None: ...
    def EvaluateScalar(self, uvw:[float, float, float], Pt:[float, float, float], Duvw:[float, float, float, float, float, float, float, float, float]) -> float: ...
...
class vtkParametricSpline(vtkParametricFunction):
    ...
    def Evaluate(self, u:[float, float, float], Pt:[float, float, float], Du:[float, float, float, float, float, float, float, float, float]) -> None: ...
    def EvaluateScalar(self, u:[float, float, float], Pt:[float, float, float], Du:[float, float, float, float, float, float, float, float, float]) -> float: ...
