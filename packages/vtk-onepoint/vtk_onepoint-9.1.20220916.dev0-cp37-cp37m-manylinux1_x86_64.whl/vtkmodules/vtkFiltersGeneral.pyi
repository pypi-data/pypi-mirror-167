...
class vtkCellTreeLocator(vtkmodules.vtkCommonDataModel.vtkAbstractCellLocator):
    def BuildLocator(self) -> None: ...
    def BuildLocatorIfNeeded(self) -> None: ...
    def BuildLocatorInternal(self) -> None: ...
    @overload
    def FindCell(self, pos:[float, float, float], tol2:float, cell:'vtkGenericCell', pcoords:[float, float, float], weights:[float, ...]) -> int: ...
    @overload
    def FindCell(self, x:[float, float, float]) -> int: ...
    def FindCellsWithinBounds(self, bbox:[float, ...], cells:'vtkIdList') -> None: ...
...
class vtkContourTriangulator(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def SetTriangulationErrorDisplay(self, _arg:int) -> None: ...
    @staticmethod
    def TriangulateContours(data:'vtkPolyData', firstLine:int, numLines:int, outputPolys:'vtkCellArray', normal:(float, float, float)) -> int: ...
    @staticmethod
