...
class vtkGenerateTimeSteps(vtkmodules.vtkCommonExecutionModel.vtkPassInputTypeAlgorithm):
    ...
    def GetTimeStepValues(self, timeStepValues:[float, ...]) -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    def SetTimeStepValues(self, count:int, timeStepValues:(float, ...)) -> None: ...
...
class vtkTransformToGrid(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    def GetDisplacementScale(self) -> float: ...
    def GetDisplacementShift(self) -> float: ...
    def GetGridExtent(self) -> (int, int, int, int, int, int): ...
    def GetGridOrigin(self) -> (float, float, float): ...
    def GetGridScalarType(self) -> int: ...
    def GetGridSpacing(self) -> (float, float, float): ...
    ...
    @overload
    def SetGridExtent(self, _arg:(int, int, int, int, int, int)) -> None: ...
    @overload
    def SetGridOrigin(self, _arg1:float, _arg2:float, _arg3:float) -> None: ...
    @overload
    def SetGridOrigin(self, _arg:(float, float, float)) -> None: ...
    ...
    @overload
    def SetGridSpacing(self, _arg:(float, float, float)) -> None: ...
