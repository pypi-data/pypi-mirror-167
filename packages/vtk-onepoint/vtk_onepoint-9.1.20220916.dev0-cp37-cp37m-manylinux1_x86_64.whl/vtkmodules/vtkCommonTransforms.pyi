...
class vtkAbstractTransform(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def TransformDoubleNormalAtPoint(self, point:(float, float, float), normal:(float, float, float)) -> (float, float, float): ...
    @overload
    def TransformDoublePoint(self, x:float, y:float, z:float) -> (float, float, float): ...
    @overload
    def TransformDoublePoint(self, point:(float, float, float)) -> (float, float, float): ...
    def TransformDoubleVectorAtPoint(self, point:(float, float, float), vector:(float, float, float)) -> (float, float, float): ...
    def TransformFloatNormalAtPoint(self, point:(float, float, float), normal:(float, float, float)) -> (float, float, float): ...
    @overload
    def TransformFloatPoint(self, x:float, y:float, z:float) -> (float, float, float): ...
    @overload
    def TransformFloatPoint(self, point:(float, float, float)) -> (float, float, float): ...
    def TransformFloatVectorAtPoint(self, point:(float, float, float), vector:(float, float, float)) -> (float, float, float): ...
    @overload
    def TransformNormalAtPoint(self, point:(float, float, float), in_:( float, float, float), out:[float, float, float]) -> None: ...
    @overload
    def TransformNormalAtPoint(self, point:(float, float, float), normal:( float, float, float)) -> (float, float, float): ...
    @overload
    def TransformPoint(self, in_:(float, float, float), out:[float, float, float]) -> None: ...
    @overload
    def TransformPoint(self, x:float, y:float, z:float) -> (float, float, float): ...
    @overload
    def TransformPoint(self, point:(float, float, float)) -> (float, float, float): ...
    def TransformPoints(self, inPts:'vtkPoints', outPts:'vtkPoints') -> None: ...
    @overload
    def TransformVectorAtPoint(self, point:(float, float, float), in_:( float, float, float), out:[float, float, float]) -> None: ...
    @overload
    def TransformVectorAtPoint(self, point:(float, float, float), vector:( float, float, float)) -> (float, float, float): ...
...
class vtkWarpTransform(vtkAbstractTransform):
    ...
    @overload
    def TemplateTransformInverse(self, in_:(float, float, float), out:[float, float, float]) -> None: ...
    @overload
    def TemplateTransformInverse(self, in_:(float, float, float), out:[float, float, float], derivative:[[float, float, float], [float, float, float], [float, float, float]]) -> None: ...
    @overload
    def TemplateTransformPoint(self, in_:(float, float, float), out:[float, float, float]) -> None: ...
    @overload
    def TemplateTransformPoint(self, in_:(float, float, float), out:[float, float, float], derivative:[[float, float, float], [float, float, float], [float, float, float]]) -> None: ...
...
class vtkGeneralTransform(vtkAbstractTransform):
    ...
    @overload
    def Concatenate(self, elements:(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float)) -> None: ...
    @overload
    ...
    @overload
    def RotateWXYZ(self, angle:float, axis:(float, float, float)) -> None: ...
    ...
    @overload
    def Scale(self, s:(float, float, float)) -> None: ...
    def SetInput(self, input:'vtkAbstractTransform') -> None: ...
    @overload
    def Translate(self, x:float, y:float, z:float) -> None: ...
    @overload
    def Translate(self, x:(float, float, float)) -> None: ...
...
class vtkLinearTransform(vtkHomogeneousTransform):
    ...
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def InternalTransformDerivative(self, in_:(float, float, float), out:[float, float, float], derivative:[[float, float, float], [float, float, float], [float, float, float]]) -> None: ...
    def InternalTransformNormal(self, in_:(float, float, float), out:[float, float, float]) -> None: ...
    def InternalTransformPoint(self, in_:(float, float, float), out:[float, float, float]) -> None: ...
    def InternalTransformVector(self, in_:(float, float, float), out:[float, float, float]) -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @overload
    def TransformDoubleNormal(self, x:float, y:float, z:float) -> (float, float, float): ...
    @overload
    def TransformDoubleNormal(self, normal:(float, float, float)) -> ( float, float, float): ...
    @overload
    def TransformDoubleVector(self, x:float, y:float, z:float) -> (float, float, float): ...
    @overload
    def TransformDoubleVector(self, vec:(float, float, float)) -> (float, float, float): ...
    @overload
    def TransformFloatNormal(self, x:float, y:float, z:float) -> (float, float, float): ...
    @overload
    def TransformFloatNormal(self, normal:(float, float, float)) -> ( float, float, float): ...
    @overload
    def TransformFloatVector(self, x:float, y:float, z:float) -> (float, float, float): ...
    @overload
    def TransformFloatVector(self, vec:(float, float, float)) -> (float, float, float): ...
    @overload
    def TransformNormal(self, in_:(float, float, float), out:[float, float, float]) -> None: ...
    @overload
    def TransformNormal(self, x:float, y:float, z:float) -> (float, float, float): ...
    @overload
    def TransformNormal(self, normal:(float, float, float)) -> (float, float, float): ...
    def TransformNormals(self, inNms:'vtkDataArray', outNms:'vtkDataArray') -> None: ...
    def TransformPoints(self, inPts:'vtkPoints', outPts:'vtkPoints') -> None: ...
    @overload
    def TransformVector(self, x:float, y:float, z:float) -> (float, float, float): ...
    @overload
    def TransformVector(self, normal:(float, float, float)) -> (float, float, float): ...
    @overload
    def TransformVector(self, in_:(float, float, float), out:[float, float, float]) -> None: ...
...
class vtkPerspectiveTransform(vtkHomogeneousTransform):
    ...
    @overload
    def SetMatrix(self, elements:(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float)) -> None: ...
    @overload
    def SetupCamera(self, position:(float, float, float), focalpoint:( float, float, float), viewup:(float, float, float)) -> None: ...
    @overload
...
class vtkTransform(vtkLinearTransform):
    ...
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    @overload
    def GetOrientation(self, orient:[float, float, float]) -> None: ...
    @overload
    def GetOrientation(self) -> (float, float, float): ...
    @overload
    @staticmethod
    def GetOrientation(orient:[float, float, float], matrix:'vtkMatrix4x4') -> None: ...
    @overload
    def GetOrientationWXYZ(self, wxyz:[float, float, float, float]) -> None: ...
    @overload
    ...
    @overload
    def GetScale(self, scale:[float, float, float]) -> None: ...
    @overload
...
class vtkTransform2D(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetPosition(self, pos:[float, float]) -> None: ...
    def GetScale(self, scale:[float, float]) -> None: ...
    def GetTranspose(self, transpose:'vtkMatrix3x3') -> None: ...
    def Identity(self) -> None: ...
    def Inverse(self) -> None: ...
    @overload
    def InverseTransformPoints(self, inPts:(float, ...), outPts:[float, ...], n:int) -> None: ...
    @overload
    ...
    @overload
    def Scale(self, s:(float, float)) -> None: ...
    @overload
    def SetMatrix(self, matrix:'vtkMatrix3x3') -> None: ...
    @overload
    def SetMatrix(self, elements:(float, float, float, float, float, float, float, float, float)) -> None: ...
    @overload
    def TransformPoints(self, inPts:(float, ...), outPts:[float, ...], n:int) -> None: ...
    @overload
    def TransformPoints(self, inPts:'vtkPoints2D', outPts:'vtkPoints2D') -> None: ...
    @overload
    def Translate(self, x:float, y:float) -> None: ...
    @overload
    def Translate(self, x:(float, float)) -> None: ...
