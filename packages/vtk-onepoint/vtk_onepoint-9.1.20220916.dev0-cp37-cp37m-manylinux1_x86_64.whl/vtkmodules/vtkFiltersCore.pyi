...
class vtkBinCellDataFilter(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    ...
    @overload
    def GenerateValues(self, numBins:int, range:[float, float]) -> None: ...
    @overload
    ...
    @overload
    def GetValues(self, binValues:[float, ...]) -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkBinnedDecimation(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetDivisionOrigin(self) -> (float, float, float): ...
    def GetDivisionSpacing(self) -> (float, float, float): ...
    def GetLargeIds(self) -> bool: ...
    @overload
    def GetNumberOfDivisions(self) -> (int, int, int): ...
    @overload
    def GetNumberOfDivisions(self, div:[int, int, int]) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    @overload
    def SetDivisionOrigin(self, o:[float, float, float]) -> None: ...
    @overload
    def SetDivisionSpacing(self, x:float, y:float, z:float) -> None: ...
    @overload
    def SetDivisionSpacing(self, s:[float, float, float]) -> None: ...
    @overload
    def SetNumberOfDivisions(self, div:[int, int, int]) -> None: ...
    @overload
...
class vtkCenterOfMass(vtkmodules.vtkCommonExecutionModel.vtkPointSetAlgorithm):
    @staticmethod
    def ComputeCenterOfMass(input:'vtkPoints', scalars:'vtkDataArray', center:[float, float, float]) -> None: ...
...
class vtkCutter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def GetCellTypeDimensions(cellTypeDimensions:[int, ...]) -> None: ...
...
class vtkConnectivityFilter(vtkmodules.vtkCommonExecutionModel.vtkPointSetAlgorithm):
    ...
    def GetClosestPoint(self) -> (float, float, float): ...
    ...
    @overload
    def SetClosestPoint(self, _arg:(float, float, float)) -> None: ...
...
class vtkEdgeSubdivisionCriterion(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def EvaluateLocationAndFields(self, p1:[float, ...], field_start:int) -> bool: ...
...
class vtkDataSetEdgeSubdivisionCriterion(vtkEdgeSubdivisionCriterion):
    def EvaluateCellDataField(self, result:[float, ...], weights:[float, ...], field:int) -> None: ...
    def EvaluateFields(self, vertex:[float, ...], weights:[float, ...], field_start:int) -> Pointer: ...
    def EvaluateLocationAndFields(self, midpt:[float, ...], field_start:int) -> bool: ...
    def EvaluatePointDataField(self, result:[float, ...], weights:[float, ...], field:int) -> None: ...
...
class vtkDecimatePro(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @overload
    def GetInflectionPoints(self, inflectionPoints:[float, ...]) -> None: ...
    @overload
...
class vtkDelaunay3D(vtkmodules.vtkCommonExecutionModel.vtkUnstructuredGridAlgorithm):
    ...
    def GetToleranceMaxValue(self) -> float: ...
    def GetToleranceMinValue(self) -> float: ...
    def InsertPoint(self, Mesh:'vtkUnstructuredGrid', points:'vtkPoints', id:int, x:[float, float, float], holeTetras:'vtkIdList') -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkElevationFilter(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    def GetHighPoint(self) -> (float, float, float): ...
    def GetLowPoint(self) -> (float, float, float): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetScalarRange(self) -> (float, float): ...
    ...
    @overload
    def SetHighPoint(self, _arg:(float, float, float)) -> None: ...
    @overload
    def SetLowPoint(self, _arg1:float, _arg2:float, _arg3:float) -> None: ...
    @overload
    def SetLowPoint(self, _arg:(float, float, float)) -> None: ...
    @overload
    def SetScalarRange(self, _arg1:float, _arg2:float) -> None: ...
    @overload
    def SetScalarRange(self, _arg:(float, float)) -> None: ...
...
class vtkFieldDataToAttributeDataFilter(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    ...
    @staticmethod
    def UpdateComponentRange(da:'vtkDataArray', compRange:[int, int]) -> int: ...
...
class vtkGlyph3D(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetFollowedCameraPosition(self) -> (float, float, float): ...
    def GetFollowedCameraViewUp(self) -> (float, float, float): ...
    ...
    def SetFollowedCameraPosition(self, data:(float, ...)) -> None: ...
    def SetFollowedCameraViewUp(self, data:(float, ...)) -> None: ...
...
class vtkHull(vtkmodules.vtkCommonExecutionModel.vtkPointSetAlgorithm):
    ...
    @overload
    def AddPlane(self, plane:[float, float, float]) -> int: ...
    @overload
    def AddPlane(self, A:float, B:float, C:float, D:float) -> int: ...
    @overload
    def AddPlane(self, plane:[float, float, float], D:float) -> int: ...
    def AddRecursiveSpherePlanes(self, level:int) -> None: ...
    @overload
    def GenerateHull(self, pd:'vtkPolyData', bounds:[float, ...]) -> None: ...
    @overload
    ...
    @overload
    def SetPlane(self, i:int, plane:[float, float, float]) -> None: ...
    @overload
    def SetPlane(self, i:int, A:float, B:float, C:float, D:float) -> None: ...
    @overload
    def SetPlane(self, i:int, plane:[float, float, float], D:float) -> None: ...
...
class vtkImplicitPolyDataDistance(vtkmodules.vtkCommonDataModel.vtkImplicitFunction):
    @overload
    def EvaluateFunction(self, x:[float, float, float]) -> float: ...
    @overload
    ...
    def EvaluateFunctionAndGetClosestPoint(self, x:[float, float, float], closestPoint:[float, float, float]) -> float: ...
    def EvaluateGradient(self, x:[float, float, float], g:[float, float, float]) -> None: ...
    def GetMTime(self) -> int: ...
    def GetNoClosestPoint(self) -> (float, float, float): ...
    def GetNoGradient(self) -> (float, float, float): ...
    ...
    @overload
    def SetNoClosestPoint(self, _arg:(float, float, float)) -> None: ...
    @overload
    def SetNoGradient(self, _arg1:float, _arg2:float, _arg3:float) -> None: ...
    @overload
    def SetNoGradient(self, _arg:(float, float, float)) -> None: ...
...
class vtkMarchingSquares(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @overload
    def GenerateValues(self, numContours:int, rangeStart:float, rangeEnd:float) -> None: ...
    def GetImageRange(self) -> (int, int, int, int, int, int): ...
    def GetLocator(self) -> 'vtkIncrementalPointLocator': ...
    def GetMTime(self) -> int: ...
    def GetNumberOfContours(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    ...
    @overload
    def SetImageRange(self, data:(int, ...)) -> None: ...
    @overload
...
class vtkPolyDataEdgeConnectivityFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def DeleteSeed(self, id:int) -> None: ...
    def DeleteSpecifiedRegion(self, id:int) -> None: ...
    def GetBarrierEdgeLength(self) -> (float, float): ...
    ...
    @overload
    def SetBarrierEdgeLength(self, _arg:(float, float)) -> None: ...
...
class vtkQuadricClustering(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @overload
    def StartAppend(self, bounds:[float, ...]) -> None: ...
    @overload
...
class vtkRectilinearSynchronizedTemplates(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def ComputeScalarsOff(self) -> None: ...
    def ComputeScalarsOn(self) -> None: ...
    def ComputeSpacing(self, data:'vtkRectilinearGrid', i:int, j:int, k:int, extent:[int, int, int, int, int, int], spacing:[float, float, float, float, float, float]) -> None: ...
    def GenerateTrianglesOff(self) -> None: ...
    def GenerateTrianglesOn(self) -> None: ...
    @overload
    def GenerateValues(self, numContours:int, range:[float, float]) -> None: ...
...
class vtkResampleToImage(vtkmodules.vtkCommonExecutionModel.vtkAlgorithm):
    ...
    def GetSamplingBounds(self) -> (float, float, float, float, float, float): ...
    def GetSamplingDimensions(self) -> (int, int, int): ...
    ...
    @overload
    def SetSamplingBounds(self, _arg:(float, float, float, float, float, float)) -> None: ...
    @overload
    def SetSamplingDimensions(self, _arg1:int, _arg2:int, _arg3:int) -> None: ...
    @overload
    def SetSamplingDimensions(self, _arg:(int, int, int)) -> None: ...
...
class vtkSimpleElevationFilter(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetVector(self) -> (float, float, float): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @overload
    def SetVector(self, _arg:(float, float, float)) -> None: ...
...
class vtkSphereTreeFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetPoint(self) -> (float, float, float): ...
    def GetRay(self) -> (float, float, float): ...
    ...
    @overload
    def SetPoint(self, _arg:(float, float, float)) -> None: ...
    @overload
    def SetRay(self, _arg1:float, _arg2:float, _arg3:float) -> None: ...
    @overload
    def SetRay(self, _arg:(float, float, float)) -> None: ...
...
class vtkStreamingTessellator(vtkmodules.vtkCommonCore.vtkObject):
    MaxFieldSize:int
    def AdaptivelySample0Facet(self, v0:[float, ...]) -> None: ...
    def AdaptivelySample1Facet(self, v0:[float, ...], v1:[float, ...]) -> None: ...
    def AdaptivelySample1FacetLinear(self, v0:[float, ...], v1:[float, ...]) -> None: ...
    def AdaptivelySample2Facet(self, v0:[float, ...], v1:[float, ...], v2:[float, ...]) -> None: ...
    def AdaptivelySample2FacetLinear(self, v0:[float, ...], v1:[float, ...], v2:[float, ...]) -> None: ...
    def AdaptivelySample3Facet(self, v0:[float, ...], v1:[float, ...], v2:[float, ...], v3:[float, ...]) -> None: ...
    def AdaptivelySample3FacetLinear(self, v0:[float, ...], v1:[float, ...], v2:[float, ...], v3:[float, ...]) -> None: ...
...
class vtkSurfaceNets2D(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @overload
    def GenerateLabels(self, numLabels:int, range:[float, float]) -> None: ...
    @overload
    ...
    @overload
    def GetLabels(self, contourValues:[float, ...]) -> None: ...
    def GetMTime(self) -> int: ...
    def GetNumberOfContours(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
...
class vtkTubeFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetDefaultNormal(self) -> (float, float, float): ...
    ...
    @overload
    def SetDefaultNormal(self, _arg:(float, float, float)) -> None: ...
...
class vtkVectorDot(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    def GetActualRange(self) -> (float, float): ...
