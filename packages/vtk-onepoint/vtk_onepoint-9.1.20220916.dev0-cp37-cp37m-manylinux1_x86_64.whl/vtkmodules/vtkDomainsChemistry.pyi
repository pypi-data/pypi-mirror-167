...
class vtkMoleculeMapper(vtkmodules.vtkRenderingCore.vtkMapper):
    ...
    def GetAtomColor(self) -> (int, int, int): ...
    ...
    def GetBondColor(self) -> (int, int, int): ...
    ...
    def GetLatticeColor(self) -> (int, int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    @overload
    def SetAtomColor(self, _arg:(int, int, int)) -> None: ...
    ...
    @overload
    def SetBondColor(self, _arg:(int, int, int)) -> None: ...
    ...
    @overload
    def SetLatticeColor(self, _arg:(int, int, int)) -> None: ...
...
class vtkPeriodicTable(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def GetDefaultRGBTuple(self, atomicNum:int, rgb:[float, float, float]) -> None: ...
    @overload
