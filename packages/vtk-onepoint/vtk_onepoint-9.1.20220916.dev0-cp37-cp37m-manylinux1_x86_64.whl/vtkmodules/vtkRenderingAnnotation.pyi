...
class vtkAxesActor(vtkmodules.vtkRenderingCore.vtkProp3D):
    ...
    def GetMTime(self) -> int: ...
    def GetNormalizedLabelPosition(self) -> (float, float, float): ...
    def GetNormalizedShaftLength(self) -> (float, float, float): ...
    def GetNormalizedTipLength(self) -> (float, float, float): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    def GetTotalLength(self) -> (float, float, float): ...
    ...
    @overload
    def SetNormalizedLabelPosition(self, v:[float, float, float]) -> None: ...
    @overload
    def SetNormalizedLabelPosition(self, x:float, y:float, z:float) -> None: ...
    @overload
    def SetNormalizedShaftLength(self, v:[float, float, float]) -> None: ...
    @overload
    def SetNormalizedShaftLength(self, x:float, y:float, z:float) -> None: ...
    @overload
    def SetNormalizedTipLength(self, v:[float, float, float]) -> None: ...
    @overload
    ...
    @overload
    def SetTotalLength(self, v:[float, float, float]) -> None: ...
    @overload
...
class vtkAxisActor(vtkmodules.vtkRenderingCore.vtkActor):
    ...
    def ComputeMaxLabelLength(self, __a:(float, float, float)) -> float: ...
    def ComputeTitleLength(self, __a:(float, float, float)) -> float: ...
    ...
    def GetAxisBaseForX(self) -> (float, float, float): ...
    def GetAxisBaseForY(self) -> (float, float, float): ...
    def GetAxisBaseForZ(self) -> (float, float, float): ...
    ...
    @overload
    def SetAxisBaseForX(self, _arg:(float, float, float)) -> None: ...
    @overload
    def SetAxisBaseForY(self, _arg1:float, _arg2:float, _arg3:float) -> None: ...
    @overload
    def SetAxisBaseForY(self, _arg:(float, float, float)) -> None: ...
    @overload
    def SetAxisBaseForZ(self, _arg1:float, _arg2:float, _arg3:float) -> None: ...
    @overload
    def SetAxisBaseForZ(self, _arg:(float, float, float)) -> None: ...
    ...
    @overload
    def SetPoint1(self, x:[float, float, float]) -> None: ...
    @overload
    def SetPoint1(self, x:float, y:float, z:float) -> None: ...
    @overload
    def SetPoint2(self, x:[float, float, float]) -> None: ...
    @overload
...
class vtkAxisActor2D(vtkmodules.vtkRenderingCore.vtkActor2D):
    ...
    def AxisVisibilityOn(self) -> None: ...
    @staticmethod
    def ComputeRange(inRange:[float, float], outRange:[float, float], inNumTicks:int, outNumTicks:int, interval:float) -> None: ...
    ...
    @overload
    def GetAdjustedRange(self, _arg:[float, float]) -> None: ...
    def GetAxisVisibility(self) -> int: ...
    ...
    @overload
    def SetPoint1(self, x:[float, float]) -> None: ...
    @overload
    def SetPoint1(self, x:float, y:float) -> None: ...
    @overload
    def SetPoint2(self, x:[float, float]) -> None: ...
    @overload
...
class vtkAxisFollower(vtkmodules.vtkRenderingCore.vtkFollower):
    ...
    @staticmethod
    def AutoScale(viewport:'vtkViewport', camera:'vtkCamera', screenSize:float, position:[float, float, float]) -> float: ...
    ...
    def GetScreenOffsetVector(self) -> (float, float): ...
    ...
    @overload
    def SetScreenOffsetVector(self, _arg:(float, float)) -> None: ...
...
class vtkBarChartActor(vtkmodules.vtkRenderingCore.vtkActor2D):
    ...
    @overload
    def SetBarColor(self, i:int, color:(float, float, float)) -> None: ...
...
class vtkCaptionActor2D(vtkmodules.vtkRenderingCore.vtkActor2D):
    ...
    def GetAttachmentPoint(self) -> (float, float, float): ...
    ...
    @overload
    def SetAttachmentPoint(self, x:[float, float, float]) -> None: ...
    @overload
...
class vtkCubeAxesActor(vtkmodules.vtkRenderingCore.vtkActor):
    ...
    def GetAxisOrigin(self) -> (float, float, float): ...
    @overload
    def GetBounds(self) -> (float, float, float, float, float, float): ...
    @overload
    def GetBounds(self, bounds:[float, float, float, float, float, float]) -> None: ...
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetOrientedBounds(self) -> (float, float, float, float, float, float): ...
    def GetRebuildAxes(self) -> bool: ...
    @overload
    def GetRenderedBounds(self, rBounds:[float, float, float, float, float, float]) -> None: ...
    @overload
    ...
    def GetXAxisRange(self) -> (float, float): ...
    ...
    def GetYAxisRange(self) -> (float, float): ...
    ...
    def GetZAxisRange(self) -> (float, float): ...
    ...
    @overload
    def SetAxisOrigin(self, _arg:(float, float, float)) -> None: ...
    @overload
    ...
    @overload
    def SetOrientedBounds(self, _arg:(float, float, float, float, float, float)) -> None: ...
    ...
    @overload
    def SetXAxisRange(self, _arg:(float, float)) -> None: ...
    ...
    @overload
    def SetYAxisRange(self, _arg:(float, float)) -> None: ...
    ...
    @overload
    def SetZAxisRange(self, _arg:(float, float)) -> None: ...
...
class vtkCubeAxesActor2D(vtkmodules.vtkRenderingCore.vtkActor2D):
    ...
    def GetNumberOfLabelsMinValue(self) -> int: ...
    @overload
    def GetRanges(self) -> (float, float, float, float, float, float): ...
    @overload
    def GetRanges(self, xmin:float, xmax:float, ymin:float, ymax:float, zmin:float, zmax:float) -> None: ...
    @overload
    def GetRanges(self, ranges:[float, float, float, float, float, float]) -> None: ...
    ...
    @overload
    def SetRanges(self, _arg:(float, float, float, float, float, float)) -> None: ...
...
class vtkLegendBoxActor(vtkmodules.vtkRenderingCore.vtkActor2D):
    ...
    def GetEntryColor(self, i:int) -> (float, float, float): ...
    ...
    @overload
    def SetEntry(self, i:int, symbol:'vtkPolyData', string:str, color:[float, float, float]) -> None: ...
    @overload
    def SetEntry(self, i:int, symbol:'vtkImageData', string:str, color:[float, float, float]) -> None: ...
    @overload
    def SetEntry(self, i:int, symbol:'vtkPolyData', icon:'vtkImageData', string:str, color:[float, float, float]) -> None: ...
    @overload
    def SetEntryColor(self, i:int, color:[float, float, float]) -> None: ...
    @overload
...
class vtkPieChartActor(vtkmodules.vtkRenderingCore.vtkActor2D):
    ...
    @overload
    def SetPieceColor(self, i:int, color:(float, float, float)) -> None: ...
...
class vtkPolarAxesActor(vtkmodules.vtkRenderingCore.vtkActor):
    ...
    def GetPole(self) -> (float, float, float): ...
    ...
    @overload
    def SetPole(self, __a:[float, float, float]) -> None: ...
    @overload
...
class vtkScalarBarActor(vtkmodules.vtkRenderingCore.vtkActor2D):
    ...
    def GetScalarBarRect(self, rect:[int, int, int, int], viewport:'vtkViewport') -> None: ...
...
class vtkSpiderPlotActor(vtkmodules.vtkRenderingCore.vtkActor2D):
    ...
    def GetAxisRange(self, i:int, range:[float, float]) -> None: ...
    def GetIndependentVariables(self) -> int: ...
    def GetIndependentVariablesMaxValue(self) -> int: ...
    def GetIndependentVariablesMinValue(self) -> int: ...
    def GetInput(self) -> 'vtkDataObject': ...
    ...
    @overload
    def SetAxisRange(self, i:int, range:[float, float]) -> None: ...
    def SetIndependentVariables(self, _arg:int) -> None: ...
    def SetIndependentVariablesToColumns(self) -> None: ...
    def SetIndependentVariablesToRows(self) -> None: ...
    def SetInputConnection(self, __a:'vtkAlgorithmOutput') -> None: ...
    ...
    @overload
    def SetPlotColor(self, i:int, color:(float, float, float)) -> None: ...
    def SetTitle(self, _arg:str) -> None: ...
    def SetTitleTextProperty(self, p:'vtkTextProperty') -> None: ...
    def SetTitleVisibility(self, _arg:int) -> None: ...
    def TitleVisibilityOff(self) -> None: ...
...
class vtkXYPlotActor(vtkmodules.vtkRenderingCore.vtkActor2D):
    ...
    def GetLegendActor(self) -> 'vtkLegendBoxActor': ...
    def GetLegendPosition(self) -> (float, float): ...
    def GetLegendPosition2(self) -> (float, float): ...
    ...
    def GetPlotColor(self, i:int) -> (float, float, float): ...
    def GetPlotCoordinate(self) -> (float, float): ...
    ...
    def GetTitle(self) -> str: ...
    def GetTitlePosition(self) -> (float, float): ...
    def GetTitleTextProperty(self) -> 'vtkTextProperty': ...
    def GetViewportCoordinate(self) -> (float, float): ...
    def GetXAxisActor2D(self) -> 'vtkAxisActor2D': ...
    def GetXLabelFormat(self) -> str: ...
    ...
    @overload
    def SetLegendPosition(self, _arg:(float, float)) -> None: ...
    @overload
    def SetLegendPosition2(self, _arg1:float, _arg2:float) -> None: ...
    @overload
    def SetLegendPosition2(self, _arg:(float, float)) -> None: ...
    ...
    @overload
    def SetPlotCoordinate(self, _arg:(float, float)) -> None: ...
    ...
    @overload
    def SetTitlePosition(self, _arg:(float, float)) -> None: ...
    ...
    @overload
    def SetViewportCoordinate(self, _arg:(float, float)) -> None: ...
    ...
    @overload
    def SetXRange(self, _arg:(float, float)) -> None: ...
    def SetXTitle(self, _arg:str) -> None: ...
    ...
    @overload
    def SetYRange(self, _arg:(float, float)) -> None: ...
