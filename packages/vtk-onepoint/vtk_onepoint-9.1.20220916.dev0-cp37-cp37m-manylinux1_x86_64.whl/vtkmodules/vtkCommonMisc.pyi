...
class vtkExprTkFunctionParser(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def GetVectorResult(self) -> (float, float, float): ...
    @overload
    def GetVectorResult(self, result:[float, float, float]) -> None: ...
    ...
    @overload
    def GetVectorVariableValue(self, variableName:str) -> (float, float, float): ...
    @overload
    def GetVectorVariableValue(self, variableName:str, value:[float, float, float]) -> None: ...
    @overload
    def GetVectorVariableValue(self, i:int) -> (float, float, float): ...
    @overload
    def GetVectorVariableValue(self, i:int, value:[float, float, float]) -> None: ...
    ...
    @overload
    def SetVectorVariableValue(self, variableName:str, values:[float, float, float]) -> None: ...
    @overload
    def SetVectorVariableValue(self, i:int, xValue:float, yValue:float, zValue:float) -> None: ...
    @overload
    def SetVectorVariableValue(self, i:int, values:[float, float, float]) -> None: ...
...
class vtkPolygonBuilder(object):
    ...
    def InsertTriangle(self, abc:(int, ...)) -> None: ...
    def Reset(self) -> None: ...
...
class vtkResourceFileLocator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def Locate(self, anchor:str, landmark_prefixes:(str, ...), landmark:str, defaultDir:str=...) -> str: ...
