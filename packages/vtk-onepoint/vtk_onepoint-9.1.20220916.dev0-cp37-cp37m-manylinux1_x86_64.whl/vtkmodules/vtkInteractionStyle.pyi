...
class vtkInteractorStyleFlight(vtkmodules.vtkRenderingCore.vtkInteractorStyle):
    ...
    def GetDefaultUpVector(self) -> (float, float, float): ...
    ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def JumpTo(self, campos:[float, float, float], focpos:[float, float, float]) -> None: ...
    ...
    def SetDefaultUpVector(self, data:(float, ...)) -> None: ...
...
class vtkInteractorStyleImage(vtkInteractorStyleTrackballCamera):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetWindowLevelCurrentPosition(self) -> (int, int): ...
    def GetWindowLevelStartPosition(self) -> (int, int): ...
    def GetXViewRightVector(self) -> (float, float, float): ...
    def GetXViewUpVector(self) -> (float, float, float): ...
    def GetYViewRightVector(self) -> (float, float, float): ...
    def GetYViewUpVector(self) -> (float, float, float): ...
    def GetZViewRightVector(self) -> (float, float, float): ...
    def GetZViewUpVector(self) -> (float, float, float): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    def SetImageOrientation(self, leftToRight:(float, float, float), bottomToTop:(float, float, float)) -> None: ...
...
class vtkInteractorStyleRubberBand2D(vtkmodules.vtkRenderingCore.vtkInteractorStyle):
    ...
    SELECT_UNION:int
    ZOOMING:int
    def GetEndPosition(self) -> (int, int): ...
    def GetInteraction(self) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetRenderOnMouseMove(self) -> bool: ...
    def GetStartPosition(self) -> (int, int): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkInteractorStyleUnicam(vtkmodules.vtkRenderingCore.vtkInteractorStyle):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetWorldUpVector(self) -> (float, float, float): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @overload
    def SetWorldUpVector(self, a:[float, float, float]) -> None: ...
    @overload
...
class vtkInteractorStyleUser(vtkmodules.vtkRenderingCore.vtkInteractorStyle):
    ...
    def GetLastPos(self) -> (int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetOldPos(self) -> (int, int): ...
...
class vtkParallelCoordinatesInteractorStyle(vtkInteractorStyleTrackballCamera):
    ...
    @overload
    def GetCursorCurrentPosition(self) -> (int, int): ...
    @overload
    def GetCursorCurrentPosition(self, viewport:'vtkViewport', pos:[float, float]) -> None: ...
    @overload
    def GetCursorLastPosition(self) -> (int, int): ...
    @overload
    def GetCursorLastPosition(self, viewport:'vtkViewport', pos:[float, float]) -> None: ...
    @overload
    def GetCursorStartPosition(self) -> (int, int): ...
    @overload
    def GetCursorStartPosition(self, viewport:'vtkViewport', pos:[float, float]) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
