...
class vtkBivariateLinearTableThreshold(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    @overload
    def AddLineEquation(self, p1:[float, ...], p2:[float, ...]) -> None: ...
    @overload
    def AddLineEquation(self, p:[float, ...], slope:float) -> None: ...
    @overload
    ...
    @overload
    @staticmethod
    def ComputeImplicitLineFunction(p1:[float, ...], p2:[float, ...], abc:[float, ...]) -> None: ...
    @overload
    @staticmethod
    def ComputeImplicitLineFunction(p:[float, ...], slope:float, abc:[float, ...]) -> None: ...
    def GetColumnRanges(self) -> (float, float): ...
    ...
    @overload
    def SetColumnRanges(self, _arg:(float, float)) -> None: ...
...
class vtkExtractHistogram(vtkmodules.vtkCommonExecutionModel.vtkTableAlgorithm):
    ...
    def GetBinRange(self) -> (float, float): ...
    ...
    def GetCustomBinRanges(self) -> (float, float): ...
    ...
    @overload
    def SetCustomBinRanges(self, _arg:(float, float)) -> None: ...
