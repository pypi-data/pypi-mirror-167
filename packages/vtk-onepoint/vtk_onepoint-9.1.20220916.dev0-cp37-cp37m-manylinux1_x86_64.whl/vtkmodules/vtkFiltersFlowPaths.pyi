...
class vtkAbstractInterpolatedVelocityField(vtkmodules.vtkCommonMath.vtkFunctionSet):
    ...
    def GetLastLocalCoordinates(self, pcoords:[float, float, float]) -> int: ...
    def GetLastWeights(self, w:[float, ...]) -> int: ...
...
class vtkAMRInterpolatedVelocityField(vtkAbstractInterpolatedVelocityField):
    def CopyParameters(self, from_:'vtkAbstractInterpolatedVelocityField') -> None: ...
    @staticmethod
    def FindGrid(q:[float, float, float], amrds:'vtkOverlappingAMR', level:int, gridId:int) -> bool: ...
    @overload
    def FunctionValues(self, x:[float, ...], f:[float, ...]) -> int: ...
    @overload
    def FunctionValues(self, x:[float, ...], f:[float, ...], userData:Pointer) -> int: ...
...
class vtkCachingInterpolatedVelocityField(vtkmodules.vtkCommonMath.vtkFunctionSet):
    ...
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetVectorsSelection(self) -> str: ...
    def InsideTest(self, x:[float, ...]) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkCompositeInterpolatedVelocityField(vtkAbstractInterpolatedVelocityField):
    def AddDataSet(self, dataset:'vtkDataSet') -> None: ...
    def CopyParameters(self, from_:'vtkAbstractInterpolatedVelocityField') -> None: ...
...
class vtkCellLocatorInterpolatedVelocityField(vtkCompositeInterpolatedVelocityField):
    ...
    def SetCellLocatorPrototype(self, prototype:'vtkAbstractCellLocator') -> None: ...
    @overload
    def SetLastCellId(self, c:int, dataindex:int) -> None: ...
    @overload
    def SetLastCellId(self, c:int) -> None: ...
...
class vtkCompositeInterpolatedVelocityFieldDataSetsType(object):
    ...
    @overload
    def __init__(self,  __a:'vtkCompositeInterpolatedVelocityFieldDataSetsType') -> None: ...
...
class vtkEvenlySpacedStreamlines2D(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @overload
    def SetStartPosition(self, _arg:(float, float, float)) -> None: ...
...
class vtkInterpolatedVelocityField(vtkCompositeInterpolatedVelocityField):
    ...
    @overload
    def SetLastCellId(self, c:int) -> None: ...
    def SnapPointOnCell(self, pOrigin:[float, ...], pProj:[float, ...]) -> int: ...
...
class vtkLagrangianParticle(object):
    ...
    def GetNextTrackedUserData(self) -> (float, ...): ...
    ...
    def GetPrevTrackedUserData(self) -> (float, ...): ...
    ...
    def GetTrackedUserData(self) -> (float, ...): ...
...
class vtkModifiedBSPTree(vtkmodules.vtkCommonDataModel.vtkAbstractCellLocator):
    ...
    @overload
    def FindCell(self, x:[float, float, float], tol2:float, GenCell:'vtkGenericCell', pcoords:[float, float, float], weights:[float, ...]) -> int: ...
    @overload
    def FindCell(self, x:[float, float, float]) -> int: ...
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def InsideCellBounds(self, x:[float, float, float], cell_ID:int) -> bool: ...
    @overload
    ...
    @overload
    def IntersectWithLine(self, p1:(float, float, float), p2:(float, float, float), tol:float, t:float, x:[float, float, float], pcoords:[float, float, float], subId:int, cellId:int, cell:'vtkGenericCell') -> int: ...
    @overload
    ...
    @overload
    def IntersectWithLine(self, p1:(float, float, float), p2:(float, float, float), points:'vtkPoints', cellIds:'vtkIdList') -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkParticleTracerBase(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def SetStaticMesh(self, _arg:int) -> None: ...
...
class vtkStreamTracer(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    UNKNOWN:'Solvers'
    def CalculateVorticity(self, cell:'vtkGenericCell', pcoords:[float, float, float], cellVectors:'vtkDoubleArray', vorticity:[float, float, float]) -> None: ...
    ...
    def GenerateNormals(self, output:'vtkPolyData', firstNormal:[float, ...], vecName:str) -> None: ...
    def GetComputeVorticity(self) -> bool: ...
...
class vtkTemporalInterpolatedVelocityField(vtkmodules.vtkCommonMath.vtkFunctionSet):
    ...
    @overload
    def FunctionValues(self, x:[float, ...], u:[float, ...]) -> int: ...
    @overload
    def FunctionValues(self, x:[float, ...], f:[float, ...], userData:Pointer) -> int: ...
    def FunctionValuesAtT(self, T:int, x:[float, ...], u:[float, ...]) -> int: ...
    def GetCachedCellIds(self, id:[int, int], ds:[int, int]) -> bool: ...
    def GetCurrentWeight(self) -> float: ...
    def GetLastGoodVelocity(self) -> (float, float, float): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    @overload
    ...
    def IsA(self, type:str) -> int: ...
    def IsStatic(self, datasetIndex:int) -> bool: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def NewInstance(self) -> 'vtkTemporalInterpolatedVelocityField': ...
    def QuickTestPoint(self, x:[float, ...]) -> int: ...
    @staticmethod
    def SafeDownCast(o:'vtkObjectBase') -> 'vtkTemporalInterpolatedVelocityField': ...
    def SelectVectors(self, fieldName:str) -> None: ...
    def SetCachedCellIds(self, id:[int, int], ds:[int, int]) -> None: ...
    def SetDataSetAtTime(self, I:int, N:int, T:float, dataset:'vtkDataSet', staticdataset:bool) -> None: ...
    def ShowCacheResults(self) -> None: ...
    def TestPoint(self, x:[float, ...]) -> int: ...
