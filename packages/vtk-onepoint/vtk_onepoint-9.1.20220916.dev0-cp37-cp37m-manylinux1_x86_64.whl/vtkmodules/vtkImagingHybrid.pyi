...
class vtkBooleanTexture(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    def GetInIn(self) -> (int, int): ...
    def GetInOn(self) -> (int, int): ...
    def GetInOut(self) -> (int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetOnIn(self) -> (int, int): ...
    def GetOnOn(self) -> (int, int): ...
    def GetOnOut(self) -> (int, int): ...
    def GetOutIn(self) -> (int, int): ...
    def GetOutOn(self) -> (int, int): ...
    def GetOutOut(self) -> (int, int): ...
...
class vtkCheckerboardSplatter(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    def GetSampleDimensions(self) -> (int, int, int): ...
    ...
    @overload
    def SetModelBounds(self, _arg:(float, float, float, float, float, float)) -> None: ...
    ...
    @overload
    def SetSampleDimensions(self, dim:[int, int, int]) -> None: ...
...
class vtkGaussianSplatter(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    def SamplePoint(self, x:[float, float, float]) -> float: ...
    def ScalarWarpingOff(self) -> None: ...
    def ScalarWarpingOn(self) -> None: ...
    def SetAccumulationMode(self, _arg:int) -> None: ...
    def SetAccumulationModeToMax(self) -> None: ...
    ...
    @overload
    def SetSampleDimensions(self, dim:[int, int, int]) -> None: ...
    def SetScalar(self, idx:int, dist2:float, sPtr:[float, ...]) -> None: ...
    def SetScalarWarping(self, _arg:int) -> None: ...
    def SetScaleFactor(self, _arg:float) -> None: ...

class vtkImageCursor3D(vtkmodules.vtkCommonExecutionModel.vtkImageInPlaceFilter):
    def GetCursorPosition(self) -> (float, float, float): ...
    ...
    @overload
    def SetCursorPosition(self, _arg:(float, float, float)) -> None: ...
...
class vtkImageRectilinearWipe(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @overload
    def SetAxis(self, _arg:(int, int)) -> None: ...
    ...
    @overload
    def SetPosition(self, _arg:(int, int)) -> None: ...
...
class vtkShepardMethod(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    def ComputeModelBounds(self, origin:[float, float, float], spacing:[float, float, float]) -> float: ...
