...
class vtkFreeTypeStringToImage(vtkmodules.vtkRenderingCore.vtkStringToImage):
    ...
    def RenderString(self, property:'vtkTextProperty', string:str, dpi:int, data:'vtkImageData', textDims:[int, int]=...) -> int: ...
    @staticmethod
...
class vtkFreeTypeTools(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetBoundingBox(self, tprop:'vtkTextProperty', str:str, dpi:int, bbox:[int, int, int, int]) -> bool: ...
    ...
    def MapTextPropertyToId(self, tprop:'vtkTextProperty', tprop_cache_id:[int, ...]) -> None: ...
    def NewInstance(self) -> 'vtkFreeTypeTools': ...
    def RenderString(self, tprop:'vtkTextProperty', str:str, dpi:int, data:'vtkImageData', textDims:[int, int]=...) -> bool: ...
    @staticmethod
...
class vtkMathTextUtilities(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def RenderString(self, str:str, data:'vtkImageData', tprop:'vtkTextProperty', dpi:int, textDims:[int, int]=...) -> bool: ...
    @staticmethod
