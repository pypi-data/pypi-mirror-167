...
class vtkCompassRepresentation(vtkmodules.vtkInteractionWidgets.vtkContinuousValueWidgetRepresentation):
    ...
    def DistanceWidgetInteraction(self, eventPos:[float, float]) -> None: ...
    ...
    def StartWidgetInteraction(self, eventPos:[float, float]) -> None: ...
    def TiltWidgetInteraction(self, eventPos:[float, float]) -> None: ...
    def UpdateDistance(self, time:float) -> None: ...
    def UpdateTilt(self, time:float) -> None: ...
    def WidgetInteraction(self, eventPos:[float, float]) -> None: ...
