...
class vtkRIBExporter(vtkExporter):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetPixelSamples(self) -> (int, int): ...
    ...
    @overload
    def SetPixelSamples(self, _arg:(int, int)) -> None: ...
    @overload
...
class vtkSVGContextDevice2D(vtkmodules.vtkRenderingContext2D.vtkContextDevice2D):
    ...
    def DrawMathTextString(self, point:[float, ...], str:str) -> None: ...
...
class vtkX3DExporterWriter(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def SetField(self, attributeID:int, type:int, a:(float, ...)) -> None: ...
    @overload
    def SetField(self, attributeID:int, type:int, a:'vtkDataArray') -> None: ...
    @overload
    def SetField(self, attributeID:int, values:(float, ...), size:int) -> None: ...
    @overload
    def SetField(self, attributeID:int, values:(int, ...), size:int, image:bool=False) -> None: ...
    def SetWriteToOutputString(self, _arg:int) -> None: ...
