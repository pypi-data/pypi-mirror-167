...
class vtkImageReader2(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    def GetDataDirection(self) -> (float, float, float, float, float, float, float, float, float): ...
    def GetDataExtent(self) -> (int, int, int, int, int, int): ...
    def GetDataIncrements(self) -> (int, int, int, int): ...
    ...
    def SetDataDirection(self, data:(float, ...)) -> None: ...
    @overload
...
class vtkImageReader(vtkImageReader2):
    ...
    def ComputeInverseTransformedExtent(self, inExtent:[int, int, int, int, int, int], outExtent:[int, int, int, int, int, int]) -> None: ...
    def ComputeInverseTransformedIncrements(self, inIncr:[int, int, int], outIncr:[int, int, int]) -> None: ...
    def GetDataMask(self) -> int: ...
    def GetDataVOI(self) -> (int, int, int, int, int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    def OpenAndSeekFile(self, extent:[int, int, int, int, int, int], slice:int) -> int: ...
    @staticmethod
    ...
    @overload
    def SetDataVOI(self, _arg:(int, int, int, int, int, int)) -> None: ...
...
class vtkDEMReader(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    def GetElevationBounds(self) -> (float, float): ...
    ...
    def GetProfileDimension(self) -> (int, int): ...
    def GetProjectionParameters(self) -> (float, float, float, float, float, float, float, float, float, float, float, float, float, float, float): ...
    def GetSpatialResolution(self) -> (float, float, float): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkDICOMImageReader(vtkImageReader2):
    ...
    def GetImageOrientationPatient(self) -> (float, float, float, float, float, float): ...
    def GetImagePositionPatient(self) -> (float, float, float): ...
    ...
    def GetPixelSpacing(self) -> (float, float, float): ...
...
class vtkImageExport(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @overload
    def GetDataDimensions(self, ptr:[int, ...]) -> None: ...
    @overload
    def GetDataDimensions(self) -> (int, int, int): ...
    @overload
    def GetDataDirection(self) -> (float, float, float, float, float, float, float, float, float): ...
    @overload
    def GetDataDirection(self, ptr:[float, ...]) -> None: ...
    @overload
    def GetDataExtent(self) -> (int, int, int, int, int, int): ...
    @overload
    def GetDataExtent(self, ptr:[int, ...]) -> None: ...
    def GetDataMemorySize(self) -> int: ...
    def GetDataNumberOfScalarComponents(self) -> int: ...
    @overload
    def GetDataOrigin(self) -> (float, float, float): ...
    @overload
    def GetDataOrigin(self, ptr:[float, ...]) -> None: ...
    def GetDataScalarType(self) -> int: ...
    def GetDataScalarTypeAsString(self) -> str: ...
    @overload
    def GetDataSpacing(self) -> (float, float, float): ...
    @overload
    def GetDataSpacing(self, ptr:[float, ...]) -> None: ...
...
class vtkMedicalImageProperties(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetDirectionCosine(self) -> (float, float, float, float, float, float): ...
    ...
    def GetModality(self) -> str: ...
    @overload
    def GetNthWindowLevelPreset(self, idx:int, w:[float, ...], l:[float, ...]) -> int: ...
    @overload
    def GetNthWindowLevelPreset(self, idx:int) -> (float, float): ...
    ...
    @overload
    def SetDirectionCosine(self, _arg:(float, float, float, float, float, float)) -> None: ...
...
class vtkNIFTIImageHeader(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetSRowX(self) -> (float, float, float, float): ...
    def GetSRowY(self) -> (float, float, float, float): ...
    def GetSRowZ(self) -> (float, float, float, float): ...
    ...
    @overload
    def SetSRowX(self, _arg:(float, float, float, float)) -> None: ...
    @overload
    def SetSRowY(self, _arg1:float, _arg2:float, _arg3:float, _arg4:float) -> None: ...
    @overload
    def SetSRowY(self, _arg:(float, float, float, float)) -> None: ...
    @overload
    def SetSRowZ(self, _arg1:float, _arg2:float, _arg3:float, _arg4:float) -> None: ...
    @overload
    def SetSRowZ(self, _arg:(float, float, float, float)) -> None: ...
...
class vtkPNGReader(vtkImageReader2):
    ...
    def GetTextChunks(self, key:str, beginEndIndex:[int, int]) -> None: ...
...
class vtkSEPReader(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    def GetFileName(self) -> str: ...
    def GetFixedDimRange(self) -> (int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
...
class vtkVolumeReader(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    def GetImageRange(self) -> (int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def IsA(self, type:str) -> int: ...
    ...
    @overload
    def SetImageRange(self, _arg:(int, int)) -> None: ...

class vtkVolume16Reader(vtkVolumeReader):
    def GetDataByteOrder(self) -> int: ...
    def GetDataByteOrderAsString(self) -> str: ...
    def GetDataDimensions(self) -> (int, int): ...
    def GetDataMask(self) -> int: ...
    def GetHeaderSize(self) -> int: ...
    def GetImage(self, ImageNumber:int) -> 'vtkImageData': ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    ...
    @overload
    def SetDataDimensions(self, _arg:(int, int)) -> None: ...
    def SetDataMask(self, _arg:int) -> None: ...
