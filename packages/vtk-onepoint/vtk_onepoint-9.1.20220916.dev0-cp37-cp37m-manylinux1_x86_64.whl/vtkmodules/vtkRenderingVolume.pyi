...
class vtkDirectionEncoder(vtkmodules.vtkCommonCore.vtkObject):
    def GetDecodedGradient(self, value:int) -> (float, float, float): ...
    def GetDecodedGradientTable(self) -> Pointer: ...
    def GetEncodedDirection(self, n:[float, float, float]) -> int: ...
...
class vtkEncodedGradientEstimator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetBounds(self) -> (int, int, int, int, int, int): ...
    ...
    def GetInputAspect(self) -> (float, float, float): ...
    def GetInputData(self) -> 'vtkImageData': ...
    def GetInputSize(self) -> (int, int, int): ...
    ...
    @overload
    def SetBounds(self, _arg:(int, int, int, int, int, int)) -> None: ...
...
class vtkFixedPointRayCastImage(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetImageInUseSize(self) -> (int, int): ...
    def GetImageMemorySize(self) -> (int, int): ...
    def GetImageOrigin(self) -> (int, int): ...
    def GetImageSampleDistance(self) -> float: ...
    def GetImageViewportSize(self) -> (int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    def GetZBufferOrigin(self) -> (int, int): ...
    def GetZBufferSize(self) -> (int, int): ...
...
class vtkVolumeMapper(vtkmodules.vtkRenderingCore.vtkAbstractVolumeMapper):
    ...
    def GetAverageIPScalarRange(self) -> (float, float): ...
    ...
    def GetCroppingRegionPlanes(self) -> (float, float, float, float, float, float): ...
    @overload
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetVoxelCroppingRegionPlanes(self) -> (float, float, float, float, float, float): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @overload
    def SetAverageIPScalarRange(self, _arg:(float, float)) -> None: ...
    ...
    @overload
    def SetCroppingRegionPlanes(self, _arg:(float, float, float, float, float, float)) -> None: ...
    @overload
    def SetInputData(self, __a:'vtkImageData') -> None: ...
    @overload
...
class vtkFixedPointVolumeRayCastMapper(vtkVolumeMapper):
    ...
    def CheckIfCropped(self, pos:[int, int, int]) -> int: ...
    def CheckMIPMinMaxVolumeFlag(self, pos:[int, int, int], c:int, maxIdx:int, flip:int) -> int: ...
    def CheckMinMaxVolumeFlag(self, pos:[int, int, int], c:int) -> int: ...
    def ComputeRayInfo(self, x:int, y:int, pos:[int, int, int], dir:[int, int, int], numSteps:[int, ...]) -> None: ...
    @overload
    ...
    def CreateCanonicalView(self, volume:'vtkVolume', image:'vtkImageData', blend_mode:int, viewDirection:[float, float, float], viewUp:[float, float, float]) -> None: ...
    def DisplayRenderedImage(self, __a:'vtkRenderer', __b:'vtkVolume') -> None: ...
    def FixedPointIncrement(self, position:[int, int, int], increment:[int, int, int]) -> None: ...
    ...
    def GetFloatTripleFromPointer(self, v:[float, float, float], ptr:[float, ...]) -> None: ...
    ...
    def GetTableScale(self) -> (float, float, float, float): ...
    def GetTableShift(self) -> (float, float, float, float): ...
    def GetUIntTripleFromPointer(self, v:[int, int, int], ptr:[int, ...]) -> None: ...
    ...
    def LookupColorUC(self, colorTable:[int, ...], scalarOpacityTable:[int, ...], index:int, color:[int, int, int, int]) -> None: ...
    def LookupDependentColorUC(self, colorTable:[int, ...], scalarOpacityTable:[int, ...], index:[int, int, int, int], components:int, color:[int, int, int, int]) -> None: ...
    def NewInstance(self) -> 'vtkFixedPointVolumeRayCastMapper': ...
    def PerImageInitialization(self, __a:'vtkRenderer', __b:'vtkVolume', __c:int, __d:[float, ...], __e:[float, ...], __f:[int, ...]) -> int: ...
    ...
    def ShiftVectorDown(self, in_:[int, int, int], out:[int, int, int]) -> None: ...
    def ShouldUseNearestNeighborInterpolation(self, vol:'vtkVolume') -> int: ...
    @overload
    def ToFixedPointDirection(self, dir:float) -> int: ...
    @overload
    def ToFixedPointDirection(self, in_:[float, float, float], out:[int, int, int]) -> None: ...
    @overload
    def ToFixedPointPosition(self, val:float) -> int: ...
    @overload
    def ToFixedPointPosition(self, in_:[float, float, float], out:[int, int, int]) -> None: ...
...
class vtkGPUVolumeRayCastMapper(vtkVolumeMapper):
    ...
    def CreateCanonicalView(self, ren:'vtkRenderer', volume:'vtkVolume', image:'vtkImageData', blend_mode:int, viewDirection:[float, float, float], viewUp:[float, float, float]) -> None: ...
    def GPURender(self, __a:'vtkRenderer', __b:'vtkVolume') -> None: ...
    def GetAutoAdjustSampleDistances(self) -> int: ...
    def GetAutoAdjustSampleDistancesMaxValue(self) -> int: ...
    def GetAutoAdjustSampleDistancesMinValue(self) -> int: ...
    def GetBoundsFromPort(self, port:int) -> (float, float, float, float, float, float): ...
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetReductionRatio(self, ratio:[float, float, float]) -> None: ...
...
class vtkProjectedTetrahedraMapper(vtkUnstructuredGridVolumeMapper):
    ...
    @staticmethod
    def TransformPoints(inPoints:'vtkPoints', projection_mat:(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float), modelview_mat:(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float), outPoints:'vtkFloatArray') -> None: ...
...
class vtkRayCastImageDisplayHelper(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def ReleaseGraphicsResources(self, __a:'vtkWindow') -> None: ...
    @overload
    def RenderTexture(self, vol:'vtkVolume', ren:'vtkRenderer', imageMemorySize:[int, int], imageViewportSize:[int, int], imageInUseSize:[int, int], imageOrigin:[int, int], requestedDepth:float, image:[int, ...]) -> None: ...
    @overload
    def RenderTexture(self, vol:'vtkVolume', ren:'vtkRenderer', imageMemorySize:[int, int], imageViewportSize:[int, int], imageInUseSize:[int, int], imageOrigin:[int, int], requestedDepth:float, image:[int, ...]) -> None: ...
    @overload
...
class vtkUnstructuredGridVolumeRayIntegrator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def Integrate(self, intersectionLengths:'vtkDoubleArray', nearIntersections:'vtkDataArray', farIntersections:'vtkDataArray', color:[float, float, float, float]) -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkUnstructuredGridLinearRayIntegrator(vtkUnstructuredGridVolumeRayIntegrator):
    ...
    @overload
    @staticmethod
    def IntegrateRay(length:float, intensity_front:float, attenuation_front:float, intensity_back:float, attenuation_back:float, color:[float, float, float, float]) -> None: ...
    @overload
    @staticmethod
    def IntegrateRay(length:float, color_front:(float, float, float), attenuation_front:float, color_back:(float, float, float), attenuation_back:float, color:[float, float, float, float]) -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkUnstructuredGridVolumeRayCastIterator(vtkmodules.vtkCommonCore.vtkObject):
    def GetBounds(self) -> (float, float): ...
    ...
    @overload
    def SetBounds(self, _arg:(float, float)) -> None: ...
...
class vtkVolumeRayCastSpaceLeapingImageFilter(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def ComputeInputExtentsForOutput(inExt:[int, int, int, int, int, int], inDim:[int, int, int], outExt:[int, int, int, int, int, int], inData:'vtkImageData') -> None: ...
    def ComputeMinMaxOff(self) -> None: ...
    def ComputeMinMaxOn(self) -> None: ...
    def ComputeOffset(self, ext:(int, int, int, int, int, int), wholeExt:( int, int, int, int, int, int), nComponents:int) -> int: ...
    ...
    def GetMinMaxVolume(self, dims:[int, int, int, int]) -> Pointer: ...
    ...
    def GetTableScale(self) -> (float, float, float, float): ...
    def GetTableShift(self) -> (float, float, float, float): ...
    def GetTableSize(self) -> (int, int, int, int): ...
