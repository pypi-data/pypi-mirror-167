...
class vtkKdTreeSelector(vtkmodules.vtkCommonExecutionModel.vtkSelectionAlgorithm):
    ...
    def GetSelectionBounds(self) -> (float, float, float, float, float, float): ...
    ...
    @overload
    def SetSelectionBounds(self, _arg:(float, float, float, float, float, float)) -> None: ...
...
class vtkLinearSelector(vtkmodules.vtkCommonExecutionModel.vtkSelectionAlgorithm):
    def GetEndPoint(self) -> (float, float, float): ...
    def GetIncludeVertices(self) -> bool: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetPoints(self) -> 'vtkPoints': ...
    def GetStartPoint(self) -> (float, float, float): ...
    ...
    @overload
    def SetEndPoint(self, _arg:(float, float, float)) -> None: ...
    ...
    @overload
    def SetStartPoint(self, _arg:(float, float, float)) -> None: ...
