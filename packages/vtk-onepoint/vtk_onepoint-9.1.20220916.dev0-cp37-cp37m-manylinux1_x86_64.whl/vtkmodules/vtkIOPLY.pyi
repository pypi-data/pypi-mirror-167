...
class vtkPLY(object):
    ...
    @staticmethod
    def get_ascii_item(__a:str, __b:int, __c:[int, ...], __d:[int, ...], __e:[float, ...]) -> None: ...
    @staticmethod
    def get_item_value(__a:str, __b:int) -> float: ...
    @staticmethod
    def get_prop_type(__a:str) -> int: ...
    @staticmethod
    def get_stored_item(__a:Pointer, __b:int, __c:[int, ...], __d:[int, ...], __e:[float, ...]) -> None: ...
    @staticmethod
...
class vtkPLYWriter(vtkmodules.vtkIOCore.vtkWriter):
    ...
    @overload
    def SetColor(self, _arg:(int, int, int)) -> None: ...
