...
class vtkExtractHistogram2D(vtkmodules.vtkFiltersStatistics.vtkStatisticsAlgorithm):
    ...
    @overload
    def GetBinRange(self, binX:int, binY:int, range:[float, float, float, float]) -> int: ...
    @overload
    def GetBinRange(self, bin:int, range:[float, float, float, float]) -> int: ...
    def GetBinWidth(self, bw:[float, float]) -> None: ...
    def GetComponentsToProcess(self) -> (int, int): ...
    def GetCustomHistogramExtents(self) -> (float, float, float, float): ...
    def GetHistogramExtents(self) -> Pointer: ...
    def GetMaximumBinCount(self) -> float: ...
    def GetNumberOfBins(self) -> (int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    @overload
    def SetComponentsToProcess(self, _arg:(int, int)) -> None: ...
    @overload
    def SetCustomHistogramExtents(self, _arg1:float, _arg2:float, _arg3:float, _arg4:float) -> None: ...
    @overload
    def SetCustomHistogramExtents(self, _arg:(float, float, float, float)) -> None: ...
    @overload
    def SetNumberOfBins(self, _arg1:int, _arg2:int) -> None: ...
    @overload
    def SetNumberOfBins(self, _arg:(int, int)) -> None: ...
...
class vtkPairwiseExtractHistogram2D(vtkmodules.vtkFiltersStatistics.vtkStatisticsAlgorithm):
    ...
    def Aggregate(self, __a:'vtkDataObjectCollection', __b:'vtkMultiBlockDataSet') -> None: ...
    @overload
    def GetBinRange(self, idx:int, binX:int, binY:int, range:[float, float, float, float]) -> int: ...
    @overload
    def GetBinRange(self, idx:int, bin:int, range:[float, float, float, float]) -> int: ...
    def GetBinWidth(self, idx:int, bw:[float, float]) -> None: ...
    ...
    @overload
    def SetCustomColumnRange(self, col:int, range:[float, float]) -> None: ...
    @overload
