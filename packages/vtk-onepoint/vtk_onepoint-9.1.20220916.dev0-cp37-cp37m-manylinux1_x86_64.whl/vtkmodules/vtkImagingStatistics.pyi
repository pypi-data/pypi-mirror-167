...
class vtkImageAccumulate(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    @overload
    def GetComponentExtent(self, extent:[int, int, int, int, int, int]) -> None: ...
    @overload
    def GetComponentExtent(self) -> (int, int, int, int, int, int): ...
    def GetComponentOrigin(self) -> (float, float, float): ...
    def GetComponentSpacing(self) -> (float, float, float): ...
    def GetIgnoreZero(self) -> int: ...
    def GetIgnoreZeroMaxValue(self) -> int: ...
    def GetIgnoreZeroMinValue(self) -> int: ...
    def GetMax(self) -> (float, float, float): ...
    def GetMean(self) -> (float, float, float): ...
    def GetMin(self) -> (float, float, float): ...
    ...
    def GetStandardDeviation(self) -> (float, float, float): ...
    ...
    @overload
    def SetComponentExtent(self, extent:[int, int, int, int, int, int]) -> None: ...
    @overload
    ...
    @overload
    def SetComponentOrigin(self, _arg:(float, float, float)) -> None: ...
    @overload
    def SetComponentSpacing(self, _arg1:float, _arg2:float, _arg3:float) -> None: ...
    @overload
    def SetComponentSpacing(self, _arg:(float, float, float)) -> None: ...
...
class vtkImageHistogram(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    def GetHistogramImageSize(self) -> (int, int): ...
    ...
    @overload
    def SetHistogramImageSize(self, _arg:(int, int)) -> None: ...
...
class vtkImageHistogramStatistics(vtkImageHistogram):
    def GetAutoRange(self) -> (float, float): ...
    def GetAutoRangeExpansionFactors(self) -> (float, float): ...
    def GetAutoRangePercentiles(self) -> (float, float): ...
    ...
    @overload
    def SetAutoRangeExpansionFactors(self, _arg:(float, float)) -> None: ...
    @overload
    def SetAutoRangePercentiles(self, _arg1:float, _arg2:float) -> None: ...
    @overload
    def SetAutoRangePercentiles(self, _arg:(float, float)) -> None: ...
