...
class vtkAxis(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    def GetUnscaledRange(self, range:[float, ...]) -> None: ...
    ...
    @overload
    def SetRange(self, range:[float, float]) -> None: ...
    ...
    @overload
    def SetUnscaledRange(self, range:[float, float]) -> None: ...
...
class vtkChartLegend(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    @overload
    def SetPoint(self, _arg:(float, float)) -> None: ...
    @overload
...
class vtkChart(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    def GetPoint1(self) -> (int, int): ...
    def GetPoint2(self) -> (int, int): ...
    ...
    @overload
    def SetPoint1(self, _arg:(int, int)) -> None: ...
    @overload
    def SetPoint2(self, _arg1:int, _arg2:int) -> None: ...
    @overload
    def SetPoint2(self, _arg:(int, int)) -> None: ...
...
class vtkChartMatrix(vtkmodules.vtkRenderingContext2D.vtkAbstractContextItem):
    ...
    def GetBorders(self, borders:[int, int, int, int]) -> None: ...
...
class vtkColorLegend(vtkChartLegend):
    ...
    def GetBoundingRect(self, painter:'vtkContext2D') -> 'vtkRectf': ...
    def GetBounds(self, bounds:[float, float, float, float]) -> None: ...
...
class vtkPlot(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    @overload
    @staticmethod
    def ClampPos(pos:[float, float], bounds:[float, float, float, float]) -> bool: ...
    @overload
    def ClampPos(self, pos:[float, float]) -> bool: ...
    def GetBounds(self, bounds:[float, float, float, float]) -> None: ...
    def GetBrush(self) -> 'vtkBrush': ...
    @overload
    def GetColor(self, rgb:[float, float, float]) -> None: ...
    @overload
    def GetColor(self, rgb:[int, int, int]) -> None: ...
    ...
    def GetUnscaledInputBounds(self, bounds:[float, float, float, float]) -> None: ...
...
class vtkControlPointsItem(vtkPlot):
    ...
    def AddPoint(self, newPos:[float, ...]) -> int: ...
    def DeselectAllPoints(self) -> None: ...
    @overload
    def DeselectPoint(self, pointId:int) -> None: ...
    @overload
    def DeselectPoint(self, currentPoint:[float, ...]) -> None: ...
    def DrawPointsOff(self) -> None: ...
    def DrawPointsOn(self) -> None: ...
    def FindPoint(self, pos:[float, ...]) -> int: ...
    def GetAddPointItem(self) -> 'vtkPlot': ...
    def GetBounds(self, bounds:[float, float, float, float]) -> None: ...
    def GetControlPoint(self, index:int, point:[float, ...]) -> None: ...
    def GetControlPointId(self, pos:[float, ...]) -> int: ...
    ...
    def GetUserBounds(self) -> (float, float, float, float): ...
    def GetValidBounds(self) -> (float, float, float, float): ...
    def IsA(self, type:str) -> int: ...
    def IsOverPoint(self, pos:[float, ...], pointId:int) -> bool: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def KeyPressEvent(self, key:'vtkContextKeyEvent') -> bool: ...
    ...
    @overload
    def RemovePoint(self, pos:[float, ...]) -> int: ...
    @overload
    ...
    @overload
    def SelectPoint(self, currentPoint:[float, ...]) -> None: ...
    def SelectPoints(self, min:'vtkVector2f', max:'vtkVector2f') -> bool: ...
    def SetControlPoint(self, index:int, point:[float, ...]) -> None: ...
    ...
    @overload
    def SetUserBounds(self, _arg:(float, float, float, float)) -> None: ...
    @overload
    def SetValidBounds(self, _arg1:float, _arg2:float, _arg3:float, _arg4:float) -> None: ...
    @overload
    def SetValidBounds(self, _arg:(float, float, float, float)) -> None: ...
    @overload
    ...
    @overload
    def ToggleSelectPoint(self, currentPoint:[float, ...]) -> None: ...
...
class vtkCompositeControlPointsItem(vtkColorTransferControlPointsItem):
    ...
    def AddPoint(self, newPos:[float, ...]) -> int: ...
    def GetControlPoint(self, index:int, point:[float, float, float, float]) -> None: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetNumberOfPoints(self) -> int: ...
...
class vtkContextArea(vtkmodules.vtkRenderingContext2D.vtkAbstractContextItem):
    ...
    @overload
    def GetFixedMarginsArray(self, margins:[int, int, int, int]) -> None: ...
    @overload
    ...
    @overload
    def SetFixedMargins(self, margins:[int, int, int, int]) -> None: ...
    @overload
...
class vtkPiecewisePointHandleItem(vtkmodules.vtkRenderingContext2D.vtkContextItem):
    ...
    def Hit(self, mouse:'vtkContextMouseEvent') -> bool: ...
    def IsA(self, type:str) -> int: ...
    def IsOverHandle(self, pos:[float, ...]) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    def MouseButtonPressEvent(self, mouse:'vtkContextMouseEvent') -> bool: ...
    def MouseButtonReleaseEvent(self, mouse:'vtkContextMouseEvent') -> bool: ...
...
class vtkPlotBar(vtkPlot):
    ...
    @overload
    def GetBounds(self, bounds:[float, float, float, float], unscaled:bool) -> None: ...
    @overload
    def GetBounds(self, bounds:[float, float, float, float]) -> None: ...
    def GetColor(self, rgb:[float, float, float]) -> None: ...
    def GetColorArrayName(self) -> str: ...
    def GetColorSeries(self) -> 'vtkColorSeries': ...
    def GetDataBounds(self, bounds:[float, float]) -> None: ...
...
class vtkPlotRangeHandlesItem(vtkPlot):
    ...
    def GetBounds(self, bounds:[float, float, float, float]) -> None: ...
    def GetExtent(self) -> (float, float, float, float): ...
    ...
    def GetHandlesRange(self, range:[float, float]) -> None: ...
    ...
    @overload
    def SetExtent(self, _arg:(float, float, float, float)) -> None: ...
...
class vtkPlotBox(vtkPlot):
    ...
    def SetColumnColor(self, colName:str, rgb:[float, ...]) -> None: ...
    @overload
    def SetInputData(self, table:'vtkTable') -> None: ...
    @overload
...
class vtkPlotPie(vtkPlot):
    def GetColorSeries(self) -> 'vtkColorSeries': ...
    def GetDimensions(self) -> (int, int, int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def IsA(self, type:str) -> int: ...
    ...
    @overload
    def SetDimensions(self, arg:(int, int, int, int)) -> None: ...
    def UpdateCache(self) -> bool: ...
