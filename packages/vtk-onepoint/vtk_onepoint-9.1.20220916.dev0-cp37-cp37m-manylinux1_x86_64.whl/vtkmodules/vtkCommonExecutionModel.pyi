...
class vtkAlgorithm(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def GetUpdateExtent(self) -> (int, int, int, int, int, int): ...
    @overload
    def GetUpdateExtent(self, port:int) -> (int, int, int, int, int, int): ...
    @overload
    ...
    @overload
    def GetUpdateExtent(self, extent:[int, int, int, int, int, int]) -> None: ...
    @overload
    def GetUpdateExtent(self, port:int, extent:[int, int, int, int, int, int]) -> None: ...
    @overload
    ...
    def UpdateExtent(self, extents:(int, int, int, int, int, int)) -> int: ...
    @overload
    ...
    def UpdatePiece(self, piece:int, numPieces:int, ghostLevels:int, extents:(int, int, int, int, int, int)=...) -> int: ...
    def UpdateProgress(self, amount:float) -> None: ...
    def UpdateTimeStep(self, time:float, piece:int=-1, numPieces:int=1, ghostLevels:int=0, extents:(int, int, int, int, int, int)=...) -> int: ...
...
class vtkStreamingDemandDrivenPipeline(vtkDemandDrivenPipeline):
    ...
    @overload
    @staticmethod
    def GetUpdateExtent(__a:'vtkInformation', extent:[int, int, int, int, int, int]) -> None: ...
    @overload
    @staticmethod
    ...
    @overload
    @staticmethod
    def GetWholeExtent(__a:'vtkInformation', extent:[int, int, int, int, int, int]) -> None: ...
    @overload
    @staticmethod
    def GetWholeExtent(__a:'vtkInformation') -> (int, int, int, int, int, int): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @staticmethod
    def SetWholeExtent(__a:'vtkInformation', extent:[int, int, int, int, int, int]) -> int: ...
    @staticmethod
...
class vtkExtentRCBPartitioner(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def GetPartitionExtent(self, idx:int, ext:[int, int, int, int, int, int]) -> None: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @overload
    def SetGlobalExtent(self, ext:[int, int, int, int, int, int]) -> None: ...
...
class vtkExtentSplitter(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def AddExtent(self, extent:[int, ...]) -> None: ...
    @overload
    def AddExtentSource(self, id:int, priority:int, x0:int, x1:int, y0:int, y1:int, z0:int, z1:int) -> None: ...
    @overload
    def AddExtentSource(self, id:int, priority:int, extent:[int, ...]) -> None: ...
    ...
    @overload
    def GetSubExtent(self, index:int) -> (int, int, int, int, int, int): ...
    @overload
    def GetSubExtent(self, index:int, extent:[int, ...]) -> None: ...
...
class vtkExtentTranslator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    def PieceToExtentThreadSafe(self, piece:int, numPieces:int, ghostLevel:int, wholeExtent:[int, ...], resultExtent:[int, ...], splitMode:int, byPoints:int) -> int: ...
    @staticmethod
    ...
    @overload
    def SetExtent(self, _arg:(int, int, int, int, int, int)) -> None: ...
    ...
    def SetSplitPath(self, len:int, splitpath:[int, ...]) -> None: ...
    @overload
...
class vtkSphereTree(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def SelectLine(self, origin:[float, float, float], ray:[float, float, float], numSelected:int) -> Pointer: ...
    @overload
    def SelectLine(self, origin:[float, float, float], ray:[float, float, float], cellIds:'vtkIdList') -> None: ...
    @overload
    def SelectPlane(self, origin:[float, float, float], normal:[float, float, float], numSelected:int) -> Pointer: ...
    @overload
    def SelectPlane(self, origin:[float, float, float], normal:[float, float, float], cellIds:'vtkIdList') -> None: ...
    @overload
    def SelectPoint(self, point:[float, float, float], numSelected:int) -> Pointer: ...
    @overload
    def SelectPoint(self, point:[float, float, float], cellIds:'vtkIdList') -> None: ...
...
class vtkThreadedImageAlgorithm(vtkImageAlgorithm):
    ...
    def GetMinimumPieceSize(self) -> (int, int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    @overload
    def SetMinimumPieceSize(self, _arg:(int, int, int)) -> None: ...
    ...
    def SplitExtent(self, splitExt:[int, int, int, int, int, int], startExt:[int, int, int, int, int, int], num:int, total:int) -> int: ...
    def ThreadedExecute(self, inData:'vtkImageData', outData:'vtkImageData', extent:[int, int, int, int, int, int], threadId:int) -> None: ...
