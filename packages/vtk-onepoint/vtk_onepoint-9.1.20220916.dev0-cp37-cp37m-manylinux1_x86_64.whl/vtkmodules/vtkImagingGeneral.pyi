...
class vtkImageSpatialAlgorithm(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    def GetKernelMiddle(self) -> (int, int, int): ...
    def GetKernelSize(self) -> (int, int, int): ...
...
class vtkImageCheckerboard(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @overload
    def SetNumberOfDivisions(self, _arg:(int, int, int)) -> None: ...
...
class vtkImageConvolve(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    @overload
    def GetKernel3x3(self) -> (float, float, float, float, float, float, float, float, float): ...
    @overload
    def GetKernel3x3(self, kernel:[float, float, float, float, float, float, float, float, float]) -> None: ...
    @overload
    def GetKernel3x3x3(self) -> (float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float): ...
    @overload
    def GetKernel3x3x3(self, kernel:[float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float]) -> None: ...
    @overload
    def GetKernel5x5(self) -> (float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float): ...
    @overload
    def GetKernel5x5(self, kernel:[float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float]) -> None: ...
    def GetKernel5x5x5(self) -> (float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float): ...
    @overload
    def GetKernel7x7(self) -> (float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float): ...
    @overload
    def GetKernel7x7(self, kernel:[float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float]) -> None: ...
    def GetKernel7x7x7(self) -> (float, ...): ...
    def GetKernelSize(self) -> (int, int, int): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    def SetKernel3x3(self, kernel:(float, float, float, float, float, float, float, float, float)) -> None: ...
    def SetKernel3x3x3(self, kernel:(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float)) -> None: ...
    def SetKernel5x5(self, kernel:(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float)) -> None: ...
    def SetKernel5x5x5(self, kernel:(float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float, float)) -> None: ...
...
class vtkImageGaussianSmooth(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetRadiusFactors(self) -> (float, float, float): ...
    def GetStandardDeviations(self) -> (float, float, float): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @overload
    def SetRadiusFactors(self, _arg:(float, float, float)) -> None: ...
    @overload
    ...
    @overload
    def SetStandardDeviations(self, _arg:(float, float, float)) -> None: ...
    @overload
...
class vtkImageSlab(vtkmodules.vtkCommonExecutionModel.vtkThreadedImageAlgorithm):
    ...
    def GetSliceRange(self) -> (int, int): ...
    ...
    @overload
    def SetSliceRange(self, _arg:(int, int)) -> None: ...
