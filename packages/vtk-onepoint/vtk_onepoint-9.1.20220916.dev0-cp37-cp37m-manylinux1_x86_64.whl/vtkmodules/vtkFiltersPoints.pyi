...
class vtkInterpolationKernel(vtkmodules.vtkCommonCore.vtkObject):
    def ComputeBasis(self, x:[float, float, float], pIds:'vtkIdList', ptId:int=0) -> int: ...
    def ComputeWeights(self, x:[float, float, float], pIds:'vtkIdList', weights:'vtkDoubleArray') -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
...
class vtkGeneralizedKernel(vtkInterpolationKernel):
    ...
    def ComputeBasis(self, x:[float, float, float], pIds:'vtkIdList', ptId:int=0) -> int: ...
    @overload
    def ComputeWeights(self, x:[float, float, float], pIds:'vtkIdList', prob:'vtkDoubleArray', weights:'vtkDoubleArray') -> int: ...
    @overload
    def ComputeWeights(self, x:[float, float, float], pIds:'vtkIdList', weights:'vtkDoubleArray') -> int: ...
...
class vtkHierarchicalBinningFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetBinBounds(self, globalBin:int, bounds:[float, float, float, float, float, float]) -> None: ...
    def GetBinOffset(self, globalBin:int, npts:int) -> int: ...
    def GetBounds(self) -> (float, float, float, float, float, float): ...
    def GetDivisions(self) -> (int, int, int): ...
    def GetLevelOffset(self, level:int, npts:int) -> int: ...
    def GetLocalBinBounds(self, level:int, localBin:int, bounds:[float, float, float, float, float, float]) -> None: ...
    ...
    @overload
    def SetDivisions(self, _arg:(int, int, int)) -> None: ...
...
class vtkPCANormalEstimation(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetOrientationPoint(self) -> (float, float, float): ...
    def GetSampleSize(self) -> int: ...
    def GetSampleSizeMaxValue(self) -> int: ...
    def GetSampleSizeMinValue(self) -> int: ...
    def IsA(self, type:str) -> int: ...
    ...
    @overload
    def SetOrientationPoint(self, _arg:(float, float, float)) -> None: ...
    def SetSampleSize(self, _arg:int) -> None: ...
...
class vtkSPHKernel(vtkInterpolationKernel):
    ...
    def ComputeDerivWeights(self, x:[float, float, float], pIds:'vtkIdList', weights:'vtkDoubleArray', gradWeights:'vtkDoubleArray') -> int: ...
...
class vtkSignedDistance(vtkmodules.vtkCommonExecutionModel.vtkImageAlgorithm):
    ...
    @overload
    def SetDimensions(self, dim:(int, int, int)) -> None: ...
    def SetLocator(self, locator:'vtkAbstractPointLocator') -> None: ...
    def SetRadius(self, _arg:float) -> None: ...
...
class vtkVoxelGrid(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetDivisions(self) -> (int, int, int): ...
    def GetKernel(self) -> 'vtkInterpolationKernel': ...
    def GetLeafSize(self) -> (float, float, float): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    ...
    @overload
    def SetLeafSize(self, _arg:(float, float, float)) -> None: ...
