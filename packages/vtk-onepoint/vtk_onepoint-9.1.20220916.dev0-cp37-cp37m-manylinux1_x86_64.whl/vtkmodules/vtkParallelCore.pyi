...
class vtkCommunicator(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def AllGather(self, sendBuffer:(int, ...), recvBuffer:[int, ...], length:int) -> int: ...
    @overload
    def AllGather(self, sendBuffer:(int, ...), recvBuffer:[int, ...], length:int) -> int: ...
    @overload
    def AllGather(self, sendBuffer:str, recvBuffer:str, length:int) -> int: ...
    @overload
    def AllGather(self, sendBuffer:(float, ...), recvBuffer:[float, ...], length:int) -> int: ...
    @overload
    def AllGather(self, sendBuffer:(int, ...), recvBuffer:[int, ...], length:int) -> int: ...
    @overload
    def AllGather(self, sendBuffer:'vtkDataArray', recvBuffer:'vtkDataArray') -> int: ...
    @overload
    def AllGather(self, sendBuffer:'vtkDataObject', recvBuffer:[vtkDataObject, ...]) -> int: ...
    @overload
    def AllGatherV(self, sendBuffer:(int, ...), recvBuffer:[int, ...], sendLength:int, recvLengths:[int, ...], offsets:[int, ...]) -> int: ...
    @overload
    def AllGatherV(self, sendBuffer:(int, ...), recvBuffer:[int, ...], sendLength:int, recvLengths:[int, ...], offsets:[int, ...]) -> int: ...
    @overload
    def AllGatherV(self, sendBuffer:str, recvBuffer:str, sendLength:int, recvLengths:[int, ...], offsets:[int, ...]) -> int: ...
    @overload
    def AllGatherV(self, sendBuffer:(float, ...), recvBuffer:[float, ...], sendLength:int, recvLengths:[int, ...], offsets:[int, ...]) -> int: ...
    @overload
    def AllGatherV(self, sendBuffer:(int, ...), recvBuffer:[int, ...], sendLength:int, recvLengths:[int, ...], offsets:[int, ...]) -> int: ...
    @overload
    def AllGatherV(self, sendBuffer:'vtkDataArray', recvBuffer:'vtkDataArray', recvLengths:[int, ...], offsets:[int, ...]) -> int: ...
    @overload
    def AllGatherV(self, sendBuffer:'vtkDataArray', recvBuffer:'vtkDataArray') -> int: ...
    def AllGatherVVoidArray(self, sendBuffer:Pointer, recvBuffer:Pointer, sendLength:int, recvLengths:[int, ...], offsets:[int, ...], type:int) -> int: ...
    def AllGatherVoidArray(self, sendBuffer:Pointer, recvBuffer:Pointer, length:int, type:int) -> int: ...
    @overload
    def AllReduce(self, sendBuffer:(int, ...), recvBuffer:[int, ...], length:int, operation:int) -> int: ...
    @overload
    def AllReduce(self, sendBuffer:(int, ...), recvBuffer:[int, ...], length:int, operation:int) -> int: ...
    @overload
    def AllReduce(self, sendBuffer:str, recvBuffer:str, length:int, operation:int) -> int: ...
    @overload
    def AllReduce(self, sendBuffer:(float, ...), recvBuffer:[float, ...], length:int, operation:int) -> int: ...
    @overload
    def AllReduce(self, sendBuffer:(int, ...), recvBuffer:[int, ...], length:int, operation:int) -> int: ...
    @overload
    ...
    @overload
    def Broadcast(self, data:[int, ...], length:int, srcProcessId:int) -> int: ...
    @overload
    def Broadcast(self, data:[int, ...], length:int, srcProcessId:int) -> int: ...
    @overload
    def Broadcast(self, data:str, length:int, srcProcessId:int) -> int: ...
    @overload
    def Broadcast(self, data:[float, ...], length:int, srcProcessId:int) -> int: ...
    @overload
    def Broadcast(self, data:[int, ...], length:int, srcProcessId:int) -> int: ...
    @overload
    ...
    @overload
    def Gather(self, sendBuffer:(int, ...), recvBuffer:[int, ...], length:int, destProcessId:int) -> int: ...
    @overload
    def Gather(self, sendBuffer:(int, ...), recvBuffer:[int, ...], length:int, destProcessId:int) -> int: ...
    @overload
    def Gather(self, sendBuffer:str, recvBuffer:str, length:int, destProcessId:int) -> int: ...
    @overload
    def Gather(self, sendBuffer:(float, ...), recvBuffer:[float, ...], length:int, destProcessId:int) -> int: ...
    @overload
    def Gather(self, sendBuffer:(int, ...), recvBuffer:[int, ...], length:int, destProcessId:int) -> int: ...
    @overload
    def Gather(self, sendBuffer:'vtkDataArray', recvBuffer:'vtkDataArray', destProcessId:int) -> int: ...
    @overload
    def Gather(self, sendBuffer:'vtkDataObject', recvBuffer:[vtkDataObject, ...], destProcessId:int) -> int: ...
    @overload
    def GatherV(self, sendBuffer:(int, ...), recvBuffer:[int, ...], sendLength:int, recvLengths:[int, ...], offsets:[int, ...], destProcessId:int) -> int: ...
    @overload
    def GatherV(self, sendBuffer:(int, ...), recvBuffer:[int, ...], sendLength:int, recvLengths:[int, ...], offsets:[int, ...], destProcessId:int) -> int: ...
    @overload
    def GatherV(self, sendBuffer:str, recvBuffer:str, sendLength:int, recvLengths:[int, ...], offsets:[int, ...], destProcessId:int) -> int: ...
    @overload
    def GatherV(self, sendBuffer:(float, ...), recvBuffer:[float, ...], sendLength:int, recvLengths:[int, ...], offsets:[int, ...], destProcessId:int) -> int: ...
    @overload
    def GatherV(self, sendBuffer:(int, ...), recvBuffer:[int, ...], sendLength:int, recvLengths:[int, ...], offsets:[int, ...], destProcessId:int) -> int: ...
    @overload
    def GatherV(self, sendBuffer:'vtkDataArray', recvBuffer:'vtkDataArray', recvLengths:[int, ...], offsets:[int, ...], destProcessId:int) -> int: ...
    def GatherVVoidArray(self, sendBuffer:Pointer, recvBuffer:Pointer, sendLength:int, recvLengths:[int, ...], offsets:[int, ...], type:int, destProcessId:int) -> int: ...
    ...
    @overload
    def Receive(self, data:[int, ...], maxlength:int, remoteHandle:int, tag:int) -> int: ...
    @overload
    def Receive(self, data:[int, ...], maxlength:int, remoteHandle:int, tag:int) -> int: ...
    @overload
    def Receive(self, data:str, maxlength:int, remoteHandle:int, tag:int) -> int: ...
    @overload
    def Receive(self, data:[float, ...], maxlength:int, remoteHandle:int, tag:int) -> int: ...
    @overload
    def Receive(self, data:[int, ...], maxlength:int, remoteHandle:int, tag:int) -> int: ...
    @overload
    ...
    @overload
    def Reduce(self, sendBuffer:(int, ...), recvBuffer:[int, ...], length:int, operation:int, destProcessId:int) -> int: ...
    @overload
    def Reduce(self, sendBuffer:(int, ...), recvBuffer:[int, ...], length:int, operation:int, destProcessId:int) -> int: ...
    @overload
    def Reduce(self, sendBuffer:str, recvBuffer:str, length:int, operation:int, destProcessId:int) -> int: ...
    @overload
    def Reduce(self, sendBuffer:(float, ...), recvBuffer:[float, ...], length:int, operation:int, destProcessId:int) -> int: ...
    @overload
    def Reduce(self, sendBuffer:(int, ...), recvBuffer:[int, ...], length:int, operation:int, destProcessId:int) -> int: ...
    @overload
    ...
    @overload
    def Scatter(self, sendBuffer:(int, ...), recvBuffer:[int, ...], length:int, srcProcessId:int) -> int: ...
    @overload
    def Scatter(self, sendBuffer:(int, ...), recvBuffer:[int, ...], length:int, srcProcessId:int) -> int: ...
    @overload
    def Scatter(self, sendBuffer:str, recvBuffer:str, length:int, srcProcessId:int) -> int: ...
    @overload
    def Scatter(self, sendBuffer:(float, ...), recvBuffer:[float, ...], length:int, srcProcessId:int) -> int: ...
    @overload
    def Scatter(self, sendBuffer:(int, ...), recvBuffer:[int, ...], length:int, srcProcessId:int) -> int: ...
    @overload
    def Scatter(self, sendBuffer:'vtkDataArray', recvBuffer:'vtkDataArray', srcProcessId:int) -> int: ...
    @overload
    def ScatterV(self, sendBuffer:(int, ...), recvBuffer:[int, ...], sendLengths:[int, ...], offsets:[int, ...], recvLength:int, srcProcessId:int) -> int: ...
    @overload
    def ScatterV(self, sendBuffer:(int, ...), recvBuffer:[int, ...], sendLengths:[int, ...], offsets:[int, ...], recvLength:int, srcProcessId:int) -> int: ...
    @overload
    def ScatterV(self, sendBuffer:str, recvBuffer:str, sendLengths:[int, ...], offsets:[int, ...], recvLength:int, srcProcessId:int) -> int: ...
    @overload
    def ScatterV(self, sendBuffer:(float, ...), recvBuffer:[float, ...], sendLengths:[int, ...], offsets:[int, ...], recvLength:int, srcProcessId:int) -> int: ...
    @overload
    def ScatterV(self, sendBuffer:(int, ...), recvBuffer:[int, ...], sendLengths:[int, ...], offsets:[int, ...], recvLength:int, srcProcessId:int) -> int: ...
    def ScatterVVoidArray(self, sendBuffer:Pointer, recvBuffer:Pointer, sendLengths:[int, ...], offsets:[int, ...], recvLength:int, type:int, srcProcessId:int) -> int: ...
    ...
    @overload
    def Send(self, data:(int, ...), length:int, remoteHandle:int, tag:int) -> int: ...
    @overload
    def Send(self, data:(int, ...), length:int, remoteHandle:int, tag:int) -> int: ...
    @overload
    def Send(self, data:str, length:int, remoteHandle:int, tag:int) -> int: ...
    @overload
    def Send(self, data:(float, ...), length:int, remoteHandle:int, tag:int) -> int: ...
    @overload
    def Send(self, data:(int, ...), length:int, remoteHandle:int, tag:int) -> int: ...
    @overload
...
class vtkMultiProcessController(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def Receive(self, data:[int, ...], maxlength:int, remoteProcessId:int, tag:int) -> int: ...
    @overload
    def Receive(self, data:[int, ...], maxlength:int, remoteProcessId:int, tag:int) -> int: ...
    @overload
    def Receive(self, data:str, maxlength:int, remoteProcessId:int, tag:int) -> int: ...
    @overload
    def Receive(self, data:[float, ...], maxlength:int, remoteProcessId:int, tag:int) -> int: ...
    @overload
    def Receive(self, data:[int, ...], maxLength:int, remoteProcessId:int, tag:int) -> int: ...
    @overload
    ...
    def ScatterV(self, sendBuffer:(int, ...), recvBuffer:[int, ...], sendLengths:[int, ...], offsets:[int, ...], recvLength:int, srcProcessId:int) -> int: ...
    @overload
    def Send(self, data:(int, ...), length:int, remoteProcessId:int, tag:int) -> int: ...
    @overload
    def Send(self, data:(int, ...), length:int, remoteProcessId:int, tag:int) -> int: ...
    @overload
    def Send(self, data:str, length:int, remoteProcessId:int, tag:int) -> int: ...
    @overload
    def Send(self, data:(float, ...), length:int, remoteProcessId:int, tag:int) -> int: ...
    @overload
    def Send(self, data:(int, ...), length:int, remoteProcessId:int, tag:int) -> int: ...
    @overload
...
class vtkFieldDataSerializer(vtkmodules.vtkCommonCore.vtkObject):
    @staticmethod
    def DeSerializeToSubExtent(subext:[int, int, int, int, int, int], gridExtent:[int, int, int, int, int, int], fieldData:'vtkFieldData', bytestream:'vtkMultiProcessStream') -> None: ...
    @staticmethod
    ...
    @staticmethod
    def SerializeSubExtent(subext:[int, int, int, int, int, int], gridExtent:[int, int, int, int, int, int], fieldData:'vtkFieldData', bytestream:'vtkMultiProcessStream') -> None: ...
    @staticmethod
...
class vtkMultiProcessStream(object):
    ...
    def Empty(self) -> bool: ...
    @overload
    def GetRawData(self, data:[int, ...]) -> None: ...
    @overload
    def GetRawData(self, data:[int, ...], size:int) -> None: ...
    @overload
    def GetRawData(self) -> (int, ...): ...
    @overload
    def Pop(self, array:[float, ...], size:int) -> None: ...
    @overload
    def Pop(self, array:[int, ...], size:int) -> None: ...
    @overload
    def Push(self, array:[float, ...], size:int) -> None: ...
    @overload
    def Push(self, array:[int, ...], size:int) -> None: ...
    @overload
    ...
    @overload
    def SetRawData(self, __a:(int, ...), size:int) -> None: ...
    def Size(self) -> int: ...
...
class vtkSubGroup(vtkmodules.vtkCommonCore.vtkObject):
    ...
    @overload
    def Broadcast(self, data:[float, ...], length:int, root:int) -> int: ...
    @overload
    def Broadcast(self, data:[int, ...], length:int, root:int) -> int: ...
    @overload
    def Broadcast(self, data:str, length:int, root:int) -> int: ...
    @overload
    def Gather(self, data:[int, ...], to:[int, ...], length:int, root:int) -> int: ...
    @overload
    def Gather(self, data:str, to:str, length:int, root:int) -> int: ...
    @overload
    def Gather(self, data:[float, ...], to:[float, ...], length:int, root:int) -> int: ...
    @overload
    def Gather(self, data:[int, ...], to:[int, ...], length:int, root:int) -> int: ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    ...
    @overload
    def ReduceMax(self, data:[float, ...], to:[float, ...], length:int, root:int) -> int: ...
    @overload
    def ReduceMax(self, data:[int, ...], to:[int, ...], length:int, root:int) -> int: ...
    @overload
    def ReduceMin(self, data:[float, ...], to:[float, ...], length:int, root:int) -> int: ...
    @overload
    def ReduceMin(self, data:[int, ...], to:[int, ...], length:int, root:int) -> int: ...
    def ReduceSum(self, data:[int, ...], to:[int, ...], length:int, root:int) -> int: ...
    @staticmethod
