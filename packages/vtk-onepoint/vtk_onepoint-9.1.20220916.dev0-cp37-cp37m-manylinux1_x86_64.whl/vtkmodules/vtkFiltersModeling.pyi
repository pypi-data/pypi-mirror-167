...
class vtkCollisionDetectionFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def IntersectPolygonWithPolygon(self, npts:int, pts:[float, ...], bounds:[float, float, float, float, float, float], npts2:int, pts2:[float, ...], bounds2:[float, float, float, float, float, float], tol2:float, x1:[float, float], x2:[float, float, float], CollisionMode:int) -> int: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
...
class vtkHausdorffDistancePointSetFilter(vtkmodules.vtkCommonExecutionModel.vtkPointSetAlgorithm):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetRelativeDistance(self) -> (float, float): ...
...
class vtkLinearCellExtrusionFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetUserVector(self) -> (float, float, float): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @overload
    def SetUserVector(self, _arg:(float, float, float)) -> None: ...
...
class vtkLinearExtrusionFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetExtrusionPoint(self) -> (float, float, float): ...
    ...
    @overload
    def SetExtrusionPoint(self, _arg:(float, float, float)) -> None: ...
...
class vtkProjectedTexture(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    def GetAspectRatio(self) -> (float, float, float): ...
    ...
    def GetSRange(self) -> (float, float): ...
    def GetTRange(self) -> (float, float): ...
    def GetUp(self) -> (float, float, float): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @overload
    def SetSRange(self, _arg:(float, float)) -> None: ...
    @overload
    def SetTRange(self, _arg1:float, _arg2:float) -> None: ...
    @overload
    def SetTRange(self, _arg:(float, float)) -> None: ...
    @overload
    def SetUp(self, _arg1:float, _arg2:float, _arg3:float) -> None: ...
    @overload
    def SetUp(self, _arg:(float, float, float)) -> None: ...
...
class vtkRotationalExtrusionFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetResolutionMaxValue(self) -> int: ...
    def GetResolutionMinValue(self) -> int: ...
    def GetRotationAxis(self) -> (float, float, float): ...
    def GetTranslation(self) -> float: ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @overload
    def SetRotationAxis(self, _arg:(float, float, float)) -> None: ...
    def SetTranslation(self, _arg:float) -> None: ...
...
class vtkRuledSurfaceFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @overload
    def SetResolution(self, _arg:(int, int)) -> None: ...
...
class vtkSelectEnclosedPoints(vtkmodules.vtkCommonExecutionModel.vtkDataSetAlgorithm):
    ...
    @overload
    def IsInsideSurface(self, x:[float, float, float]) -> int: ...
    @overload
    def IsInsideSurface(self, x:float, y:float, z:float) -> int: ...
    @overload
    @staticmethod
    def IsInsideSurface(x:[float, float, float], surface:'vtkPolyData', bds:[float, float, float, float, float, float], length:float, tol:float, locator:'vtkAbstractCellLocator', cellIds:'vtkIdList', genCell:'vtkGenericCell', counter:'vtkIntersectionCounter', poole:'vtkRandomPool'=..., seqIdx:int=0) -> int: ...
    @staticmethod
...
class vtkSpherePuzzleArrows(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetPermutation(self) -> (int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int): ...
    def IsA(self, type:str) -> int: ...
    @staticmethod
    def IsTypeOf(type:str) -> int: ...
    ...
    @overload
    def SetPermutation(self, data:(int, ...)) -> None: ...
    @overload
...
class vtkTrimmedExtrusionFilter(vtkmodules.vtkCommonExecutionModel.vtkPolyDataAlgorithm):
    ...
    def GetExtrusionDirection(self) -> (float, float, float): ...
    ...
    @overload
    def SetExtrusionDirection(self, _arg:(float, float, float)) -> None: ...
...
class vtkVolumeOfRevolutionFilter(vtkmodules.vtkCommonExecutionModel.vtkUnstructuredGridAlgorithm):
    def GetAxisDirection(self) -> (float, float, float): ...
    def GetAxisPosition(self) -> (float, float, float): ...
    def GetNumberOfGenerationsFromBase(self, type:str) -> int: ...
    @staticmethod
    def GetNumberOfGenerationsFromBaseType(type:str) -> int: ...
    def GetOutputPointsPrecision(self) -> int: ...
    ...
    @overload
    def SetAxisDirection(self, _arg:(float, float, float)) -> None: ...
    @overload
    def SetAxisPosition(self, _arg1:float, _arg2:float, _arg3:float) -> None: ...
    @overload
    def SetAxisPosition(self, _arg:(float, float, float)) -> None: ...
    def SetOutputPointsPrecision(self, _arg:int) -> None: ...
    def SetResolution(self, _arg:int) -> None: ...
