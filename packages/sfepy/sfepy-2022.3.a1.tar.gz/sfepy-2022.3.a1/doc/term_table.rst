...
.. list-table:: Basic terms
   ...
   * - dw_biot
     ...
     - :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`bio <multi_physics-biot>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`the.ela <multi_physics-thermo_elasticity>`
   * - ev_biot_stress
   ...
   * - dw_diffusion
     ...
     - .. math::
            \int_{\Omega} K_{ij} \nabla_i q \nabla_j p
     - :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`bio <multi_physics-biot>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`poi.neu <diffusion-poisson_neumann>`
   ...
   * - dw_div_grad
     ...
     - :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`, :ref:`sto <navier_stokes-stokes>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`nav.sto <navier_stokes-navier_stokes>`
   * - dw_dot
     ...
     - :ref:`hyd <quantum-hydrogen>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`bal <large_deformation-balloon>`, :ref:`adv.1D <dg-advection_1D>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`osc <quantum-oscillator>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`adv.2D <dg-advection_2D>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`bor <quantum-boron>`, :ref:`wel <quantum-well>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`aco <acoustics-acoustics>`, :ref:`ela <linear_elasticity-elastodynamic>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`
   * - dw_elastic_wave
   ...
   * - dw_integrate
     ...
     - :ref:`aco <acoustics-acoustics>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`poi.neu <diffusion-poisson_neumann>`
   * - ev_integrate_mat
   ...
   * - dw_laplace
     ...
     - .. math::
            \int_{\Omega} c \nabla q \cdot \nabla p
     - :ref:`hyd <quantum-hydrogen>`, :ref:`cub <diffusion-cube>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`lap.1d <diffusion-laplace_1d>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`poi.par.stu <diffusion-poisson_parametric_study>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`poi <diffusion-poisson>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`lap.flu.2d <diffusion-laplace_fluid_2d>`, :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`osc <quantum-oscillator>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`poi.fie.dep.mat <diffusion-poisson_field_dependent_material>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`lap.cou.lcb <diffusion-laplace_coupling_lcbcs>`, :ref:`bor <quantum-boron>`, :ref:`wel <quantum-well>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`poi.iga <diffusion-poisson_iga>`, :ref:`lap.tim.ebc <diffusion-laplace_time_ebcs>`, :ref:`aco <acoustics-acoustics>`, :ref:`poi.sho.syn <diffusion-poisson_short_syntax>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`lap.2D <dg-laplace_2D>`, :ref:`sin <diffusion-sinbc>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`
   * - dw_lin_convect
   ...
   * - dw_lin_elastic
     ...
     - :ref:`two.bod.con <linear_elasticity-two_bodies_contact>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`, :ref:`lin.ela.mM <homogenization-linear_elastic_mM>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`lin.ela.iga <linear_elasticity-linear_elastic_iga>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`, :ref:`pre.fib <linear_elasticity-prestress_fibres>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`its.4 <linear_elasticity-its2D_4>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`lin.ela <linear_elasticity-linear_elastic>`, :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`, :ref:`bio <multi_physics-biot>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`ela.con.sph <linear_elasticity-elastic_contact_sphere>`, :ref:`pie.ela.mac <multi_physics-piezo_elasticity_macro>`, :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`ela <linear_elasticity-elastodynamic>`, :ref:`mat.non <linear_elasticity-material_nonlinearity>`, :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`ela.con.pla <linear_elasticity-elastic_contact_planes>`
   * - dw_lin_elastic_iso
   ...
   * - dw_point_load
     ...
     - .. math::
           ...
           \mbox{ in a region }
     - :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`its.4 <linear_elasticity-its2D_4>`, :ref:`she.can <linear_elasticity-shell10x_cantilever>`, :ref:`its.2 <linear_elasticity-its2D_2>`
   * - dw_point_lspring
   ...
   * - dw_stokes
     ...
     - .. math::
           ...
           \cdot \ul{u}
     - :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`, :ref:`sto <navier_stokes-stokes>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`nav.sto <navier_stokes-navier_stokes>`
   * - dw_stokes_wave
   ...
   * - dw_volume_lvf
     ...
     - .. math::
           ...
           \int_{\Omega} f q
     - :ref:`bur.2D <dg-burgers_2D>`, :ref:`poi.par.stu <diffusion-poisson_parametric_study>`, :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`poi.iga <diffusion-poisson_iga>`
   * - ev_volume_surface
