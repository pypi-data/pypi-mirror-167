            ...
            class Shapes:
                ...
                class Segment():
                    def __init__(self, TYPE=None, START_POS=[], END_POS=[], SIZE=26, ELASTICITY=0, FRICTION=1) -> None:
                        ...
                        self.segment_shape = pymunk.Segment(
                            self.type, self.start_pos, self.end_pos, self.size)
                ...
                class Rect():
                    def __init__(self, POSITION=[], SIZE=[], COLOR='red', ELASTICITY=0.8, FRICTION=1, MASS=1) -> None:
                        ...
                        self.rect_moment = pymunk.moment_for_box(
                            self.mass, self.size)
                        self.rect_body = pymunk.Body(
                            self.mass, self.rect_moment)
                        self.rect_body.position = self.position

                        self.rect_shape = pymunk.Poly.create_box(
                            self.rect_body, self.size)
        ...
        class Rect:
            def __init__(self, COLOR=(), POSITION=[], SIZE=[], THICKNESS=0, SURF=None, FUNCTION='none', R=0):
                ...
                if len(SIZE) == 1:
                    ...
                    self.size = SIZE
                print(self.size)
                center = [POSITION[0] + self.size[0] /
                          2, POSITION[1]+self.size[1]/2]
                ...
                self.DL_diagonal = math.sqrt(self.size[0]**2+self.size[1]**2)
