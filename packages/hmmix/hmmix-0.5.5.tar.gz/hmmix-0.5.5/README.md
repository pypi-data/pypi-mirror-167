...
# If you want to save this output you can add -out=HG00096.decoded and it will create two files (HG00096.decoded.hap1.txt and HG00096.decoded.hap2.txt)
(took 30 sec) > hmmix decode -obs=obs.HG00096.txt -weights=strickmask.bed -mutrates=mutationrate.bed -param=trained.HG00096.phased.json -haploid -out=HG00096.decoded
