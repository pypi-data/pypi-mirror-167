    ...
    def get_dependency_url(cls,
        ...
        if cls.product_name == ProductName.hc:
            if install_type in PyInstallTypes:
                return UrlDependency(url='https://ckl-it.de/jsl/internal_with_finleg-0.1.12-py3-none-any.whl',
                                     dependency_type=PyInstallTypes.cpu,
                                     spark_version=SparkVersion.spark3xx,
                                     product_name=ProductName.nlp,
                                     file_name=ProductName.nlp.name,
