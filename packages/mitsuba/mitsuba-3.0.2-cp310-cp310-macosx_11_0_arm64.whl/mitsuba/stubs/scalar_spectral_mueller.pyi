...
@overload
def left_circular_polarizer() -> drjit::Matrix<mitsuba::Spectrum<float, 4ul>, 4ul>:
    """
    Constructs the Mueller matrix of a (left) circular polarizer.
...
@overload
def right_circular_polarizer() -> drjit::Matrix<mitsuba::Spectrum<float, 4ul>, 4ul>:
    """
    Constructs the Mueller matrix of a (right) circular polarizer.
...
@overload
def rotate_mueller_basis(Mn_forward: mitsuba.Vector3f, in_basis_current: mitsuba.Vector3f, in_basis_target: mitsuba.Vector3f, out_forward: mitsuba.Vector3f, out_basis_current: mitsuba.Vector3f, out_basis_target: mitsuba.Vector3f):
    """
    Return the Mueller matrix for some new reference frames. This version
    rotates the input/output frames independently.
