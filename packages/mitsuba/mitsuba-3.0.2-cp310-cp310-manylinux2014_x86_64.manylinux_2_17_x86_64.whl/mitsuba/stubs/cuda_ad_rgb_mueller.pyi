...
@overload
def left_circular_polarizer() -> drjit::Matrix<mitsuba::Color<drjit::DiffArray<drjit::CUDAArray<float> >, 3ul>, 4ul>:
    """
    Constructs the Mueller matrix of a (left) circular polarizer.
...
@overload
def right_circular_polarizer() -> drjit::Matrix<mitsuba::Color<drjit::DiffArray<drjit::CUDAArray<float> >, 3ul>, 4ul>:
    """
    Constructs the Mueller matrix of a (right) circular polarizer.
...
@overload
def rotate_mueller_basis(Mn_forward: mitsuba.cuda_ad_rgb.Vector3f, in_basis_current: mitsuba.cuda_ad_rgb.Vector3f, in_basis_target: mitsuba.cuda_ad_rgb.Vector3f, out_forward: mitsuba.cuda_ad_rgb.Vector3f, out_basis_current: mitsuba.cuda_ad_rgb.Vector3f, out_basis_target: mitsuba.cuda_ad_rgb.Vector3f):
    """
    Return the Mueller matrix for some new reference frames. This version
    rotates the input/output frames independently.
