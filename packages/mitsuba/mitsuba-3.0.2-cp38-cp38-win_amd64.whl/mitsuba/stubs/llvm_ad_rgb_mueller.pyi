...
@overload
def left_circular_polarizer() -> drjit::Matrix<mitsuba::Color<drjit::DiffArray<drjit::LLVMArray<float> >,3>,4>:
    """
    Constructs the Mueller matrix of a (left) circular polarizer.
...
@overload
def right_circular_polarizer() -> drjit::Matrix<mitsuba::Color<drjit::DiffArray<drjit::LLVMArray<float> >,3>,4>:
    """
    Constructs the Mueller matrix of a (right) circular polarizer.
