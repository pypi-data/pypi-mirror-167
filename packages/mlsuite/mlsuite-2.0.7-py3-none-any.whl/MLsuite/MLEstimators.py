...
class ML():
    ...
    def Classification(self):
        ...
        'LinearSVMl1'   : {
            'estimator' : LinearSVC(penalty='l1', max_iter=1e6, random_state=123456),
            'parameters': {
        ...
        'SGD'           : {
            'estimator' : SGDClassifier(max_iter =1e5, learning_rate='optimal', n_jobs=2, random_state=123456),
            'parameters': {
