...
def transform(records, number_of_rotated_keys, dimension):
    ...
    tracker_log(f'ids - {df["ids"].values.tolist()}', f'W-UD-1to5 - transform - ')
    ...
    tracker_log(f'ts - {grouped_df["ts"].values.tolist()}', f'W-UD-1to5 - transform - ')
    ...
    for x in range(chunks):
        ...
        if df_sliced.shape[0] >= number_of_rotated_keys:
            ...
            tracker_log(f'{unique_ids}', f'W-UD-1to5 - transform - ')
