...
class Website:
    ...
    def expire_metrics(self):
        ...
        for id in ids:
            ...
            if expire_pg != 1:
                tracker_log(f'Expire key {self.metric_pageviews_key} = {expire_pg}', f'Website - ', 'warning')
            ...
            if expire_ud != 1:
                tracker_log(f'Expire key {self.metric_unique_device_key} = {expire_ud}', f'Website - ', 'warning')
