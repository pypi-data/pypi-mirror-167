...
def is_weird(last_visited, last_visited_rounded):
    ...
    # 2022-09-14 19:01:46.816000 -> 2022-09-14 19:02:00 is not between [2022-09-14 19:00:00 2022-09-14 19:01:00 2022-09-14 19:02:00]
    if now_inf <= record_rounded_dt <= now_sup:
        tracker_log(f'{record_dt} -> {record_rounded_dt} between [{now_inf} {now} {now_sup}]')
        return False
    else:
        tracker_log(f'{record_dt} -> {record_rounded_dt} is not between [{now_inf} {now} {now_sup}]')
        return True
