...
def is_weird(last_visited, last_visited_rounded):
    ...
    # TRACKER - 2022-09-14 19:19:45.383000 -> 2022-09-14 19:20:00 between [2022-09-14 19:19:00 2022-09-14 19:20:00 2022-09-14 19:21:00]
    # TRACKER - 2022-09-14 19:21:11.038000 -> 2022-09-14 19:21:00 between [2022-09-14 19:19:00 2022-09-14 19:20:00 2022-09-14 19:21:00]
    # Website - notification_of_active_websites - warning - [1663183200000 1663183260000] active websites 0 []
    # TRACKER - 2022-09-14 19:19:45.625000 -> 2022-09-14 19:20:00 between [2022-09-14 19:19:00 2022-09-14 19:20:00 2022-09-14 19:21:00]
    # Soit modifier le last updated
    if now_inf <= record_dt <= now_sup:
        tracker_log(f'{record_dt} -> {record_rounded_dt} between [{now_inf} {now} {now_sup}] <- {now}')
        return False
    else:
        tracker_log(f'{record_dt} -> {record_rounded_dt} is not between [{now_inf} {now} {now_sup}] <- {now}')
        return True
