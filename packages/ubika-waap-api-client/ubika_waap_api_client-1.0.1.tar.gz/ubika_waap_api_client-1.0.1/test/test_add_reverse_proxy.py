...
from ubika_waap_api_client.models.add_reverse_proxy import AddReverseProxy  # noqa: E501
from ubika_waap_api_client.rest import ApiException

class TestAddReverseProxy(unittest.TestCase):
    """AddReverseProxy unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test AddReverseProxy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ubika_waap_api_client.models.add_reverse_proxy.AddReverseProxy()  # noqa: E501
        if include_optional :
            return AddReverseProxy(
                ...
                no_log_on = ubika_waap_api_client.models.add_reverse_proxy_no_log_on.AddReverseProxy_noLogOn(
                    ...
                    value = '0', ), 
                labels = [
                    ubika_waap_api_client.models.add_reverse_proxy_labels_array.AddReverseProxyLabelsArray(
                        uid = '0', 
                        name = '0', )
                    ], 
