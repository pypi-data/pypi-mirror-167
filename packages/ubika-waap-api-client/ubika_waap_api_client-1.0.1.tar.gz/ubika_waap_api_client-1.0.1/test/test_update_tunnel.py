...
from ubika_waap_api_client.models.update_tunnel import UpdateTunnel  # noqa: E501
from ubika_waap_api_client.rest import ApiException

class TestUpdateTunnel(unittest.TestCase):
    """UpdateTunnel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = ubika_waap_api_client.models.update_tunnel.UpdateTunnel()  # noqa: E501
        if include_optional :
            return UpdateTunnel(
                name = '0', 
                ...
                workflow = ubika_waap_api_client.models.create_appliance_sysctl_profile.CreateAppliance_sysctlProfile(
                    ...
                    name = '0', ), 
                workflow_parameters = [
                    ubika_waap_api_client.models.update_tunnel_workflow_parameters_array.UpdateTunnelWorkflowParametersArray()
                    ], 
                application_template = '0', 
                enabled = True, 
                labels = [
                    ubika_waap_api_client.models.update_tunnel_labels_array.UpdateTunnelLabelsArray(
                        uid = '0', 
                        name = '0', )
                    ], 
                network = ubika_waap_api_client.models.update_tunnel_network.UpdateTunnel_network(
                ...
                logs = ubika_waap_api_client.models.update_tunnel_logs.UpdateTunnel_logs(
