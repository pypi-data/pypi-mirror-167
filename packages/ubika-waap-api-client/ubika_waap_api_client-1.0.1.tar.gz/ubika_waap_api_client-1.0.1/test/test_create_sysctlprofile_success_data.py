...
from ubika_waap_api_client.models.create_sysctlprofile_success_data import CreateSysctlprofileSuccessData  # noqa: E501
from ubika_waap_api_client.rest import ApiException

class TestCreateSysctlprofileSuccessData(unittest.TestCase):
    """CreateSysctlprofileSuccessData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CreateSysctlprofileSuccessData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ubika_waap_api_client.models.create_sysctlprofile_success_data.CreateSysctlprofileSuccessData()  # noqa: E501
        if include_optional :
            return CreateSysctlprofileSuccessData(
                uid = '0', 
                name = '0', 
                kernel_shm_max = 56, 
    ...
    def testCreateSysctlprofileSuccessData(self):
        """Test CreateSysctlprofileSuccessData"""
