...
from ubika_waap_api_client.models.get_tunnels_data_success_array_network_incoming import GetTunnelsDataSuccessArrayNetworkIncoming  # noqa: E501
from ubika_waap_api_client.rest import ApiException

class TestGetTunnelsDataSuccessArrayNetworkIncoming(unittest.TestCase):
    """GetTunnelsDataSuccessArrayNetworkIncoming unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GetTunnelsDataSuccessArrayNetworkIncoming
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ubika_waap_api_client.models.get_tunnels_data_success_array_network_incoming.GetTunnelsDataSuccessArrayNetworkIncoming()  # noqa: E501
        if include_optional :
            return GetTunnelsDataSuccessArrayNetworkIncoming(
                incoming_type = '0', 
                ip = '0', 
                port = 56, 
    ...
    def testGetTunnelsDataSuccessArrayNetworkIncoming(self):
        """Test GetTunnelsDataSuccessArrayNetworkIncoming"""
