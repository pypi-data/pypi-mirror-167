...
from ubika_waap_api_client.models.get_icx_success import GetIcxSuccess  # noqa: E501
from ubika_waap_api_client.rest import ApiException

class TestGetIcxSuccess(unittest.TestCase):
    """GetIcxSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = ubika_waap_api_client.models.get_icx_success.GetIcxSuccess()  # noqa: E501
        if include_optional :
            return GetIcxSuccess(
                data = [
                    ubika_waap_api_client.models.get_icx_data_success_array.GetIcxDataSuccessArray(
                        uid = '0', 
                        name = '0', 
                        description = '0', 
                        editable = True, 
