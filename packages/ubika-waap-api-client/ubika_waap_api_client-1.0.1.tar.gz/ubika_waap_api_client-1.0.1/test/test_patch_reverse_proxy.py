...
from ubika_waap_api_client.models.patch_reverse_proxy import PatchReverseProxy  # noqa: E501
from ubika_waap_api_client.rest import ApiException

class TestPatchReverseProxy(unittest.TestCase):
    """PatchReverseProxy unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PatchReverseProxy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ubika_waap_api_client.models.patch_reverse_proxy.PatchReverseProxy()  # noqa: E501
        if include_optional :
            return PatchReverseProxy(
                name = '0', 
                enabled = True, 
                healthcheck_uri = '0', 
                ...
                no_log_on = ubika_waap_api_client.models.add_reverse_proxy_no_log_on.AddReverseProxy_noLogOn(
                    ...
                    value = '0', ), 
                labels = [
                    ubika_waap_api_client.models.patch_reverse_proxy_labels_array.PatchReverseProxyLabelsArray(
                        uid = '0', 
                        name = '0', )
                    ], 
    ...
    def testPatchReverseProxy(self):
        """Test PatchReverseProxy"""
