...
from ubika_waap_api_client.models.get_sysctlprofiles_data_success_array import GetSysctlprofilesDataSuccessArray  # noqa: E501
from ubika_waap_api_client.rest import ApiException

class TestGetSysctlprofilesDataSuccessArray(unittest.TestCase):
    """GetSysctlprofilesDataSuccessArray unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GetSysctlprofilesDataSuccessArray
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ubika_waap_api_client.models.get_sysctlprofiles_data_success_array.GetSysctlprofilesDataSuccessArray()  # noqa: E501
        if include_optional :
            return GetSysctlprofilesDataSuccessArray(
                uid = '0', 
                name = '0', 
                kernel_shm_max = 56, 
    ...
    def testGetSysctlprofilesDataSuccessArray(self):
        """Test GetSysctlprofilesDataSuccessArray"""
