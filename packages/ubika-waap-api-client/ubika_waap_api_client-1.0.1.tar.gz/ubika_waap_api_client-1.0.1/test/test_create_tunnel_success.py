...
from ubika_waap_api_client.models.create_tunnel_success import CreateTunnelSuccess  # noqa: E501
from ubika_waap_api_client.rest import ApiException

class TestCreateTunnelSuccess(unittest.TestCase):
    """CreateTunnelSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test CreateTunnelSuccess
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ubika_waap_api_client.models.create_tunnel_success.CreateTunnelSuccess()  # noqa: E501
        if include_optional :
            return CreateTunnelSuccess(
                data = ubika_waap_api_client.models.create_tunnel_success_data.CreateTunnelSuccess_data(
                    uid = '0', 
                    name = '0', 
                    type = '0', 
                    network = ubika_waap_api_client.models.create_tunnel_success_data_network.CreateTunnelSuccess_data_network(
                    ...
                    workflow = ubika_waap_api_client.models.create_appliance_sysctl_profile.CreateAppliance_sysctlProfile(
                        ...
                        name = '0', ), 
                    workflow_parameters = [
                        ubika_waap_api_client.models.create_tunnel_workflow_parameters_success_array.CreateTunnelWorkflowParametersSuccessArray()
                        ], 
    ...
    def testCreateTunnelSuccess(self):
        """Test CreateTunnelSuccess"""
