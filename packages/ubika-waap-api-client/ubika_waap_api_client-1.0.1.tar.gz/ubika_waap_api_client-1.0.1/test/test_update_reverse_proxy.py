...
from ubika_waap_api_client.models.update_reverse_proxy import UpdateReverseProxy  # noqa: E501
from ubika_waap_api_client.rest import ApiException

class TestUpdateReverseProxy(unittest.TestCase):
    """UpdateReverseProxy unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test UpdateReverseProxy
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ubika_waap_api_client.models.update_reverse_proxy.UpdateReverseProxy()  # noqa: E501
        if include_optional :
            return UpdateReverseProxy(
                appliance = ubika_waap_api_client.models.update_network_interface_device.UpdateNetworkInterface_device(
                    uid = '0', ), 
                name = '0', 
                enabled = True, 
                healthcheck_uri = '0', 
                ...
                no_log_on = ubika_waap_api_client.models.add_reverse_proxy_no_log_on.AddReverseProxy_noLogOn(
                    ...
                    value = '0', ), 
                labels = [
                    ubika_waap_api_client.models.update_reverse_proxy_labels_array.UpdateReverseProxyLabelsArray(
                        uid = '0', 
                        name = '0', )
                    ], 
                syslog_destinations = ubika_waap_api_client.models.add_reverse_proxy_syslog_destinations.AddReverseProxy_syslogDestinations(
                    enabled = True, 
                    uids = '0', ), 
                logs = ubika_waap_api_client.models.add_reverse_proxy_logs.AddReverseProxy_logs(
                    debug = True, 
                    filter = ubika_waap_api_client.models.apply_ssl_key_uid.Apply_SSLKeyUid(
                        uid = '0', ), ), 
    ...
    def testUpdateReverseProxy(self):
        """Test UpdateReverseProxy"""
