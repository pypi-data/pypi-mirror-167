...
from ubika_waap_api_client.models.create_tunnel import CreateTunnel  # noqa: E501
from ubika_waap_api_client.rest import ApiException

class TestCreateTunnel(unittest.TestCase):
    """CreateTunnel unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = ubika_waap_api_client.models.create_tunnel.CreateTunnel()  # noqa: E501
        if include_optional :
            return CreateTunnel(
                name = '0', 
                ...
                workflow = ubika_waap_api_client.models.create_appliance_sysctl_profile.CreateAppliance_sysctlProfile(
                    ...
                    name = '0', ), 
                workflow_parameters = [
                    ubika_waap_api_client.models.create_tunnel_workflow_parameters_array.CreateTunnelWorkflowParametersArray(
                        name = '0', 
                        value = '0', )
                    ], 
                ...
                enabled = True, 
                labels = [
                    ubika_waap_api_client.models.create_tunnel_labels_array.CreateTunnelLabelsArray(
                        uid = '0', 
                        name = '0', )
                    ], 
                network = ubika_waap_api_client.models.create_tunnel_network.CreateTunnel_network(
                ...
                logs = ubika_waap_api_client.models.create_tunnel_logs.CreateTunnel_logs(
                    ...
                    debug = True, 
                    filter = '0', 
                    realtime = ubika_waap_api_client.models.create_tunnel_logs_realtime.CreateTunnel_logs_realtime(
                        security = True, 
                        security_format = '0', 
                        wam_format = '0', 
                        wam = True, 
                        ...
                        syslog_destination_profiles = [
                            ubika_waap_api_client.models.create_tunnel_syslog_destination_profiles_array.CreateTunnelSyslogDestinationProfilesArray(
                                uid = '0', 
                                name = '0', )
                            ], ), ), 
