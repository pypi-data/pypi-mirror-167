...
from ubika_waap_api_client.models.get_reverse_proxies_success import GetReverseProxiesSuccess  # noqa: E501
from ubika_waap_api_client.rest import ApiException

class TestGetReverseProxiesSuccess(unittest.TestCase):
    """GetReverseProxiesSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test GetReverseProxiesSuccess
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ubika_waap_api_client.models.get_reverse_proxies_success.GetReverseProxiesSuccess()  # noqa: E501
        if include_optional :
            return GetReverseProxiesSuccess(
                data = [
                    ubika_waap_api_client.models.get_reverse_proxies_data_success_array.GetReverseProxiesDataSuccessArray(
    ...
    def testGetReverseProxiesSuccess(self):
        """Test GetReverseProxiesSuccess"""
