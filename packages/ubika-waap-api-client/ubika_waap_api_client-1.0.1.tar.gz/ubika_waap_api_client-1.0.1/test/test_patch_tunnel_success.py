...
from ubika_waap_api_client.models.patch_tunnel_success import PatchTunnelSuccess  # noqa: E501
from ubika_waap_api_client.rest import ApiException

class TestPatchTunnelSuccess(unittest.TestCase):
    """PatchTunnelSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PatchTunnelSuccess
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ubika_waap_api_client.models.patch_tunnel_success.PatchTunnelSuccess()  # noqa: E501
        if include_optional :
            return PatchTunnelSuccess(
                data = ubika_waap_api_client.models.patch_tunnel_success_data.PatchTunnelSuccess_data(
                    uid = '0', 
                    name = '0', 
                    type = '0', 
                    ...
                    workflow = ubika_waap_api_client.models.create_appliance_sysctl_profile.CreateAppliance_sysctlProfile(
                        ...
                        name = '0', ), 
                    workflow_parameters = [
                        ubika_waap_api_client.models.patch_tunnel_workflow_parameters_success_array.PatchTunnelWorkflowParametersSuccessArray()
                        ], 
    ...
    def testPatchTunnelSuccess(self):
        """Test PatchTunnelSuccess"""
