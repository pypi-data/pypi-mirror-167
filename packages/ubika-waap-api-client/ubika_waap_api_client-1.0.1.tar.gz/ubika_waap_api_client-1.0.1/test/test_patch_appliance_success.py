...
from ubika_waap_api_client.models.patch_appliance_success import PatchApplianceSuccess  # noqa: E501
from ubika_waap_api_client.rest import ApiException

class TestPatchApplianceSuccess(unittest.TestCase):
    """PatchApplianceSuccess unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PatchApplianceSuccess
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ubika_waap_api_client.models.patch_appliance_success.PatchApplianceSuccess()  # noqa: E501
        if include_optional :
            return PatchApplianceSuccess(
                data = ubika_waap_api_client.models.patch_appliance_success_data.PatchApplianceSuccess_data(
                    uid = '0', 
                    name = '0', 
                    role = '0', 
                    autoscale = True, 
    ...
    def testPatchApplianceSuccess(self):
        """Test PatchApplianceSuccess"""
