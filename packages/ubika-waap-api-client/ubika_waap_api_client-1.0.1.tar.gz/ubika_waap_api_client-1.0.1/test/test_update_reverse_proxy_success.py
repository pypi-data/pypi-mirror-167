...
from ubika_waap_api_client.models.update_reverse_proxy_success import UpdateReverseProxySuccess  # noqa: E501
from ubika_waap_api_client.rest import ApiException

class TestUpdateReverseProxySuccess(unittest.TestCase):
    """UpdateReverseProxySuccess unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test UpdateReverseProxySuccess
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ubika_waap_api_client.models.update_reverse_proxy_success.UpdateReverseProxySuccess()  # noqa: E501
        if include_optional :
            return UpdateReverseProxySuccess(
                data = ubika_waap_api_client.models.update_reverse_proxy_success_data.UpdateReverseProxySuccess_data(
                    ...
                    no_log_on = ubika_waap_api_client.models.add_reverse_proxy_no_log_on.AddReverseProxy_noLogOn(
                        ...
                        value = '0', ), 
                    labels = [
                        ubika_waap_api_client.models.update_reverse_proxy_labels_success_array.UpdateReverseProxyLabelsSuccessArray(
                            uid = '0', 
                            name = '0', )
                        ], 
    ...
    def testUpdateReverseProxySuccess(self):
        """Test UpdateReverseProxySuccess"""
