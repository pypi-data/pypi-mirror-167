...
from ubika_waap_api_client.models.patch_tunnel_logs import PatchTunnelLogs  # noqa: E501
from ubika_waap_api_client.rest import ApiException

class TestPatchTunnelLogs(unittest.TestCase):
    """PatchTunnelLogs unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test PatchTunnelLogs
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = ubika_waap_api_client.models.patch_tunnel_logs.PatchTunnelLogs()  # noqa: E501
        if include_optional :
            return PatchTunnelLogs(
