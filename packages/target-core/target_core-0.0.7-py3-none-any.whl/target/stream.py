    ...
    async def writelines(self, lines: TextIO) -> Tuple[Optional[Any], Dict[Any, Any]]:
        ...
        for raw_line in lines:
            ...
            if message_type == 'SCHEMA':
                ...
                getcontext().prec = max(_all_precisions(line['schema']), default=getcontext().prec)
...
# def main(loader: type[Loader] = Loader, lines: TextIO = TextIOWrapper(sys.stdin.buffer, encoding='utf-8')) -> None:
