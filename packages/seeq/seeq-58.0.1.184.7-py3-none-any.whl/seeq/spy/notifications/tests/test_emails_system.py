...
def test_send_email():
    with mock.patch('seeq.spy.notifications._emails._call_send_email_api', mock.Mock(return_value=None)):
        ...
        test_status3 = Status()
        spy.notifications.send_email('test@seeq.com', 'Subject', 'Content', quiet=True, status=test_status3)
    ...
    with mock.patch('seeq.spy.notifications._emails._call_send_email_api',
        ...
        test_status1 = Status()
        spy.notifications.send_email('test@seeq.com', 'Subject', 'Content', errors='catalog', status=test_status1)
        ...
        spy.notifications.send_email('test@seeq.com', 'Subject', 'Content',
                                     errors='catalog', quiet=True, status=test_status2)
