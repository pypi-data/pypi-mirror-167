...
class Workstep(Item):
    ...
    @staticmethod
    def pull(workstep_tuple, *, worksheet=None, session: Session = None, errors='raise', status=None):
        ...
        workstep._pull(session, workstep_tuple, errors, status)
        return workstep

    def _pull(self, session: Session, workstep_tuple, errors, status):
        workbook_id, worksheet_id, workstep_id = workstep_tuple
