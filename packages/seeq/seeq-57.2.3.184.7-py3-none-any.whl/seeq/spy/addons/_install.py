...
def install(tool: Union[pd.DataFrame, pd.Series, dict, list], *, include_workbook_parameters: bool = True,
            update_tool: bool = False, update_permissions: bool = False, errors: str = 'raise',
            quiet: bool = False, status: Optional[Status] = None, session: Optional[Session] = None) -> pd.DataFrame:
    """
    ...
    >>>     "Target URL": "https://www.my.seeq.com/data-lab/8FB008FF-ECF0-4837-B3D4-7FCBB49CC108/apps/my_tool.ipynb",
    ...
    >>>         "Name": 'My New Tool',
    >>>         "Description": "this is an awesome tool",
    >>>         "Target URL": "https://my.seeq.com/data-lab/8FB008FF-ECF0-4837-B3D4-7FCBB49CC108/apps/my_tool.ipynb",
    >>>         "Icon": "fa fa-bell",
    >>>         "Groups": ['My Seeq Group']},
    >>>     {
    >>>         "Name": 'Your New Tool',
    >>>         "Description": "this is an awesome tool",
    >>>         "Target URL": "https://my.seeq.com/data-lab/F4DS345D-23DS-2344-SVSE-345234TSDF52/apps/tool2.ipynb",
    >>>         "Icon": "fa fa-bars",
    >>>         "Groups": ['Everyone']}]
