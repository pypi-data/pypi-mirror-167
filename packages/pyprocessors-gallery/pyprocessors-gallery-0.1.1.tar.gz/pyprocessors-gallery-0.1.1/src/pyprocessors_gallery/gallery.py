...
class GalleryParameters(ProcessorParameters):
    ...
    internal: str = Field(None,
                          ...
                          extra="internal")
    one_json: Optional[str] = Field(None, description="""Json array with a very long description with markdown, then you need to define a single rule composed of 2 tokens:<ol>
